...
namespace JOPPD
{
    public class NeoporeziviPrimitakElementPregledWorkItem : MdiWorkItemBase
    {
        public NeoporeziviPrimitakElementPregledWorkItem()
            : base("NeoporeziviPrimitak", new uscNeoporeziviPrimitakElementPregled())
        {
