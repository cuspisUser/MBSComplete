...
namespace JOPPD
{
    public partial class uscRadnoVrijeme : Controls.BaseUserControl
    {
        #region Svojstva
        ...
        private bool SaveData()
        {
            ...
            {
                if (save.Insert("JOPPDOznakaRadnogVremena"))
                {
            ...
            {
                if (save.Update("JOPPDOznakaRadnogVremena"))
                {
                    return true;
                }
            }
        ...
        public StringBuilder ValidateDataInput()
        {
            ...
            else if (BusinessLogic.pKratkiOpis.Length > 60)
            {
                message.Append(" - Kratki opis može sadržavati maksimalno 60 znakova");
            }
        ...
        private void btnSpremiZatvori_Click(object sender, EventArgs e)
        {
            ...
            if (message.Length == 0)
            {
                ...
                {
                    lblValidationMessages.Text = "Dogodila se greška prilikom upisa Radnog vremena.\nKontaktirajte administratora";
                }
            }
            else
            {
