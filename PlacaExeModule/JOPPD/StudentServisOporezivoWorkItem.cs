...
namespace JOPPD
{
    public class StudentServisOporezivoWorkItem : MdiWorkItemBase
    {
        public StudentServisOporezivoWorkItem()
            : base("StudentServisOporezivo", new uscStudentServisOporezivoPregled())
        {
