...
namespace JOPPD
{
    public class OznakaPrimitkaElementPregledWorkItem : MdiWorkItemBase
    {
        public OznakaPrimitkaElementPregledWorkItem()
            : base("OznakaPrimitkaElement", new uscOznakaPrimitkaElementPregled())
        {
