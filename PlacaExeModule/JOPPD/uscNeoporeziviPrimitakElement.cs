...
namespace JOPPD
{
    public partial class uscNeoporeziviPrimitakElement : Controls.BaseUserControl
    {
        #region Svojstva
        ...
        public uscNeoporeziviPrimitakElement(FormEditMode formEditMode)
        {
            InitializeComponent();
        ...
        private bool SaveData()
        {
            ...
            {
                if (save.InsertNeoporeziviPrimitakElement())
                {
            ...
            {
                if (save.UpdateNeoporeziviPrimitakElement())
                {
                    return true;
                }
            }
        ...
        {
            ucbJOPPDOznaka.DataSource = element.GetJOPPDOznakaNeoporeziviPrimitak().DefaultView;
        ...
        private void btnSpremiZatvori_Click(object sender, EventArgs e)
        {
            ...
            if (message.Length == 0)
            {
                ...
                {
                    lblValidationMessages.Text = "Dogodila se greška prilikom upisa neoporezivog primitka elementa.\nKontaktirajte administratora";
                }
            }
            else
            {
        ...
        private void btnSpremiNovi_Click(object sender, EventArgs e)
        {
            ...
            if (message.Length == 0)
            {
                ...
                {
                    lblValidationMessages.Text = "Dogodila se greška prilikom upisa neoporezivog primitka element.\nKontaktirajte administratora";
                }
            }
            else
            {
