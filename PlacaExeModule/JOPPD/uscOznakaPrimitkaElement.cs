...
namespace JOPPD
{
    public partial class uscOznakaPrimitkaElement : Controls.BaseUserControl
    {
        #region Svojstva
        ...
        {
            ucbJOPPDOznaka.DataSource = element.GetJOPPDOznakaPrimitka().DefaultView; 
        ...
        private void btnSpremiZatvori_Click(object sender, EventArgs e)
        {
            ...
            if (message.Length == 0)
            {
                ...
                {
                    lblValidationMessages.Text = "Dogodila se greška prilikom upisa oznake primitka elementa.\nKontaktirajte administratora";
                }
            }
            else
            {
