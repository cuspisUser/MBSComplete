...
namespace JOPPD
{
    public partial class uscNacinIsplateElement : Controls.BaseUserControl
    {
        #region Svojstva
        ...
        public uscNacinIsplateElement(FormEditMode formEditMode)
        {
            InitializeComponent();
        ...
        private bool SaveData()
        {
            ...
            {
                if (save.InsertNacinIsplateElement())
                {
            ...
            {
                if (save.UpdateNacinIsplateElement())
                {
                    return true;
                }
            }
        ...
        {
            ucbJOPPDOznaka.DataSource = element.GetJOPPDOznakaNacinIsplate().DefaultView;
        ...
        private void btnSpremiZatvori_Click(object sender, EventArgs e)
        {
            ...
            if (message.Length == 0)
            {
                ...
                {
                    lblValidationMessages.Text = "Dogodila se greška prilikom upisa načina ispate elementa.\nKontaktirajte administratora";
                }
            }
            else
            {
        ...
        private void btnSpremiNovi_Click(object sender, EventArgs e)
        {
            ...
            if (message.Length == 0)
            {
                ...
                {
                    lblValidationMessages.Text = "Dogodila se greška prilikom upisa načina isplate element.\nKontaktirajte administratora";
                }
            }
            else
            {
