...
{
    [SmartPart]
    public partial class uscNagradeNatjecanjaPregled : UserControl, ISmartPartInfoProvider, IFilteredView
    {
        ...
        private void LoadDataMainGrid()
        {
            ...
            ugdNagradeNatjecanja.DataSource = element.GetNagradeNatjecanja();
        ...
        {
            using (uscObracuni objekt = new uscObracuni(Enums.FormEditMode.Insert, Enums.Vrstaobracuna.NagradeNatjecanja))
            {
                if (objekt.ShowDialogForm("NagradeNatjecanja") == DialogResult.OK)
                    LoadDataMainGrid();
            }
        }
        ...
        public void Update(object sender, EventArgs e)
        {
            if (ugdNagradeNatjecanja.ActiveRow != null)
            {
                ...
                using (uscObracuni objekt = new uscObracuni(Enums.FormEditMode.Update, Enums.Vrstaobracuna.NagradeNatjecanja))
                {
                    if (objekt.ShowDialogForm("NagradeNatjecanja") == DialogResult.OK)
                        LoadDataMainGrid();
                }
        ...
        public void Virmani(object sender, EventArgs e)
        {
            if (this.ugdNagradeNatjecanja.ActiveRow != null)
            {
                ...
                VirmaniWorkItemUser.OsobeIzObracuna.obracunRaznoVrsta = Enums.Vrstaobracuna.NagradeNatjecanja;
