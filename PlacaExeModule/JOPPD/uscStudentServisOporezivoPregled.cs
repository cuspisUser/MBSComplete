...
{
    [SmartPart]
    public partial class uscStudentServisOporezivoPregled : UserControl, ISmartPartInfoProvider, IFilteredView
    {
        ...
        {
            using (uscObracuni objekt = new uscObracuni(Enums.FormEditMode.Insert, Enums.Vrstaobracuna.StudentServisOporezivo))
            {
                if (objekt.ShowDialogForm("StudentServisOporezivo") == DialogResult.OK)
                    LoadDataMainGrid();
            }
        }
        ...
        public void Update(object sender, EventArgs e)
        {
            if (ugdNagradeNatjecanja.ActiveRow != null)
            {
                ...
                using (uscObracuni objekt = new uscObracuni(Enums.FormEditMode.Update, Enums.Vrstaobracuna.StudentServisOporezivo))
                {
                    if (objekt.ShowDialogForm("StudentServisOporezivo") == DialogResult.OK)
                        LoadDataMainGrid();
                }
        ...
        public void Virmani(object sender, EventArgs e)
        {
            if (this.ugdNagradeNatjecanja.ActiveRow != null)
            {
                ...
                VirmaniWorkItemUser.OsobeIzObracuna.obracunRaznoVrsta = Enums.Vrstaobracuna.StudentServisOporezivo;
