...
namespace JOPPD
{
    public class StjecateljPrimitkaElementPregledWorkItem : MdiWorkItemBase
    {
        public StjecateljPrimitkaElementPregledWorkItem()
            : base("StjecateljPrimitkaElement", new uscStjecateljPrimitkaElementPregled())
        {
