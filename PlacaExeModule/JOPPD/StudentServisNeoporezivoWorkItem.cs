...
namespace JOPPD
{
    public class StudentServisNeoporezivoWorkItem : MdiWorkItemBase
    {
        public StudentServisNeoporezivoWorkItem()
            : base("StudentServisNeoporezivo", new uscStudentServisNeoporezivoPregled())
        {
            this.UICommandDefinitionContainer.Add(new UICommandDefinition[]{
                ...
                new UICommandDefinition("Virmani", "Virmani", this.Site + ".Tasks", ImageResourcesNew.page_refresh, null, null), 
