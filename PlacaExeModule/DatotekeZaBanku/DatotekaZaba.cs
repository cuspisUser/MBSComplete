...
{
    public class DatotekaZaba : UserControl
    {
        ...
        public DatotekaZaba()
        {
            base.Load += new EventHandler(this.DatotekaZaba_Load);
            this.sifraObracuna = "";
            this.Ziro = "";
            this.VBDI = My.Resources.ResourcesPlacaExe.VBDIZABA;
        ...
        private void DatotekaZaba_Load(object sender, EventArgs e)
        {
            this.datumUplate.Value = DateTime.Now;
            this.BrojPoslovnice.Value = "0";
            this.datumUplate.Focus();
            this.datumUplate.Select();
            this.datumUplate.SelectAll();
        ...
        private void InitializeComponent()
        {
            ...
            this.Panel2.Size = new System.Drawing.Size(437, 24);
            this.Panel2.TabIndex = 1;
            // 
            // ButtonDatotekaUniverzalna
            // 
            this.ButtonDatotekaUniverzalna.Location = new System.Drawing.Point(212, 1);
            ...
            this.ButtonDatotekaUniverzalna.TabIndex = 6;
            ...
            this.PozivNaBrojZaduzenja.Location = new System.Drawing.Point(167, 89);
            ...
            this.UltraLabel2.Location = new System.Drawing.Point(12, 89);
            ...
            this.ModelZaduzenja.Location = new System.Drawing.Point(167, 65);
            ...
            this.BrojPoslovnice.Location = new System.Drawing.Point(167, 40);
            this.BrojPoslovnice.MaxLength = 8;
            this.BrojPoslovnice.Name = "BrojPoslovnice";
            this.BrojPoslovnice.Size = new System.Drawing.Size(108, 21);
            ...
            this.datumUplate.Location = new System.Drawing.Point(167, 16);
            this.datumUplate.Name = "datumUplate";
            this.datumUplate.Size = new System.Drawing.Size(108, 21);
            ...
            this.Name = "DatotekaZaba";
            this.Size = new System.Drawing.Size(453, 177);
        ...
        private void SnimiDatoteku()
        {
            ...
            {
                string str = "";
                str = Conversions.ToString(Operators.ConcatenateObject(Operators.ConcatenateObject("PL", Interaction.IIf(this.datumUplate.Text.Trim() == "", DateTime.Now.ToString("ddMMyy"), Conversions.ToDate(this.datumUplate.Value).ToString("ddMMyy"))), ".TXT"));
                try
                {
                    ...
                    {
                        if (this.Datoteka_Zaba(dialog.FileName))
                        {
        ...
        internal UltraTextEditor BrojPoslovnice;
        ...
        private void ButtonDatotekaUniverzalna_Click(object sender, EventArgs e)
        {
            ...
            frmRadSaBankama.IzradiDatotekuZbrojnogNalogaPoBanci(this.VBDI, (DateTime)this.datumUplate.Value, this.ModelZaduzenja.Text, this.PozivNaBrojZaduzenja.Text);
        }
    }
}
