namespace NetAdvantage.Controls
{
    ...
    public class IRADataGrid : DeklaritDataGrid
    {
        private int currentRow;
        private IRADataSet dsIRADataSet1 = new IRADataSet();
        private System.Data.DataView dv1;
        private int m_FillByIDTIPIRAIDTIPIRA;
        private int m_FillByIRADOKIDDOKUMENTIRADOKIDDOKUMENT;
        private int m_FillByIRAGODIDGODINEIRADOKIDDOKUMENTIRADOKIDDOKUMENT;
        private short m_FillByIRAGODIDGODINEIRADOKIDDOKUMENTIRAGODIDGODINE;
        private short m_FillByIRAGODIDGODINEIRAGODIDGODINE;
        private int m_FillByIRAPARTNERIDPARTNERIRAPARTNERIDPARTNER;
        ...
        {
            this.BindDataGrid();
            DeklaritDataGrid.myFillMethods = new TypeConverter.StandardValuesCollection(new string[] { "Fill", "FillByIRADOKIDDOKUMENT", "FillByIRAPARTNERIDPARTNER", "FillByIDTIPIRA", "FillByIRAGODIDGODINE", "FillByIRAGODIDGODINEIRADOKIDDOKUMENT" });
        ...
        private void BindDataGrid()
        {
            ...
            this.dv1.Table = this.dsIRADataSet1.IRA;
        ...
        {
            this.PreFill();
            this.dsIRADataSet1 = new IRADataSet();
            this.m_StartRow = 0;
        ...
        private void FillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    ...
                    {
                        this.DataAdapter.FillPage(this.dsIRADataSet1, 0, this.PageSize);
                    }
                    else
                    {
                        MethodInfo info = this.DataAdapter.GetType().GetMethod("FillPageBy" + this.FillMethod.Substring(6));
                        this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsIRADataSet1, info, 0, this.PageSize);
                    }
                }
                else if (this.FillMethod == "Fill")
                {
                    this.DataAdapter.Fill(this.dsIRADataSet1);
                }
                else
                {
                    MethodInfo info2 = this.DataAdapter.GetType().GetMethod(this.FillMethod);
                    this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsIRADataSet1, info2);
                }
        ...
        private void ReFillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    if (this.FillMethod == "Fill")
                    {
                        this.DataAdapter.FillPage(this.dsIRADataSet1, this.startRowThread, this.PageSize);
                    }
                    else
                    {
                        MethodInfo info = this.DataAdapter.GetType().GetMethod("FillPageBy" + this.FillMethod.Substring(6));
                        this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsIRADataSet1, info, this.startRowThread, this.PageSize);
                    }
                }
        ...
        private void ResumeBindingPostThread()
        {
            ...
            this.EndUpdate();
            this.BindDataGrid();
            this.Text = "IRA : " + this.DataView.Count.ToString(CultureInfo.InvariantCulture) + " " + Deklarit.Resources.Resources.Rows;
        ...
        public virtual IIRADataAdapter DataAdapter
        {
            get
            {
                ...
                if (DataAdapterFactory.Provider != null)
                {
                    return DataAdapterFactory.GetIRADataAdapter();
                }
                return null;
            }
        }
        ...
        public virtual IRADataSet DataSet
        {
            get
            {
                return this.dsIRADataSet1;
            }
            set
            {
                this.dsIRADataSet1 = value;
            }
        }
        ...
        public virtual int FillByIDTIPIRAIDTIPIRA
        {
            get
            {
                return this.m_FillByIDTIPIRAIDTIPIRA;
            }
            set
            {
                this.m_FillByIDTIPIRAIDTIPIRA = value;
            }
        }
        ...
        public virtual int FillByIRADOKIDDOKUMENTIRADOKIDDOKUMENT
        {
            get
            {
                return this.m_FillByIRADOKIDDOKUMENTIRADOKIDDOKUMENT;
            }
            set
            {
                this.m_FillByIRADOKIDDOKUMENTIRADOKIDDOKUMENT = value;
            }
        }
        ...
        public virtual int FillByIRAGODIDGODINEIRADOKIDDOKUMENTIRADOKIDDOKUMENT
        {
            get
            {
                return this.m_FillByIRAGODIDGODINEIRADOKIDDOKUMENTIRADOKIDDOKUMENT;
            }
            set
            {
                this.m_FillByIRAGODIDGODINEIRADOKIDDOKUMENTIRADOKIDDOKUMENT = value;
            }
        }
        ...
        public virtual short FillByIRAGODIDGODINEIRADOKIDDOKUMENTIRAGODIDGODINE
        {
            get
            {
                return this.m_FillByIRAGODIDGODINEIRADOKIDDOKUMENTIRAGODIDGODINE;
            }
            set
            {
                this.m_FillByIRAGODIDGODINEIRADOKIDDOKUMENTIRAGODIDGODINE = value;
            }
        }
        ...
        public virtual short FillByIRAGODIDGODINEIRAGODIDGODINE
        {
            get
            {
                return this.m_FillByIRAGODIDGODINEIRAGODIDGODINE;
            }
            set
            {
                this.m_FillByIRAGODIDGODINEIRAGODIDGODINE = value;
            }
        }
        ...
        public virtual int FillByIRAPARTNERIDPARTNERIRAPARTNERIDPARTNER
        {
            get
            {
                return this.m_FillByIRAPARTNERIDPARTNERIRAPARTNERIDPARTNER;
            }
            set
            {
                this.m_FillByIRAPARTNERIDPARTNERIRAPARTNERIDPARTNER = value;
            }
        }
