namespace NetAdvantage.Controls
{
    ...
    public class S_FIN_KONTO_KARTICEDataGrid : DeklaritDataGrid
    {
        private int currentRow;
        private S_FIN_KONTO_KARTICEDataSet dsS_FIN_KONTO_KARTICEDataSet1 = new S_FIN_KONTO_KARTICEDataSet();
        ...
        public S_FIN_KONTO_KARTICEDataGrid()
        {
            this.BindDataGrid();
        ...
        private void BindDataGrid()
        {
            ...
            this.dv1.Table = this.dsS_FIN_KONTO_KARTICEDataSet1.S_FIN_KONTO_KARTICE;
        ...
        {
            this.PreFill();
            this.dsS_FIN_KONTO_KARTICEDataSet1 = new S_FIN_KONTO_KARTICEDataSet();
            this.m_StartRow = 0;
        ...
        private void FillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dsS_FIN_KONTO_KARTICEDataSet1, this.m_ParameterORG, this.m_ParameterMT, this.m_ParameterDOK, this.m_ParameterRAZDOBLJEOD, this.m_ParameterRAZDOBLJEDO, this.m_ParameterPOCETNIKONTO, this.m_ParameterZAVRSNIKONTO, 0, this.PageSize);
                }
                else
                {
                    this.DataAdapter.Fill(this.dsS_FIN_KONTO_KARTICEDataSet1, this.m_ParameterORG, this.m_ParameterMT, this.m_ParameterDOK, this.m_ParameterRAZDOBLJEOD, this.m_ParameterRAZDOBLJEDO, this.m_ParameterPOCETNIKONTO, this.m_ParameterZAVRSNIKONTO);
                }
        ...
        private void ReFillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dsS_FIN_KONTO_KARTICEDataSet1, this.m_ParameterORG, this.m_ParameterMT, this.m_ParameterDOK, this.m_ParameterRAZDOBLJEOD, this.m_ParameterRAZDOBLJEDO, this.m_ParameterPOCETNIKONTO, this.m_ParameterZAVRSNIKONTO, this.startRowThread, this.PageSize);
                }
        ...
        private void ResumeBindingPostThread()
        {
            ...
            this.EndUpdate();
            this.BindDataGrid();
            this.Text = "S_FIN_KONTO_KARTICE : " + this.DataView.Count.ToString(CultureInfo.InvariantCulture) + " " + Deklarit.Resources.Resources.Rows;
        ...
        public virtual IS_FIN_KONTO_KARTICEDataAdapter DataAdapter
        {
            get
            {
                ...
                if (DataAdapterFactory.Provider != null)
                {
                    return DataAdapterFactory.GetS_FIN_KONTO_KARTICEDataAdapter();
                }
                return null;
            }
        }
        ...
        [Browsable(false), Category("Deklarit Work With ")]
        public virtual S_FIN_KONTO_KARTICEDataSet DataSet
        {
            get
            {
                return this.dsS_FIN_KONTO_KARTICEDataSet1;
            }
            set
            {
                this.dsS_FIN_KONTO_KARTICEDataSet1 = value;
            }
        }
