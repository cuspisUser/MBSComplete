namespace NetAdvantage.Controls
{
    ...
    public class vw_mjeseci_godine_isplateDataGrid : DeklaritDataGrid
    {
        private int currentRow;
        private vw_mjeseci_godine_isplateDataSet dsvw_mjeseci_godine_isplateDataSet1 = new vw_mjeseci_godine_isplateDataSet();
        ...
        public vw_mjeseci_godine_isplateDataGrid()
        {
            this.BindDataGrid();
        ...
        private void BindDataGrid()
        {
            ...
            this.dv1.Table = this.dsvw_mjeseci_godine_isplateDataSet1.vw_mjeseci_godine_isplate;
        ...
        {
            this.PreFill();
            this.dsvw_mjeseci_godine_isplateDataSet1 = new vw_mjeseci_godine_isplateDataSet();
            this.m_StartRow = 0;
        ...
        private void FillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dsvw_mjeseci_godine_isplateDataSet1, 0, this.PageSize);
                }
                else
                {
                    this.DataAdapter.Fill(this.dsvw_mjeseci_godine_isplateDataSet1);
                }
        ...
        private void ReFillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dsvw_mjeseci_godine_isplateDataSet1, this.startRowThread, this.PageSize);
                }
        ...
        private void ResumeBindingPostThread()
        {
            ...
            this.EndUpdate();
            this.BindDataGrid();
            this.Text = "vw_mjeseci_godine_isplate : " + this.DataView.Count.ToString(CultureInfo.InvariantCulture) + " " + Deklarit.Resources.Resources.Rows;
        ...
        public virtual Ivw_mjeseci_godine_isplateDataAdapter DataAdapter
        {
            get
            {
                ...
                if (DataAdapterFactory.Provider != null)
                {
                    return DataAdapterFactory.Getvw_mjeseci_godine_isplateDataAdapter();
                }
                return null;
            }
        }
        ...
        [Browsable(false), Category("Deklarit Work With ")]
        public virtual vw_mjeseci_godine_isplateDataSet DataSet
        {
            get
            {
                return this.dsvw_mjeseci_godine_isplateDataSet1;
            }
            set
            {
                this.dsvw_mjeseci_godine_isplateDataSet1 = value;
            }
        }
