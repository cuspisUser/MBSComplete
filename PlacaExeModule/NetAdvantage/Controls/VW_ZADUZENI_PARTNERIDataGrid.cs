namespace NetAdvantage.Controls
{
    ...
    public class VW_ZADUZENI_PARTNERIDataGrid : DeklaritDataGrid
    {
        private int currentRow;
        private VW_ZADUZENI_PARTNERIDataSet dsVW_ZADUZENI_PARTNERIDataSet1 = new VW_ZADUZENI_PARTNERIDataSet();
        ...
        public VW_ZADUZENI_PARTNERIDataGrid()
        {
            this.BindDataGrid();
        ...
        private void BindDataGrid()
        {
            ...
            this.dv1.Table = this.dsVW_ZADUZENI_PARTNERIDataSet1.VW_ZADUZENI_PARTNERI;
        ...
        {
            this.PreFill();
            this.dsVW_ZADUZENI_PARTNERIDataSet1 = new VW_ZADUZENI_PARTNERIDataSet();
            this.m_StartRow = 0;
        ...
        private void FillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dsVW_ZADUZENI_PARTNERIDataSet1, 0, this.PageSize);
                }
                else
                {
                    this.DataAdapter.Fill(this.dsVW_ZADUZENI_PARTNERIDataSet1);
                }
        ...
        private void ReFillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dsVW_ZADUZENI_PARTNERIDataSet1, this.startRowThread, this.PageSize);
                }
        ...
        private void ResumeBindingPostThread()
        {
            ...
            this.EndUpdate();
            this.BindDataGrid();
            this.Text = "VW_ZADUZENI_PARTNERI : " + this.DataView.Count.ToString(CultureInfo.InvariantCulture) + " " + Deklarit.Resources.Resources.Rows;
        ...
        public virtual IVW_ZADUZENI_PARTNERIDataAdapter DataAdapter
        {
            get
            {
                ...
                if (DataAdapterFactory.Provider != null)
                {
                    return DataAdapterFactory.GetVW_ZADUZENI_PARTNERIDataAdapter();
                }
                return null;
            }
        }
        ...
        public virtual VW_ZADUZENI_PARTNERIDataSet DataSet
        {
            get
            {
                return this.dsVW_ZADUZENI_PARTNERIDataSet1;
            }
            set
            {
                this.dsVW_ZADUZENI_PARTNERIDataSet1 = value;
            }
        }
