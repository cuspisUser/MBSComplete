namespace NetAdvantage.Controls
{
    ...
    public class S_FIN_FINANCIJSKO_UPRAVLJANJEDataGrid : DeklaritDataGrid
    {
        private int currentRow;
        private S_FIN_FINANCIJSKO_UPRAVLJANJEDataSet dsS_FIN_FINANCIJSKO_UPRAVLJANJEDataSet1 = new S_FIN_FINANCIJSKO_UPRAVLJANJEDataSet();
        ...
        public S_FIN_FINANCIJSKO_UPRAVLJANJEDataGrid()
        {
            this.BindDataGrid();
        ...
        private void BindDataGrid()
        {
            ...
            this.dv1.Table = this.dsS_FIN_FINANCIJSKO_UPRAVLJANJEDataSet1.S_FIN_FINANCIJSKO_UPRAVLJANJE;
        ...
        {
            this.PreFill();
            this.dsS_FIN_FINANCIJSKO_UPRAVLJANJEDataSet1 = new S_FIN_FINANCIJSKO_UPRAVLJANJEDataSet();
            this.m_StartRow = 0;
        ...
        private void FillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dsS_FIN_FINANCIJSKO_UPRAVLJANJEDataSet1, this.m_ParameterRAZDOBLJEOD, this.m_ParameterRAZDOBLJEDO, 0, this.PageSize);
                }
                else
                {
                    this.DataAdapter.Fill(this.dsS_FIN_FINANCIJSKO_UPRAVLJANJEDataSet1, this.m_ParameterRAZDOBLJEOD, this.m_ParameterRAZDOBLJEDO);
                }
        ...
        private void ReFillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dsS_FIN_FINANCIJSKO_UPRAVLJANJEDataSet1, this.m_ParameterRAZDOBLJEOD, this.m_ParameterRAZDOBLJEDO, this.startRowThread, this.PageSize);
                }
        ...
        private void ResumeBindingPostThread()
        {
            ...
            this.EndUpdate();
            this.BindDataGrid();
            this.Text = "S_FIN_FINANCIJSKO_UPRAVLJANJE : " + this.DataView.Count.ToString(CultureInfo.InvariantCulture) + " " + Deklarit.Resources.Resources.Rows;
        ...
        public virtual IS_FIN_FINANCIJSKO_UPRAVLJANJEDataAdapter DataAdapter
        {
            get
            {
                ...
                if (DataAdapterFactory.Provider != null)
                {
                    return DataAdapterFactory.GetS_FIN_FINANCIJSKO_UPRAVLJANJEDataAdapter();
                }
                return null;
            }
        }
        ...
        public virtual S_FIN_FINANCIJSKO_UPRAVLJANJEDataSet DataSet
        {
            get
            {
                return this.dsS_FIN_FINANCIJSKO_UPRAVLJANJEDataSet1;
            }
            set
            {
                this.dsS_FIN_FINANCIJSKO_UPRAVLJANJEDataSet1 = value;
            }
        }
