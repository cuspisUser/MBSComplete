namespace NetAdvantage.Controls
{
    ...
    public class TIPOLAKSICEDataGrid : DeklaritDataGrid
    {
        private int currentRow;
        private TIPOLAKSICEDataSet dsTIPOLAKSICEDataSet1 = new TIPOLAKSICEDataSet();
        ...
        private void BindDataGrid()
        {
            ...
            this.dv1.Table = this.dsTIPOLAKSICEDataSet1.TIPOLAKSICE;
        ...
        private void FillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    ...
                    {
                        this.DataAdapter.FillPage(this.dsTIPOLAKSICEDataSet1, 0, this.PageSize);
                    }
                    else
                    {
                        MethodInfo info = this.DataAdapter.GetType().GetMethod("FillPageBy" + this.FillMethod.Substring(6));
                        this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsTIPOLAKSICEDataSet1, info, 0, this.PageSize);
                    }
                }
                else if (this.FillMethod == "Fill")
                {
                    this.DataAdapter.Fill(this.dsTIPOLAKSICEDataSet1);
                }
                else
                {
                    MethodInfo info2 = this.DataAdapter.GetType().GetMethod(this.FillMethod);
                    this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsTIPOLAKSICEDataSet1, info2);
                }
        ...
        private void ReFillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    if (this.FillMethod == "Fill")
                    {
                        this.DataAdapter.FillPage(this.dsTIPOLAKSICEDataSet1, this.startRowThread, this.PageSize);
                    }
                    else
                    {
                        MethodInfo info = this.DataAdapter.GetType().GetMethod("FillPageBy" + this.FillMethod.Substring(6));
                        this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsTIPOLAKSICEDataSet1, info, this.startRowThread, this.PageSize);
                    }
                }
        ...
        private void ResumeBindingPostThread()
        {
            ...
            this.EndUpdate();
            this.BindDataGrid();
            this.Text = "Tipovi olakšica : " + this.DataView.Count.ToString(CultureInfo.InvariantCulture) + " " + Deklarit.Resources.Resources.Rows;
        ...
        public virtual ITIPOLAKSICEDataAdapter DataAdapter
        {
            get
            {
        ...
        public virtual TIPOLAKSICEDataSet DataSet
        {
            get
            {
                return this.dsTIPOLAKSICEDataSet1;
            }
            set
            {
                this.dsTIPOLAKSICEDataSet1 = value;
            }
        }
