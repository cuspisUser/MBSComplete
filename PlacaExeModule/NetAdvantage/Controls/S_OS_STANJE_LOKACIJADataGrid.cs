namespace NetAdvantage.Controls
{
    ...
    public class S_OS_STANJE_LOKACIJADataGrid : DeklaritDataGrid
    {
        private int currentRow;
        private S_OS_STANJE_LOKACIJADataSet dsS_OS_STANJE_LOKACIJADataSet1 = new S_OS_STANJE_LOKACIJADataSet();
        private System.Data.DataView dv1;
        private bool m_FillByPage = true;
        private bool m_GridLoading;
        private int m_PageSize = 60;
        private long m_Parameterinvbroj = 0L;
        private int m_StartRow;
        private int startRowThread;
        private const int WM_SETREDRAW = 11;

        public S_OS_STANJE_LOKACIJADataGrid()
        {
            this.BindDataGrid();
        ...
        private void BindDataGrid()
        {
            ...
            this.dv1.Table = this.dsS_OS_STANJE_LOKACIJADataSet1.S_OS_STANJE_LOKACIJA;
        ...
        {
            this.PreFill();
            this.dsS_OS_STANJE_LOKACIJADataSet1 = new S_OS_STANJE_LOKACIJADataSet();
            this.m_StartRow = 0;
        ...
        private void FillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dsS_OS_STANJE_LOKACIJADataSet1, this.m_Parameterinvbroj, 0, this.PageSize);
                }
                else
                {
                    this.DataAdapter.Fill(this.dsS_OS_STANJE_LOKACIJADataSet1, this.m_Parameterinvbroj);
                }
        ...
        private void ReFillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dsS_OS_STANJE_LOKACIJADataSet1, this.m_Parameterinvbroj, this.startRowThread, this.PageSize);
                }
        ...
        private void ResumeBindingPostThread()
        {
            ...
            this.EndUpdate();
            this.BindDataGrid();
            this.Text = "S_OS_STANJE_LOKACIJA : " + this.DataView.Count.ToString(CultureInfo.InvariantCulture) + " " + Deklarit.Resources.Resources.Rows;
        ...
        public virtual IS_OS_STANJE_LOKACIJADataAdapter DataAdapter
        {
            get
            {
                ...
                if (DataAdapterFactory.Provider != null)
                {
                    return DataAdapterFactory.GetS_OS_STANJE_LOKACIJADataAdapter();
                }
                return null;
            }
        }
        ...
        [Browsable(false), Category("Deklarit Work With ")]
        public virtual S_OS_STANJE_LOKACIJADataSet DataSet
        {
            get
            {
                return this.dsS_OS_STANJE_LOKACIJADataSet1;
            }
            set
            {
                this.dsS_OS_STANJE_LOKACIJADataSet1 = value;
            }
        }
        ...
        public virtual long Parameterinvbroj
        {
            get
            {
                return this.m_Parameterinvbroj;
            }
            set
            {
                this.m_Parameterinvbroj = value;
            }
        }
    }
}
