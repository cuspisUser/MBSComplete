namespace NetAdvantage.Controls
{
    ...
    public class S_OD_KREDIT_OBRACUNATDataGrid : DeklaritDataGrid
    {
        private int currentRow;
        private S_OD_KREDIT_OBRACUNATDataSet dsS_OD_KREDIT_OBRACUNATDataSet1 = new S_OD_KREDIT_OBRACUNATDataSet();
        ...
        public S_OD_KREDIT_OBRACUNATDataGrid()
        {
            this.BindDataGrid();
        ...
        private void BindDataGrid()
        {
            ...
            this.dv1.Table = this.dsS_OD_KREDIT_OBRACUNATDataSet1.S_OD_KREDIT_OBRACUNAT;
        ...
        {
            this.PreFill();
            this.dsS_OD_KREDIT_OBRACUNATDataSet1 = new S_OD_KREDIT_OBRACUNATDataSet();
            this.m_StartRow = 0;
        ...
        private void FillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dsS_OD_KREDIT_OBRACUNATDataSet1, this.m_ParameterIDOBRACUN, 0, this.PageSize);
                }
                else
                {
                    this.DataAdapter.Fill(this.dsS_OD_KREDIT_OBRACUNATDataSet1, this.m_ParameterIDOBRACUN);
                }
        ...
        private void ReFillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dsS_OD_KREDIT_OBRACUNATDataSet1, this.m_ParameterIDOBRACUN, this.startRowThread, this.PageSize);
                }
        ...
        private void ResumeBindingPostThread()
        {
            ...
            this.EndUpdate();
            this.BindDataGrid();
            this.Text = "S_OD_KREDIT_OBRACUNAT : " + this.DataView.Count.ToString(CultureInfo.InvariantCulture) + " " + Deklarit.Resources.Resources.Rows;
        ...
        public virtual IS_OD_KREDIT_OBRACUNATDataAdapter DataAdapter
        {
            get
            {
                ...
                if (DataAdapterFactory.Provider != null)
                {
                    return DataAdapterFactory.GetS_OD_KREDIT_OBRACUNATDataAdapter();
                }
                return null;
            }
        }
        ...
        public virtual S_OD_KREDIT_OBRACUNATDataSet DataSet
        {
            get
            {
                return this.dsS_OD_KREDIT_OBRACUNATDataSet1;
            }
            set
            {
                this.dsS_OD_KREDIT_OBRACUNATDataSet1 = value;
            }
        }
