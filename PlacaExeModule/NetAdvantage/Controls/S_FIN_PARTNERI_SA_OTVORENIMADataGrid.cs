namespace NetAdvantage.Controls
{
    ...
    public class S_FIN_PARTNERI_SA_OTVORENIMADataGrid : DeklaritDataGrid
    {
        private int currentRow;
        private S_FIN_PARTNERI_SA_OTVORENIMADataSet dsS_FIN_PARTNERI_SA_OTVORENIMADataSet1 = new S_FIN_PARTNERI_SA_OTVORENIMADataSet();
        ...
        public S_FIN_PARTNERI_SA_OTVORENIMADataGrid()
        {
            this.BindDataGrid();
        ...
        private void BindDataGrid()
        {
            ...
            this.dv1.Table = this.dsS_FIN_PARTNERI_SA_OTVORENIMADataSet1.S_FIN_PARTNERI_SA_OTVORENIMA;
        ...
        {
            this.PreFill();
            this.dsS_FIN_PARTNERI_SA_OTVORENIMADataSet1 = new S_FIN_PARTNERI_SA_OTVORENIMADataSet();
            this.m_StartRow = 0;
        ...
        private void FillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dsS_FIN_PARTNERI_SA_OTVORENIMADataSet1, this.m_Parametergodina, 0, this.PageSize);
                }
                else
                {
                    this.DataAdapter.Fill(this.dsS_FIN_PARTNERI_SA_OTVORENIMADataSet1, this.m_Parametergodina);
                }
        ...
        private void ReFillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dsS_FIN_PARTNERI_SA_OTVORENIMADataSet1, this.m_Parametergodina, this.startRowThread, this.PageSize);
                }
        ...
        private void ResumeBindingPostThread()
        {
            ...
            this.EndUpdate();
            this.BindDataGrid();
            this.Text = "S_FIN_PARTNERI_SA_OTVORENIMA : " + this.DataView.Count.ToString(CultureInfo.InvariantCulture) + " " + Deklarit.Resources.Resources.Rows;
        ...
        public virtual IS_FIN_PARTNERI_SA_OTVORENIMADataAdapter DataAdapter
        {
            get
            {
                ...
                if (DataAdapterFactory.Provider != null)
                {
                    return DataAdapterFactory.GetS_FIN_PARTNERI_SA_OTVORENIMADataAdapter();
                }
                return null;
            }
        }
        ...
        public virtual S_FIN_PARTNERI_SA_OTVORENIMADataSet DataSet
        {
            get
            {
                return this.dsS_FIN_PARTNERI_SA_OTVORENIMADataSet1;
            }
            set
            {
                this.dsS_FIN_PARTNERI_SA_OTVORENIMADataSet1 = value;
            }
        }
