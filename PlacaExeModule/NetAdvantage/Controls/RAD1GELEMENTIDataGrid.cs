namespace NetAdvantage.Controls
{
    ...
    public class RAD1GELEMENTIDataGrid : DeklaritDataGrid
    {
        private int currentRow;
        private RAD1GELEMENTIDataSet dsRAD1GELEMENTIDataSet1 = new RAD1GELEMENTIDataSet();
        ...
        private void BindDataGrid()
        {
            ...
            this.dv1.Table = this.dsRAD1GELEMENTIDataSet1.RAD1GELEMENTI;
        ...
        private void FillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    ...
                    {
                        this.DataAdapter.FillPage(this.dsRAD1GELEMENTIDataSet1, 0, this.PageSize);
                    }
                    else
                    {
                        MethodInfo info = this.DataAdapter.GetType().GetMethod("FillPageBy" + this.FillMethod.Substring(6));
                        this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsRAD1GELEMENTIDataSet1, info, 0, this.PageSize);
                    }
                }
                else if (this.FillMethod == "Fill")
                {
                    this.DataAdapter.Fill(this.dsRAD1GELEMENTIDataSet1);
                }
                else
                {
                    MethodInfo info2 = this.DataAdapter.GetType().GetMethod(this.FillMethod);
                    this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsRAD1GELEMENTIDataSet1, info2);
                }
        ...
        private void ReFillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    if (this.FillMethod == "Fill")
                    {
                        this.DataAdapter.FillPage(this.dsRAD1GELEMENTIDataSet1, this.startRowThread, this.PageSize);
                    }
                    else
                    {
                        MethodInfo info = this.DataAdapter.GetType().GetMethod("FillPageBy" + this.FillMethod.Substring(6));
                        this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsRAD1GELEMENTIDataSet1, info, this.startRowThread, this.PageSize);
                    }
                }
        ...
        private void ResumeBindingPostThread()
        {
            ...
            this.EndUpdate();
            this.BindDataGrid();
            this.Text = "RAD1GELEMENTI : " + this.DataView.Count.ToString(CultureInfo.InvariantCulture) + " " + Deklarit.Resources.Resources.Rows;
        ...
        public virtual IRAD1GELEMENTIDataAdapter DataAdapter
        {
            get
            {
        ...
        [Category("Deklarit Work With "), Browsable(false)]
        public virtual RAD1GELEMENTIDataSet DataSet
        {
            get
            {
                return this.dsRAD1GELEMENTIDataSet1;
            }
            set
            {
                this.dsRAD1GELEMENTIDataSet1 = value;
            }
        }
