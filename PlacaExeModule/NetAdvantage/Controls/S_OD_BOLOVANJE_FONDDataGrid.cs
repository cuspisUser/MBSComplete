namespace NetAdvantage.Controls
{
    ...
    public class S_OD_BOLOVANJE_FONDDataGrid : DeklaritDataGrid
    {
        private int currentRow;
        private S_OD_BOLOVANJE_FONDDataSet dsS_OD_BOLOVANJE_FONDDataSet1 = new S_OD_BOLOVANJE_FONDDataSet();
        ...
        public S_OD_BOLOVANJE_FONDDataGrid()
        {
            this.BindDataGrid();
        ...
        private void BindDataGrid()
        {
            ...
            this.dv1.Table = this.dsS_OD_BOLOVANJE_FONDDataSet1.S_OD_BOLOVANJE_FOND;
        ...
        {
            this.PreFill();
            this.dsS_OD_BOLOVANJE_FONDDataSet1 = new S_OD_BOLOVANJE_FONDDataSet();
            this.m_StartRow = 0;
        ...
        private void FillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dsS_OD_BOLOVANJE_FONDDataSet1, this.m_ParameterODD, this.m_ParameterDOOO, this.m_Parameteridradnik, 0, this.PageSize);
                }
                else
                {
                    this.DataAdapter.Fill(this.dsS_OD_BOLOVANJE_FONDDataSet1, this.m_ParameterODD, this.m_ParameterDOOO, this.m_Parameteridradnik);
                }
        ...
        private void ReFillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dsS_OD_BOLOVANJE_FONDDataSet1, this.m_ParameterODD, this.m_ParameterDOOO, this.m_Parameteridradnik, this.startRowThread, this.PageSize);
                }
        ...
        private void ResumeBindingPostThread()
        {
            ...
            this.EndUpdate();
            this.BindDataGrid();
            this.Text = "S_OD_BOLOVANJE_FOND : " + this.DataView.Count.ToString(CultureInfo.InvariantCulture) + " " + Deklarit.Resources.Resources.Rows;
        ...
        public virtual IS_OD_BOLOVANJE_FONDDataAdapter DataAdapter
        {
            get
            {
                ...
                if (DataAdapterFactory.Provider != null)
                {
                    return DataAdapterFactory.GetS_OD_BOLOVANJE_FONDDataAdapter();
                }
                return null;
            }
        }
        ...
        public virtual S_OD_BOLOVANJE_FONDDataSet DataSet
        {
            get
            {
                return this.dsS_OD_BOLOVANJE_FONDDataSet1;
            }
            set
            {
                this.dsS_OD_BOLOVANJE_FONDDataSet1 = value;
            }
        }
