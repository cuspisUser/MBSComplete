namespace NetAdvantage.Controls
{
    ...
    public class S_OD_KONACNIDataGrid : DeklaritDataGrid
    {
        private int currentRow;
        private S_OD_KONACNIDataSet dsS_OD_KONACNIDataSet1 = new S_OD_KONACNIDataSet();
        ...
        private void BindDataGrid()
        {
            ...
            this.dv1.Table = this.dsS_OD_KONACNIDataSet1.S_OD_KONACNI;
        ...
        private void FillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dsS_OD_KONACNIDataSet1, this.m_ParameterGODINA, this.m_ParameterIDOBRACUN, 0, this.PageSize);
                }
                else
                {
                    this.DataAdapter.Fill(this.dsS_OD_KONACNIDataSet1, this.m_ParameterGODINA, this.m_ParameterIDOBRACUN);
                }
        ...
        private void ReFillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dsS_OD_KONACNIDataSet1, this.m_ParameterGODINA, this.m_ParameterIDOBRACUN, this.startRowThread, this.PageSize);
                }
        ...
        private void ResumeBindingPostThread()
        {
            ...
            this.EndUpdate();
            this.BindDataGrid();
            this.Text = "S_OD_KONACNI : " + this.DataView.Count.ToString(CultureInfo.InvariantCulture) + " " + Deklarit.Resources.Resources.Rows;
        ...
        public virtual IS_OD_KONACNIDataAdapter DataAdapter
        {
            get
            {
                ...
                if (DataAdapterFactory.Provider != null)
                {
                    return DataAdapterFactory.GetS_OD_KONACNIDataAdapter();
                }
                return null;
            }
        }
        ...
        public virtual S_OD_KONACNIDataSet DataSet
        {
            get
            {
                return this.dsS_OD_KONACNIDataSet1;
            }
            set
            {
                this.dsS_OD_KONACNIDataSet1 = value;
            }
        }
