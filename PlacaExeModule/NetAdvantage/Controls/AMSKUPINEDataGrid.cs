namespace NetAdvantage.Controls
{
    ...
    public class AMSKUPINEDataGrid : DeklaritDataGrid
    {
        private int currentRow;
        private AMSKUPINEDataSet dsAMSKUPINEDataSet1 = new AMSKUPINEDataSet();
        private System.Data.DataView dv1;
        private string m_FillByKTOISPRAVKAIDKONTOKTOISPRAVKAIDKONTO;
        private string m_FillByKTOIZVORAIDKONTOKTOIZVORAIDKONTO;
        private string m_FillByKTONABAVKEIDKONTOKTONABAVKEIDKONTO;
        ...
        public AMSKUPINEDataGrid()
        {
            this.BindDataGrid();
            DeklaritDataGrid.myFillMethods = new TypeConverter.StandardValuesCollection(new string[] { "Fill", "FillByKTOIZVORAIDKONTO", "FillByKTOISPRAVKAIDKONTO", "FillByKTONABAVKEIDKONTO" });
        ...
        private void BindDataGrid()
        {
            ...
            this.dv1.Table = this.dsAMSKUPINEDataSet1.AMSKUPINE;
        ...
        private void FillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    ...
                    {
                        this.DataAdapter.FillPage(this.dsAMSKUPINEDataSet1, 0, this.PageSize);
                    }
                    else
                    {
                        MethodInfo info = this.DataAdapter.GetType().GetMethod("FillPageBy" + this.FillMethod.Substring(6));
                        this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsAMSKUPINEDataSet1, info, 0, this.PageSize);
                    }
                }
                else if (this.FillMethod == "Fill")
                {
                    this.DataAdapter.Fill(this.dsAMSKUPINEDataSet1);
                }
                else
                {
                    MethodInfo info2 = this.DataAdapter.GetType().GetMethod(this.FillMethod);
                    this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsAMSKUPINEDataSet1, info2);
                }
        ...
        private void ReFillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    if (this.FillMethod == "Fill")
                    {
                        this.DataAdapter.FillPage(this.dsAMSKUPINEDataSet1, this.startRowThread, this.PageSize);
                    }
                    else
                    {
                        MethodInfo info = this.DataAdapter.GetType().GetMethod("FillPageBy" + this.FillMethod.Substring(6));
                        this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsAMSKUPINEDataSet1, info, this.startRowThread, this.PageSize);
                    }
                }
        ...
        private void ResumeBindingPostThread()
        {
            ...
            this.EndUpdate();
            this.BindDataGrid();
            this.Text = "Amortizacijske skupine : " + this.DataView.Count.ToString(CultureInfo.InvariantCulture) + " " + Deklarit.Resources.Resources.Rows;
        ...
        public virtual IAMSKUPINEDataAdapter DataAdapter
        {
            get
            {
        ...
        public virtual AMSKUPINEDataSet DataSet
        {
            get
            {
                return this.dsAMSKUPINEDataSet1;
            }
            set
            {
                this.dsAMSKUPINEDataSet1 = value;
            }
        }
