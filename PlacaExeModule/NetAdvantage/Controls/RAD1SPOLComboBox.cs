namespace NetAdvantage.Controls
{
    ...
    public class RAD1SPOLComboBox : DeklaritComboBox
    {
        private System.Data.DataSet m_DataSet = new RAD1SPOLDataSet();
        protected string m_FillMethod = "Fill";

        public RAD1SPOLComboBox()
        {
            this.Text = "RAD1SPOLID";
            DataView defaultView = this.DataSet.Tables["RAD1SPOL"].DefaultView;
            defaultView.Sort = "RAD1SPOLNAZIV";
            this.DisplayMember = "RAD1SPOLNAZIV";
            this.ValueMember = "RAD1SPOLID";
        ...
        protected override void InitLayout()
        {
            ...
            if (!this.DesignMode && this.FillAtStartup)
            {
                ...
                {
                    DataView view = ComboHelper.GetComboValues(this.DataSet, "RAD1SPOL", "RAD1SPOLID", "RAD1SPOLNAZIV", true, "<" + Deklarit.Resources.Resources.Empty + ">");
                    this.DataSource = null;
                    view.Sort = "Name";
        ...
        public IRAD1SPOLDataAdapter DataAdapter
        {
            get
            {
