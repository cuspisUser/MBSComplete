namespace NetAdvantage.Controls
{
    ...
    public class IRAVRSTAIZNOSADataGrid : DeklaritDataGrid
    {
        private int currentRow;
        private IRAVRSTAIZNOSADataSet dsIRAVRSTAIZNOSADataSet1 = new IRAVRSTAIZNOSADataSet();
        ...
        private void BindDataGrid()
        {
            ...
            this.dv1.Table = this.dsIRAVRSTAIZNOSADataSet1.IRAVRSTAIZNOSA;
        ...
        private void FillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    ...
                    {
                        this.DataAdapter.FillPage(this.dsIRAVRSTAIZNOSADataSet1, 0, this.PageSize);
                    }
                    else
                    {
                        MethodInfo info = this.DataAdapter.GetType().GetMethod("FillPageBy" + this.FillMethod.Substring(6));
                        this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsIRAVRSTAIZNOSADataSet1, info, 0, this.PageSize);
                    }
                }
                else if (this.FillMethod == "Fill")
                {
                    this.DataAdapter.Fill(this.dsIRAVRSTAIZNOSADataSet1);
                }
                else
                {
                    MethodInfo info2 = this.DataAdapter.GetType().GetMethod(this.FillMethod);
                    this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsIRAVRSTAIZNOSADataSet1, info2);
                }
        ...
        private void ReFillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    if (this.FillMethod == "Fill")
                    {
                        this.DataAdapter.FillPage(this.dsIRAVRSTAIZNOSADataSet1, this.startRowThread, this.PageSize);
                    }
                    else
                    {
                        MethodInfo info = this.DataAdapter.GetType().GetMethod("FillPageBy" + this.FillMethod.Substring(6));
                        this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsIRAVRSTAIZNOSADataSet1, info, this.startRowThread, this.PageSize);
                    }
                }
        ...
        private void ResumeBindingPostThread()
        {
            ...
            this.EndUpdate();
            this.BindDataGrid();
            this.Text = "Vrste iznosa IRA : " + this.DataView.Count.ToString(CultureInfo.InvariantCulture) + " " + Deklarit.Resources.Resources.Rows;
        ...
        public virtual IIRAVRSTAIZNOSADataAdapter DataAdapter
        {
            get
            {
                ...
                if (DataAdapterFactory.Provider != null)
                {
                    return DataAdapterFactory.GetIRAVRSTAIZNOSADataAdapter();
                }
                return null;
            }
        }
        ...
        [Browsable(false), Category("Deklarit Work With ")]
        public virtual IRAVRSTAIZNOSADataSet DataSet
        {
            get
            {
                return this.dsIRAVRSTAIZNOSADataSet1;
            }
            set
            {
                this.dsIRAVRSTAIZNOSADataSet1 = value;
            }
        }
