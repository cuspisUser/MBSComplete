namespace NetAdvantage.Controls
{
    ...
    public class GOOBRACUNDataGrid : DeklaritDataGrid
    {
        private int currentRow;
        private GOOBRACUNDataSet dsGOOBRACUNDataSet1 = new GOOBRACUNDataSet();
        private System.Data.DataView dv1;
        private int m_FillByIDRADNIKIDRADNIK;
        ...
        public GOOBRACUNDataGrid()
        {
            this.BindDataGrid();
            DeklaritDataGrid.myFillMethods = new TypeConverter.StandardValuesCollection(new string[] { "Fill", "FillByIDRADNIK" });
        ...
        private void BindDataGrid()
        {
            ...
            this.dv1.Table = this.dsGOOBRACUNDataSet1.GOOBRACUN;
        ...
        {
            this.PreFill();
            this.dsGOOBRACUNDataSet1 = new GOOBRACUNDataSet();
            this.m_StartRow = 0;
        ...
        private void FillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    ...
                    {
                        this.DataAdapter.FillPage(this.dsGOOBRACUNDataSet1, 0, this.PageSize);
                    }
                    else
                    {
                        MethodInfo info = this.DataAdapter.GetType().GetMethod("FillPageBy" + this.FillMethod.Substring(6));
                        this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsGOOBRACUNDataSet1, info, 0, this.PageSize);
                    }
                }
                else if (this.FillMethod == "Fill")
                {
                    this.DataAdapter.Fill(this.dsGOOBRACUNDataSet1);
                }
                else
                {
                    MethodInfo info2 = this.DataAdapter.GetType().GetMethod(this.FillMethod);
                    this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsGOOBRACUNDataSet1, info2);
                }
        ...
        private void ReFillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    if (this.FillMethod == "Fill")
                    {
                        this.DataAdapter.FillPage(this.dsGOOBRACUNDataSet1, this.startRowThread, this.PageSize);
                    }
                    else
                    {
                        MethodInfo info = this.DataAdapter.GetType().GetMethod("FillPageBy" + this.FillMethod.Substring(6));
                        this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsGOOBRACUNDataSet1, info, this.startRowThread, this.PageSize);
                    }
                }
        ...
        private void ResumeBindingPostThread()
        {
            ...
            this.EndUpdate();
            this.BindDataGrid();
            this.Text = "Godišnji odbici i olakšice : " + this.DataView.Count.ToString(CultureInfo.InvariantCulture) + " " + Deklarit.Resources.Resources.Rows;
        ...
        public virtual IGOOBRACUNDataAdapter DataAdapter
        {
            get
            {
                ...
                if (DataAdapterFactory.Provider != null)
                {
                    return DataAdapterFactory.GetGOOBRACUNDataAdapter();
                }
                return null;
            }
        }
        ...
        [Category("Deklarit Work With "), Browsable(false)]
        public virtual GOOBRACUNDataSet DataSet
        {
            get
            {
                return this.dsGOOBRACUNDataSet1;
            }
            set
            {
                this.dsGOOBRACUNDataSet1 = value;
            }
        }
        ...
        public virtual int FillByIDRADNIKIDRADNIK
        {
            get
            {
                return this.m_FillByIDRADNIKIDRADNIK;
            }
            set
            {
                this.m_FillByIDRADNIKIDRADNIK = value;
            }
        }
