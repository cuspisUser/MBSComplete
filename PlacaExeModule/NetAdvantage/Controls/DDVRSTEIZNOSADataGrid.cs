namespace NetAdvantage.Controls
{
    ...
    public class DDVRSTEIZNOSADataGrid : DeklaritDataGrid
    {
        private int currentRow;
        private DDVRSTEIZNOSADataSet dsDDVRSTEIZNOSADataSet1 = new DDVRSTEIZNOSADataSet();
        ...
        private void BindDataGrid()
        {
            ...
            this.dv1.Table = this.dsDDVRSTEIZNOSADataSet1.DDVRSTEIZNOSA;
        ...
        private void FillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    ...
                    {
                        this.DataAdapter.FillPage(this.dsDDVRSTEIZNOSADataSet1, 0, this.PageSize);
                    }
                    else
                    {
                        MethodInfo info = this.DataAdapter.GetType().GetMethod("FillPageBy" + this.FillMethod.Substring(6));
                        this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsDDVRSTEIZNOSADataSet1, info, 0, this.PageSize);
                    }
                }
                else if (this.FillMethod == "Fill")
                {
                    this.DataAdapter.Fill(this.dsDDVRSTEIZNOSADataSet1);
                }
                else
                {
                    MethodInfo info2 = this.DataAdapter.GetType().GetMethod(this.FillMethod);
                    this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsDDVRSTEIZNOSADataSet1, info2);
                }
        ...
        private void ReFillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    if (this.FillMethod == "Fill")
                    {
                        this.DataAdapter.FillPage(this.dsDDVRSTEIZNOSADataSet1, this.startRowThread, this.PageSize);
                    }
                    else
                    {
                        MethodInfo info = this.DataAdapter.GetType().GetMethod("FillPageBy" + this.FillMethod.Substring(6));
                        this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsDDVRSTEIZNOSADataSet1, info, this.startRowThread, this.PageSize);
                    }
                }
        ...
        private void ResumeBindingPostThread()
        {
            ...
            this.EndUpdate();
            this.BindDataGrid();
            this.Text = "DD-Vrste iznosa : " + this.DataView.Count.ToString(CultureInfo.InvariantCulture) + " " + Deklarit.Resources.Resources.Rows;
        ...
        public virtual IDDVRSTEIZNOSADataAdapter DataAdapter
        {
            get
            {
                ...
                if (DataAdapterFactory.Provider != null)
                {
                    return DataAdapterFactory.GetDDVRSTEIZNOSADataAdapter();
                }
                return null;
            }
        }
        ...
        public virtual DDVRSTEIZNOSADataSet DataSet
        {
            get
            {
                return this.dsDDVRSTEIZNOSADataSet1;
            }
            set
            {
                this.dsDDVRSTEIZNOSADataSet1 = value;
            }
        }
