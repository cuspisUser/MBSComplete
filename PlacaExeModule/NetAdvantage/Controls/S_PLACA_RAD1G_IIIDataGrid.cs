namespace NetAdvantage.Controls
{
    ...
    public class S_PLACA_RAD1G_IIIDataGrid : DeklaritDataGrid
    {
        private int currentRow;
        private S_PLACA_RAD1G_IIIDataSet dsS_PLACA_RAD1G_IIIDataSet1 = new S_PLACA_RAD1G_IIIDataSet();
        ...
        public S_PLACA_RAD1G_IIIDataGrid()
        {
            this.BindDataGrid();
        ...
        private void BindDataGrid()
        {
            ...
            this.dv1.Table = this.dsS_PLACA_RAD1G_IIIDataSet1.S_PLACA_RAD1G_III;
        ...
        {
            this.PreFill();
            this.dsS_PLACA_RAD1G_IIIDataSet1 = new S_PLACA_RAD1G_IIIDataSet();
            this.m_StartRow = 0;
        ...
        private void FillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dsS_PLACA_RAD1G_IIIDataSet1, this.m_ParameterMJESECISPLATE, this.m_ParameterGODINAISPLATE, 0, this.PageSize);
                }
                else
                {
                    this.DataAdapter.Fill(this.dsS_PLACA_RAD1G_IIIDataSet1, this.m_ParameterMJESECISPLATE, this.m_ParameterGODINAISPLATE);
                }
        ...
        private void ReFillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dsS_PLACA_RAD1G_IIIDataSet1, this.m_ParameterMJESECISPLATE, this.m_ParameterGODINAISPLATE, this.startRowThread, this.PageSize);
                }
        ...
        private void ResumeBindingPostThread()
        {
            ...
            this.EndUpdate();
            this.BindDataGrid();
            this.Text = "S_PLACA_RAD1G_III : " + this.DataView.Count.ToString(CultureInfo.InvariantCulture) + " " + Deklarit.Resources.Resources.Rows;
        ...
        public virtual IS_PLACA_RAD1G_IIIDataAdapter DataAdapter
        {
            get
            {
                ...
                if (DataAdapterFactory.Provider != null)
                {
                    return DataAdapterFactory.GetS_PLACA_RAD1G_IIIDataAdapter();
                }
                return null;
            }
        }
        ...
        public virtual S_PLACA_RAD1G_IIIDataSet DataSet
        {
            get
            {
                return this.dsS_PLACA_RAD1G_IIIDataSet1;
            }
            set
            {
                this.dsS_PLACA_RAD1G_IIIDataSet1 = value;
            }
        }
