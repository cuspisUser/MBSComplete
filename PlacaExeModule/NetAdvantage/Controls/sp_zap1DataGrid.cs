namespace NetAdvantage.Controls
{
    ...
    public class sp_zap1DataGrid : DeklaritDataGrid
    {
        private int currentRow;
        private sp_zap1DataSet dssp_zap1DataSet1 = new sp_zap1DataSet();
        ...
        private void BindDataGrid()
        {
            ...
            this.dv1.Table = this.dssp_zap1DataSet1.sp_zap1;
        ...
        private void FillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dssp_zap1DataSet1, this.m_ParameterIDOBRACUN, 0, this.PageSize);
                }
                else
                {
                    this.DataAdapter.Fill(this.dssp_zap1DataSet1, this.m_ParameterIDOBRACUN);
                }
        ...
        private void ReFillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dssp_zap1DataSet1, this.m_ParameterIDOBRACUN, this.startRowThread, this.PageSize);
                }
        ...
        private void ResumeBindingPostThread()
        {
            ...
            this.EndUpdate();
            this.BindDataGrid();
            this.Text = "sp_zap1 : " + this.DataView.Count.ToString(CultureInfo.InvariantCulture) + " " + Deklarit.Resources.Resources.Rows;
        ...
        public virtual Isp_zap1DataAdapter DataAdapter
        {
            get
            {
                ...
                if (DataAdapterFactory.Provider != null)
                {
                    return DataAdapterFactory.Getsp_zap1DataAdapter();
                }
                return null;
            }
        }
        ...
        public virtual sp_zap1DataSet DataSet
        {
            get
            {
                return this.dssp_zap1DataSet1;
            }
            set
            {
                this.dssp_zap1DataSet1 = value;
            }
        }
