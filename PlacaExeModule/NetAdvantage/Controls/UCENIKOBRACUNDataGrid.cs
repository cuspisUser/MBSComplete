namespace NetAdvantage.Controls
{
    ...
    public class UCENIKOBRACUNDataGrid : DeklaritDataGrid
    {
        private int currentRow;
        private UCENIKOBRACUNDataSet dsUCENIKOBRACUNDataSet1 = new UCENIKOBRACUNDataSet();
        private System.Data.DataView dv1;
        private bool m_FillByPage = false;
        private int m_FillByUCOBRMJESECUCOBRMJESEC;
        ...
        public UCENIKOBRACUNDataGrid()
        {
            this.BindDataGrid();
            DeklaritDataGrid.myFillMethods = new TypeConverter.StandardValuesCollection(new string[] { "Fill", "FillByUCOBRMJESEC" });
        ...
        private void BindDataGrid()
        {
            ...
            this.dv1.Table = this.dsUCENIKOBRACUNDataSet1.UCENIKOBRACUN;
        ...
        private void FillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    ...
                    {
                        this.DataAdapter.FillPage(this.dsUCENIKOBRACUNDataSet1, 0, this.PageSize);
                    }
                    else
                    {
                        MethodInfo info = this.DataAdapter.GetType().GetMethod("FillPageBy" + this.FillMethod.Substring(6));
                        this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsUCENIKOBRACUNDataSet1, info, 0, this.PageSize);
                    }
                }
                else if (this.FillMethod == "Fill")
                {
                    this.DataAdapter.Fill(this.dsUCENIKOBRACUNDataSet1);
                }
                else
                {
                    MethodInfo info2 = this.DataAdapter.GetType().GetMethod(this.FillMethod);
                    this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsUCENIKOBRACUNDataSet1, info2);
                }
        ...
        private void ReFillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    if (this.FillMethod == "Fill")
                    {
                        this.DataAdapter.FillPage(this.dsUCENIKOBRACUNDataSet1, this.startRowThread, this.PageSize);
                    }
                    else
                    {
                        MethodInfo info = this.DataAdapter.GetType().GetMethod("FillPageBy" + this.FillMethod.Substring(6));
                        this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsUCENIKOBRACUNDataSet1, info, this.startRowThread, this.PageSize);
                    }
                }
        ...
        private void ResumeBindingPostThread()
        {
            ...
            this.EndUpdate();
            this.BindDataGrid();
            this.Text = "UCENIKOBRACUN : " + this.DataView.Count.ToString(CultureInfo.InvariantCulture) + " " + Deklarit.Resources.Resources.Rows;
        ...
        public virtual IUCENIKOBRACUNDataAdapter DataAdapter
        {
            get
            {
                ...
                if (DataAdapterFactory.Provider != null)
                {
                    return DataAdapterFactory.GetUCENIKOBRACUNDataAdapter();
                }
                return null;
            }
        }
        ...
        public virtual UCENIKOBRACUNDataSet DataSet
        {
            get
            {
                return this.dsUCENIKOBRACUNDataSet1;
            }
            set
            {
                this.dsUCENIKOBRACUNDataSet1 = value;
            }
        }
        ...
        public virtual int FillByUCOBRMJESECUCOBRMJESEC
        {
            get
            {
                return this.m_FillByUCOBRMJESECUCOBRMJESEC;
            }
            set
            {
                this.m_FillByUCOBRMJESECUCOBRMJESEC = value;
            }
        }
