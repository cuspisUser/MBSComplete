namespace NetAdvantage.Controls
{
    ...
    public class TIPDOKUMENTADataGrid : DeklaritDataGrid
    {
        private int currentRow;
        private TIPDOKUMENTADataSet dsTIPDOKUMENTADataSet1 = new TIPDOKUMENTADataSet();
        ...
        private void BindDataGrid()
        {
            ...
            this.dv1.Table = this.dsTIPDOKUMENTADataSet1.TIPDOKUMENTA;
        ...
        private void FillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    ...
                    {
                        this.DataAdapter.FillPage(this.dsTIPDOKUMENTADataSet1, 0, this.PageSize);
                    }
                    else
                    {
                        MethodInfo info = this.DataAdapter.GetType().GetMethod("FillPageBy" + this.FillMethod.Substring(6));
                        this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsTIPDOKUMENTADataSet1, info, 0, this.PageSize);
                    }
                }
                else if (this.FillMethod == "Fill")
                {
                    this.DataAdapter.Fill(this.dsTIPDOKUMENTADataSet1);
                }
                else
                {
                    MethodInfo info2 = this.DataAdapter.GetType().GetMethod(this.FillMethod);
                    this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsTIPDOKUMENTADataSet1, info2);
                }
        ...
        private void ReFillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    if (this.FillMethod == "Fill")
                    {
                        this.DataAdapter.FillPage(this.dsTIPDOKUMENTADataSet1, this.startRowThread, this.PageSize);
                    }
                    else
                    {
                        MethodInfo info = this.DataAdapter.GetType().GetMethod("FillPageBy" + this.FillMethod.Substring(6));
                        this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsTIPDOKUMENTADataSet1, info, this.startRowThread, this.PageSize);
                    }
                }
        ...
        private void ResumeBindingPostThread()
        {
            ...
            this.EndUpdate();
            this.BindDataGrid();
            this.Text = "TIPDOKUMENTA : " + this.DataView.Count.ToString(CultureInfo.InvariantCulture) + " " + Deklarit.Resources.Resources.Rows;
        ...
        public virtual ITIPDOKUMENTADataAdapter DataAdapter
        {
            get
            {
                ...
                if (DataAdapterFactory.Provider != null)
                {
                    return DataAdapterFactory.GetTIPDOKUMENTADataAdapter();
                }
                return null;
            }
        }
        ...
        public virtual TIPDOKUMENTADataSet DataSet
        {
            get
            {
                return this.dsTIPDOKUMENTADataSet1;
            }
            set
            {
                this.dsTIPDOKUMENTADataSet1 = value;
            }
        }
