namespace NetAdvantage.Controls
{
    ...
    public class STRANEKNJIZENJADataGrid : DeklaritDataGrid
    {
        private int currentRow;
        private STRANEKNJIZENJADataSet dsSTRANEKNJIZENJADataSet1 = new STRANEKNJIZENJADataSet();
        ...
        public STRANEKNJIZENJADataGrid()
        {
            this.BindDataGrid();
        ...
        private void BindDataGrid()
        {
            ...
            this.dv1.Table = this.dsSTRANEKNJIZENJADataSet1.STRANEKNJIZENJA;
        ...
        private void FillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    ...
                    {
                        this.DataAdapter.FillPage(this.dsSTRANEKNJIZENJADataSet1, 0, this.PageSize);
                    }
                    else
                    {
                        MethodInfo info = this.DataAdapter.GetType().GetMethod("FillPageBy" + this.FillMethod.Substring(6));
                        this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsSTRANEKNJIZENJADataSet1, info, 0, this.PageSize);
                    }
                }
                else if (this.FillMethod == "Fill")
                {
                    this.DataAdapter.Fill(this.dsSTRANEKNJIZENJADataSet1);
                }
                else
                {
                    MethodInfo info2 = this.DataAdapter.GetType().GetMethod(this.FillMethod);
                    this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsSTRANEKNJIZENJADataSet1, info2);
                }
        ...
        private void ReFillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    if (this.FillMethod == "Fill")
                    {
                        this.DataAdapter.FillPage(this.dsSTRANEKNJIZENJADataSet1, this.startRowThread, this.PageSize);
                    }
                    else
                    {
                        MethodInfo info = this.DataAdapter.GetType().GetMethod("FillPageBy" + this.FillMethod.Substring(6));
                        this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsSTRANEKNJIZENJADataSet1, info, this.startRowThread, this.PageSize);
                    }
                }
        ...
        private void ResumeBindingPostThread()
        {
            ...
            this.EndUpdate();
            this.BindDataGrid();
            this.Text = "Strane knjiženja : " + this.DataView.Count.ToString(CultureInfo.InvariantCulture) + " " + Deklarit.Resources.Resources.Rows;
        ...
        public virtual ISTRANEKNJIZENJADataAdapter DataAdapter
        {
            get
            {
                ...
                if (DataAdapterFactory.Provider != null)
                {
                    return DataAdapterFactory.GetSTRANEKNJIZENJADataAdapter();
                }
                return null;
            }
        }
        ...
        public virtual STRANEKNJIZENJADataSet DataSet
        {
            get
            {
                return this.dsSTRANEKNJIZENJADataSet1;
            }
            set
            {
                this.dsSTRANEKNJIZENJADataSet1 = value;
            }
        }
