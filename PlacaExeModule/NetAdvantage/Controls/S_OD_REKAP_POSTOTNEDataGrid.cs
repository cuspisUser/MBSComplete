namespace NetAdvantage.Controls
{
    ...
    public class S_OD_REKAP_POSTOTNEDataGrid : DeklaritDataGrid
    {
        private int currentRow;
        private S_OD_REKAP_POSTOTNEDataSet dsS_OD_REKAP_POSTOTNEDataSet1 = new S_OD_REKAP_POSTOTNEDataSet();
        ...
        public S_OD_REKAP_POSTOTNEDataGrid()
        {
            this.BindDataGrid();
        ...
        private void BindDataGrid()
        {
            ...
            this.dv1.Table = this.dsS_OD_REKAP_POSTOTNEDataSet1.S_OD_REKAP_POSTOTNE;
        ...
        private void FillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dsS_OD_REKAP_POSTOTNEDataSet1, this.m_ParameterIDOBRACUN, 0, this.PageSize);
                }
                else
                {
                    this.DataAdapter.Fill(this.dsS_OD_REKAP_POSTOTNEDataSet1, this.m_ParameterIDOBRACUN);
                }
        ...
        private void ReFillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dsS_OD_REKAP_POSTOTNEDataSet1, this.m_ParameterIDOBRACUN, this.startRowThread, this.PageSize);
                }
        ...
        private void ResumeBindingPostThread()
        {
            ...
            this.EndUpdate();
            this.BindDataGrid();
            this.Text = "S_OD_REKAP_POSTOTNE : " + this.DataView.Count.ToString(CultureInfo.InvariantCulture) + " " + Deklarit.Resources.Resources.Rows;
        ...
        public virtual IS_OD_REKAP_POSTOTNEDataAdapter DataAdapter
        {
            get
            {
                ...
                if (DataAdapterFactory.Provider != null)
                {
                    return DataAdapterFactory.GetS_OD_REKAP_POSTOTNEDataAdapter();
                }
                return null;
            }
        }
        ...
        [Category("Deklarit Work With "), Browsable(false)]
        public virtual S_OD_REKAP_POSTOTNEDataSet DataSet
        {
            get
            {
                return this.dsS_OD_REKAP_POSTOTNEDataSet1;
            }
            set
            {
                this.dsS_OD_REKAP_POSTOTNEDataSet1 = value;
            }
        }
