namespace NetAdvantage.Controls
{
    ...
    public class OSOBNIODBITAKDataGrid : DeklaritDataGrid
    {
        private int currentRow;
        private OSOBNIODBITAKDataSet dsOSOBNIODBITAKDataSet1 = new OSOBNIODBITAKDataSet();
        ...
        private void BindDataGrid()
        {
            ...
            this.dv1.Table = this.dsOSOBNIODBITAKDataSet1.OSOBNIODBITAK;
        ...
        private void FillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    ...
                    {
                        this.DataAdapter.FillPage(this.dsOSOBNIODBITAKDataSet1, 0, this.PageSize);
                    }
                    else
                    {
                        MethodInfo info = this.DataAdapter.GetType().GetMethod("FillPageBy" + this.FillMethod.Substring(6));
                        this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsOSOBNIODBITAKDataSet1, info, 0, this.PageSize);
                    }
                }
                else if (this.FillMethod == "Fill")
                {
                    this.DataAdapter.Fill(this.dsOSOBNIODBITAKDataSet1);
                }
                else
                {
                    MethodInfo info2 = this.DataAdapter.GetType().GetMethod(this.FillMethod);
                    this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsOSOBNIODBITAKDataSet1, info2);
                }
        ...
        private void ReFillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    if (this.FillMethod == "Fill")
                    {
                        this.DataAdapter.FillPage(this.dsOSOBNIODBITAKDataSet1, this.startRowThread, this.PageSize);
                    }
                    else
                    {
                        MethodInfo info = this.DataAdapter.GetType().GetMethod("FillPageBy" + this.FillMethod.Substring(6));
                        this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsOSOBNIODBITAKDataSet1, info, this.startRowThread, this.PageSize);
                    }
                }
        ...
        private void ResumeBindingPostThread()
        {
            ...
            this.EndUpdate();
            this.BindDataGrid();
            this.Text = "Faktori osobnog odbitka : " + this.DataView.Count.ToString(CultureInfo.InvariantCulture) + " " + Deklarit.Resources.Resources.Rows;
        ...
        public virtual IOSOBNIODBITAKDataAdapter DataAdapter
        {
            get
            {
                ...
                if (DataAdapterFactory.Provider != null)
                {
                    return DataAdapterFactory.GetOSOBNIODBITAKDataAdapter();
                }
                return null;
            }
        }
        ...
        public virtual OSOBNIODBITAKDataSet DataSet
        {
            get
            {
                return this.dsOSOBNIODBITAKDataSet1;
            }
            set
            {
                this.dsOSOBNIODBITAKDataSet1 = value;
            }
        }
