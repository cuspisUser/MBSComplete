namespace NetAdvantage.Controls
{
    ...
    public class S_PLACA_KONACNI_POREZ_REKAPITULACIJA_PO_RADNICIMADataGrid : DeklaritDataGrid
    {
        private int currentRow;
        private S_PLACA_KONACNI_POREZ_REKAPITULACIJA_PO_RADNICIMADataSet dsS_PLACA_KONACNI_POREZ_REKAPITULACIJA_PO_RADNICIMADataSet1 = new S_PLACA_KONACNI_POREZ_REKAPITULACIJA_PO_RADNICIMADataSet();
        ...
        public S_PLACA_KONACNI_POREZ_REKAPITULACIJA_PO_RADNICIMADataGrid()
        {
            this.BindDataGrid();
        ...
        private void BindDataGrid()
        {
            ...
            this.dv1.Table = this.dsS_PLACA_KONACNI_POREZ_REKAPITULACIJA_PO_RADNICIMADataSet1.S_PLACA_KONACNI_POREZ_REKAPITULACIJA_PO_RADNICIMA;
        ...
        private void FillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dsS_PLACA_KONACNI_POREZ_REKAPITULACIJA_PO_RADNICIMADataSet1, this.m_ParameterIDOBRACUN, 0, this.PageSize);
                }
                else
                {
                    this.DataAdapter.Fill(this.dsS_PLACA_KONACNI_POREZ_REKAPITULACIJA_PO_RADNICIMADataSet1, this.m_ParameterIDOBRACUN);
                }
        ...
        private void ReFillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dsS_PLACA_KONACNI_POREZ_REKAPITULACIJA_PO_RADNICIMADataSet1, this.m_ParameterIDOBRACUN, this.startRowThread, this.PageSize);
                }
        ...
        private void ResumeBindingPostThread()
        {
            ...
            this.EndUpdate();
            this.BindDataGrid();
            this.Text = "S_PLACA_KONACNI_POREZ_REKAPITULACIJA_PO_RADNICIMA : " + this.DataView.Count.ToString(CultureInfo.InvariantCulture) + " " + Deklarit.Resources.Resources.Rows;
        ...
        public virtual IS_PLACA_KONACNI_POREZ_REKAPITULACIJA_PO_RADNICIMADataAdapter DataAdapter
        {
            get
            {
                ...
                if (DataAdapterFactory.Provider != null)
                {
                    return DataAdapterFactory.GetS_PLACA_KONACNI_POREZ_REKAPITULACIJA_PO_RADNICIMADataAdapter();
                }
                return null;
            }
        }
        ...
        public virtual S_PLACA_KONACNI_POREZ_REKAPITULACIJA_PO_RADNICIMADataSet DataSet
        {
            get
            {
                return this.dsS_PLACA_KONACNI_POREZ_REKAPITULACIJA_PO_RADNICIMADataSet1;
            }
            set
            {
                this.dsS_PLACA_KONACNI_POREZ_REKAPITULACIJA_PO_RADNICIMADataSet1 = value;
            }
        }
