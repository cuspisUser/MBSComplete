namespace NetAdvantage.Controls
{
    ...
    public class S_OD_STANJE_KREDITADataGrid : DeklaritDataGrid
    {
        private int currentRow;
        private S_OD_STANJE_KREDITADataSet dsS_OD_STANJE_KREDITADataSet1 = new S_OD_STANJE_KREDITADataSet();
        ...
        public S_OD_STANJE_KREDITADataGrid()
        {
            this.BindDataGrid();
        ...
        {
            this.PreFill();
            this.dsS_OD_STANJE_KREDITADataSet1 = new S_OD_STANJE_KREDITADataSet();
            this.m_StartRow = 0;
        ...
        private void FillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dsS_OD_STANJE_KREDITADataSet1, this.m_ParameterIDOBRACUN, 0, this.PageSize);
                }
                else
                {
                    this.DataAdapter.Fill(this.dsS_OD_STANJE_KREDITADataSet1, this.m_ParameterIDOBRACUN);
                }
        ...
        private void ReFillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dsS_OD_STANJE_KREDITADataSet1, this.m_ParameterIDOBRACUN, this.startRowThread, this.PageSize);
                }
        ...
        private void ResumeBindingPostThread()
        {
            ...
            this.EndUpdate();
            this.BindDataGrid();
            this.Text = "S_OD_STANJE_KREDITA : " + this.DataView.Count.ToString(CultureInfo.InvariantCulture) + " " + Deklarit.Resources.Resources.Rows;
        ...
        public virtual IS_OD_STANJE_KREDITADataAdapter DataAdapter
        {
            get
            {
                ...
                if (DataAdapterFactory.Provider != null)
                {
                    return DataAdapterFactory.GetS_OD_STANJE_KREDITADataAdapter();
                }
                return null;
            }
        }
        ...
        [Category("Deklarit Work With "), Browsable(false)]
        public virtual S_OD_STANJE_KREDITADataSet DataSet
        {
            get
            {
                return this.dsS_OD_STANJE_KREDITADataSet1;
            }
            set
            {
                this.dsS_OD_STANJE_KREDITADataSet1 = value;
            }
        }
