namespace NetAdvantage.Controls
{
    ...
    public class SHEMADDDataGrid : DeklaritDataGrid
    {
        private int currentRow;
        private SHEMADDDataSet dsSHEMADDDataSet1 = new SHEMADDDataSet();
        private System.Data.DataView dv1;
        private bool m_FillByPage = false;
        private int m_FillBySHEMADDOJIDORGJEDSHEMADDOJIDORGJED;
        ...
        public SHEMADDDataGrid()
        {
            this.BindDataGrid();
            DeklaritDataGrid.myFillMethods = new TypeConverter.StandardValuesCollection(new string[] { "Fill", "FillBySHEMADDOJIDORGJED" });
        ...
        private void FillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    ...
                    {
                        this.DataAdapter.FillPage(this.dsSHEMADDDataSet1, 0, this.PageSize);
                    }
                    else
                    {
                        MethodInfo info = this.DataAdapter.GetType().GetMethod("FillPageBy" + this.FillMethod.Substring(6));
                        this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsSHEMADDDataSet1, info, 0, this.PageSize);
                    }
                }
                else if (this.FillMethod == "Fill")
                {
                    this.DataAdapter.Fill(this.dsSHEMADDDataSet1);
                }
                else
                {
                    MethodInfo info2 = this.DataAdapter.GetType().GetMethod(this.FillMethod);
                    this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsSHEMADDDataSet1, info2);
                }
        ...
        private void ReFillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    if (this.FillMethod == "Fill")
                    {
                        this.DataAdapter.FillPage(this.dsSHEMADDDataSet1, this.startRowThread, this.PageSize);
                    }
                    else
                    {
                        MethodInfo info = this.DataAdapter.GetType().GetMethod("FillPageBy" + this.FillMethod.Substring(6));
                        this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsSHEMADDDataSet1, info, this.startRowThread, this.PageSize);
                    }
                }
        ...
        private void ResumeBindingPostThread()
        {
            ...
            this.EndUpdate();
            this.BindDataGrid();
            this.Text = "Shema drugi dohodak : " + this.DataView.Count.ToString(CultureInfo.InvariantCulture) + " " + Deklarit.Resources.Resources.Rows;
        ...
        public virtual ISHEMADDDataAdapter DataAdapter
        {
            get
            {
                ...
                if (DataAdapterFactory.Provider != null)
                {
                    return DataAdapterFactory.GetSHEMADDDataAdapter();
                }
                return null;
            }
        }
        ...
        [Category("Deklarit Work With "), Browsable(false)]
        public virtual SHEMADDDataSet DataSet
        {
            get
            {
                return this.dsSHEMADDDataSet1;
            }
            set
            {
                this.dsSHEMADDDataSet1 = value;
            }
        }
        ...
        public virtual int FillBySHEMADDOJIDORGJEDSHEMADDOJIDORGJED
        {
            get
            {
                return this.m_FillBySHEMADDOJIDORGJEDSHEMADDOJIDORGJED;
            }
            set
            {
                this.m_FillBySHEMADDOJIDORGJEDSHEMADDOJIDORGJED = value;
            }
        }
