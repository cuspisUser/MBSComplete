namespace NetAdvantage.Controls
{
    ...
    public class sp_diskete_za_bankuDataGrid : DeklaritDataGrid
    {
        private int currentRow;
        private sp_diskete_za_bankuDataSet dssp_diskete_za_bankuDataSet1 = new sp_diskete_za_bankuDataSet();
        ...
        private string m_Parametervbdibanke = "";
        private int m_StartRow;
        private int startRowThread;
        private const int WM_SETREDRAW = 11;

        public sp_diskete_za_bankuDataGrid()
        {
            this.BindDataGrid();
        ...
        private void BindDataGrid()
        {
            ...
            this.dv1.Table = this.dssp_diskete_za_bankuDataSet1.sp_diskete_za_banku;
        ...
        {
            this.PreFill();
            this.dssp_diskete_za_bankuDataSet1 = new sp_diskete_za_bankuDataSet();
            this.m_StartRow = 0;
        ...
        private void FillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dssp_diskete_za_bankuDataSet1, this.m_Parameteridobracun, this.m_Parametervbdibanke, 0, this.PageSize);
                }
                else
                {
                    this.DataAdapter.Fill(this.dssp_diskete_za_bankuDataSet1, this.m_Parameteridobracun, this.m_Parametervbdibanke);
                }
        ...
        private void ReFillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dssp_diskete_za_bankuDataSet1, this.m_Parameteridobracun, this.m_Parametervbdibanke, this.startRowThread, this.PageSize);
                }
        ...
        private void ResumeBindingPostThread()
        {
            ...
            this.EndUpdate();
            this.BindDataGrid();
            this.Text = "sp_diskete_za_banku : " + this.DataView.Count.ToString(CultureInfo.InvariantCulture) + " " + Deklarit.Resources.Resources.Rows;
        ...
        public virtual Isp_diskete_za_bankuDataAdapter DataAdapter
        {
            get
            {
                ...
                if (DataAdapterFactory.Provider != null)
                {
                    return DataAdapterFactory.Getsp_diskete_za_bankuDataAdapter();
                }
                return null;
            }
        }
        ...
        public virtual sp_diskete_za_bankuDataSet DataSet
        {
            get
            {
                return this.dssp_diskete_za_bankuDataSet1;
            }
            set
            {
                this.dssp_diskete_za_bankuDataSet1 = value;
            }
        }
        ...
        public virtual string Parametervbdibanke
        {
            get
            {
                return this.m_Parametervbdibanke;
            }
            set
            {
                this.m_Parametervbdibanke = value;
            }
        }
    }
}
