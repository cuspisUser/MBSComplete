namespace NetAdvantage.Controls
{
    ...
    public class UGOVORORADUComboBox : DeklaritComboBox
    {
        private System.Data.DataSet m_DataSet = new UGOVORORADUDataSet();
        protected string m_FillMethod = "Fill";

        public UGOVORORADUComboBox()
        {
            this.Text = "IDUGOVORORADU";
            DataView defaultView = this.DataSet.Tables["UGOVORORADU"].DefaultView;
            defaultView.Sort = "NAZIVUGOVORORADU";
            this.DisplayMember = "NAZIVUGOVORORADU";
            this.ValueMember = "IDUGOVORORADU";
        ...
        protected override void InitLayout()
        {
            ...
            if (!this.DesignMode && this.FillAtStartup)
            {
                ...
                {
                    DataView view = ComboHelper.GetComboValues(this.DataSet, "UGOVORORADU", "IDUGOVORORADU", "NAZIVUGOVORORADU", true, "<" + Deklarit.Resources.Resources.Empty + ">");
                    this.DataSource = null;
                    view.Sort = "Name";
        ...
        public IUGOVORORADUDataAdapter DataAdapter
        {
            get
            {
