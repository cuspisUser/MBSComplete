namespace NetAdvantage.Controls
{
    ...
    public class VRSTAOBUSTAVEDataGrid : DeklaritDataGrid
    {
        private int currentRow;
        private VRSTAOBUSTAVEDataSet dsVRSTAOBUSTAVEDataSet1 = new VRSTAOBUSTAVEDataSet();
        ...
        private void BindDataGrid()
        {
            ...
            this.dv1.Table = this.dsVRSTAOBUSTAVEDataSet1.VRSTEOBUSTAVA;
        ...
        private void FillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    ...
                    {
                        this.DataAdapter.FillPage(this.dsVRSTAOBUSTAVEDataSet1, 0, this.PageSize);
                    }
                    else
                    {
                        MethodInfo info = this.DataAdapter.GetType().GetMethod("FillPageBy" + this.FillMethod.Substring(6));
                        this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsVRSTAOBUSTAVEDataSet1, info, 0, this.PageSize);
                    }
                }
                else if (this.FillMethod == "Fill")
                {
                    this.DataAdapter.Fill(this.dsVRSTAOBUSTAVEDataSet1);
                }
                else
                {
                    MethodInfo info2 = this.DataAdapter.GetType().GetMethod(this.FillMethod);
                    this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsVRSTAOBUSTAVEDataSet1, info2);
                }
        ...
        private void ReFillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    if (this.FillMethod == "Fill")
                    {
                        this.DataAdapter.FillPage(this.dsVRSTAOBUSTAVEDataSet1, this.startRowThread, this.PageSize);
                    }
                    else
                    {
                        MethodInfo info = this.DataAdapter.GetType().GetMethod("FillPageBy" + this.FillMethod.Substring(6));
                        this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsVRSTAOBUSTAVEDataSet1, info, this.startRowThread, this.PageSize);
                    }
                }
        ...
        private void ResumeBindingPostThread()
        {
            ...
            this.EndUpdate();
            this.BindDataGrid();
            this.Text = "Vrste obustava : " + this.DataView.Count.ToString(CultureInfo.InvariantCulture) + " " + Deklarit.Resources.Resources.Rows;
        ...
        public virtual IVRSTAOBUSTAVEDataAdapter DataAdapter
        {
            get
            {
                ...
                if (DataAdapterFactory.Provider != null)
                {
                    return DataAdapterFactory.GetVRSTAOBUSTAVEDataAdapter();
                }
                return null;
            }
        }
        ...
        public virtual VRSTAOBUSTAVEDataSet DataSet
        {
            get
            {
                return this.dsVRSTAOBUSTAVEDataSet1;
            }
            set
            {
                this.dsVRSTAOBUSTAVEDataSet1 = value;
            }
        }
