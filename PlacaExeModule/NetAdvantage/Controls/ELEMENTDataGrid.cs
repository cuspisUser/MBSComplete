namespace NetAdvantage.Controls
{
    ...
    public class ELEMENTDataGrid : DeklaritDataGrid
    {
        private int currentRow;
        private ELEMENTDataSet dsELEMENTDataSet1 = new ELEMENTDataSet();
        private System.Data.DataView dv1;
        private string m_FillByIDOSNOVAOSIGURANJAIDOSNOVAOSIGURANJA;
        private short m_FillByIDVRSTAELEMENTAIDVRSTAELEMENTA;
        ...
        public ELEMENTDataGrid()
        {
            this.BindDataGrid();
            DeklaritDataGrid.myFillMethods = new TypeConverter.StandardValuesCollection(new string[] { "Fill", "FillByIDVRSTAELEMENTA", "FillByIDOSNOVAOSIGURANJA" });
        ...
        private void BindDataGrid()
        {
            ...
            this.dv1.Table = this.dsELEMENTDataSet1.ELEMENT;
        ...
        private void FillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    ...
                    {
                        this.DataAdapter.FillPage(this.dsELEMENTDataSet1, 0, this.PageSize);
                    }
                    else
                    {
                        MethodInfo info = this.DataAdapter.GetType().GetMethod("FillPageBy" + this.FillMethod.Substring(6));
                        this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsELEMENTDataSet1, info, 0, this.PageSize);
                    }
                }
                else if (this.FillMethod == "Fill")
                {
                    this.DataAdapter.Fill(this.dsELEMENTDataSet1);
                }
                else
                {
                    MethodInfo info2 = this.DataAdapter.GetType().GetMethod(this.FillMethod);
                    this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsELEMENTDataSet1, info2);
                }
        ...
        private void ReFillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    if (this.FillMethod == "Fill")
                    {
                        this.DataAdapter.FillPage(this.dsELEMENTDataSet1, this.startRowThread, this.PageSize);
                    }
                    else
                    {
                        MethodInfo info = this.DataAdapter.GetType().GetMethod("FillPageBy" + this.FillMethod.Substring(6));
                        this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsELEMENTDataSet1, info, this.startRowThread, this.PageSize);
                    }
                }
        ...
        private void ResumeBindingPostThread()
        {
            ...
            this.EndUpdate();
            this.BindDataGrid();
            this.Text = "Elementi : " + this.DataView.Count.ToString(CultureInfo.InvariantCulture) + " " + Deklarit.Resources.Resources.Rows;
        ...
        public virtual IELEMENTDataAdapter DataAdapter
        {
            get
            {
        ...
        public virtual ELEMENTDataSet DataSet
        {
            get
            {
                return this.dsELEMENTDataSet1;
            }
            set
            {
                this.dsELEMENTDataSet1 = value;
            }
        }
