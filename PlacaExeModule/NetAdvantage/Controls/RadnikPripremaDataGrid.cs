namespace NetAdvantage.Controls
{
    ...
    public class RadnikPripremaDataGrid : DeklaritDataGrid
    {
        private int currentRow;
        private RadnikPripremaDataSet dsRadnikPripremaDataSet1 = new RadnikPripremaDataSet();
        ...
        private void BindDataGrid()
        {
            ...
            this.dv1.Table = this.dsRadnikPripremaDataSet1.RADNIK;
        ...
        {
            this.PreFill();
            this.dsRadnikPripremaDataSet1 = new RadnikPripremaDataSet();
            this.m_StartRow = 0;
        ...
        private void FillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dsRadnikPripremaDataSet1, 0, this.PageSize);
                }
                else
                {
                    this.DataAdapter.Fill(this.dsRadnikPripremaDataSet1);
                }
        ...
        private void ReFillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dsRadnikPripremaDataSet1, this.startRowThread, this.PageSize);
                }
        ...
        private void ResumeBindingPostThread()
        {
            ...
            this.EndUpdate();
            this.BindDataGrid();
            this.Text = "RadnikPriprema : " + this.DataView.Count.ToString(CultureInfo.InvariantCulture) + " " + Deklarit.Resources.Resources.Rows;
        ...
        public virtual IRadnikPripremaDataAdapter DataAdapter
        {
            get
            {
                ...
                if (DataAdapterFactory.Provider != null)
                {
                    return DataAdapterFactory.GetRadnikPripremaDataAdapter();
                }
                return null;
            }
        }
        ...
        [Category("Deklarit Work With "), Browsable(false)]
        public virtual RadnikPripremaDataSet DataSet
        {
            get
            {
                return this.dsRadnikPripremaDataSet1;
            }
            set
            {
                this.dsRadnikPripremaDataSet1 = value;
            }
        }
