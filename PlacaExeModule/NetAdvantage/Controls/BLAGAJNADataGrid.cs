namespace NetAdvantage.Controls
{
    ...
    public class BLAGAJNADataGrid : DeklaritDataGrid
    {
        private int currentRow;
        private BLAGAJNADataSet dsBLAGAJNADataSet1 = new BLAGAJNADataSet();
        private System.Data.DataView dv1;
        private string m_FillByBLGKONTOIDKONTOBLGKONTOIDKONTO;
        ...
        public BLAGAJNADataGrid()
        {
            this.BindDataGrid();
            DeklaritDataGrid.myFillMethods = new TypeConverter.StandardValuesCollection(new string[] { "Fill", "FillByBLGKONTOIDKONTO" });
        ...
        private void FillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    ...
                    {
                        this.DataAdapter.FillPage(this.dsBLAGAJNADataSet1, 0, this.PageSize);
                    }
                    else
                    {
                        MethodInfo info = this.DataAdapter.GetType().GetMethod("FillPageBy" + this.FillMethod.Substring(6));
                        this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsBLAGAJNADataSet1, info, 0, this.PageSize);
                    }
                }
                else if (this.FillMethod == "Fill")
                {
                    this.DataAdapter.Fill(this.dsBLAGAJNADataSet1);
                }
                else
                {
                    MethodInfo info2 = this.DataAdapter.GetType().GetMethod(this.FillMethod);
                    this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsBLAGAJNADataSet1, info2);
                }
        ...
        private void ReFillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    if (this.FillMethod == "Fill")
                    {
                        this.DataAdapter.FillPage(this.dsBLAGAJNADataSet1, this.startRowThread, this.PageSize);
                    }
                    else
                    {
                        MethodInfo info = this.DataAdapter.GetType().GetMethod("FillPageBy" + this.FillMethod.Substring(6));
                        this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsBLAGAJNADataSet1, info, this.startRowThread, this.PageSize);
                    }
                }
        ...
        private void ResumeBindingPostThread()
        {
            ...
            this.EndUpdate();
            this.BindDataGrid();
            this.Text = "BLAGAJNA : " + this.DataView.Count.ToString(CultureInfo.InvariantCulture) + " " + Deklarit.Resources.Resources.Rows;
        ...
        public virtual IBLAGAJNADataAdapter DataAdapter
        {
            get
            {
                ...
                if (DataAdapterFactory.Provider != null)
                {
                    return DataAdapterFactory.GetBLAGAJNADataAdapter();
                }
                return null;
            }
        }
        ...
        public virtual BLAGAJNADataSet DataSet
        {
            get
            {
                return this.dsBLAGAJNADataSet1;
            }
            set
            {
                this.dsBLAGAJNADataSet1 = value;
            }
        }
        ...
        public virtual string FillByBLGKONTOIDKONTOBLGKONTOIDKONTO
        {
            get
            {
                return this.m_FillByBLGKONTOIDKONTOBLGKONTOIDKONTO;
            }
            set
            {
                this.m_FillByBLGKONTOIDKONTOBLGKONTOIDKONTO = value;
            }
        }
