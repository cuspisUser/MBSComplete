namespace NetAdvantage.Controls
{
    ...
    public class PregledObracunaDataGrid : DeklaritDataGrid
    {
        private int currentRow;
        private PregledObracunaDataSet dsPregledObracunaDataSet1 = new PregledObracunaDataSet();
        ...
        public PregledObracunaDataGrid()
        {
            this.BindDataGrid();
        ...
        private void BindDataGrid()
        {
            ...
            this.dv1.Table = this.dsPregledObracunaDataSet1.PregledObracuna;
        ...
        {
            this.PreFill();
            this.dsPregledObracunaDataSet1 = new PregledObracunaDataSet();
            this.m_StartRow = 0;
        ...
        private void FillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dsPregledObracunaDataSet1, 0, this.PageSize);
                }
                else
                {
                    this.DataAdapter.Fill(this.dsPregledObracunaDataSet1);
                }
        ...
        private void ReFillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dsPregledObracunaDataSet1, this.startRowThread, this.PageSize);
                }
        ...
        private void ResumeBindingPostThread()
        {
            ...
            this.EndUpdate();
            this.BindDataGrid();
            this.Text = "PregledObracuna : " + this.DataView.Count.ToString(CultureInfo.InvariantCulture) + " " + Deklarit.Resources.Resources.Rows;
        ...
        public virtual IPregledObracunaDataAdapter DataAdapter
        {
            get
            {
                ...
                if (DataAdapterFactory.Provider != null)
                {
                    return DataAdapterFactory.GetPregledObracunaDataAdapter();
                }
                return null;
            }
        }
        ...
        [Category("Deklarit Work With "), Browsable(false)]
        public virtual PregledObracunaDataSet DataSet
        {
            get
            {
                return this.dsPregledObracunaDataSet1;
            }
            set
            {
                this.dsPregledObracunaDataSet1 = value;
            }
        }
