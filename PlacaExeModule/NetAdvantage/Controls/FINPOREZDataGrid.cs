namespace NetAdvantage.Controls
{
    ...
    public class FINPOREZDataGrid : DeklaritDataGrid
    {
        private int currentRow;
        private FINPOREZDataSet dsFINPOREZDataSet1 = new FINPOREZDataSet();
        ...
        private void BindDataGrid()
        {
            ...
            this.dv1.Table = this.dsFINPOREZDataSet1.FINPOREZ;
        ...
        private void FillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    ...
                    {
                        this.DataAdapter.FillPage(this.dsFINPOREZDataSet1, 0, this.PageSize);
                    }
                    else
                    {
                        MethodInfo info = this.DataAdapter.GetType().GetMethod("FillPageBy" + this.FillMethod.Substring(6));
                        this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsFINPOREZDataSet1, info, 0, this.PageSize);
                    }
                }
                else if (this.FillMethod == "Fill")
                {
                    this.DataAdapter.Fill(this.dsFINPOREZDataSet1);
                }
                else
                {
                    MethodInfo info2 = this.DataAdapter.GetType().GetMethod(this.FillMethod);
                    this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsFINPOREZDataSet1, info2);
                }
        ...
        private void ReFillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    if (this.FillMethod == "Fill")
                    {
                        this.DataAdapter.FillPage(this.dsFINPOREZDataSet1, this.startRowThread, this.PageSize);
                    }
                    else
                    {
                        MethodInfo info = this.DataAdapter.GetType().GetMethod("FillPageBy" + this.FillMethod.Substring(6));
                        this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsFINPOREZDataSet1, info, this.startRowThread, this.PageSize);
                    }
                }
        ...
        private void ResumeBindingPostThread()
        {
            ...
            this.EndUpdate();
            this.BindDataGrid();
            this.Text = "FINPOREZ : " + this.DataView.Count.ToString(CultureInfo.InvariantCulture) + " " + Deklarit.Resources.Resources.Rows;
        ...
        public virtual IFINPOREZDataAdapter DataAdapter
        {
            get
            {
        ...
        [Browsable(false), Category("Deklarit Work With ")]
        public virtual FINPOREZDataSet DataSet
        {
            get
            {
                return this.dsFINPOREZDataSet1;
            }
            set
            {
                this.dsFINPOREZDataSet1 = value;
            }
        }
