namespace NetAdvantage.Controls
{
    ...
    public class OBRACUNDataGrid : DeklaritDataGrid
    {
        private int currentRow;
        private OBRACUNDataSet dsOBRACUNDataSet1 = new OBRACUNDataSet();
        ...
        private void BindDataGrid()
        {
            ...
            this.dv1.Table = this.dsOBRACUNDataSet1.OBRACUN;
        ...
        private void FillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    ...
                    {
                        this.DataAdapter.FillPage(this.dsOBRACUNDataSet1, 0, this.PageSize);
                    }
                    else
                    {
                        MethodInfo info = this.DataAdapter.GetType().GetMethod("FillPageBy" + this.FillMethod.Substring(6));
                        this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsOBRACUNDataSet1, info, 0, this.PageSize);
                    }
                }
                else if (this.FillMethod == "Fill")
                {
                    this.DataAdapter.Fill(this.dsOBRACUNDataSet1);
                }
                else
                {
                    MethodInfo info2 = this.DataAdapter.GetType().GetMethod(this.FillMethod);
                    this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsOBRACUNDataSet1, info2);
                }
            ...
            {
                MessageBox.Show("Dogodila se greška prilikom učitavanja.\n\r" + exception1.Message.ToString());
                return;
            }
        }
        ...
        private void ReFillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    if (this.FillMethod == "Fill")
                    {
                        this.DataAdapter.FillPage(this.dsOBRACUNDataSet1, this.startRowThread, this.PageSize);
                    }
                    else
                    {
                        MethodInfo info = this.DataAdapter.GetType().GetMethod("FillPageBy" + this.FillMethod.Substring(6));
                        this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsOBRACUNDataSet1, info, this.startRowThread, this.PageSize);
                    }
                }
        ...
        private void ResumeBindingPostThread()
        {
            ...
            this.EndUpdate();
            this.BindDataGrid();
            this.Text = "Obraeun : " + this.DataView.Count.ToString(CultureInfo.InvariantCulture) + " " + Deklarit.Resources.Resources.Rows;
        ...
        public virtual IOBRACUNDataAdapter DataAdapter
        {
            get
            {
                ...
                if (DataAdapterFactory.Provider != null)
                {
                    return DataAdapterFactory.GetOBRACUNDataAdapter();
                }
                return null;
            }
        }
        ...
        public virtual OBRACUNDataSet DataSet
        {
            get
            {
                return this.dsOBRACUNDataSet1;
            }
            set
            {
                this.dsOBRACUNDataSet1 = value;
            }
        }
