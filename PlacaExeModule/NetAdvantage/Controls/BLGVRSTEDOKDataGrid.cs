namespace NetAdvantage.Controls
{
    ...
    public class BLGVRSTEDOKDataGrid : DeklaritDataGrid
    {
        private int currentRow;
        private BLGVRSTEDOKDataSet dsBLGVRSTEDOKDataSet1 = new BLGVRSTEDOKDataSet();
        ...
        private void BindDataGrid()
        {
            ...
            this.dv1.Table = this.dsBLGVRSTEDOKDataSet1.BLGVRSTEDOK;
        ...
        private void FillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    ...
                    {
                        this.DataAdapter.FillPage(this.dsBLGVRSTEDOKDataSet1, 0, this.PageSize);
                    }
                    else
                    {
                        MethodInfo info = this.DataAdapter.GetType().GetMethod("FillPageBy" + this.FillMethod.Substring(6));
                        this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsBLGVRSTEDOKDataSet1, info, 0, this.PageSize);
                    }
                }
                else if (this.FillMethod == "Fill")
                {
                    this.DataAdapter.Fill(this.dsBLGVRSTEDOKDataSet1);
                }
                else
                {
                    MethodInfo info2 = this.DataAdapter.GetType().GetMethod(this.FillMethod);
                    this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsBLGVRSTEDOKDataSet1, info2);
                }
        ...
        private void ReFillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    if (this.FillMethod == "Fill")
                    {
                        this.DataAdapter.FillPage(this.dsBLGVRSTEDOKDataSet1, this.startRowThread, this.PageSize);
                    }
                    else
                    {
                        MethodInfo info = this.DataAdapter.GetType().GetMethod("FillPageBy" + this.FillMethod.Substring(6));
                        this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsBLGVRSTEDOKDataSet1, info, this.startRowThread, this.PageSize);
                    }
                }
        ...
        private void ResumeBindingPostThread()
        {
            ...
            this.EndUpdate();
            this.BindDataGrid();
            this.Text = "BLGVRSTEDOK : " + this.DataView.Count.ToString(CultureInfo.InvariantCulture) + " " + Deklarit.Resources.Resources.Rows;
        ...
        public virtual IBLGVRSTEDOKDataAdapter DataAdapter
        {
            get
            {
                ...
                if (DataAdapterFactory.Provider != null)
                {
                    return DataAdapterFactory.GetBLGVRSTEDOKDataAdapter();
                }
                return null;
            }
        }
        ...
        public virtual BLGVRSTEDOKDataSet DataSet
        {
            get
            {
                return this.dsBLGVRSTEDOKDataSet1;
            }
            set
            {
                this.dsBLGVRSTEDOKDataSet1 = value;
            }
        }
