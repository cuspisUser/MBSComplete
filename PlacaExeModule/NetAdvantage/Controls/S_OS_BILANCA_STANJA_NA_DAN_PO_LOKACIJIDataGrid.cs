namespace NetAdvantage.Controls
{
    ...
    public class S_OS_BILANCA_STANJA_NA_DAN_PO_LOKACIJIDataGrid : DeklaritDataGrid
    {
        private int currentRow;
        private S_OS_BILANCA_STANJA_NA_DAN_PO_LOKACIJIDataSet dsS_OS_BILANCA_STANJA_NA_DAN_PO_LOKACIJIDataSet1 = new S_OS_BILANCA_STANJA_NA_DAN_PO_LOKACIJIDataSet();
        private System.Data.DataView dv1;
        private bool m_FillByPage = true;
        private bool m_GridLoading;
        private int m_PageSize = 60;
        private DateTime m_ParameterDATUM = DateTime.Now;
        private string m_ParameterSORT = "";
        private int m_ParameterVRSTA = 0;
        private int m_StartRow;
        private int startRowThread;
        private const int WM_SETREDRAW = 11;

        public S_OS_BILANCA_STANJA_NA_DAN_PO_LOKACIJIDataGrid()
        {
            this.BindDataGrid();
        ...
        {
            this.PreFill();
            this.dsS_OS_BILANCA_STANJA_NA_DAN_PO_LOKACIJIDataSet1 = new S_OS_BILANCA_STANJA_NA_DAN_PO_LOKACIJIDataSet();
            this.m_StartRow = 0;
        ...
        private void FillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dsS_OS_BILANCA_STANJA_NA_DAN_PO_LOKACIJIDataSet1, this.m_ParameterDATUM, this.m_ParameterSORT, this.m_ParameterVRSTA, 0, this.PageSize);
                }
                else
                {
                    this.DataAdapter.Fill(this.dsS_OS_BILANCA_STANJA_NA_DAN_PO_LOKACIJIDataSet1, this.m_ParameterDATUM, this.m_ParameterSORT, this.m_ParameterVRSTA);
                }
        ...
        private void ReFillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dsS_OS_BILANCA_STANJA_NA_DAN_PO_LOKACIJIDataSet1, this.m_ParameterDATUM, this.m_ParameterSORT, this.m_ParameterVRSTA, this.startRowThread, this.PageSize);
                }
        ...
        private void ResumeBindingPostThread()
        {
            ...
            this.EndUpdate();
            this.BindDataGrid();
            this.Text = "S_OS_BILANCA_STANJA_NA_DAN_PO_LOKACIJI : " + this.DataView.Count.ToString(CultureInfo.InvariantCulture) + " " + Deklarit.Resources.Resources.Rows;
        ...
        public virtual IS_OS_BILANCA_STANJA_NA_DAN_PO_LOKACIJIDataAdapter DataAdapter
        {
            get
            {
                ...
                if (DataAdapterFactory.Provider != null)
                {
                    return DataAdapterFactory.GetS_OS_BILANCA_STANJA_NA_DAN_PO_LOKACIJIDataAdapter();
                }
                return null;
            }
        }
        ...
        [Browsable(false), Category("Deklarit Work With ")]
        public virtual S_OS_BILANCA_STANJA_NA_DAN_PO_LOKACIJIDataSet DataSet
        {
            get
            {
                return this.dsS_OS_BILANCA_STANJA_NA_DAN_PO_LOKACIJIDataSet1;
            }
            set
            {
                this.dsS_OS_BILANCA_STANJA_NA_DAN_PO_LOKACIJIDataSet1 = value;
            }
        }
        ...
        public virtual DateTime ParameterDATUM
        {
            get
            {
                return this.m_ParameterDATUM;
            }
            set
            {
                this.m_ParameterDATUM = value;
            }
        }
