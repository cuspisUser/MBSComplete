namespace NetAdvantage.Controls
{
    ...
    public class S_DD_POTVRDADataGrid : DeklaritDataGrid
    {
        private int currentRow;
        private S_DD_POTVRDADataSet dsS_DD_POTVRDADataSet1 = new S_DD_POTVRDADataSet();
        ...
        private void BindDataGrid()
        {
            ...
            this.dv1.Table = this.dsS_DD_POTVRDADataSet1.S_DD_POTVRDA;
        ...
        {
            this.PreFill();
            this.dsS_DD_POTVRDADataSet1 = new S_DD_POTVRDADataSet();
            this.m_StartRow = 0;
        ...
        private void FillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dsS_DD_POTVRDADataSet1, this.m_ParameterGODINAISPLATE, 0, this.PageSize);
                }
                else
                {
                    this.DataAdapter.Fill(this.dsS_DD_POTVRDADataSet1, this.m_ParameterGODINAISPLATE);
                }
        ...
        private void ReFillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dsS_DD_POTVRDADataSet1, this.m_ParameterGODINAISPLATE, this.startRowThread, this.PageSize);
                }
        ...
        private void ResumeBindingPostThread()
        {
            ...
            this.EndUpdate();
            this.BindDataGrid();
            this.Text = "S_DD_POTVRDA : " + this.DataView.Count.ToString(CultureInfo.InvariantCulture) + " " + Deklarit.Resources.Resources.Rows;
        ...
        public virtual IS_DD_POTVRDADataAdapter DataAdapter
        {
            get
            {
                ...
                if (DataAdapterFactory.Provider != null)
                {
                    return DataAdapterFactory.GetS_DD_POTVRDADataAdapter();
                }
                return null;
            }
        }
        ...
        public virtual S_DD_POTVRDADataSet DataSet
        {
            get
            {
                return this.dsS_DD_POTVRDADataSet1;
            }
            set
            {
                this.dsS_DD_POTVRDADataSet1 = value;
            }
        }
