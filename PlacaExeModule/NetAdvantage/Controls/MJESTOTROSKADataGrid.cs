namespace NetAdvantage.Controls
{
    ...
    public class MJESTOTROSKADataGrid : DeklaritDataGrid
    {
        private int currentRow;
        private MJESTOTROSKADataSet dsMJESTOTROSKADataSet1 = new MJESTOTROSKADataSet();
        ...
        private void BindDataGrid()
        {
            ...
            this.dv1.Table = this.dsMJESTOTROSKADataSet1.MJESTOTROSKA;
        ...
        private void FillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    ...
                    {
                        this.DataAdapter.FillPage(this.dsMJESTOTROSKADataSet1, 0, this.PageSize);
                    }
                    else
                    {
                        MethodInfo info = this.DataAdapter.GetType().GetMethod("FillPageBy" + this.FillMethod.Substring(6));
                        this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsMJESTOTROSKADataSet1, info, 0, this.PageSize);
                    }
                }
                else if (this.FillMethod == "Fill")
                {
                    this.DataAdapter.Fill(this.dsMJESTOTROSKADataSet1);
                }
                else
                {
                    MethodInfo info2 = this.DataAdapter.GetType().GetMethod(this.FillMethod);
                    this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsMJESTOTROSKADataSet1, info2);
                }
        ...
        private void ReFillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    if (this.FillMethod == "Fill")
                    {
                        this.DataAdapter.FillPage(this.dsMJESTOTROSKADataSet1, this.startRowThread, this.PageSize);
                    }
                    else
                    {
                        MethodInfo info = this.DataAdapter.GetType().GetMethod("FillPageBy" + this.FillMethod.Substring(6));
                        this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsMJESTOTROSKADataSet1, info, this.startRowThread, this.PageSize);
                    }
                }
        ...
        private void ResumeBindingPostThread()
        {
            ...
            this.EndUpdate();
            this.BindDataGrid();
            this.Text = "MJESTOTROSKA : " + this.DataView.Count.ToString(CultureInfo.InvariantCulture) + " " + Deklarit.Resources.Resources.Rows;
        ...
        public virtual IMJESTOTROSKADataAdapter DataAdapter
        {
            get
            {
        ...
        [Browsable(false), Category("Deklarit Work With ")]
        public virtual MJESTOTROSKADataSet DataSet
        {
            get
            {
                return this.dsMJESTOTROSKADataSet1;
            }
            set
            {
                this.dsMJESTOTROSKADataSet1 = value;
            }
        }
