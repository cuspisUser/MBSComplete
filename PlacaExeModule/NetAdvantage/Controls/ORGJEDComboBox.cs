namespace NetAdvantage.Controls
{
    ...
    public class ORGJEDComboBox : DeklaritComboBox
    {
        private System.Data.DataSet m_DataSet = new ORGJEDDataSet();
        protected string m_FillMethod = "Fill";

        public ORGJEDComboBox()
        {
            this.Text = "IDORGJED";
            DataView defaultView = this.DataSet.Tables["ORGJED"].DefaultView;
            defaultView.Sort = "oj";
            this.DisplayMember = "oj";
            this.ValueMember = "IDORGJED";
        ...
        protected override void InitLayout()
        {
            ...
            if (!this.DesignMode && this.FillAtStartup)
            {
                ...
                {
                    DataView view = ComboHelper.GetComboValues(this.DataSet, "ORGJED", "IDORGJED", "oj", true, "<" + Deklarit.Resources.Resources.Empty + ">");
                    this.DataSource = null;
                    view.Sort = "Name";
        ...
        public IORGJEDDataAdapter DataAdapter
        {
            get
            {
