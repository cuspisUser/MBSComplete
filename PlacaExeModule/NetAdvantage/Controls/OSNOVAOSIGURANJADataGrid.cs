namespace NetAdvantage.Controls
{
    ...
    public class OSNOVAOSIGURANJADataGrid : DeklaritDataGrid
    {
        private int currentRow;
        private OSNOVAOSIGURANJADataSet dsOSNOVAOSIGURANJADataSet1 = new OSNOVAOSIGURANJADataSet();
        private System.Data.DataView dv1;
        private bool m_FillByPage = false;
        private string m_FillByZAMOOIDOSNOVAOSIGURANJAZAMOOIDOSNOVAOSIGURANJA;
        ...
        public OSNOVAOSIGURANJADataGrid()
        {
            this.BindDataGrid();
            DeklaritDataGrid.myFillMethods = new TypeConverter.StandardValuesCollection(new string[] { "Fill", "FillByZAMOOIDOSNOVAOSIGURANJA" });
        ...
        private void BindDataGrid()
        {
            ...
            this.dv1.Table = this.dsOSNOVAOSIGURANJADataSet1.OSNOVAOSIGURANJA;
        ...
        private void FillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    ...
                    {
                        this.DataAdapter.FillPage(this.dsOSNOVAOSIGURANJADataSet1, 0, this.PageSize);
                    }
                    else
                    {
                        MethodInfo info = this.DataAdapter.GetType().GetMethod("FillPageBy" + this.FillMethod.Substring(6));
                        this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsOSNOVAOSIGURANJADataSet1, info, 0, this.PageSize);
                    }
                }
                else if (this.FillMethod == "Fill")
                {
                    this.DataAdapter.Fill(this.dsOSNOVAOSIGURANJADataSet1);
                }
                else
                {
                    MethodInfo info2 = this.DataAdapter.GetType().GetMethod(this.FillMethod);
                    this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsOSNOVAOSIGURANJADataSet1, info2);
                }
        ...
        private void ReFillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    if (this.FillMethod == "Fill")
                    {
                        this.DataAdapter.FillPage(this.dsOSNOVAOSIGURANJADataSet1, this.startRowThread, this.PageSize);
                    }
                    else
                    {
                        MethodInfo info = this.DataAdapter.GetType().GetMethod("FillPageBy" + this.FillMethod.Substring(6));
                        this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsOSNOVAOSIGURANJADataSet1, info, this.startRowThread, this.PageSize);
                    }
                }
        ...
        private void ResumeBindingPostThread()
        {
            ...
            this.EndUpdate();
            this.BindDataGrid();
            this.Text = "R-Sm - Osnove osiguranja : " + this.DataView.Count.ToString(CultureInfo.InvariantCulture) + " " + Deklarit.Resources.Resources.Rows;
        ...
        public virtual IOSNOVAOSIGURANJADataAdapter DataAdapter
        {
            get
            {
                ...
                if (DataAdapterFactory.Provider != null)
                {
                    return DataAdapterFactory.GetOSNOVAOSIGURANJADataAdapter();
                }
                return null;
            }
        }
        ...
        [Browsable(false), Category("Deklarit Work With ")]
        public virtual OSNOVAOSIGURANJADataSet DataSet
        {
            get
            {
                return this.dsOSNOVAOSIGURANJADataSet1;
            }
            set
            {
                this.dsOSNOVAOSIGURANJADataSet1 = value;
            }
        }
        ...
        public virtual string FillByZAMOOIDOSNOVAOSIGURANJAZAMOOIDOSNOVAOSIGURANJA
        {
            get
            {
                return this.m_FillByZAMOOIDOSNOVAOSIGURANJAZAMOOIDOSNOVAOSIGURANJA;
            }
            set
            {
                this.m_FillByZAMOOIDOSNOVAOSIGURANJAZAMOOIDOSNOVAOSIGURANJA = value;
            }
        }
