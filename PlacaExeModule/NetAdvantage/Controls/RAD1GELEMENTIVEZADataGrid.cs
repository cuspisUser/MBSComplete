namespace NetAdvantage.Controls
{
    ...
    public class RAD1GELEMENTIVEZADataGrid : DeklaritDataGrid
    {
        private int currentRow;
        private RAD1GELEMENTIVEZADataSet dsRAD1GELEMENTIVEZADataSet1 = new RAD1GELEMENTIVEZADataSet();
        private System.Data.DataView dv1;
        private int m_FillByIDELEMENTIDELEMENT;
        private bool m_FillByPage = false;
        private int m_FillByRAD1GELEMENTIIDRAD1GELEMENTIID;
        ...
        public RAD1GELEMENTIVEZADataGrid()
        {
            this.BindDataGrid();
            DeklaritDataGrid.myFillMethods = new TypeConverter.StandardValuesCollection(new string[] { "Fill", "FillByIDELEMENT", "FillByRAD1GELEMENTIID" });
        ...
        private void BindDataGrid()
        {
            ...
            this.dv1.Table = this.dsRAD1GELEMENTIVEZADataSet1.RAD1GELEMENTIVEZA;
        ...
        private void FillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    ...
                    {
                        this.DataAdapter.FillPage(this.dsRAD1GELEMENTIVEZADataSet1, 0, this.PageSize);
                    }
                    else
                    {
                        MethodInfo info = this.DataAdapter.GetType().GetMethod("FillPageBy" + this.FillMethod.Substring(6));
                        this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsRAD1GELEMENTIVEZADataSet1, info, 0, this.PageSize);
                    }
                }
                else if (this.FillMethod == "Fill")
                {
                    this.DataAdapter.Fill(this.dsRAD1GELEMENTIVEZADataSet1);
                }
                else
                {
                    MethodInfo info2 = this.DataAdapter.GetType().GetMethod(this.FillMethod);
                    this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsRAD1GELEMENTIVEZADataSet1, info2);
                }
        ...
        private void ReFillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    if (this.FillMethod == "Fill")
                    {
                        this.DataAdapter.FillPage(this.dsRAD1GELEMENTIVEZADataSet1, this.startRowThread, this.PageSize);
                    }
                    else
                    {
                        MethodInfo info = this.DataAdapter.GetType().GetMethod("FillPageBy" + this.FillMethod.Substring(6));
                        this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsRAD1GELEMENTIVEZADataSet1, info, this.startRowThread, this.PageSize);
                    }
                }
        ...
        private void ResumeBindingPostThread()
        {
            ...
            this.EndUpdate();
            this.BindDataGrid();
            this.Text = "Veza elementi RAD1G i elementi : " + this.DataView.Count.ToString(CultureInfo.InvariantCulture) + " " + Deklarit.Resources.Resources.Rows;
        ...
        public virtual IRAD1GELEMENTIVEZADataAdapter DataAdapter
        {
            get
            {
        ...
        public virtual RAD1GELEMENTIVEZADataSet DataSet
        {
            get
            {
                return this.dsRAD1GELEMENTIVEZADataSet1;
            }
            set
            {
                this.dsRAD1GELEMENTIVEZADataSet1 = value;
            }
        }
