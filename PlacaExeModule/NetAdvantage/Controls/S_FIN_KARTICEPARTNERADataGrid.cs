namespace NetAdvantage.Controls
{
    ...
    public class S_FIN_KARTICEPARTNERADataGrid : DeklaritDataGrid
    {
        private int currentRow;
        private S_FIN_KARTICEPARTNERADataSet dsS_FIN_KARTICEPARTNERADataSet1 = new S_FIN_KARTICEPARTNERADataSet();
        ...
        public S_FIN_KARTICEPARTNERADataGrid()
        {
            this.BindDataGrid();
        ...
        private void BindDataGrid()
        {
            ...
            this.dv1.Table = this.dsS_FIN_KARTICEPARTNERADataSet1.S_FIN_KARTICEPARTNERA;
        ...
        {
            this.PreFill();
            this.dsS_FIN_KARTICEPARTNERADataSet1 = new S_FIN_KARTICEPARTNERADataSet();
            this.m_StartRow = 0;
        ...
        private void FillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dsS_FIN_KARTICEPARTNERADataSet1, this.m_ParameterORG, this.m_ParameterMT, this.m_ParameterDOK, this.m_ParameterRAZDOBLJEOD, this.m_ParameterRAZDOBLJEDO, this.m_ParameterPOCETNIKONTO, this.m_ParameterZAVRSNIKONTO, this.m_ParameterIDAKTIVNOST, this.m_ParameterIDPARTNER, this.m_ParameterSORT, 0, this.PageSize);
                }
                else
                {
                    this.DataAdapter.Fill(this.dsS_FIN_KARTICEPARTNERADataSet1, this.m_ParameterORG, this.m_ParameterMT, this.m_ParameterDOK, this.m_ParameterRAZDOBLJEOD, this.m_ParameterRAZDOBLJEDO, this.m_ParameterPOCETNIKONTO, this.m_ParameterZAVRSNIKONTO, this.m_ParameterIDAKTIVNOST, this.m_ParameterIDPARTNER, this.m_ParameterSORT);
                }
        ...
        private void ResumeBindingPostThread()
        {
            ...
            this.EndUpdate();
            this.BindDataGrid();
            this.Text = "S_FIN_KARTICE_PARTNERA : " + this.DataView.Count.ToString(CultureInfo.InvariantCulture) + " " + Deklarit.Resources.Resources.Rows;
        ...
        public virtual IS_FIN_KARTICEPARTNERADataAdapter DataAdapter
        {
            get
            {
                ...
                if (DataAdapterFactory.Provider != null)
                {
                    return DataAdapterFactory.GetS_FIN_KARTICEPARTNERADataAdapter();
                }
                return null;
            }
        }
        ...
        [Category("Deklarit Work With "), Browsable(false)]
        public virtual S_FIN_KARTICEPARTNERADataSet DataSet
        {
            get
            {
                return this.dsS_FIN_KARTICEPARTNERADataSet1;
            }
            set
            {
                this.dsS_FIN_KARTICEPARTNERADataSet1 = value;
            }
        }
