namespace NetAdvantage.Controls
{
    ...
    public class OSDOKUMENTDataGrid : DeklaritDataGrid
    {
        private int currentRow;
        private OSDOKUMENTDataSet dsOSDOKUMENTDataSet1 = new OSDOKUMENTDataSet();
        ...
        private void BindDataGrid()
        {
            ...
            this.dv1.Table = this.dsOSDOKUMENTDataSet1.OSDOKUMENT;
        ...
        private void FillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    ...
                    {
                        this.DataAdapter.FillPage(this.dsOSDOKUMENTDataSet1, 0, this.PageSize);
                    }
                    else
                    {
                        MethodInfo info = this.DataAdapter.GetType().GetMethod("FillPageBy" + this.FillMethod.Substring(6));
                        this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsOSDOKUMENTDataSet1, info, 0, this.PageSize);
                    }
                }
                else if (this.FillMethod == "Fill")
                {
                    this.DataAdapter.Fill(this.dsOSDOKUMENTDataSet1);
                }
                else
                {
                    MethodInfo info2 = this.DataAdapter.GetType().GetMethod(this.FillMethod);
                    this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsOSDOKUMENTDataSet1, info2);
                }
        ...
        private void ReFillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    if (this.FillMethod == "Fill")
                    {
                        this.DataAdapter.FillPage(this.dsOSDOKUMENTDataSet1, this.startRowThread, this.PageSize);
                    }
                    else
                    {
                        MethodInfo info = this.DataAdapter.GetType().GetMethod("FillPageBy" + this.FillMethod.Substring(6));
                        this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsOSDOKUMENTDataSet1, info, this.startRowThread, this.PageSize);
                    }
                }
        ...
        private void ResumeBindingPostThread()
        {
            ...
            this.EndUpdate();
            this.BindDataGrid();
            this.Text = "OSDOKUMENT : " + this.DataView.Count.ToString(CultureInfo.InvariantCulture) + " " + Deklarit.Resources.Resources.Rows;
        ...
        public virtual IOSDOKUMENTDataAdapter DataAdapter
        {
            get
            {
        ...
        public virtual OSDOKUMENTDataSet DataSet
        {
            get
            {
                return this.dsOSDOKUMENTDataSet1;
            }
            set
            {
                this.dsOSDOKUMENTDataSet1 = value;
            }
        }
