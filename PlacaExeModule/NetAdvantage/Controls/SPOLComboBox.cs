namespace NetAdvantage.Controls
{
    ...
    public class SPOLComboBox : DeklaritComboBox
    {
        private System.Data.DataSet m_DataSet = new SPOLDataSet();
        protected string m_FillMethod = "Fill";

        public SPOLComboBox()
        {
            this.Text = "IDSPOL";
            DataView defaultView = this.DataSet.Tables["SPOL"].DefaultView;
            defaultView.Sort = "NAZIVSPOL";
            this.DisplayMember = "NAZIVSPOL";
            this.ValueMember = "IDSPOL";
        ...
        protected override void InitLayout()
        {
            ...
            if (!this.DesignMode && this.FillAtStartup)
            {
                ...
                {
                    DataView view = ComboHelper.GetComboValues(this.DataSet, "SPOL", "IDSPOL", "NAZIVSPOL", true, "<" + Deklarit.Resources.Resources.Empty + ">");
                    this.DataSource = null;
                    view.Sort = "Name";
        ...
        public ISPOLDataAdapter DataAdapter
        {
            get
            {
