namespace NetAdvantage.Controls
{
    ...
    public class S_OD_IPPDataGrid : DeklaritDataGrid
    {
        private int currentRow;
        private S_OD_IPPDataSet dsS_OD_IPPDataSet1 = new S_OD_IPPDataSet();
        ...
        private string m_Parametermjesec = "";
        private int m_StartRow;
        private int startRowThread;
        private const int WM_SETREDRAW = 11;

        public S_OD_IPPDataGrid()
        {
            this.BindDataGrid();
        ...
        private void BindDataGrid()
        {
            ...
            this.dv1.Table = this.dsS_OD_IPPDataSet1.S_OD_IPP;
        ...
        {
            this.PreFill();
            this.dsS_OD_IPPDataSet1 = new S_OD_IPPDataSet();
            this.m_StartRow = 0;
        ...
        private void FillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dsS_OD_IPPDataSet1, this.m_Parametermjesec, this.m_Parametergodina, 0, this.PageSize);
                }
                else
                {
                    this.DataAdapter.Fill(this.dsS_OD_IPPDataSet1, this.m_Parametermjesec, this.m_Parametergodina);
                }
        ...
        private void ReFillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dsS_OD_IPPDataSet1, this.m_Parametermjesec, this.m_Parametergodina, this.startRowThread, this.PageSize);
                }
        ...
        private void ResumeBindingPostThread()
        {
            ...
            this.EndUpdate();
            this.BindDataGrid();
            this.Text = "S_OD_IPP : " + this.DataView.Count.ToString(CultureInfo.InvariantCulture) + " " + Deklarit.Resources.Resources.Rows;
        ...
        public virtual IS_OD_IPPDataAdapter DataAdapter
        {
            get
            {
                ...
                if (DataAdapterFactory.Provider != null)
                {
                    return DataAdapterFactory.GetS_OD_IPPDataAdapter();
                }
                return null;
            }
        }
        ...
        [Browsable(false), Category("Deklarit Work With ")]
        public virtual S_OD_IPPDataSet DataSet
        {
            get
            {
                return this.dsS_OD_IPPDataSet1;
            }
            set
            {
                this.dsS_OD_IPPDataSet1 = value;
            }
        }
