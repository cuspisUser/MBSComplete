namespace NetAdvantage.Controls
{
    ...
    public class S_FIN_IRA_PLACANJEDataGrid : DeklaritDataGrid
    {
        private int currentRow;
        private S_FIN_IRA_PLACANJEDataSet dsS_FIN_IRA_PLACANJEDataSet1 = new S_FIN_IRA_PLACANJEDataSet();
        ...
        public S_FIN_IRA_PLACANJEDataGrid()
        {
            this.BindDataGrid();
        ...
        {
            this.PreFill();
            this.dsS_FIN_IRA_PLACANJEDataSet1 = new S_FIN_IRA_PLACANJEDataSet();
            this.m_StartRow = 0;
        ...
        private void FillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dsS_FIN_IRA_PLACANJEDataSet1, this.m_ParameterIDDOKUMENT, 0, this.PageSize);
                }
                else
                {
                    this.DataAdapter.Fill(this.dsS_FIN_IRA_PLACANJEDataSet1, this.m_ParameterIDDOKUMENT);
                }
        ...
        private void ReFillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dsS_FIN_IRA_PLACANJEDataSet1, this.m_ParameterIDDOKUMENT, this.startRowThread, this.PageSize);
                }
        ...
        private void ResumeBindingPostThread()
        {
            ...
            this.EndUpdate();
            this.BindDataGrid();
            this.Text = "S_FIN_IRA_PLACANJE : " + this.DataView.Count.ToString(CultureInfo.InvariantCulture) + " " + Deklarit.Resources.Resources.Rows;
        ...
        public virtual IS_FIN_IRA_PLACANJEDataAdapter DataAdapter
        {
            get
            {
                ...
                if (DataAdapterFactory.Provider != null)
                {
                    return DataAdapterFactory.GetS_FIN_IRA_PLACANJEDataAdapter();
                }
                return null;
            }
        }
        ...
        public virtual S_FIN_IRA_PLACANJEDataSet DataSet
        {
            get
            {
                return this.dsS_FIN_IRA_PLACANJEDataSet1;
            }
            set
            {
                this.dsS_FIN_IRA_PLACANJEDataSet1 = value;
            }
        }
