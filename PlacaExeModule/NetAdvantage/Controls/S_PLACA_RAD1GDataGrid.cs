namespace NetAdvantage.Controls
{
    ...
    public class S_PLACA_RAD1GDataGrid : DeklaritDataGrid
    {
        private int currentRow;
        private S_PLACA_RAD1GDataSet dsS_PLACA_RAD1GDataSet1 = new S_PLACA_RAD1GDataSet();
        private System.Data.DataView dv1;
        private bool m_FillByPage = true;
        private bool m_GridLoading;
        private int m_PageSize = 60;
        private DateTime m_ParameterDATUMNAKOJIRACUNAMSTAROST = DateTime.Now;
        private string m_ParameterGODINAISPLATE = "";
        private string m_ParameterMJESECISPLATE = "";
        private string m_ParameterMJESECODLASKA = "";
        private int m_StartRow;
        private int startRowThread;
        private const int WM_SETREDRAW = 11;

        public S_PLACA_RAD1GDataGrid()
        {
            this.BindDataGrid();
        ...
        private void BindDataGrid()
        {
            ...
            this.dv1.Table = this.dsS_PLACA_RAD1GDataSet1.S_PLACA_RAD1G;
        ...
        {
            this.PreFill();
            this.dsS_PLACA_RAD1GDataSet1 = new S_PLACA_RAD1GDataSet();
            this.m_StartRow = 0;
        ...
        private void FillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dsS_PLACA_RAD1GDataSet1, this.m_ParameterGODINAISPLATE, this.m_ParameterMJESECISPLATE, this.m_ParameterDATUMNAKOJIRACUNAMSTAROST, this.m_ParameterMJESECODLASKA, 0, this.PageSize);
                }
                else
                {
                    this.DataAdapter.Fill(this.dsS_PLACA_RAD1GDataSet1, this.m_ParameterGODINAISPLATE, this.m_ParameterMJESECISPLATE, this.m_ParameterDATUMNAKOJIRACUNAMSTAROST, this.m_ParameterMJESECODLASKA);
                }
        ...
        private void ReFillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dsS_PLACA_RAD1GDataSet1, this.m_ParameterGODINAISPLATE, this.m_ParameterMJESECISPLATE, this.m_ParameterDATUMNAKOJIRACUNAMSTAROST, this.m_ParameterMJESECODLASKA, this.startRowThread, this.PageSize);
                }
        ...
        private void ResumeBindingPostThread()
        {
            ...
            this.EndUpdate();
            this.BindDataGrid();
            this.Text = "S_PLACA_RAD1G : " + this.DataView.Count.ToString(CultureInfo.InvariantCulture) + " " + Deklarit.Resources.Resources.Rows;
        ...
        public virtual IS_PLACA_RAD1GDataAdapter DataAdapter
        {
            get
            {
                ...
                if (DataAdapterFactory.Provider != null)
                {
                    return DataAdapterFactory.GetS_PLACA_RAD1GDataAdapter();
                }
                return null;
            }
        }
        ...
        [Browsable(false), Category("Deklarit Work With ")]
        public virtual S_PLACA_RAD1GDataSet DataSet
        {
            get
            {
                return this.dsS_PLACA_RAD1GDataSet1;
            }
            set
            {
                this.dsS_PLACA_RAD1GDataSet1 = value;
            }
        }
        ...
        public virtual DateTime ParameterDATUMNAKOJIRACUNAMSTAROST
        {
            get
            {
                return this.m_ParameterDATUMNAKOJIRACUNAMSTAROST;
            }
            set
            {
                this.m_ParameterDATUMNAKOJIRACUNAMSTAROST = value;
            }
        }
        ...
        public virtual string ParameterMJESECISPLATE
        {
            get
            {
                return this.m_ParameterMJESECISPLATE;
            }
            set
            {
                this.m_ParameterMJESECISPLATE = value;
            }
        }
        ...
        public virtual string ParameterMJESECODLASKA
        {
            get
            {
                return this.m_ParameterMJESECODLASKA;
            }
            set
            {
                this.m_ParameterMJESECODLASKA = value;
            }
        }
    }
}
