namespace NetAdvantage.Controls
{
    ...
    public class SHEMAURADataGrid : DeklaritDataGrid
    {
        private int currentRow;
        private SHEMAURADataSet dsSHEMAURADataSet1 = new SHEMAURADataSet();
        private System.Data.DataView dv1;
        private bool m_FillByPage = false;
        private int m_FillByPARTNERSHEMAURAIDPARTNERPARTNERSHEMAURAIDPARTNER;
        ...
        public SHEMAURADataGrid()
        {
            this.BindDataGrid();
            DeklaritDataGrid.myFillMethods = new TypeConverter.StandardValuesCollection(new string[] { "Fill", "FillByPARTNERSHEMAURAIDPARTNER" });
        ...
        private void BindDataGrid()
        {
            ...
            this.dv1.Table = this.dsSHEMAURADataSet1.SHEMAURA;
        ...
        private void FillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    ...
                    {
                        this.DataAdapter.FillPage(this.dsSHEMAURADataSet1, 0, this.PageSize);
                    }
                    else
                    {
                        MethodInfo info = this.DataAdapter.GetType().GetMethod("FillPageBy" + this.FillMethod.Substring(6));
                        this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsSHEMAURADataSet1, info, 0, this.PageSize);
                    }
                }
                else if (this.FillMethod == "Fill")
                {
                    this.DataAdapter.Fill(this.dsSHEMAURADataSet1);
                }
                else
                {
                    MethodInfo info2 = this.DataAdapter.GetType().GetMethod(this.FillMethod);
                    this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsSHEMAURADataSet1, info2);
                }
        ...
        private void ReFillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    if (this.FillMethod == "Fill")
                    {
                        this.DataAdapter.FillPage(this.dsSHEMAURADataSet1, this.startRowThread, this.PageSize);
                    }
                    else
                    {
                        MethodInfo info = this.DataAdapter.GetType().GetMethod("FillPageBy" + this.FillMethod.Substring(6));
                        this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsSHEMAURADataSet1, info, this.startRowThread, this.PageSize);
                    }
                }
        ...
        private void ResumeBindingPostThread()
        {
            ...
            this.EndUpdate();
            this.BindDataGrid();
            this.Text = "Shema kontiranja URA : " + this.DataView.Count.ToString(CultureInfo.InvariantCulture) + " " + Deklarit.Resources.Resources.Rows;
        ...
        public virtual ISHEMAURADataAdapter DataAdapter
        {
            get
            {
                ...
                if (DataAdapterFactory.Provider != null)
                {
                    return DataAdapterFactory.GetSHEMAURADataAdapter();
                }
                return null;
            }
        }
        ...
        public virtual SHEMAURADataSet DataSet
        {
            get
            {
                return this.dsSHEMAURADataSet1;
            }
            set
            {
                this.dsSHEMAURADataSet1 = value;
            }
        }
        ...
        public virtual int FillByPARTNERSHEMAURAIDPARTNERPARTNERSHEMAURAIDPARTNER
        {
            get
            {
                return this.m_FillByPARTNERSHEMAURAIDPARTNERPARTNERSHEMAURAIDPARTNER;
            }
            set
            {
                this.m_FillByPARTNERSHEMAURAIDPARTNERPARTNERSHEMAURAIDPARTNER = value;
            }
        }
