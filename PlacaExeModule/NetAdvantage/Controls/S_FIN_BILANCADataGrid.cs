namespace NetAdvantage.Controls
{
    ...
    public class S_FIN_BILANCADataGrid : DeklaritDataGrid
    {
        private int currentRow;
        private S_FIN_BILANCADataSet dsS_FIN_BILANCADataSet1 = new S_FIN_BILANCADataSet();
        private System.Data.DataView dv1;
        private bool m_FillByPage = true;
        private bool m_GridLoading;
        private int m_PageSize = 60;
        private short m_ParameterANA = 0;
        private string m_ParameterDOK = "";
        private string m_ParameterKLASA = "";
        private string m_ParameterMT = "";
        private string m_ParameterORG = "";
        private DateTime m_ParameterRAZDOBLJEDO = DateTime.Now;
        private DateTime m_ParameterRAZDOBLJEOD = DateTime.Now;
        private short m_ParameterSKR = 0;
        private short m_ParameterVRSTABILANCE = 0;
        private int m_StartRow;
        private int startRowThread;
        private const int WM_SETREDRAW = 11;

        public S_FIN_BILANCADataGrid()
        {
            this.BindDataGrid();
        ...
        private void BindDataGrid()
        {
            ...
            this.dv1.Table = this.dsS_FIN_BILANCADataSet1.S_FIN_BILANCA;
        ...
        private void FillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dsS_FIN_BILANCADataSet1, this.m_ParameterRAZDOBLJEOD, this.m_ParameterRAZDOBLJEDO, this.m_ParameterORG, this.m_ParameterMT, this.m_ParameterDOK, this.m_ParameterANA, this.m_ParameterSKR, this.m_ParameterKLASA, this.m_ParameterVRSTABILANCE, 0, this.PageSize);
                }
                else
                {
                    this.DataAdapter.Fill(this.dsS_FIN_BILANCADataSet1, this.m_ParameterRAZDOBLJEOD, this.m_ParameterRAZDOBLJEDO, this.m_ParameterORG, this.m_ParameterMT, this.m_ParameterDOK, this.m_ParameterANA, this.m_ParameterSKR, this.m_ParameterKLASA, this.m_ParameterVRSTABILANCE);
                }
        ...
        private void ReFillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dsS_FIN_BILANCADataSet1, this.m_ParameterRAZDOBLJEOD, this.m_ParameterRAZDOBLJEDO, this.m_ParameterORG, this.m_ParameterMT, this.m_ParameterDOK, this.m_ParameterANA, this.m_ParameterSKR, this.m_ParameterKLASA, this.m_ParameterVRSTABILANCE, this.startRowThread, this.PageSize);
                }
        ...
        private void ResumeBindingPostThread()
        {
            ...
            this.EndUpdate();
            this.BindDataGrid();
            this.Text = "S_FIN_BILANCA : " + this.DataView.Count.ToString(CultureInfo.InvariantCulture) + " " + Deklarit.Resources.Resources.Rows;
        ...
        public virtual IS_FIN_BILANCADataAdapter DataAdapter
        {
            get
            {
                ...
                if (DataAdapterFactory.Provider != null)
                {
                    return DataAdapterFactory.GetS_FIN_BILANCADataAdapter();
                }
                return null;
            }
        }
        ...
        public virtual S_FIN_BILANCADataSet DataSet
        {
            get
            {
                return this.dsS_FIN_BILANCADataSet1;
            }
            set
            {
                this.dsS_FIN_BILANCADataSet1 = value;
            }
        }
        ...
        public virtual short ParameterANA
        {
            get
            {
                return this.m_ParameterANA;
            }
            set
            {
                this.m_ParameterANA = value;
            }
        }
        ...
        public virtual string ParameterKLASA
        {
            get
            {
                return this.m_ParameterKLASA;
            }
            set
            {
                this.m_ParameterKLASA = value;
            }
        }
        ...
        public virtual short ParameterSKR
        {
            get
            {
                return this.m_ParameterSKR;
            }
            set
            {
                this.m_ParameterSKR = value;
            }
        }
        ...
        public virtual short ParameterVRSTABILANCE
        {
            get
            {
                return this.m_ParameterVRSTABILANCE;
            }
            set
            {
                this.m_ParameterVRSTABILANCE = value;
            }
        }
    }
}
