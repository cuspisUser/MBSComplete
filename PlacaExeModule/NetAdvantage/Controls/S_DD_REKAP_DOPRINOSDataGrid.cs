namespace NetAdvantage.Controls
{
    ...
    public class S_DD_REKAP_DOPRINOSDataGrid : DeklaritDataGrid
    {
        private int currentRow;
        private S_DD_REKAP_DOPRINOSDataSet dsS_DD_REKAP_DOPRINOSDataSet1 = new S_DD_REKAP_DOPRINOSDataSet();
        ...
        public S_DD_REKAP_DOPRINOSDataGrid()
        {
            this.BindDataGrid();
        ...
        private void BindDataGrid()
        {
            ...
            this.dv1.Table = this.dsS_DD_REKAP_DOPRINOSDataSet1.S_DD_REKAP_DOPRINOS;
        ...
        {
            this.PreFill();
            this.dsS_DD_REKAP_DOPRINOSDataSet1 = new S_DD_REKAP_DOPRINOSDataSet();
            this.m_StartRow = 0;
        ...
        private void FillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dsS_DD_REKAP_DOPRINOSDataSet1, this.m_ParameterIDOBRACUN, 0, this.PageSize);
                }
                else
                {
                    this.DataAdapter.Fill(this.dsS_DD_REKAP_DOPRINOSDataSet1, this.m_ParameterIDOBRACUN);
                }
        ...
        private void ReFillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dsS_DD_REKAP_DOPRINOSDataSet1, this.m_ParameterIDOBRACUN, this.startRowThread, this.PageSize);
                }
        ...
        private void ResumeBindingPostThread()
        {
            ...
            this.EndUpdate();
            this.BindDataGrid();
            this.Text = "S_DD_REKAP_DOPRINOS : " + this.DataView.Count.ToString(CultureInfo.InvariantCulture) + " " + Deklarit.Resources.Resources.Rows;
        ...
        public virtual IS_DD_REKAP_DOPRINOSDataAdapter DataAdapter
        {
            get
            {
                ...
                if (DataAdapterFactory.Provider != null)
                {
                    return DataAdapterFactory.GetS_DD_REKAP_DOPRINOSDataAdapter();
                }
                return null;
            }
        }
        ...
        [Category("Deklarit Work With "), Browsable(false)]
        public virtual S_DD_REKAP_DOPRINOSDataSet DataSet
        {
            get
            {
                return this.dsS_DD_REKAP_DOPRINOSDataSet1;
            }
            set
            {
                this.dsS_DD_REKAP_DOPRINOSDataSet1 = value;
            }
        }
