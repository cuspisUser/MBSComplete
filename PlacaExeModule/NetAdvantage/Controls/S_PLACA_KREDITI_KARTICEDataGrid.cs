namespace NetAdvantage.Controls
{
    ...
    public class S_PLACA_KREDITI_KARTICEDataGrid : DeklaritDataGrid
    {
        private int currentRow;
        private S_PLACA_KREDITI_KARTICEDataSet dsS_PLACA_KREDITI_KARTICEDataSet1 = new S_PLACA_KREDITI_KARTICEDataSet();
        ...
        public S_PLACA_KREDITI_KARTICEDataGrid()
        {
            this.BindDataGrid();
        ...
        private void BindDataGrid()
        {
            ...
            this.dv1.Table = this.dsS_PLACA_KREDITI_KARTICEDataSet1.S_PLACA_KREDITI_KARTICE;
        ...
        {
            this.PreFill();
            this.dsS_PLACA_KREDITI_KARTICEDataSet1 = new S_PLACA_KREDITI_KARTICEDataSet();
            this.m_StartRow = 0;
        ...
        private void FillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dsS_PLACA_KREDITI_KARTICEDataSet1, this.m_ParameterIDOBRACUN, 0, this.PageSize);
                }
                else
                {
                    this.DataAdapter.Fill(this.dsS_PLACA_KREDITI_KARTICEDataSet1, this.m_ParameterIDOBRACUN);
                }
        ...
        private void ReFillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dsS_PLACA_KREDITI_KARTICEDataSet1, this.m_ParameterIDOBRACUN, this.startRowThread, this.PageSize);
                }
        ...
        private void ResumeBindingPostThread()
        {
            ...
            this.EndUpdate();
            this.BindDataGrid();
            this.Text = "S_PLACA_KREDITI_KARTICE : " + this.DataView.Count.ToString(CultureInfo.InvariantCulture) + " " + Deklarit.Resources.Resources.Rows;
        ...
        public virtual IS_PLACA_KREDITI_KARTICEDataAdapter DataAdapter
        {
            get
            {
                ...
                if (DataAdapterFactory.Provider != null)
                {
                    return DataAdapterFactory.GetS_PLACA_KREDITI_KARTICEDataAdapter();
                }
                return null;
            }
        }
        ...
        public virtual S_PLACA_KREDITI_KARTICEDataSet DataSet
        {
            get
            {
                return this.dsS_PLACA_KREDITI_KARTICEDataSet1;
            }
            set
            {
                this.dsS_PLACA_KREDITI_KARTICEDataSet1 = value;
            }
        }
