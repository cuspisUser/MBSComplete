namespace NetAdvantage.Controls
{
    ...
    public class S_PLACA_RAD1M_DIO2DataGrid : DeklaritDataGrid
    {
        private int currentRow;
        private S_PLACA_RAD1M_DIO2DataSet dsS_PLACA_RAD1M_DIO2DataSet1 = new S_PLACA_RAD1M_DIO2DataSet();
        ...
        public S_PLACA_RAD1M_DIO2DataGrid()
        {
            this.BindDataGrid();
        ...
        private void BindDataGrid()
        {
            ...
            this.dv1.Table = this.dsS_PLACA_RAD1M_DIO2DataSet1.S_PLACA_RAD1M_DIO2;
        ...
        {
            this.PreFill();
            this.dsS_PLACA_RAD1M_DIO2DataSet1 = new S_PLACA_RAD1M_DIO2DataSet();
            this.m_StartRow = 0;
        ...
        private void FillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dsS_PLACA_RAD1M_DIO2DataSet1, this.m_ParameterMJESECISPLATE, this.m_ParameterGODINAISPLATE, 0, this.PageSize);
                }
                else
                {
                    this.DataAdapter.Fill(this.dsS_PLACA_RAD1M_DIO2DataSet1, this.m_ParameterMJESECISPLATE, this.m_ParameterGODINAISPLATE);
                }
        ...
        private void ReFillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dsS_PLACA_RAD1M_DIO2DataSet1, this.m_ParameterMJESECISPLATE, this.m_ParameterGODINAISPLATE, this.startRowThread, this.PageSize);
                }
        ...
        private void ResumeBindingPostThread()
        {
            ...
            this.EndUpdate();
            this.BindDataGrid();
            this.Text = "S_PLACA_RAD1M_DIO2 : " + this.DataView.Count.ToString(CultureInfo.InvariantCulture) + " " + Deklarit.Resources.Resources.Rows;
        ...
        public virtual IS_PLACA_RAD1M_DIO2DataAdapter DataAdapter
        {
            get
            {
                ...
                if (DataAdapterFactory.Provider != null)
                {
                    return DataAdapterFactory.GetS_PLACA_RAD1M_DIO2DataAdapter();
                }
                return null;
            }
        }
        ...
        [Category("Deklarit Work With "), Browsable(false)]
        public virtual S_PLACA_RAD1M_DIO2DataSet DataSet
        {
            get
            {
                return this.dsS_PLACA_RAD1M_DIO2DataSet1;
            }
            set
            {
                this.dsS_PLACA_RAD1M_DIO2DataSet1 = value;
            }
        }
