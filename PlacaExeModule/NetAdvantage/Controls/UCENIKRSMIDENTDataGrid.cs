namespace NetAdvantage.Controls
{
    ...
    public class UCENIKRSMIDENTDataGrid : DeklaritDataGrid
    {
        private int currentRow;
        private UCENIKRSMIDENTDataSet dsUCENIKRSMIDENTDataSet1 = new UCENIKRSMIDENTDataSet();
        ...
        private void BindDataGrid()
        {
            ...
            this.dv1.Table = this.dsUCENIKRSMIDENTDataSet1.UCENIKRSMIDENT;
        ...
        private void FillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    ...
                    {
                        this.DataAdapter.FillPage(this.dsUCENIKRSMIDENTDataSet1, 0, this.PageSize);
                    }
                    else
                    {
                        MethodInfo info = this.DataAdapter.GetType().GetMethod("FillPageBy" + this.FillMethod.Substring(6));
                        this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsUCENIKRSMIDENTDataSet1, info, 0, this.PageSize);
                    }
                }
                else if (this.FillMethod == "Fill")
                {
                    this.DataAdapter.Fill(this.dsUCENIKRSMIDENTDataSet1);
                }
                else
                {
                    MethodInfo info2 = this.DataAdapter.GetType().GetMethod(this.FillMethod);
                    this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsUCENIKRSMIDENTDataSet1, info2);
                }
        ...
        private void ReFillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    if (this.FillMethod == "Fill")
                    {
                        this.DataAdapter.FillPage(this.dsUCENIKRSMIDENTDataSet1, this.startRowThread, this.PageSize);
                    }
                    else
                    {
                        MethodInfo info = this.DataAdapter.GetType().GetMethod("FillPageBy" + this.FillMethod.Substring(6));
                        this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsUCENIKRSMIDENTDataSet1, info, this.startRowThread, this.PageSize);
                    }
                }
        ...
        private void ResumeBindingPostThread()
        {
            ...
            this.EndUpdate();
            this.BindDataGrid();
            this.Text = "UCENIKRSMIDENT : " + this.DataView.Count.ToString(CultureInfo.InvariantCulture) + " " + Deklarit.Resources.Resources.Rows;
        ...
        public virtual IUCENIKRSMIDENTDataAdapter DataAdapter
        {
            get
            {
                ...
                if (DataAdapterFactory.Provider != null)
                {
                    return DataAdapterFactory.GetUCENIKRSMIDENTDataAdapter();
                }
                return null;
            }
        }
        ...
        public virtual UCENIKRSMIDENTDataSet DataSet
        {
            get
            {
                return this.dsUCENIKRSMIDENTDataSet1;
            }
            set
            {
                this.dsUCENIKRSMIDENTDataSet1 = value;
            }
        }
