namespace NetAdvantage.Controls
{
    ...
    public class s_od_pripremaDataGrid : DeklaritDataGrid
    {
        private int currentRow;
        private s_od_pripremaDataSet dss_od_pripremaDataSet1 = new s_od_pripremaDataSet();
        private System.Data.DataView dv1;
        private bool m_FillByPage = true;
        private bool m_GridLoading;
        private int m_PageSize = 60;
        private int m_Parametergodina = 0;
        private int m_Parameterid = 0;
        private int m_Parametermjesec = 0;
        private string m_Parametervrsta = "";
        private int m_StartRow;
        private int startRowThread;
        private const int WM_SETREDRAW = 11;

        public s_od_pripremaDataGrid()
        {
            this.BindDataGrid();
        ...
        private void BindDataGrid()
        {
            ...
            this.dv1.Table = this.dss_od_pripremaDataSet1.s_od_priprema;
        ...
        {
            this.PreFill();
            this.dss_od_pripremaDataSet1 = new s_od_pripremaDataSet();
            this.m_StartRow = 0;
        ...
        private void FillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dss_od_pripremaDataSet1, this.m_Parametergodina, this.m_Parameterid, this.m_Parametermjesec, this.m_Parametervrsta, 0, this.PageSize);
                }
                else
                {
                    this.DataAdapter.Fill(this.dss_od_pripremaDataSet1, this.m_Parametergodina, this.m_Parameterid, this.m_Parametermjesec, this.m_Parametervrsta);
                }
        ...
        private void ReFillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dss_od_pripremaDataSet1, this.m_Parametergodina, this.m_Parameterid, this.m_Parametermjesec, this.m_Parametervrsta, this.startRowThread, this.PageSize);
                }
        ...
        private void ResumeBindingPostThread()
        {
            ...
            this.EndUpdate();
            this.BindDataGrid();
            this.Text = "s_od_priprema : " + this.DataView.Count.ToString(CultureInfo.InvariantCulture) + " " + Deklarit.Resources.Resources.Rows;
        ...
        public virtual Is_od_pripremaDataAdapter DataAdapter
        {
            get
            {
                ...
                if (DataAdapterFactory.Provider != null)
                {
                    return DataAdapterFactory.Gets_od_pripremaDataAdapter();
                }
                return null;
            }
        }
        ...
        [Browsable(false), Category("Deklarit Work With ")]
        public virtual s_od_pripremaDataSet DataSet
        {
            get
            {
                return this.dss_od_pripremaDataSet1;
            }
            set
            {
                this.dss_od_pripremaDataSet1 = value;
            }
        }
        ...
        public virtual int Parametermjesec
        {
            get
            {
                return this.m_Parametermjesec;
            }
            set
            {
                this.m_Parametermjesec = value;
            }
        }
