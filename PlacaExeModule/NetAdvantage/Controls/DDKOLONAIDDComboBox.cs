namespace NetAdvantage.Controls
{
    ...
    public class DDKOLONAIDDComboBox : DeklaritComboBox
    {
        private System.Data.DataSet m_DataSet = new DDKOLONAIDDDataSet();
        protected string m_FillMethod = "Fill";

        public DDKOLONAIDDComboBox()
        {
            this.Text = "IDKOLONAIDD";
            DataView defaultView = this.DataSet.Tables["DDKOLONAIDD"].DefaultView;
            defaultView.Sort = "NAZIVKOLONAIDD";
            this.DisplayMember = "NAZIVKOLONAIDD";
            this.ValueMember = "IDKOLONAIDD";
        ...
        protected override void InitLayout()
        {
            ...
            if (!this.DesignMode && this.FillAtStartup)
            {
                ...
                {
                    DataView view = ComboHelper.GetComboValues(this.DataSet, "DDKOLONAIDD", "IDKOLONAIDD", "NAZIVKOLONAIDD", true, "<" + Deklarit.Resources.Resources.Empty + ">");
                    this.DataSource = null;
                    view.Sort = "Name";
        ...
        public IDDKOLONAIDDDataAdapter DataAdapter
        {
            get
            {
