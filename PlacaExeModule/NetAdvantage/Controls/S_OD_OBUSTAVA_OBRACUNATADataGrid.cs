namespace NetAdvantage.Controls
{
    ...
    public class S_OD_OBUSTAVA_OBRACUNATADataGrid : DeklaritDataGrid
    {
        private int currentRow;
        private S_OD_OBUSTAVA_OBRACUNATADataSet dsS_OD_OBUSTAVA_OBRACUNATADataSet1 = new S_OD_OBUSTAVA_OBRACUNATADataSet();
        ...
        public S_OD_OBUSTAVA_OBRACUNATADataGrid()
        {
            this.BindDataGrid();
        ...
        private void BindDataGrid()
        {
            ...
            this.dv1.Table = this.dsS_OD_OBUSTAVA_OBRACUNATADataSet1.S_OD_OBUSTAVA_OBRACUNATA;
        ...
        {
            this.PreFill();
            this.dsS_OD_OBUSTAVA_OBRACUNATADataSet1 = new S_OD_OBUSTAVA_OBRACUNATADataSet();
            this.m_StartRow = 0;
        ...
        private void FillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dsS_OD_OBUSTAVA_OBRACUNATADataSet1, this.m_ParameterIDOBRACUN, 0, this.PageSize);
                }
                else
                {
                    this.DataAdapter.Fill(this.dsS_OD_OBUSTAVA_OBRACUNATADataSet1, this.m_ParameterIDOBRACUN);
                }
        ...
        private void ReFillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dsS_OD_OBUSTAVA_OBRACUNATADataSet1, this.m_ParameterIDOBRACUN, this.startRowThread, this.PageSize);
                }
        ...
        private void ResumeBindingPostThread()
        {
            ...
            this.EndUpdate();
            this.BindDataGrid();
            this.Text = "S_OD_OBUSTAVA_OBRACUNATA : " + this.DataView.Count.ToString(CultureInfo.InvariantCulture) + " " + Deklarit.Resources.Resources.Rows;
        ...
        public virtual IS_OD_OBUSTAVA_OBRACUNATADataAdapter DataAdapter
        {
            get
            {
                ...
                if (DataAdapterFactory.Provider != null)
                {
                    return DataAdapterFactory.GetS_OD_OBUSTAVA_OBRACUNATADataAdapter();
                }
                return null;
            }
        }
        ...
        [Category("Deklarit Work With "), Browsable(false)]
        public virtual S_OD_OBUSTAVA_OBRACUNATADataSet DataSet
        {
            get
            {
                return this.dsS_OD_OBUSTAVA_OBRACUNATADataSet1;
            }
            set
            {
                this.dsS_OD_OBUSTAVA_OBRACUNATADataSet1 = value;
            }
        }
