namespace NetAdvantage.Controls
{
    ...
    public class S_PLACA_RAD1G_SATIDataGrid : DeklaritDataGrid
    {
        private int currentRow;
        private S_PLACA_RAD1G_SATIDataSet dsS_PLACA_RAD1G_SATIDataSet1 = new S_PLACA_RAD1G_SATIDataSet();
        ...
        public S_PLACA_RAD1G_SATIDataGrid()
        {
            this.BindDataGrid();
        ...
        private void BindDataGrid()
        {
            ...
            this.dv1.Table = this.dsS_PLACA_RAD1G_SATIDataSet1.S_PLACA_RAD1G_SATI;
        ...
        {
            this.PreFill();
            this.dsS_PLACA_RAD1G_SATIDataSet1 = new S_PLACA_RAD1G_SATIDataSet();
            this.m_StartRow = 0;
        ...
        private void FillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dsS_PLACA_RAD1G_SATIDataSet1, this.m_ParameterGODINAOBRACUNA, 0, this.PageSize);
                }
                else
                {
                    this.DataAdapter.Fill(this.dsS_PLACA_RAD1G_SATIDataSet1, this.m_ParameterGODINAOBRACUNA);
                }
        ...
        private void ReFillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dsS_PLACA_RAD1G_SATIDataSet1, this.m_ParameterGODINAOBRACUNA, this.startRowThread, this.PageSize);
                }
        ...
        private void ResumeBindingPostThread()
        {
            ...
            this.EndUpdate();
            this.BindDataGrid();
            this.Text = "S_PLACA_RAD1G_SATI : " + this.DataView.Count.ToString(CultureInfo.InvariantCulture) + " " + Deklarit.Resources.Resources.Rows;
        ...
        public virtual IS_PLACA_RAD1G_SATIDataAdapter DataAdapter
        {
            get
            {
                ...
                if (DataAdapterFactory.Provider != null)
                {
                    return DataAdapterFactory.GetS_PLACA_RAD1G_SATIDataAdapter();
                }
                return null;
            }
        }
        ...
        [Category("Deklarit Work With "), Browsable(false)]
        public virtual S_PLACA_RAD1G_SATIDataSet DataSet
        {
            get
            {
                return this.dsS_PLACA_RAD1G_SATIDataSet1;
            }
            set
            {
                this.dsS_PLACA_RAD1G_SATIDataSet1 = value;
            }
        }
