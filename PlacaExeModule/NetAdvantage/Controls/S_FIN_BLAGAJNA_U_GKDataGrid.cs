namespace NetAdvantage.Controls
{
    ...
    public class S_FIN_BLAGAJNA_U_GKDataGrid : DeklaritDataGrid
    {
        private int currentRow;
        private S_FIN_BLAGAJNA_U_GKDataSet dsS_FIN_BLAGAJNA_U_GKDataSet1 = new S_FIN_BLAGAJNA_U_GKDataSet();
        ...
        public S_FIN_BLAGAJNA_U_GKDataGrid()
        {
            this.BindDataGrid();
        ...
        private void BindDataGrid()
        {
            ...
            this.dv1.Table = this.dsS_FIN_BLAGAJNA_U_GKDataSet1.S_FIN_BLAGAJNA_U_GK;
        ...
        {
            this.PreFill();
            this.dsS_FIN_BLAGAJNA_U_GKDataSet1 = new S_FIN_BLAGAJNA_U_GKDataSet();
            this.m_StartRow = 0;
        ...
        private void FillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dsS_FIN_BLAGAJNA_U_GKDataSet1, this.m_ParameterDAT1, this.m_ParameterDAT2, this.m_ParameterBLAG, 0, this.PageSize);
                }
                else
                {
                    this.DataAdapter.Fill(this.dsS_FIN_BLAGAJNA_U_GKDataSet1, this.m_ParameterDAT1, this.m_ParameterDAT2, this.m_ParameterBLAG);
                }
        ...
        private void ReFillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dsS_FIN_BLAGAJNA_U_GKDataSet1, this.m_ParameterDAT1, this.m_ParameterDAT2, this.m_ParameterBLAG, this.startRowThread, this.PageSize);
                }
        ...
        private void ResumeBindingPostThread()
        {
            ...
            this.EndUpdate();
            this.BindDataGrid();
            this.Text = "S_FIN_BLAGAJNA_U_GK : " + this.DataView.Count.ToString(CultureInfo.InvariantCulture) + " " + Deklarit.Resources.Resources.Rows;
        ...
        public virtual IS_FIN_BLAGAJNA_U_GKDataAdapter DataAdapter
        {
            get
            {
                ...
                if (DataAdapterFactory.Provider != null)
                {
                    return DataAdapterFactory.GetS_FIN_BLAGAJNA_U_GKDataAdapter();
                }
                return null;
            }
        }
        ...
        [Browsable(false), Category("Deklarit Work With ")]
        public virtual S_FIN_BLAGAJNA_U_GKDataSet DataSet
        {
            get
            {
                return this.dsS_FIN_BLAGAJNA_U_GKDataSet1;
            }
            set
            {
                this.dsS_FIN_BLAGAJNA_U_GKDataSet1 = value;
            }
        }
