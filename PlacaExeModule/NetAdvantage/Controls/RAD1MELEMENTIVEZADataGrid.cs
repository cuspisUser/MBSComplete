namespace NetAdvantage.Controls
{
    ...
    public class RAD1MELEMENTIVEZADataGrid : DeklaritDataGrid
    {
        private int currentRow;
        private RAD1MELEMENTIVEZADataSet dsRAD1MELEMENTIVEZADataSet1 = new RAD1MELEMENTIVEZADataSet();
        private System.Data.DataView dv1;
        private int m_FillByIDELEMENTIDELEMENT;
        private bool m_FillByPage = false;
        private int m_FillByRAD1ELEMENTIIDRAD1ELEMENTIID;
        ...
        public RAD1MELEMENTIVEZADataGrid()
        {
            this.BindDataGrid();
            DeklaritDataGrid.myFillMethods = new TypeConverter.StandardValuesCollection(new string[] { "Fill", "FillByIDELEMENT", "FillByRAD1ELEMENTIID" });
        ...
        private void FillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    ...
                    {
                        this.DataAdapter.FillPage(this.dsRAD1MELEMENTIVEZADataSet1, 0, this.PageSize);
                    }
                    else
                    {
                        MethodInfo info = this.DataAdapter.GetType().GetMethod("FillPageBy" + this.FillMethod.Substring(6));
                        this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsRAD1MELEMENTIVEZADataSet1, info, 0, this.PageSize);
                    }
                }
                else if (this.FillMethod == "Fill")
                {
                    this.DataAdapter.Fill(this.dsRAD1MELEMENTIVEZADataSet1);
                }
                else
                {
                    MethodInfo info2 = this.DataAdapter.GetType().GetMethod(this.FillMethod);
                    this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsRAD1MELEMENTIVEZADataSet1, info2);
                }
        ...
        private void ReFillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    if (this.FillMethod == "Fill")
                    {
                        this.DataAdapter.FillPage(this.dsRAD1MELEMENTIVEZADataSet1, this.startRowThread, this.PageSize);
                    }
                    else
                    {
                        MethodInfo info = this.DataAdapter.GetType().GetMethod("FillPageBy" + this.FillMethod.Substring(6));
                        this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsRAD1MELEMENTIVEZADataSet1, info, this.startRowThread, this.PageSize);
                    }
                }
        ...
        private void ResumeBindingPostThread()
        {
            ...
            this.EndUpdate();
            this.BindDataGrid();
            this.Text = "Veza RAD1M elementi i elementi : " + this.DataView.Count.ToString(CultureInfo.InvariantCulture) + " " + Deklarit.Resources.Resources.Rows;
        ...
        public virtual IRAD1MELEMENTIVEZADataAdapter DataAdapter
        {
            get
            {
                ...
                if (DataAdapterFactory.Provider != null)
                {
                    return DataAdapterFactory.GetRAD1MELEMENTIVEZADataAdapter();
                }
                return null;
            }
        }
        ...
        [Category("Deklarit Work With "), Browsable(false)]
        public virtual RAD1MELEMENTIVEZADataSet DataSet
        {
            get
            {
                return this.dsRAD1MELEMENTIVEZADataSet1;
            }
            set
            {
                this.dsRAD1MELEMENTIVEZADataSet1 = value;
            }
        }
        ...
        public virtual int FillByRAD1ELEMENTIIDRAD1ELEMENTIID
        {
            get
            {
                return this.m_FillByRAD1ELEMENTIIDRAD1ELEMENTIID;
            }
            set
            {
                this.m_FillByRAD1ELEMENTIIDRAD1ELEMENTIID = value;
            }
        }
