namespace NetAdvantage.Controls
{
    ...
    public class BRACNOSTANJEDataGrid : DeklaritDataGrid
    {
        private int currentRow;
        private BRACNOSTANJEDataSet dsBRACNOSTANJEDataSet1 = new BRACNOSTANJEDataSet();
        ...
        private void BindDataGrid()
        {
            ...
            this.dv1.Table = this.dsBRACNOSTANJEDataSet1.BRACNOSTANJE;
        ...
        private void FillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    ...
                    {
                        this.DataAdapter.FillPage(this.dsBRACNOSTANJEDataSet1, 0, this.PageSize);
                    }
                    else
                    {
                        MethodInfo info = this.DataAdapter.GetType().GetMethod("FillPageBy" + this.FillMethod.Substring(6));
                        this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsBRACNOSTANJEDataSet1, info, 0, this.PageSize);
                    }
                }
                else if (this.FillMethod == "Fill")
                {
                    this.DataAdapter.Fill(this.dsBRACNOSTANJEDataSet1);
                }
                else
                {
                    MethodInfo info2 = this.DataAdapter.GetType().GetMethod(this.FillMethod);
                    this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsBRACNOSTANJEDataSet1, info2);
                }
        ...
        private void ReFillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    if (this.FillMethod == "Fill")
                    {
                        this.DataAdapter.FillPage(this.dsBRACNOSTANJEDataSet1, this.startRowThread, this.PageSize);
                    }
                    else
                    {
                        MethodInfo info = this.DataAdapter.GetType().GetMethod("FillPageBy" + this.FillMethod.Substring(6));
                        this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsBRACNOSTANJEDataSet1, info, this.startRowThread, this.PageSize);
                    }
                }
        ...
        private void ResumeBindingPostThread()
        {
            ...
            this.EndUpdate();
            this.BindDataGrid();
            this.Text = "Braeno stanje : " + this.DataView.Count.ToString(CultureInfo.InvariantCulture) + " " + Deklarit.Resources.Resources.Rows;
        ...
        public virtual IBRACNOSTANJEDataAdapter DataAdapter
        {
            get
            {
                ...
                if (DataAdapterFactory.Provider != null)
                {
                    return DataAdapterFactory.GetBRACNOSTANJEDataAdapter();
                }
                return null;
            }
        }
        ...
        public virtual BRACNOSTANJEDataSet DataSet
        {
            get
            {
                return this.dsBRACNOSTANJEDataSet1;
            }
            set
            {
                this.dsBRACNOSTANJEDataSet1 = value;
            }
        }
