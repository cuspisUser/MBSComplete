namespace NetAdvantage.Controls
{
    ...
    public class OSRAZMJESTAJDataGrid : DeklaritDataGrid
    {
        private int currentRow;
        private OSRAZMJESTAJDataSet dsOSRAZMJESTAJDataSet1 = new OSRAZMJESTAJDataSet();
        private System.Data.DataView dv1;
        private int m_FillByIDLOKACIJEIDLOKACIJE;
        private long m_FillByINVBROJINVBROJ;
        ...
        public OSRAZMJESTAJDataGrid()
        {
            this.BindDataGrid();
            DeklaritDataGrid.myFillMethods = new TypeConverter.StandardValuesCollection(new string[] { "Fill", "FillByIDLOKACIJE", "FillByINVBROJ" });
        ...
        private void BindDataGrid()
        {
            ...
            this.dv1.Table = this.dsOSRAZMJESTAJDataSet1.OSRAZMJESTAJ;
        ...
        private void FillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    ...
                    {
                        this.DataAdapter.FillPage(this.dsOSRAZMJESTAJDataSet1, 0, this.PageSize);
                    }
                    else
                    {
                        MethodInfo info = this.DataAdapter.GetType().GetMethod("FillPageBy" + this.FillMethod.Substring(6));
                        this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsOSRAZMJESTAJDataSet1, info, 0, this.PageSize);
                    }
                }
                else if (this.FillMethod == "Fill")
                {
                    this.DataAdapter.Fill(this.dsOSRAZMJESTAJDataSet1);
                }
                else
                {
                    MethodInfo info2 = this.DataAdapter.GetType().GetMethod(this.FillMethod);
                    this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsOSRAZMJESTAJDataSet1, info2);
                }
        ...
        private void ReFillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    if (this.FillMethod == "Fill")
                    {
                        this.DataAdapter.FillPage(this.dsOSRAZMJESTAJDataSet1, this.startRowThread, this.PageSize);
                    }
                    else
                    {
                        MethodInfo info = this.DataAdapter.GetType().GetMethod("FillPageBy" + this.FillMethod.Substring(6));
                        this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsOSRAZMJESTAJDataSet1, info, this.startRowThread, this.PageSize);
                    }
                }
        ...
        private void ResumeBindingPostThread()
        {
            ...
            this.EndUpdate();
            this.BindDataGrid();
            this.Text = "OSRAZMJESTAJ : " + this.DataView.Count.ToString(CultureInfo.InvariantCulture) + " " + Deklarit.Resources.Resources.Rows;
        ...
        public virtual IOSRAZMJESTAJDataAdapter DataAdapter
        {
            get
            {
                ...
                if (DataAdapterFactory.Provider != null)
                {
                    return DataAdapterFactory.GetOSRAZMJESTAJDataAdapter();
                }
                return null;
            }
        }
        ...
        public virtual OSRAZMJESTAJDataSet DataSet
        {
            get
            {
                return this.dsOSRAZMJESTAJDataSet1;
            }
            set
            {
                this.dsOSRAZMJESTAJDataSet1 = value;
            }
        }
        ...
        public virtual int FillByIDLOKACIJEIDLOKACIJE
        {
            get
            {
                return this.m_FillByIDLOKACIJEIDLOKACIJE;
            }
            set
            {
                this.m_FillByIDLOKACIJEIDLOKACIJE = value;
            }
        }
        ...
        public virtual long FillByINVBROJINVBROJ
        {
            get
            {
                return this.m_FillByINVBROJINVBROJ;
            }
            set
            {
                this.m_FillByINVBROJINVBROJ = value;
            }
        }
