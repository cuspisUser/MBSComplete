namespace NetAdvantage.Controls
{
    ...
    public class S_OD_STAT_KREDITDataGrid : DeklaritDataGrid
    {
        private int currentRow;
        private S_OD_STAT_KREDITDataSet dsS_OD_STAT_KREDITDataSet1 = new S_OD_STAT_KREDITDataSet();
        ...
        public S_OD_STAT_KREDITDataGrid()
        {
            this.BindDataGrid();
        ...
        private void BindDataGrid()
        {
            ...
            this.dv1.Table = this.dsS_OD_STAT_KREDITDataSet1.S_OD_STAT_KREDIT;
        ...
        {
            this.PreFill();
            this.dsS_OD_STAT_KREDITDataSet1 = new S_OD_STAT_KREDITDataSet();
            this.m_StartRow = 0;
        ...
        private void FillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dsS_OD_STAT_KREDITDataSet1, this.m_ParameterIDOBRACUN, 0, this.PageSize);
                }
                else
                {
                    this.DataAdapter.Fill(this.dsS_OD_STAT_KREDITDataSet1, this.m_ParameterIDOBRACUN);
                }
        ...
        private void ReFillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dsS_OD_STAT_KREDITDataSet1, this.m_ParameterIDOBRACUN, this.startRowThread, this.PageSize);
                }
        ...
        private void ResumeBindingPostThread()
        {
            ...
            this.EndUpdate();
            this.BindDataGrid();
            this.Text = "S_OD_STAT_KREDIT : " + this.DataView.Count.ToString(CultureInfo.InvariantCulture) + " " + Deklarit.Resources.Resources.Rows;
        ...
        public virtual IS_OD_STAT_KREDITDataAdapter DataAdapter
        {
            get
            {
                ...
                if (DataAdapterFactory.Provider != null)
                {
                    return DataAdapterFactory.GetS_OD_STAT_KREDITDataAdapter();
                }
                return null;
            }
        }
        ...
        [Browsable(false), Category("Deklarit Work With ")]
        public virtual S_OD_STAT_KREDITDataSet DataSet
        {
            get
            {
                return this.dsS_OD_STAT_KREDITDataSet1;
            }
            set
            {
                this.dsS_OD_STAT_KREDITDataSet1 = value;
            }
        }
