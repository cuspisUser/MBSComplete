namespace NetAdvantage.Controls
{
    ...
    public class S_PLACA_RAD1G_IVDataGrid : DeklaritDataGrid
    {
        private int currentRow;
        private S_PLACA_RAD1G_IVDataSet dsS_PLACA_RAD1G_IVDataSet1 = new S_PLACA_RAD1G_IVDataSet();
        ...
        public S_PLACA_RAD1G_IVDataGrid()
        {
            this.BindDataGrid();
        ...
        private void BindDataGrid()
        {
            ...
            this.dv1.Table = this.dsS_PLACA_RAD1G_IVDataSet1.S_PLACA_RAD1G_IV;
        ...
        {
            this.PreFill();
            this.dsS_PLACA_RAD1G_IVDataSet1 = new S_PLACA_RAD1G_IVDataSet();
            this.m_StartRow = 0;
        ...
        private void FillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dsS_PLACA_RAD1G_IVDataSet1, this.m_ParameterGODINAOBRACUNA, 0, this.PageSize);
                }
                else
                {
                    this.DataAdapter.Fill(this.dsS_PLACA_RAD1G_IVDataSet1, this.m_ParameterGODINAOBRACUNA);
                }
        ...
        private void ReFillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dsS_PLACA_RAD1G_IVDataSet1, this.m_ParameterGODINAOBRACUNA, this.startRowThread, this.PageSize);
                }
        ...
        private void ResumeBindingPostThread()
        {
            ...
            this.EndUpdate();
            this.BindDataGrid();
            this.Text = "S_PLACA_RAD1G_IV : " + this.DataView.Count.ToString(CultureInfo.InvariantCulture) + " " + Deklarit.Resources.Resources.Rows;
        ...
        public virtual IS_PLACA_RAD1G_IVDataAdapter DataAdapter
        {
            get
            {
                ...
                if (DataAdapterFactory.Provider != null)
                {
                    return DataAdapterFactory.GetS_PLACA_RAD1G_IVDataAdapter();
                }
                return null;
            }
        }
        ...
        public virtual S_PLACA_RAD1G_IVDataSet DataSet
        {
            get
            {
                return this.dsS_PLACA_RAD1G_IVDataSet1;
            }
            set
            {
                this.dsS_PLACA_RAD1G_IVDataSet1 = value;
            }
        }
