namespace NetAdvantage.Controls
{
    ...
    public class uraDocsDataGrid : DeklaritDataGrid
    {
        ...
        private void ResumeBindingPostThread()
        {
            ...
            this.EndUpdate();
            this.BindDataGrid();
            this.Text = "uraDocs : " + this.DataView.Count.ToString(CultureInfo.InvariantCulture) + " " + Deklarit.Resources.Resources.Rows;
        ...
        public virtual IuraDocsDataAdapter DataAdapter
        {
            get
            {
                ...
                if (DataAdapterFactory.Provider != null)
                {
                    return DataAdapterFactory.GeturaDocsDataAdapter();
                }
                return null;
            }
        }
