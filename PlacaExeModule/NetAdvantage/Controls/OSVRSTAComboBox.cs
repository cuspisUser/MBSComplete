namespace NetAdvantage.Controls
{
    ...
    public class OSVRSTAComboBox : DeklaritComboBox
    {
        private System.Data.DataSet m_DataSet = new OSVRSTADataSet();
        protected string m_FillMethod = "Fill";

        public OSVRSTAComboBox()
        {
            this.Text = "IDOSVRSTA";
            DataView defaultView = this.DataSet.Tables["OSVRSTA"].DefaultView;
            defaultView.Sort = "OSV";
            this.DisplayMember = "OSV";
            this.ValueMember = "IDOSVRSTA";
        ...
        protected override void InitLayout()
        {
            ...
            if (!this.DesignMode && this.FillAtStartup)
            {
                ...
                {
                    DataView view = ComboHelper.GetComboValues(this.DataSet, "OSVRSTA", "IDOSVRSTA", "OSV", true, "<" + Deklarit.Resources.Resources.Empty + ">");
                    this.DataSource = null;
                    view.Sort = "Name";
        ...
        public IOSVRSTADataAdapter DataAdapter
        {
            get
            {
