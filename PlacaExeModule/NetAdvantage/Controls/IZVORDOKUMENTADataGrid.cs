namespace NetAdvantage.Controls
{
    ...
    public class IZVORDOKUMENTADataGrid : DeklaritDataGrid
    {
        private int currentRow;
        private IZVORDOKUMENTADataSet dsIZVORDOKUMENTADataSet1 = new IZVORDOKUMENTADataSet();
        ...
        private void BindDataGrid()
        {
            ...
            this.dv1.Table = this.dsIZVORDOKUMENTADataSet1.IZVORDOKUMENTA;
        ...
        private void FillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    ...
                    {
                        this.DataAdapter.FillPage(this.dsIZVORDOKUMENTADataSet1, 0, this.PageSize);
                    }
                    else
                    {
                        MethodInfo info = this.DataAdapter.GetType().GetMethod("FillPageBy" + this.FillMethod.Substring(6));
                        this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsIZVORDOKUMENTADataSet1, info, 0, this.PageSize);
                    }
                }
                else if (this.FillMethod == "Fill")
                {
                    this.DataAdapter.Fill(this.dsIZVORDOKUMENTADataSet1);
                }
                else
                {
                    MethodInfo info2 = this.DataAdapter.GetType().GetMethod(this.FillMethod);
                    this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsIZVORDOKUMENTADataSet1, info2);
                }
        ...
        private void ReFillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    if (this.FillMethod == "Fill")
                    {
                        this.DataAdapter.FillPage(this.dsIZVORDOKUMENTADataSet1, this.startRowThread, this.PageSize);
                    }
                    else
                    {
                        MethodInfo info = this.DataAdapter.GetType().GetMethod("FillPageBy" + this.FillMethod.Substring(6));
                        this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsIZVORDOKUMENTADataSet1, info, this.startRowThread, this.PageSize);
                    }
                }
        ...
        private void ResumeBindingPostThread()
        {
            ...
            this.EndUpdate();
            this.BindDataGrid();
            this.Text = "IZVORDOKUMENTA : " + this.DataView.Count.ToString(CultureInfo.InvariantCulture) + " " + Deklarit.Resources.Resources.Rows;
        ...
        public virtual IIZVORDOKUMENTADataAdapter DataAdapter
        {
            get
            {
        ...
        [Category("Deklarit Work With "), Browsable(false)]
        public virtual IZVORDOKUMENTADataSet DataSet
        {
            get
            {
                return this.dsIZVORDOKUMENTADataSet1;
            }
            set
            {
                this.dsIZVORDOKUMENTADataSet1 = value;
            }
        }
