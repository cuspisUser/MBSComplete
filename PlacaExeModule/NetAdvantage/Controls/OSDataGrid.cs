namespace NetAdvantage.Controls
{
    ...
    public class OSDataGrid : DeklaritDataGrid
    {
        private int currentRow;
        private OSDataSet dsOSDataSet1 = new OSDataSet();
        private System.Data.DataView dv1;
        private int m_FillByIDAMSKUPINEIDAMSKUPINE;
        private int m_FillByIDOSVRSTAIDOSVRSTA;
        ...
        {
            this.BindDataGrid();
            DeklaritDataGrid.myFillMethods = new TypeConverter.StandardValuesCollection(new string[] { "Fill", "FillByIDOSVRSTA", "FillByIDAMSKUPINE" });
        ...
        private void BindDataGrid()
        {
            ...
            this.dv1.Table = this.dsOSDataSet1.OS;
        ...
        private void FillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    ...
                    {
                        this.DataAdapter.FillPage(this.dsOSDataSet1, 0, this.PageSize);
                    }
                    else
                    {
                        MethodInfo info = this.DataAdapter.GetType().GetMethod("FillPageBy" + this.FillMethod.Substring(6));
                        this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsOSDataSet1, info, 0, this.PageSize);
                    }
                }
                else if (this.FillMethod == "Fill")
                {
                    this.DataAdapter.Fill(this.dsOSDataSet1);
                }
                else
                {
                    MethodInfo info2 = this.DataAdapter.GetType().GetMethod(this.FillMethod);
                    this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsOSDataSet1, info2);
                }
        ...
        private void ReFillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    if (this.FillMethod == "Fill")
                    {
                        this.DataAdapter.FillPage(this.dsOSDataSet1, this.startRowThread, this.PageSize);
                    }
                    else
                    {
                        MethodInfo info = this.DataAdapter.GetType().GetMethod("FillPageBy" + this.FillMethod.Substring(6));
                        this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsOSDataSet1, info, this.startRowThread, this.PageSize);
                    }
                }
        ...
        private void ResumeBindingPostThread()
        {
            ...
            this.EndUpdate();
            this.BindDataGrid();
            this.Text = "OS : " + this.DataView.Count.ToString(CultureInfo.InvariantCulture) + " " + Deklarit.Resources.Resources.Rows;
        ...
        public virtual IOSDataAdapter DataAdapter
        {
            get
            {
                ...
                if (DataAdapterFactory.Provider != null)
                {
                    return DataAdapterFactory.GetOSDataAdapter();
                }
                return null;
            }
        }
        ...
        [Browsable(false), Category("Deklarit Work With ")]
        public virtual OSDataSet DataSet
        {
            get
            {
                return this.dsOSDataSet1;
            }
            set
            {
                this.dsOSDataSet1 = value;
            }
        }
        ...
        public virtual int FillByIDAMSKUPINEIDAMSKUPINE
        {
            get
            {
                return this.m_FillByIDAMSKUPINEIDAMSKUPINE;
            }
            set
            {
                this.m_FillByIDAMSKUPINEIDAMSKUPINE = value;
            }
        }
        ...
        public virtual int FillByIDOSVRSTAIDOSVRSTA
        {
            get
            {
                return this.m_FillByIDOSVRSTAIDOSVRSTA;
            }
            set
            {
                this.m_FillByIDOSVRSTAIDOSVRSTA = value;
            }
        }
