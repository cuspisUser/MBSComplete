namespace NetAdvantage.Controls
{
    ...
    public class DOSIPZAGLAVLJEDataGrid : DeklaritDataGrid
    {
        private int currentRow;
        private DOSIPZAGLAVLJEDataSet dsDOSIPZAGLAVLJEDataSet1 = new DOSIPZAGLAVLJEDataSet();
        private System.Data.DataView dv1;
        private string m_FillByDOSIPIDENTDOSIPIDENT;
        ...
        public DOSIPZAGLAVLJEDataGrid()
        {
            this.BindDataGrid();
            DeklaritDataGrid.myFillMethods = new TypeConverter.StandardValuesCollection(new string[] { "Fill", "FillByDOSIPIDENT" });
        ...
        private void BindDataGrid()
        {
            ...
            this.dv1.Table = this.dsDOSIPZAGLAVLJEDataSet1.DOSIPZAGLAVLJE;
        ...
        private void FillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    ...
                    {
                        this.DataAdapter.FillPage(this.dsDOSIPZAGLAVLJEDataSet1, 0, this.PageSize);
                    }
                    else
                    {
                        MethodInfo info = this.DataAdapter.GetType().GetMethod("FillPageBy" + this.FillMethod.Substring(6));
                        this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsDOSIPZAGLAVLJEDataSet1, info, 0, this.PageSize);
                    }
                }
                else if (this.FillMethod == "Fill")
                {
                    this.DataAdapter.Fill(this.dsDOSIPZAGLAVLJEDataSet1);
                }
                else
                {
                    MethodInfo info2 = this.DataAdapter.GetType().GetMethod(this.FillMethod);
                    this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsDOSIPZAGLAVLJEDataSet1, info2);
                }
        ...
        private void ReFillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    if (this.FillMethod == "Fill")
                    {
                        this.DataAdapter.FillPage(this.dsDOSIPZAGLAVLJEDataSet1, this.startRowThread, this.PageSize);
                    }
                    else
                    {
                        MethodInfo info = this.DataAdapter.GetType().GetMethod("FillPageBy" + this.FillMethod.Substring(6));
                        this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsDOSIPZAGLAVLJEDataSet1, info, this.startRowThread, this.PageSize);
                    }
                }
        ...
        private void ResumeBindingPostThread()
        {
            ...
            this.EndUpdate();
            this.BindDataGrid();
            this.Text = "DOSIPZAGLAVLJE : " + this.DataView.Count.ToString(CultureInfo.InvariantCulture) + " " + Deklarit.Resources.Resources.Rows;
        ...
        public virtual IDOSIPZAGLAVLJEDataAdapter DataAdapter
        {
            get
            {
                ...
                if (DataAdapterFactory.Provider != null)
                {
                    return DataAdapterFactory.GetDOSIPZAGLAVLJEDataAdapter();
                }
                return null;
            }
        }
        ...
        [Browsable(false), Category("Deklarit Work With ")]
        public virtual DOSIPZAGLAVLJEDataSet DataSet
        {
            get
            {
                return this.dsDOSIPZAGLAVLJEDataSet1;
            }
            set
            {
                this.dsDOSIPZAGLAVLJEDataSet1 = value;
            }
        }
        ...
        public virtual string FillByDOSIPIDENTDOSIPIDENT
        {
            get
            {
                return this.m_FillByDOSIPIDENTDOSIPIDENT;
            }
            set
            {
                this.m_FillByDOSIPIDENTDOSIPIDENT = value;
            }
        }
