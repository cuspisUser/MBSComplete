namespace NetAdvantage.Controls
{
    ...
    public class VW_MJESECI_GODINE_OBRACUNADataGrid : DeklaritDataGrid
    {
        private int currentRow;
        private VW_MJESECI_GODINE_OBRACUNADataSet dsVW_MJESECI_GODINE_OBRACUNADataSet1 = new VW_MJESECI_GODINE_OBRACUNADataSet();
        ...
        public VW_MJESECI_GODINE_OBRACUNADataGrid()
        {
            this.BindDataGrid();
        ...
        private void BindDataGrid()
        {
            ...
            this.dv1.Table = this.dsVW_MJESECI_GODINE_OBRACUNADataSet1.VW_MJESECI_GODINE_OBRACUNA;
        ...
        {
            this.PreFill();
            this.dsVW_MJESECI_GODINE_OBRACUNADataSet1 = new VW_MJESECI_GODINE_OBRACUNADataSet();
            this.m_StartRow = 0;
        ...
        private void FillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dsVW_MJESECI_GODINE_OBRACUNADataSet1, 0, this.PageSize);
                }
                else
                {
                    this.DataAdapter.Fill(this.dsVW_MJESECI_GODINE_OBRACUNADataSet1);
                }
        ...
        private void ReFillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dsVW_MJESECI_GODINE_OBRACUNADataSet1, this.startRowThread, this.PageSize);
                }
        ...
        private void ResumeBindingPostThread()
        {
            ...
            this.EndUpdate();
            this.BindDataGrid();
            this.Text = "VW_MJESECI_GODINE_OBRACUNA : " + this.DataView.Count.ToString(CultureInfo.InvariantCulture) + " " + Deklarit.Resources.Resources.Rows;
        ...
        public virtual IVW_MJESECI_GODINE_OBRACUNADataAdapter DataAdapter
        {
            get
            {
                ...
                if (DataAdapterFactory.Provider != null)
                {
                    return DataAdapterFactory.GetVW_MJESECI_GODINE_OBRACUNADataAdapter();
                }
                return null;
            }
        }
        ...
        public virtual VW_MJESECI_GODINE_OBRACUNADataSet DataSet
        {
            get
            {
                return this.dsVW_MJESECI_GODINE_OBRACUNADataSet1;
            }
            set
            {
                this.dsVW_MJESECI_GODINE_OBRACUNADataSet1 = value;
            }
        }
