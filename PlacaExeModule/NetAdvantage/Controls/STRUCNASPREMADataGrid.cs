namespace NetAdvantage.Controls
{
    ...
    public class STRUCNASPREMADataGrid : DeklaritDataGrid
    {
        private int currentRow;
        private STRUCNASPREMADataSet dsSTRUCNASPREMADataSet1 = new STRUCNASPREMADataSet();
        ...
        private void BindDataGrid()
        {
            ...
            this.dv1.Table = this.dsSTRUCNASPREMADataSet1.STRUCNASPREMA;
        ...
        private void FillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    ...
                    {
                        this.DataAdapter.FillPage(this.dsSTRUCNASPREMADataSet1, 0, this.PageSize);
                    }
                    else
                    {
                        MethodInfo info = this.DataAdapter.GetType().GetMethod("FillPageBy" + this.FillMethod.Substring(6));
                        this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsSTRUCNASPREMADataSet1, info, 0, this.PageSize);
                    }
                }
                else if (this.FillMethod == "Fill")
                {
                    this.DataAdapter.Fill(this.dsSTRUCNASPREMADataSet1);
                }
                else
                {
                    MethodInfo info2 = this.DataAdapter.GetType().GetMethod(this.FillMethod);
                    this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsSTRUCNASPREMADataSet1, info2);
                }
        ...
        private void ReFillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    if (this.FillMethod == "Fill")
                    {
                        this.DataAdapter.FillPage(this.dsSTRUCNASPREMADataSet1, this.startRowThread, this.PageSize);
                    }
                    else
                    {
                        MethodInfo info = this.DataAdapter.GetType().GetMethod("FillPageBy" + this.FillMethod.Substring(6));
                        this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsSTRUCNASPREMADataSet1, info, this.startRowThread, this.PageSize);
                    }
                }
        ...
        private void ResumeBindingPostThread()
        {
            ...
            this.EndUpdate();
            this.BindDataGrid();
            this.Text = "Struene spreme : " + this.DataView.Count.ToString(CultureInfo.InvariantCulture) + " " + Deklarit.Resources.Resources.Rows;
        ...
        public virtual ISTRUCNASPREMADataAdapter DataAdapter
        {
            get
            {
                ...
                if (DataAdapterFactory.Provider != null)
                {
                    return DataAdapterFactory.GetSTRUCNASPREMADataAdapter();
                }
                return null;
            }
        }
        ...
        public virtual STRUCNASPREMADataSet DataSet
        {
            get
            {
                return this.dsSTRUCNASPREMADataSet1;
            }
            set
            {
                this.dsSTRUCNASPREMADataSet1 = value;
            }
        }
