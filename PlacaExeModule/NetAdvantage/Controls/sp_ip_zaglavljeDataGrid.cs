namespace NetAdvantage.Controls
{
    ...
    public class sp_ip_zaglavljeDataGrid : DeklaritDataGrid
    {
        private int currentRow;
        private sp_ip_zaglavljeDataSet dssp_ip_zaglavljeDataSet1 = new sp_ip_zaglavljeDataSet();
        ...
        public sp_ip_zaglavljeDataGrid()
        {
            this.BindDataGrid();
        ...
        private void BindDataGrid()
        {
            ...
            this.dv1.Table = this.dssp_ip_zaglavljeDataSet1.sp_ip_zaglavlje;
        ...
        {
            this.PreFill();
            this.dssp_ip_zaglavljeDataSet1 = new sp_ip_zaglavljeDataSet();
            this.m_StartRow = 0;
        ...
        private void FillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dssp_ip_zaglavljeDataSet1, this.m_Parametergodina, 0, this.PageSize);
                }
                else
                {
                    this.DataAdapter.Fill(this.dssp_ip_zaglavljeDataSet1, this.m_Parametergodina);
                }
        ...
        private void ReFillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dssp_ip_zaglavljeDataSet1, this.m_Parametergodina, this.startRowThread, this.PageSize);
                }
        ...
        private void ResumeBindingPostThread()
        {
            ...
            this.EndUpdate();
            this.BindDataGrid();
            this.Text = "sp_ip_zaglavlje : " + this.DataView.Count.ToString(CultureInfo.InvariantCulture) + " " + Deklarit.Resources.Resources.Rows;
        ...
        public virtual Isp_ip_zaglavljeDataAdapter DataAdapter
        {
            get
            {
                ...
                if (DataAdapterFactory.Provider != null)
                {
                    return DataAdapterFactory.Getsp_ip_zaglavljeDataAdapter();
                }
                return null;
            }
        }
        ...
        [Browsable(false), Category("Deklarit Work With ")]
        public virtual sp_ip_zaglavljeDataSet DataSet
        {
            get
            {
                return this.dssp_ip_zaglavljeDataSet1;
            }
            set
            {
                this.dssp_ip_zaglavljeDataSet1 = value;
            }
        }
