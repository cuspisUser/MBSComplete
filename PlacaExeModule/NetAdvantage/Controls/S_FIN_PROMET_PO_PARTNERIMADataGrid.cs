namespace NetAdvantage.Controls
{
    ...
    public class S_FIN_PROMET_PO_PARTNERIMADataGrid : DeklaritDataGrid
    {
        private int currentRow;
        private S_FIN_PROMET_PO_PARTNERIMADataSet dsS_FIN_PROMET_PO_PARTNERIMADataSet1 = new S_FIN_PROMET_PO_PARTNERIMADataSet();
        ...
        private int m_ParameterDOPARTNERA = 0;
        private int m_ParameterIDAKTIVNOST = 0;
        private int m_ParameterMT = 0;
        private int m_ParameterODPARTNERA = 0;
        ...
        public S_FIN_PROMET_PO_PARTNERIMADataGrid()
        {
            this.BindDataGrid();
        ...
        private void BindDataGrid()
        {
            ...
            this.dv1.Table = this.dsS_FIN_PROMET_PO_PARTNERIMADataSet1.S_FIN_PROMET_PO_PARTNERIMA;
        ...
        {
            this.PreFill();
            this.dsS_FIN_PROMET_PO_PARTNERIMADataSet1 = new S_FIN_PROMET_PO_PARTNERIMADataSet();
            this.m_StartRow = 0;
        ...
        private void FillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dsS_FIN_PROMET_PO_PARTNERIMADataSet1, this.m_ParameterODPARTNERA, this.m_ParameterDOPARTNERA, this.m_ParameterMT, this.m_ParameterORG, this.m_ParameterIDAKTIVNOST, this.m_ParameterRAZDOBLJEOD, this.m_ParameterRAZDOBLJEDO, this.m_ParameterDODATNIUVJET, this.m_ParameterPOCETNIKONTO, this.m_ParameterZAVRSNIKONTO, 0, this.PageSize);
                }
                else
                {
                    this.DataAdapter.Fill(this.dsS_FIN_PROMET_PO_PARTNERIMADataSet1, this.m_ParameterODPARTNERA, this.m_ParameterDOPARTNERA, this.m_ParameterMT, this.m_ParameterORG, this.m_ParameterIDAKTIVNOST, this.m_ParameterRAZDOBLJEOD, this.m_ParameterRAZDOBLJEDO, this.m_ParameterDODATNIUVJET, this.m_ParameterPOCETNIKONTO, this.m_ParameterZAVRSNIKONTO);
                }
        ...
        private void ResumeBindingPostThread()
        {
            ...
            this.EndUpdate();
            this.BindDataGrid();
            this.Text = "S_FIN_PROMET_PO_PARTNERIMA : " + this.DataView.Count.ToString(CultureInfo.InvariantCulture) + " " + Deklarit.Resources.Resources.Rows;
        ...
        public virtual IS_FIN_PROMET_PO_PARTNERIMADataAdapter DataAdapter
        {
            get
            {
                ...
                if (DataAdapterFactory.Provider != null)
                {
                    return DataAdapterFactory.GetS_FIN_PROMET_PO_PARTNERIMADataAdapter();
                }
                return null;
            }
        }
        ...
        [Category("Deklarit Work With "), Browsable(false)]
        public virtual S_FIN_PROMET_PO_PARTNERIMADataSet DataSet
        {
            get
            {
                return this.dsS_FIN_PROMET_PO_PARTNERIMADataSet1;
            }
            set
            {
                this.dsS_FIN_PROMET_PO_PARTNERIMADataSet1 = value;
            }
        }
        ...
        public virtual int ParameterDOPARTNERA
        {
            get
            {
                return this.m_ParameterDOPARTNERA;
            }
            set
            {
                this.m_ParameterDOPARTNERA = value;
            }
        }
        ...
        public virtual int ParameterODPARTNERA
        {
            get
            {
                return this.m_ParameterODPARTNERA;
            }
            set
            {
                this.m_ParameterODPARTNERA = value;
            }
        }
