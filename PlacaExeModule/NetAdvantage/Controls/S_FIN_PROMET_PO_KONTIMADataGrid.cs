namespace NetAdvantage.Controls
{
    ...
    public class S_FIN_PROMET_PO_KONTIMADataGrid : DeklaritDataGrid
    {
        private int currentRow;
        private S_FIN_PROMET_PO_KONTIMADataSet dsS_FIN_PROMET_PO_KONTIMADataSet1 = new S_FIN_PROMET_PO_KONTIMADataSet();
        ...
        public S_FIN_PROMET_PO_KONTIMADataGrid()
        {
            this.BindDataGrid();
        ...
        private void BindDataGrid()
        {
            ...
            this.dv1.Table = this.dsS_FIN_PROMET_PO_KONTIMADataSet1.S_FIN_PROMET_PO_KONTIMA;
        ...
        {
            this.PreFill();
            this.dsS_FIN_PROMET_PO_KONTIMADataSet1 = new S_FIN_PROMET_PO_KONTIMADataSet();
            this.m_StartRow = 0;
        ...
        private void FillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dsS_FIN_PROMET_PO_KONTIMADataSet1, this.m_ParameterORG, this.m_ParameterMT, this.m_ParameterDOK, this.m_ParameterRAZDOBLJEOD, this.m_ParameterRAZDOBLJEDO, this.m_ParameterPOCETNIKONTO, this.m_ParameterZAVRSNIKONTO, 0, this.PageSize);
                }
                else
                {
                    this.DataAdapter.Fill(this.dsS_FIN_PROMET_PO_KONTIMADataSet1, this.m_ParameterORG, this.m_ParameterMT, this.m_ParameterDOK, this.m_ParameterRAZDOBLJEOD, this.m_ParameterRAZDOBLJEDO, this.m_ParameterPOCETNIKONTO, this.m_ParameterZAVRSNIKONTO);
                }
        ...
        private void ReFillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dsS_FIN_PROMET_PO_KONTIMADataSet1, this.m_ParameterORG, this.m_ParameterMT, this.m_ParameterDOK, this.m_ParameterRAZDOBLJEOD, this.m_ParameterRAZDOBLJEDO, this.m_ParameterPOCETNIKONTO, this.m_ParameterZAVRSNIKONTO, this.startRowThread, this.PageSize);
                }
        ...
        private void ResumeBindingPostThread()
        {
            ...
            this.EndUpdate();
            this.BindDataGrid();
            this.Text = "S_FIN_PROMET_PO_KONTIMA : " + this.DataView.Count.ToString(CultureInfo.InvariantCulture) + " " + Deklarit.Resources.Resources.Rows;
        ...
        public virtual IS_FIN_PROMET_PO_KONTIMADataAdapter DataAdapter
        {
            get
            {
                ...
                if (DataAdapterFactory.Provider != null)
                {
                    return DataAdapterFactory.GetS_FIN_PROMET_PO_KONTIMADataAdapter();
                }
                return null;
            }
        }
        ...
        [Browsable(false), Category("Deklarit Work With ")]
        public virtual S_FIN_PROMET_PO_KONTIMADataSet DataSet
        {
            get
            {
                return this.dsS_FIN_PROMET_PO_KONTIMADataSet1;
            }
            set
            {
                this.dsS_FIN_PROMET_PO_KONTIMADataSet1 = value;
            }
        }
