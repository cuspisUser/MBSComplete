namespace NetAdvantage.Controls
{
    ...
    public class vw_DD_MJESECI_GODINE_ISPLATEDataGrid : DeklaritDataGrid
    {
        private int currentRow;
        private vw_DD_MJESECI_GODINE_ISPLATEDataSet dsvw_DD_MJESECI_GODINE_ISPLATEDataSet1 = new vw_DD_MJESECI_GODINE_ISPLATEDataSet();
        ...
        public vw_DD_MJESECI_GODINE_ISPLATEDataGrid()
        {
            this.BindDataGrid();
        ...
        private void BindDataGrid()
        {
            ...
            this.dv1.Table = this.dsvw_DD_MJESECI_GODINE_ISPLATEDataSet1.vw_DD_MJESECI_GODINE_ISPLATE;
        ...
        {
            this.PreFill();
            this.dsvw_DD_MJESECI_GODINE_ISPLATEDataSet1 = new vw_DD_MJESECI_GODINE_ISPLATEDataSet();
            this.m_StartRow = 0;
        ...
        private void FillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dsvw_DD_MJESECI_GODINE_ISPLATEDataSet1, 0, this.PageSize);
                }
                else
                {
                    this.DataAdapter.Fill(this.dsvw_DD_MJESECI_GODINE_ISPLATEDataSet1);
                }
        ...
        private void ReFillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dsvw_DD_MJESECI_GODINE_ISPLATEDataSet1, this.startRowThread, this.PageSize);
                }
        ...
        private void ResumeBindingPostThread()
        {
            ...
            this.EndUpdate();
            this.BindDataGrid();
            this.Text = "vw_DD_MJESECI_GODINE_ISPLATE : " + this.DataView.Count.ToString(CultureInfo.InvariantCulture) + " " + Deklarit.Resources.Resources.Rows;
        ...
        public virtual Ivw_DD_MJESECI_GODINE_ISPLATEDataAdapter DataAdapter
        {
            get
            {
                ...
                if (DataAdapterFactory.Provider != null)
                {
                    return DataAdapterFactory.Getvw_DD_MJESECI_GODINE_ISPLATEDataAdapter();
                }
                return null;
            }
        }
        ...
        public virtual vw_DD_MJESECI_GODINE_ISPLATEDataSet DataSet
        {
            get
            {
                return this.dsvw_DD_MJESECI_GODINE_ISPLATEDataSet1;
            }
            set
            {
                this.dsvw_DD_MJESECI_GODINE_ISPLATEDataSet1 = value;
            }
        }
