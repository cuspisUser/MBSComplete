namespace NetAdvantage.Controls
{
    ...
    public class S_OD_REKAP_OLAKSICEDataGrid : DeklaritDataGrid
    {
        private int currentRow;
        private S_OD_REKAP_OLAKSICEDataSet dsS_OD_REKAP_OLAKSICEDataSet1 = new S_OD_REKAP_OLAKSICEDataSet();
        ...
        public S_OD_REKAP_OLAKSICEDataGrid()
        {
            this.BindDataGrid();
        ...
        private void BindDataGrid()
        {
            ...
            this.dv1.Table = this.dsS_OD_REKAP_OLAKSICEDataSet1.S_OD_REKAP_OLAKSICE;
        ...
        private void FillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dsS_OD_REKAP_OLAKSICEDataSet1, this.m_ParameterIDOBRACUN, 0, this.PageSize);
                }
                else
                {
                    this.DataAdapter.Fill(this.dsS_OD_REKAP_OLAKSICEDataSet1, this.m_ParameterIDOBRACUN);
                }
        ...
        private void ReFillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dsS_OD_REKAP_OLAKSICEDataSet1, this.m_ParameterIDOBRACUN, this.startRowThread, this.PageSize);
                }
        ...
        private void ResumeBindingPostThread()
        {
            ...
            this.EndUpdate();
            this.BindDataGrid();
            this.Text = "S_OD_REKAP_OLAKSICE : " + this.DataView.Count.ToString(CultureInfo.InvariantCulture) + " " + Deklarit.Resources.Resources.Rows;
        ...
        public virtual IS_OD_REKAP_OLAKSICEDataAdapter DataAdapter
        {
            get
            {
                ...
                if (DataAdapterFactory.Provider != null)
                {
                    return DataAdapterFactory.GetS_OD_REKAP_OLAKSICEDataAdapter();
                }
                return null;
            }
        }
        ...
        [Browsable(false), Category("Deklarit Work With ")]
        public virtual S_OD_REKAP_OLAKSICEDataSet DataSet
        {
            get
            {
                return this.dsS_OD_REKAP_OLAKSICEDataSet1;
            }
            set
            {
                this.dsS_OD_REKAP_OLAKSICEDataSet1 = value;
            }
        }
