namespace NetAdvantage.Controls
{
    ...
    public class sp_id_detaljiDataGrid : DeklaritDataGrid
    {
        private int currentRow;
        private sp_id_detaljiDataSet dssp_id_detaljiDataSet1 = new sp_id_detaljiDataSet();
        ...
        private short m_ParameterVOLONTERI = 0;
        private int m_StartRow;
        private int startRowThread;
        private const int WM_SETREDRAW = 11;

        public sp_id_detaljiDataGrid()
        {
            this.BindDataGrid();
        ...
        private void BindDataGrid()
        {
            ...
            this.dv1.Table = this.dssp_id_detaljiDataSet1.sp_id_detalji;
        ...
        {
            this.PreFill();
            this.dssp_id_detaljiDataSet1 = new sp_id_detaljiDataSet();
            this.m_StartRow = 0;
        ...
        private void FillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dssp_id_detaljiDataSet1, this.m_Parameteridobracun, this.m_ParametermjeseCISPLATE, this.m_ParametergodinaISPLATE, this.m_ParameterVOLONTERI, 0, this.PageSize);
                }
                else
                {
                    this.DataAdapter.Fill(this.dssp_id_detaljiDataSet1, this.m_Parameteridobracun, this.m_ParametermjeseCISPLATE, this.m_ParametergodinaISPLATE, this.m_ParameterVOLONTERI);
                }
        ...
        private void ReFillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dssp_id_detaljiDataSet1, this.m_Parameteridobracun, this.m_ParametermjeseCISPLATE, this.m_ParametergodinaISPLATE, this.m_ParameterVOLONTERI, this.startRowThread, this.PageSize);
                }
        ...
        private void ResumeBindingPostThread()
        {
            ...
            this.EndUpdate();
            this.BindDataGrid();
            this.Text = "sp_id_detalji : " + this.DataView.Count.ToString(CultureInfo.InvariantCulture) + " " + Deklarit.Resources.Resources.Rows;
        ...
        public virtual Isp_id_detaljiDataAdapter DataAdapter
        {
            get
            {
                ...
                if (DataAdapterFactory.Provider != null)
                {
                    return DataAdapterFactory.Getsp_id_detaljiDataAdapter();
                }
                return null;
            }
        }
        ...
        public virtual sp_id_detaljiDataSet DataSet
        {
            get
            {
                return this.dssp_id_detaljiDataSet1;
            }
            set
            {
                this.dssp_id_detaljiDataSet1 = value;
            }
        }
        ...
        public virtual short ParameterVOLONTERI
        {
            get
            {
                return this.m_ParameterVOLONTERI;
            }
            set
            {
                this.m_ParameterVOLONTERI = value;
            }
        }
    }
}
