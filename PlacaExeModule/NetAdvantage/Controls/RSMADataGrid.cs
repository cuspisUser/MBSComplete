namespace NetAdvantage.Controls
{
    ...
    public class RSMADataGrid : DeklaritDataGrid
    {
        private int currentRow;
        private RSMADataSet dsRSMADataSet1 = new RSMADataSet();
        private System.Data.DataView dv1;
        private string m_FillByIDOBRACUNIDOBRACUN;
        private string m_FillByIDRSVRSTEOBRACUNAIDRSVRSTEOBRACUNA;
        private string m_FillByIDRSVRSTEOBVEZNIKAIDRSVRSTEOBVEZNIKA;
        ...
        {
            this.BindDataGrid();
            DeklaritDataGrid.myFillMethods = new TypeConverter.StandardValuesCollection(new string[] { "Fill", "FillByIDOBRACUN", "FillByIDRSVRSTEOBVEZNIKA", "FillByIDRSVRSTEOBRACUNA" });
        ...
        private void BindDataGrid()
        {
            ...
            this.dv1.Table = this.dsRSMADataSet1.RSMA;
        ...
        private void FillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    ...
                    {
                        this.DataAdapter.FillPage(this.dsRSMADataSet1, 0, this.PageSize);
                    }
                    else
                    {
                        MethodInfo info = this.DataAdapter.GetType().GetMethod("FillPageBy" + this.FillMethod.Substring(6));
                        this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsRSMADataSet1, info, 0, this.PageSize);
                    }
                }
                else if (this.FillMethod == "Fill")
                {
                    this.DataAdapter.Fill(this.dsRSMADataSet1);
                }
                else
                {
                    MethodInfo info2 = this.DataAdapter.GetType().GetMethod(this.FillMethod);
                    this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsRSMADataSet1, info2);
                }
        ...
        private void ReFillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    if (this.FillMethod == "Fill")
                    {
                        this.DataAdapter.FillPage(this.dsRSMADataSet1, this.startRowThread, this.PageSize);
                    }
                    else
                    {
                        MethodInfo info = this.DataAdapter.GetType().GetMethod("FillPageBy" + this.FillMethod.Substring(6));
                        this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsRSMADataSet1, info, this.startRowThread, this.PageSize);
                    }
                }
        ...
        private void ResumeBindingPostThread()
        {
            ...
            this.EndUpdate();
            this.BindDataGrid();
            this.Text = "RSMA : " + this.DataView.Count.ToString(CultureInfo.InvariantCulture) + " " + Deklarit.Resources.Resources.Rows;
        ...
        public virtual IRSMADataAdapter DataAdapter
        {
            get
            {
                ...
                if (DataAdapterFactory.Provider != null)
                {
                    return DataAdapterFactory.GetRSMADataAdapter();
                }
                return null;
            }
        }
        ...
        public virtual RSMADataSet DataSet
        {
            get
            {
                return this.dsRSMADataSet1;
            }
            set
            {
                this.dsRSMADataSet1 = value;
            }
        }
        ...
        public virtual string FillByIDOBRACUNIDOBRACUN
        {
            get
            {
                return this.m_FillByIDOBRACUNIDOBRACUN;
            }
            set
            {
                this.m_FillByIDOBRACUNIDOBRACUN = value;
            }
        }
        ...
        public virtual string FillByIDRSVRSTEOBRACUNAIDRSVRSTEOBRACUNA
        {
            get
            {
                return this.m_FillByIDRSVRSTEOBRACUNAIDRSVRSTEOBRACUNA;
            }
            set
            {
                this.m_FillByIDRSVRSTEOBRACUNAIDRSVRSTEOBRACUNA = value;
            }
        }
        ...
        public virtual string FillByIDRSVRSTEOBVEZNIKAIDRSVRSTEOBVEZNIKA
        {
            get
            {
                return this.m_FillByIDRSVRSTEOBVEZNIKAIDRSVRSTEOBVEZNIKA;
            }
            set
            {
                this.m_FillByIDRSVRSTEOBVEZNIKAIDRSVRSTEOBVEZNIKA = value;
            }
        }
