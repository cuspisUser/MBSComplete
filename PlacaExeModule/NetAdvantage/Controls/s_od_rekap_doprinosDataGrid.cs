namespace NetAdvantage.Controls
{
    ...
    public class s_od_rekap_doprinosDataGrid : DeklaritDataGrid
    {
        private int currentRow;
        private s_od_rekap_doprinosDataSet dss_od_rekap_doprinosDataSet1 = new s_od_rekap_doprinosDataSet();
        ...
        public s_od_rekap_doprinosDataGrid()
        {
            this.BindDataGrid();
        ...
        private void BindDataGrid()
        {
            ...
            this.dv1.Table = this.dss_od_rekap_doprinosDataSet1.s_od_rekap_doprinos;
        ...
        private void FillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dss_od_rekap_doprinosDataSet1, this.m_Parameteridobracun, 0, this.PageSize);
                }
                else
                {
                    this.DataAdapter.Fill(this.dss_od_rekap_doprinosDataSet1, this.m_Parameteridobracun);
                }
        ...
        private void ReFillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dss_od_rekap_doprinosDataSet1, this.m_Parameteridobracun, this.startRowThread, this.PageSize);
                }
        ...
        private void ResumeBindingPostThread()
        {
            ...
            this.EndUpdate();
            this.BindDataGrid();
            this.Text = "s_od_rekap_doprinos : " + this.DataView.Count.ToString(CultureInfo.InvariantCulture) + " " + Deklarit.Resources.Resources.Rows;
        ...
        public virtual Is_od_rekap_doprinosDataAdapter DataAdapter
        {
            get
            {
                ...
                if (DataAdapterFactory.Provider != null)
                {
                    return DataAdapterFactory.Gets_od_rekap_doprinosDataAdapter();
                }
                return null;
            }
        }
        ...
        public virtual s_od_rekap_doprinosDataSet DataSet
        {
            get
            {
                return this.dss_od_rekap_doprinosDataSet1;
            }
            set
            {
                this.dss_od_rekap_doprinosDataSet1 = value;
            }
        }
