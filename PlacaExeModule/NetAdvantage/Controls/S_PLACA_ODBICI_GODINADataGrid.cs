namespace NetAdvantage.Controls
{
    ...
    public class S_PLACA_ODBICI_GODINADataGrid : DeklaritDataGrid
    {
        private int currentRow;
        private S_PLACA_ODBICI_GODINADataSet dsS_PLACA_ODBICI_GODINADataSet1 = new S_PLACA_ODBICI_GODINADataSet();
        ...
        public S_PLACA_ODBICI_GODINADataGrid()
        {
            this.BindDataGrid();
        ...
        {
            this.PreFill();
            this.dsS_PLACA_ODBICI_GODINADataSet1 = new S_PLACA_ODBICI_GODINADataSet();
            this.m_StartRow = 0;
        ...
        private void FillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dsS_PLACA_ODBICI_GODINADataSet1, this.m_ParameterGODINAISPLATE, 0, this.PageSize);
                }
                else
                {
                    this.DataAdapter.Fill(this.dsS_PLACA_ODBICI_GODINADataSet1, this.m_ParameterGODINAISPLATE);
                }
        ...
        private void ReFillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dsS_PLACA_ODBICI_GODINADataSet1, this.m_ParameterGODINAISPLATE, this.startRowThread, this.PageSize);
                }
        ...
        private void ResumeBindingPostThread()
        {
            ...
            this.EndUpdate();
            this.BindDataGrid();
            this.Text = "S_PLACA_ODBICI_GODINA : " + this.DataView.Count.ToString(CultureInfo.InvariantCulture) + " " + Deklarit.Resources.Resources.Rows;
        ...
        public virtual IS_PLACA_ODBICI_GODINADataAdapter DataAdapter
        {
            get
            {
                ...
                if (DataAdapterFactory.Provider != null)
                {
                    return DataAdapterFactory.GetS_PLACA_ODBICI_GODINADataAdapter();
                }
                return null;
            }
        }
        ...
        public virtual S_PLACA_ODBICI_GODINADataSet DataSet
        {
            get
            {
                return this.dsS_PLACA_ODBICI_GODINADataSet1;
            }
            set
            {
                this.dsS_PLACA_ODBICI_GODINADataSet1 = value;
            }
        }
