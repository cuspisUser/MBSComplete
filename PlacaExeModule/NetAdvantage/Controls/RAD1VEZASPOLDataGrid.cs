namespace NetAdvantage.Controls
{
    ...
    public class RAD1VEZASPOLDataGrid : DeklaritDataGrid
    {
        private int currentRow;
        private RAD1VEZASPOLDataSet dsRAD1VEZASPOLDataSet1 = new RAD1VEZASPOLDataSet();
        private System.Data.DataView dv1;
        private int m_FillByIDSPOLIDSPOL;
        private bool m_FillByPage = false;
        private int m_FillByRAD1SPOLIDRAD1SPOLID;
        ...
        public RAD1VEZASPOLDataGrid()
        {
            this.BindDataGrid();
            DeklaritDataGrid.myFillMethods = new TypeConverter.StandardValuesCollection(new string[] { "Fill", "FillByIDSPOL", "FillByRAD1SPOLID" });
        ...
        private void BindDataGrid()
        {
            ...
            this.dv1.Table = this.dsRAD1VEZASPOLDataSet1.RAD1VEZASPOL;
        ...
        private void FillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    ...
                    {
                        this.DataAdapter.FillPage(this.dsRAD1VEZASPOLDataSet1, 0, this.PageSize);
                    }
                    else
                    {
                        MethodInfo info = this.DataAdapter.GetType().GetMethod("FillPageBy" + this.FillMethod.Substring(6));
                        this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsRAD1VEZASPOLDataSet1, info, 0, this.PageSize);
                    }
                }
                else if (this.FillMethod == "Fill")
                {
                    this.DataAdapter.Fill(this.dsRAD1VEZASPOLDataSet1);
                }
                else
                {
                    MethodInfo info2 = this.DataAdapter.GetType().GetMethod(this.FillMethod);
                    this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsRAD1VEZASPOLDataSet1, info2);
                }
        ...
        private void ReFillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    if (this.FillMethod == "Fill")
                    {
                        this.DataAdapter.FillPage(this.dsRAD1VEZASPOLDataSet1, this.startRowThread, this.PageSize);
                    }
                    else
                    {
                        MethodInfo info = this.DataAdapter.GetType().GetMethod("FillPageBy" + this.FillMethod.Substring(6));
                        this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsRAD1VEZASPOLDataSet1, info, this.startRowThread, this.PageSize);
                    }
                }
        ...
        private void ResumeBindingPostThread()
        {
            ...
            this.EndUpdate();
            this.BindDataGrid();
            this.Text = "Veza RAD1 i spol : " + this.DataView.Count.ToString(CultureInfo.InvariantCulture) + " " + Deklarit.Resources.Resources.Rows;
        ...
        public virtual IRAD1VEZASPOLDataAdapter DataAdapter
        {
            get
            {
                ...
                if (DataAdapterFactory.Provider != null)
                {
                    return DataAdapterFactory.GetRAD1VEZASPOLDataAdapter();
                }
                return null;
            }
        }
        ...
        public virtual RAD1VEZASPOLDataSet DataSet
        {
            get
            {
                return this.dsRAD1VEZASPOLDataSet1;
            }
            set
            {
                this.dsRAD1VEZASPOLDataSet1 = value;
            }
        }
        ...
        public virtual int FillByRAD1SPOLIDRAD1SPOLID
        {
            get
            {
                return this.m_FillByRAD1SPOLIDRAD1SPOLID;
            }
            set
            {
                this.m_FillByRAD1SPOLIDRAD1SPOLID = value;
            }
        }
