namespace NetAdvantage.Controls
{
    ...
    public class partnerabecedaDataGrid : DeklaritDataGrid
    {
        ...
        private void ResumeBindingPostThread()
        {
            ...
            this.EndUpdate();
            this.BindDataGrid();
            this.Text = "partnerabeceda : " + this.DataView.Count.ToString(CultureInfo.InvariantCulture) + " " + Deklarit.Resources.Resources.Rows;
        ...
        public virtual IpartnerabecedaDataAdapter DataAdapter
        {
            get
            {
                ...
                if (DataAdapterFactory.Provider != null)
                {
                    return DataAdapterFactory.GetpartnerabecedaDataAdapter();
                }
                return null;
            }
        }
