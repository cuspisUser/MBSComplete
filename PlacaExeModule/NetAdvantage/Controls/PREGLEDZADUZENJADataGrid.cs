namespace NetAdvantage.Controls
{
    ...
    public class PREGLEDZADUZENJADataGrid : DeklaritDataGrid
    {
        private int currentRow;
        private PREGLEDZADUZENJADataSet dsPREGLEDZADUZENJADataSet1 = new PREGLEDZADUZENJADataSet();
        ...
        public PREGLEDZADUZENJADataGrid()
        {
            this.BindDataGrid();
        ...
        private void BindDataGrid()
        {
            ...
            this.dv1.Table = this.dsPREGLEDZADUZENJADataSet1.PARTNERZADUZENJE;
        ...
        {
            this.PreFill();
            this.dsPREGLEDZADUZENJADataSet1 = new PREGLEDZADUZENJADataSet();
            this.m_StartRow = 0;
        ...
        private void FillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dsPREGLEDZADUZENJADataSet1, 0, this.PageSize);
                }
                else
                {
                    this.DataAdapter.Fill(this.dsPREGLEDZADUZENJADataSet1);
                }
        ...
        private void ReFillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dsPREGLEDZADUZENJADataSet1, this.startRowThread, this.PageSize);
                }
        ...
        private void ResumeBindingPostThread()
        {
            ...
            this.EndUpdate();
            this.BindDataGrid();
            this.Text = "PREGLEDZADUZENJA : " + this.DataView.Count.ToString(CultureInfo.InvariantCulture) + " " + Deklarit.Resources.Resources.Rows;
        ...
        public virtual IPREGLEDZADUZENJADataAdapter DataAdapter
        {
            get
            {
                ...
                if (DataAdapterFactory.Provider != null)
                {
                    return DataAdapterFactory.GetPREGLEDZADUZENJADataAdapter();
                }
                return null;
            }
        }
        ...
        public virtual PREGLEDZADUZENJADataSet DataSet
        {
            get
            {
                return this.dsPREGLEDZADUZENJADataSet1;
            }
            set
            {
                this.dsPREGLEDZADUZENJADataSet1 = value;
            }
        }
