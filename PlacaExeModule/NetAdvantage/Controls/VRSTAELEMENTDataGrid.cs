namespace NetAdvantage.Controls
{
    ...
    public class VRSTAELEMENTDataGrid : DeklaritDataGrid
    {
        private int currentRow;
        private VRSTAELEMENTDataSet dsVRSTAELEMENTDataSet1 = new VRSTAELEMENTDataSet();
        ...
        private void BindDataGrid()
        {
            ...
            this.dv1.Table = this.dsVRSTAELEMENTDataSet1.VRSTAELEMENT;
        ...
        private void FillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    ...
                    {
                        this.DataAdapter.FillPage(this.dsVRSTAELEMENTDataSet1, 0, this.PageSize);
                    }
                    else
                    {
                        MethodInfo info = this.DataAdapter.GetType().GetMethod("FillPageBy" + this.FillMethod.Substring(6));
                        this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsVRSTAELEMENTDataSet1, info, 0, this.PageSize);
                    }
                }
                else if (this.FillMethod == "Fill")
                {
                    this.DataAdapter.Fill(this.dsVRSTAELEMENTDataSet1);
                }
                else
                {
                    MethodInfo info2 = this.DataAdapter.GetType().GetMethod(this.FillMethod);
                    this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsVRSTAELEMENTDataSet1, info2);
                }
        ...
        private void ReFillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    if (this.FillMethod == "Fill")
                    {
                        this.DataAdapter.FillPage(this.dsVRSTAELEMENTDataSet1, this.startRowThread, this.PageSize);
                    }
                    else
                    {
                        MethodInfo info = this.DataAdapter.GetType().GetMethod("FillPageBy" + this.FillMethod.Substring(6));
                        this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsVRSTAELEMENTDataSet1, info, this.startRowThread, this.PageSize);
                    }
                }
        ...
        private void ResumeBindingPostThread()
        {
            ...
            this.EndUpdate();
            this.BindDataGrid();
            this.Text = "Vrste elementa : " + this.DataView.Count.ToString(CultureInfo.InvariantCulture) + " " + Deklarit.Resources.Resources.Rows;
        ...
        public virtual IVRSTAELEMENTDataAdapter DataAdapter
        {
            get
            {
                ...
                if (DataAdapterFactory.Provider != null)
                {
                    return DataAdapterFactory.GetVRSTAELEMENTDataAdapter();
                }
                return null;
            }
        }
        ...
        public virtual VRSTAELEMENTDataSet DataSet
        {
            get
            {
                return this.dsVRSTAELEMENTDataSet1;
            }
            set
            {
                this.dsVRSTAELEMENTDataSet1 = value;
            }
        }
