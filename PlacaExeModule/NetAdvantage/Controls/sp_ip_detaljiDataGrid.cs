namespace NetAdvantage.Controls
{
    ...
    public class sp_ip_detaljiDataGrid : DeklaritDataGrid
    {
        private int currentRow;
        private sp_ip_detaljiDataSet dssp_ip_detaljiDataSet1 = new sp_ip_detaljiDataSet();
        ...
        private void BindDataGrid()
        {
            ...
            this.dv1.Table = this.dssp_ip_detaljiDataSet1.sp_ip_detalji;
        ...
        {
            this.PreFill();
            this.dssp_ip_detaljiDataSet1 = new sp_ip_detaljiDataSet();
            this.m_StartRow = 0;
        ...
        private void FillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dssp_ip_detaljiDataSet1, this.m_Parametergodina, 0, this.PageSize);
                }
                else
                {
                    this.DataAdapter.Fill(this.dssp_ip_detaljiDataSet1, this.m_Parametergodina);
                }
        ...
        private void ReFillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dssp_ip_detaljiDataSet1, this.m_Parametergodina, this.startRowThread, this.PageSize);
                }
        ...
        private void ResumeBindingPostThread()
        {
            ...
            this.EndUpdate();
            this.BindDataGrid();
            this.Text = "sp_ip_detalji : " + this.DataView.Count.ToString(CultureInfo.InvariantCulture) + " " + Deklarit.Resources.Resources.Rows;
        ...
        public virtual Isp_ip_detaljiDataAdapter DataAdapter
        {
            get
            {
                ...
                if (DataAdapterFactory.Provider != null)
                {
                    return DataAdapterFactory.Getsp_ip_detaljiDataAdapter();
                }
                return null;
            }
        }
        ...
        public virtual sp_ip_detaljiDataSet DataSet
        {
            get
            {
                return this.dssp_ip_detaljiDataSet1;
            }
            set
            {
                this.dssp_ip_detaljiDataSet1 = value;
            }
        }
