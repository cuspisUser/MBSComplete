namespace NetAdvantage.Controls
{
    ...
    public class MZOSTABLICEDataGrid : DeklaritDataGrid
    {
        private int currentRow;
        private MZOSTABLICEDataSet dsMZOSTABLICEDataSet1 = new MZOSTABLICEDataSet();
        ...
        private void BindDataGrid()
        {
            ...
            this.dv1.Table = this.dsMZOSTABLICEDataSet1.MZOSTABLICE;
        ...
        private void FillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    ...
                    {
                        this.DataAdapter.FillPage(this.dsMZOSTABLICEDataSet1, 0, this.PageSize);
                    }
                    else
                    {
                        MethodInfo info = this.DataAdapter.GetType().GetMethod("FillPageBy" + this.FillMethod.Substring(6));
                        this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsMZOSTABLICEDataSet1, info, 0, this.PageSize);
                    }
                }
                else if (this.FillMethod == "Fill")
                {
                    this.DataAdapter.Fill(this.dsMZOSTABLICEDataSet1);
                }
                else
                {
                    MethodInfo info2 = this.DataAdapter.GetType().GetMethod(this.FillMethod);
                    this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsMZOSTABLICEDataSet1, info2);
                }
        ...
        private void ReFillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    if (this.FillMethod == "Fill")
                    {
                        this.DataAdapter.FillPage(this.dsMZOSTABLICEDataSet1, this.startRowThread, this.PageSize);
                    }
                    else
                    {
                        MethodInfo info = this.DataAdapter.GetType().GetMethod("FillPageBy" + this.FillMethod.Substring(6));
                        this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsMZOSTABLICEDataSet1, info, this.startRowThread, this.PageSize);
                    }
                }
        ...
        private void ResumeBindingPostThread()
        {
            ...
            this.EndUpdate();
            this.BindDataGrid();
            this.Text = "MZOŠ Tablica : " + this.DataView.Count.ToString(CultureInfo.InvariantCulture) + " " + Deklarit.Resources.Resources.Rows;
        ...
        public virtual IMZOSTABLICEDataAdapter DataAdapter
        {
            get
            {
                ...
                if (DataAdapterFactory.Provider != null)
                {
                    return DataAdapterFactory.GetMZOSTABLICEDataAdapter();
                }
                return null;
            }
        }
        ...
        public virtual MZOSTABLICEDataSet DataSet
        {
            get
            {
                return this.dsMZOSTABLICEDataSet1;
            }
            set
            {
                this.dsMZOSTABLICEDataSet1 = value;
            }
        }
