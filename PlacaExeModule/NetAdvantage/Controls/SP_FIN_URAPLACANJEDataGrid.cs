namespace NetAdvantage.Controls
{
    ...
    public class SP_FIN_URAPLACANJEDataGrid : DeklaritDataGrid
    {
        private int currentRow;
        private SP_FIN_URAPLACANJEDataSet dsSP_FIN_URAPLACANJEDataSet1 = new SP_FIN_URAPLACANJEDataSet();
        private System.Data.DataView dv1;
        private bool m_FillByPage = true;
        private bool m_GridLoading;
        private int m_PageSize = 60;
        private int m_ParameterIDDOKUMENT = 0;
        private int m_StartRow;
        private int startRowThread;
        private const int WM_SETREDRAW = 11;

        public SP_FIN_URAPLACANJEDataGrid()
        {
            this.BindDataGrid();
        ...
        private void BindDataGrid()
        {
            ...
            this.dv1.Table = this.dsSP_FIN_URAPLACANJEDataSet1.SP_FIN_URAPLACANJE;
        ...
        {
            this.PreFill();
            this.dsSP_FIN_URAPLACANJEDataSet1 = new SP_FIN_URAPLACANJEDataSet();
            this.m_StartRow = 0;
        ...
        private void FillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dsSP_FIN_URAPLACANJEDataSet1, this.m_ParameterIDDOKUMENT, 0, this.PageSize);
                }
                else
                {
                    this.DataAdapter.Fill(this.dsSP_FIN_URAPLACANJEDataSet1, this.m_ParameterIDDOKUMENT);
                }
        ...
        private void ReFillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dsSP_FIN_URAPLACANJEDataSet1, this.m_ParameterIDDOKUMENT, this.startRowThread, this.PageSize);
                }
        ...
        private void ResumeBindingPostThread()
        {
            ...
            this.EndUpdate();
            this.BindDataGrid();
            this.Text = "SP_FIN_URAPLACANJE : " + this.DataView.Count.ToString(CultureInfo.InvariantCulture) + " " + Deklarit.Resources.Resources.Rows;
        ...
        public virtual ISP_FIN_URAPLACANJEDataAdapter DataAdapter
        {
            get
            {
                ...
                if (DataAdapterFactory.Provider != null)
                {
                    return DataAdapterFactory.GetSP_FIN_URAPLACANJEDataAdapter();
                }
                return null;
            }
        }
        ...
        public virtual SP_FIN_URAPLACANJEDataSet DataSet
        {
            get
            {
                return this.dsSP_FIN_URAPLACANJEDataSet1;
            }
            set
            {
                this.dsSP_FIN_URAPLACANJEDataSet1 = value;
            }
        }
        ...
        public virtual int ParameterIDDOKUMENT
        {
            get
            {
                return this.m_ParameterIDDOKUMENT;
            }
            set
            {
                this.m_ParameterIDDOKUMENT = value;
            }
        }
    }
}
