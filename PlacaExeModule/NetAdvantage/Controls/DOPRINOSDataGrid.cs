namespace NetAdvantage.Controls
{
    ...
    public class DOPRINOSDataGrid : DeklaritDataGrid
    {
        private int currentRow;
        private DOPRINOSDataSet dsDOPRINOSDataSet1 = new DOPRINOSDataSet();
        private System.Data.DataView dv1;
        private int m_FillByIDVRSTADOPRINOSIDVRSTADOPRINOS;
        ...
        public DOPRINOSDataGrid()
        {
            this.BindDataGrid();
            DeklaritDataGrid.myFillMethods = new TypeConverter.StandardValuesCollection(new string[] { "Fill", "FillByIDVRSTADOPRINOS" });
        ...
        private void BindDataGrid()
        {
            ...
            this.dv1.Table = this.dsDOPRINOSDataSet1.DOPRINOS;
        ...
        private void FillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    ...
                    {
                        this.DataAdapter.FillPage(this.dsDOPRINOSDataSet1, 0, this.PageSize);
                    }
                    else
                    {
                        MethodInfo info = this.DataAdapter.GetType().GetMethod("FillPageBy" + this.FillMethod.Substring(6));
                        this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsDOPRINOSDataSet1, info, 0, this.PageSize);
                    }
                }
                else if (this.FillMethod == "Fill")
                {
                    this.DataAdapter.Fill(this.dsDOPRINOSDataSet1);
                }
                else
                {
                    MethodInfo info2 = this.DataAdapter.GetType().GetMethod(this.FillMethod);
                    this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsDOPRINOSDataSet1, info2);
                }
        ...
        private void ReFillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    if (this.FillMethod == "Fill")
                    {
                        this.DataAdapter.FillPage(this.dsDOPRINOSDataSet1, this.startRowThread, this.PageSize);
                    }
                    else
                    {
                        MethodInfo info = this.DataAdapter.GetType().GetMethod("FillPageBy" + this.FillMethod.Substring(6));
                        this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsDOPRINOSDataSet1, info, this.startRowThread, this.PageSize);
                    }
                }
        ...
        private void ResumeBindingPostThread()
        {
            ...
            this.EndUpdate();
            this.BindDataGrid();
            this.Text = "Doprinosi : " + this.DataView.Count.ToString(CultureInfo.InvariantCulture) + " " + Deklarit.Resources.Resources.Rows;
        ...
        public virtual IDOPRINOSDataAdapter DataAdapter
        {
            get
            {
                ...
                if (DataAdapterFactory.Provider != null)
                {
                    return DataAdapterFactory.GetDOPRINOSDataAdapter();
                }
                return null;
            }
        }
        ...
        [Browsable(false), Category("Deklarit Work With ")]
        public virtual DOPRINOSDataSet DataSet
        {
            get
            {
                return this.dsDOPRINOSDataSet1;
            }
            set
            {
                this.dsDOPRINOSDataSet1 = value;
            }
        }
        ...
        public virtual int FillByIDVRSTADOPRINOSIDVRSTADOPRINOS
        {
            get
            {
                return this.m_FillByIDVRSTADOPRINOSIDVRSTADOPRINOS;
            }
            set
            {
                this.m_FillByIDVRSTADOPRINOSIDVRSTADOPRINOS = value;
            }
        }
