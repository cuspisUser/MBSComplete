namespace NetAdvantage.Controls
{
    ...
    public class trazi_proizvodDataGrid : DeklaritDataGrid
    {
        ...
        private void BindDataGrid()
        {
            ...
            this.dv1.Table = this.dstrazi_proizvodDataSet1.PROIZVOD;
        ...
        {
            this.PreFill();
            this.dstrazi_proizvodDataSet1 = new trazi_proizvodDataSet();
            this.m_StartRow = 0;
        ...
        private void FillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dstrazi_proizvodDataSet1, this.m_Parameternazivproizvod, 0, this.PageSize);
                }
                else
                {
        ...
        private void ReFillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dstrazi_proizvodDataSet1, this.m_Parameternazivproizvod, this.startRowThread, this.PageSize);
                }
        ...
        private void ResumeBindingPostThread()
        {
            ...
            this.EndUpdate();
            this.BindDataGrid();
            this.Text = "trazi_proizvod : " + this.DataView.Count.ToString(CultureInfo.InvariantCulture) + " " + Deklarit.Resources.Resources.Rows;
        ...
        public virtual Itrazi_proizvodDataAdapter DataAdapter
        {
            get
            {
