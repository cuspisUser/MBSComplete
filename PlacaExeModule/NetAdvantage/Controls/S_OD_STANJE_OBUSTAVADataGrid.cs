namespace NetAdvantage.Controls
{
    ...
    public class S_OD_STANJE_OBUSTAVADataGrid : DeklaritDataGrid
    {
        private int currentRow;
        private S_OD_STANJE_OBUSTAVADataSet dsS_OD_STANJE_OBUSTAVADataSet1 = new S_OD_STANJE_OBUSTAVADataSet();
        ...
        public S_OD_STANJE_OBUSTAVADataGrid()
        {
            this.BindDataGrid();
        ...
        private void BindDataGrid()
        {
            ...
            this.dv1.Table = this.dsS_OD_STANJE_OBUSTAVADataSet1.S_OD_STANJE_OBUSTAVA;
        ...
        {
            this.PreFill();
            this.dsS_OD_STANJE_OBUSTAVADataSet1 = new S_OD_STANJE_OBUSTAVADataSet();
            this.m_StartRow = 0;
        ...
        private void FillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dsS_OD_STANJE_OBUSTAVADataSet1, this.m_Parameteridobracun, 0, this.PageSize);
                }
                else
                {
                    this.DataAdapter.Fill(this.dsS_OD_STANJE_OBUSTAVADataSet1, this.m_Parameteridobracun);
                }
        ...
        private void ReFillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dsS_OD_STANJE_OBUSTAVADataSet1, this.m_Parameteridobracun, this.startRowThread, this.PageSize);
                }
        ...
        private void ResumeBindingPostThread()
        {
            ...
            this.EndUpdate();
            this.BindDataGrid();
            this.Text = "S_OD_STANJE_OBUSTAVA : " + this.DataView.Count.ToString(CultureInfo.InvariantCulture) + " " + Deklarit.Resources.Resources.Rows;
        ...
        public virtual IS_OD_STANJE_OBUSTAVADataAdapter DataAdapter
        {
            get
            {
                ...
                if (DataAdapterFactory.Provider != null)
                {
                    return DataAdapterFactory.GetS_OD_STANJE_OBUSTAVADataAdapter();
                }
                return null;
            }
        }
        ...
        public virtual S_OD_STANJE_OBUSTAVADataSet DataSet
        {
            get
            {
                return this.dsS_OD_STANJE_OBUSTAVADataSet1;
            }
            set
            {
                this.dsS_OD_STANJE_OBUSTAVADataSet1 = value;
            }
        }
