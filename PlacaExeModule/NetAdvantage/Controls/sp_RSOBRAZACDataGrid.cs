namespace NetAdvantage.Controls
{
    ...
    public class sp_RSOBRAZACDataGrid : DeklaritDataGrid
    {
        ...
        private void BindDataGrid()
        {
            ...
            this.dv1.Table = this.dssp_RSOBRAZACDataSet1.sp_RSOBRAZAC;
        ...
        {
            this.PreFill();
            this.dssp_RSOBRAZACDataSet1 = new sp_RSOBRAZACDataSet();
            this.m_StartRow = 0;
        ...
        private void FillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dssp_RSOBRAZACDataSet1, this.m_ParameterIDOBRACUN, this.m_Parameterdd, 0, this.PageSize);
                }
                else
                {
                    this.DataAdapter.Fill(this.dssp_RSOBRAZACDataSet1, this.m_ParameterIDOBRACUN, this.m_Parameterdd);
                }
        ...
        private void ReFillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dssp_RSOBRAZACDataSet1, this.m_ParameterIDOBRACUN, this.m_Parameterdd, this.startRowThread, this.PageSize);
                }
        ...
        private void ResumeBindingPostThread()
        {
            ...
            this.EndUpdate();
            this.BindDataGrid();
            this.Text = "sp_RSOBRAZAC : " + this.DataView.Count.ToString(CultureInfo.InvariantCulture) + " " + Deklarit.Resources.Resources.Rows;
        ...
        public virtual Isp_RSOBRAZACDataAdapter DataAdapter
        {
            get
            {
                ...
                if (DataAdapterFactory.Provider != null)
                {
                    return DataAdapterFactory.Getsp_RSOBRAZACDataAdapter();
                }
                return null;
            }
        }
        ...
        [Browsable(false), Category("Deklarit Work With ")]
        public virtual sp_RSOBRAZACDataSet DataSet
        {
            get
            {
                return this.dssp_RSOBRAZACDataSet1;
            }
            set
            {
                this.dssp_RSOBRAZACDataSet1 = value;
            }
        }
