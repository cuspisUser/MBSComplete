namespace NetAdvantage.Controls
{
    ...
    public class PROVIDER_NETODataGrid : DeklaritDataGrid
    {
        ...
        private void BindDataGrid()
        {
            ...
            this.dv1.Table = this.dsPROVIDER_NETODataSet1.ELEMENT;
        ...
        {
            this.PreFill();
            this.dsPROVIDER_NETODataSet1 = new PROVIDER_NETODataSet();
            this.m_StartRow = 0;
        ...
        private void FillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dsPROVIDER_NETODataSet1, 0, this.PageSize);
                }
                else
                {
        ...
        private void ReFillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dsPROVIDER_NETODataSet1, this.startRowThread, this.PageSize);
                }
        ...
        private void ResumeBindingPostThread()
        {
            ...
            this.EndUpdate();
            this.BindDataGrid();
            this.Text = "PROVIDER_NETO : " + this.DataView.Count.ToString(CultureInfo.InvariantCulture) + " " + Deklarit.Resources.Resources.Rows;
        ...
        public virtual IPROVIDER_NETODataAdapter DataAdapter
        {
            get
            {
