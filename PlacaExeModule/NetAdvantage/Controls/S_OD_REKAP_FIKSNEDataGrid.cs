namespace NetAdvantage.Controls
{
    ...
    public class S_OD_REKAP_FIKSNEDataGrid : DeklaritDataGrid
    {
        private int currentRow;
        private S_OD_REKAP_FIKSNEDataSet dsS_OD_REKAP_FIKSNEDataSet1 = new S_OD_REKAP_FIKSNEDataSet();
        ...
        public S_OD_REKAP_FIKSNEDataGrid()
        {
            this.BindDataGrid();
        ...
        private void BindDataGrid()
        {
            ...
            this.dv1.Table = this.dsS_OD_REKAP_FIKSNEDataSet1.S_OD_REKAP_FIKSNE;
        ...
        {
            this.PreFill();
            this.dsS_OD_REKAP_FIKSNEDataSet1 = new S_OD_REKAP_FIKSNEDataSet();
            this.m_StartRow = 0;
        ...
        private void FillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dsS_OD_REKAP_FIKSNEDataSet1, this.m_ParameterIDOBRACUN, 0, this.PageSize);
                }
                else
                {
                    this.DataAdapter.Fill(this.dsS_OD_REKAP_FIKSNEDataSet1, this.m_ParameterIDOBRACUN);
                }
        ...
        private void ReFillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dsS_OD_REKAP_FIKSNEDataSet1, this.m_ParameterIDOBRACUN, this.startRowThread, this.PageSize);
                }
        ...
        private void ResumeBindingPostThread()
        {
            ...
            this.EndUpdate();
            this.BindDataGrid();
            this.Text = "S_OD_REKAP_FIKSNE : " + this.DataView.Count.ToString(CultureInfo.InvariantCulture) + " " + Deklarit.Resources.Resources.Rows;
        ...
        public virtual IS_OD_REKAP_FIKSNEDataAdapter DataAdapter
        {
            get
            {
                ...
                if (DataAdapterFactory.Provider != null)
                {
                    return DataAdapterFactory.GetS_OD_REKAP_FIKSNEDataAdapter();
                }
                return null;
            }
        }
        ...
        public virtual S_OD_REKAP_FIKSNEDataSet DataSet
        {
            get
            {
                return this.dsS_OD_REKAP_FIKSNEDataSet1;
            }
            set
            {
                this.dsS_OD_REKAP_FIKSNEDataSet1 = value;
            }
        }
