namespace NetAdvantage.Controls
{
    ...
    public class SKUPPOREZAIDOPRINOSADataGrid : DeklaritDataGrid
    {
        private int currentRow;
        private SKUPPOREZAIDOPRINOSADataSet dsSKUPPOREZAIDOPRINOSADataSet1 = new SKUPPOREZAIDOPRINOSADataSet();
        ...
        public SKUPPOREZAIDOPRINOSADataGrid()
        {
            this.BindDataGrid();
        ...
        private void BindDataGrid()
        {
            ...
            this.dv1.Table = this.dsSKUPPOREZAIDOPRINOSADataSet1.SKUPPOREZAIDOPRINOSA;
        ...
        private void FillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    ...
                    {
                        this.DataAdapter.FillPage(this.dsSKUPPOREZAIDOPRINOSADataSet1, 0, this.PageSize);
                    }
                    else
                    {
                        MethodInfo info = this.DataAdapter.GetType().GetMethod("FillPageBy" + this.FillMethod.Substring(6));
                        this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsSKUPPOREZAIDOPRINOSADataSet1, info, 0, this.PageSize);
                    }
                }
                else if (this.FillMethod == "Fill")
                {
                    this.DataAdapter.Fill(this.dsSKUPPOREZAIDOPRINOSADataSet1);
                }
                else
                {
                    MethodInfo info2 = this.DataAdapter.GetType().GetMethod(this.FillMethod);
                    this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsSKUPPOREZAIDOPRINOSADataSet1, info2);
                }
        ...
        private void ReFillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    if (this.FillMethod == "Fill")
                    {
                        this.DataAdapter.FillPage(this.dsSKUPPOREZAIDOPRINOSADataSet1, this.startRowThread, this.PageSize);
                    }
                    else
                    {
                        MethodInfo info = this.DataAdapter.GetType().GetMethod("FillPageBy" + this.FillMethod.Substring(6));
                        this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsSKUPPOREZAIDOPRINOSADataSet1, info, this.startRowThread, this.PageSize);
                    }
                }
        ...
        private void ResumeBindingPostThread()
        {
            ...
            this.EndUpdate();
            this.BindDataGrid();
            this.Text = "Skupine poreza i doprinosa : " + this.DataView.Count.ToString(CultureInfo.InvariantCulture) + " " + Deklarit.Resources.Resources.Rows;
        ...
        public virtual ISKUPPOREZAIDOPRINOSADataAdapter DataAdapter
        {
            get
            {
        ...
        [Category("Deklarit Work With "), Browsable(false)]
        public virtual SKUPPOREZAIDOPRINOSADataSet DataSet
        {
            get
            {
                return this.dsSKUPPOREZAIDOPRINOSADataSet1;
            }
            set
            {
                this.dsSKUPPOREZAIDOPRINOSADataSet1 = value;
            }
        }
