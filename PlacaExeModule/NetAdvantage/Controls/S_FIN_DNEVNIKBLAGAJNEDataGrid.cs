namespace NetAdvantage.Controls
{
    ...
    public class S_FIN_DNEVNIKBLAGAJNEDataGrid : DeklaritDataGrid
    {
        private int currentRow;
        private S_FIN_DNEVNIKBLAGAJNEDataSet dsS_FIN_DNEVNIKBLAGAJNEDataSet1 = new S_FIN_DNEVNIKBLAGAJNEDataSet();
        ...
        private DateTime m_Parameterdat1 = DateTime.Now;
        private DateTime m_Parameterdat2 = DateTime.Now;
        private int m_StartRow;
        private int startRowThread;
        private const int WM_SETREDRAW = 11;

        public S_FIN_DNEVNIKBLAGAJNEDataGrid()
        {
            this.BindDataGrid();
        ...
        private void BindDataGrid()
        {
            ...
            this.dv1.Table = this.dsS_FIN_DNEVNIKBLAGAJNEDataSet1.S_FIN_DNEVNIKBLAGAJNE;
        ...
        {
            this.PreFill();
            this.dsS_FIN_DNEVNIKBLAGAJNEDataSet1 = new S_FIN_DNEVNIKBLAGAJNEDataSet();
            this.m_StartRow = 0;
        ...
        private void FillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dsS_FIN_DNEVNIKBLAGAJNEDataSet1, this.m_Parameterdat1, this.m_Parameterdat2, this.m_Parameterblag, 0, this.PageSize);
                }
                else
                {
                    this.DataAdapter.Fill(this.dsS_FIN_DNEVNIKBLAGAJNEDataSet1, this.m_Parameterdat1, this.m_Parameterdat2, this.m_Parameterblag);
                }
        ...
        private void ReFillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dsS_FIN_DNEVNIKBLAGAJNEDataSet1, this.m_Parameterdat1, this.m_Parameterdat2, this.m_Parameterblag, this.startRowThread, this.PageSize);
                }
        ...
        private void ResumeBindingPostThread()
        {
            ...
            this.EndUpdate();
            this.BindDataGrid();
            this.Text = "S_FIN_DNEVNIKBLAGAJNE : " + this.DataView.Count.ToString(CultureInfo.InvariantCulture) + " " + Deklarit.Resources.Resources.Rows;
        ...
        public virtual IS_FIN_DNEVNIKBLAGAJNEDataAdapter DataAdapter
        {
            get
            {
                ...
                if (DataAdapterFactory.Provider != null)
                {
                    return DataAdapterFactory.GetS_FIN_DNEVNIKBLAGAJNEDataAdapter();
                }
                return null;
            }
        }
        ...
        public virtual S_FIN_DNEVNIKBLAGAJNEDataSet DataSet
        {
            get
            {
                return this.dsS_FIN_DNEVNIKBLAGAJNEDataSet1;
            }
            set
            {
                this.dsS_FIN_DNEVNIKBLAGAJNEDataSet1 = value;
            }
        }
        ...
        public virtual DateTime Parameterdat1
        {
            get
            {
                return this.m_Parameterdat1;
            }
            set
            {
                this.m_Parameterdat1 = value;
            }
        }
        ...
        public virtual DateTime Parameterdat2
        {
            get
            {
                return this.m_Parameterdat2;
            }
            set
            {
                this.m_Parameterdat2 = value;
            }
        }
    }
}
