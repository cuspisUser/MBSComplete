namespace NetAdvantage.Controls
{
    ...
    public class S_OS_STANJE_LOKACIJA_ISPIS_NALJEPNICADataGrid : DeklaritDataGrid
    {
        private int currentRow;
        private S_OS_STANJE_LOKACIJA_ISPIS_NALJEPNICADataSet dsS_OS_STANJE_LOKACIJA_ISPIS_NALJEPNICADataSet1 = new S_OS_STANJE_LOKACIJA_ISPIS_NALJEPNICADataSet();
        private System.Data.DataView dv1;
        private bool m_FillByPage = true;
        private bool m_GridLoading;
        private int m_PageSize = 60;
        private int m_ParameterIDLOKACIJE = 0;
        private int m_StartRow;
        private int startRowThread;
        private const int WM_SETREDRAW = 11;

        public S_OS_STANJE_LOKACIJA_ISPIS_NALJEPNICADataGrid()
        {
            this.BindDataGrid();
        ...
        private void BindDataGrid()
        {
            ...
            this.dv1.Table = this.dsS_OS_STANJE_LOKACIJA_ISPIS_NALJEPNICADataSet1.S_OS_STANJE_LOKACIJA_ISPIS_NALJEPNICA;
        ...
        private void FillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dsS_OS_STANJE_LOKACIJA_ISPIS_NALJEPNICADataSet1, this.m_ParameterIDLOKACIJE, 0, this.PageSize);
                }
                else
                {
                    this.DataAdapter.Fill(this.dsS_OS_STANJE_LOKACIJA_ISPIS_NALJEPNICADataSet1, this.m_ParameterIDLOKACIJE);
                }
        ...
        private void ReFillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dsS_OS_STANJE_LOKACIJA_ISPIS_NALJEPNICADataSet1, this.m_ParameterIDLOKACIJE, this.startRowThread, this.PageSize);
                }
        ...
        private void ResumeBindingPostThread()
        {
            ...
            this.EndUpdate();
            this.BindDataGrid();
            this.Text = " : " + this.DataView.Count.ToString(CultureInfo.InvariantCulture) + " " + Deklarit.Resources.Resources.Rows;
        ...
        public virtual IS_OS_STANJE_LOKACIJA_ISPIS_NALJEPNICADataAdapter DataAdapter
        {
            get
            {
                ...
                if (DataAdapterFactory.Provider != null)
                {
                    return DataAdapterFactory.GetS_OS_STANJE_LOKACIJA_ISPIS_NALJEPNICADataAdapter();
                }
                return null;
            }
        }
        ...
        [Browsable(false), Category("Deklarit Work With ")]
        public virtual S_OS_STANJE_LOKACIJA_ISPIS_NALJEPNICADataSet DataSet
        {
            get
            {
                return this.dsS_OS_STANJE_LOKACIJA_ISPIS_NALJEPNICADataSet1;
            }
            set
            {
                this.dsS_OS_STANJE_LOKACIJA_ISPIS_NALJEPNICADataSet1 = value;
            }
        }
        ...
        public virtual int ParameterIDLOKACIJE
        {
            get
            {
                return this.m_ParameterIDLOKACIJE;
            }
            set
            {
                this.m_ParameterIDLOKACIJE = value;
            }
        }
    }
}
