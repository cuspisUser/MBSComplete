namespace NetAdvantage.Controls
{
    ...
    public class ORGJEDDataGrid : DeklaritDataGrid
    {
        private int currentRow;
        private ORGJEDDataSet dsORGJEDDataSet1 = new ORGJEDDataSet();
        ...
        private void BindDataGrid()
        {
            ...
            this.dv1.Table = this.dsORGJEDDataSet1.ORGJED;
        ...
        private void FillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    ...
                    {
                        this.DataAdapter.FillPage(this.dsORGJEDDataSet1, 0, this.PageSize);
                    }
                    else
                    {
                        MethodInfo info = this.DataAdapter.GetType().GetMethod("FillPageBy" + this.FillMethod.Substring(6));
                        this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsORGJEDDataSet1, info, 0, this.PageSize);
                    }
                }
                else if (this.FillMethod == "Fill")
                {
                    this.DataAdapter.Fill(this.dsORGJEDDataSet1);
                }
                else
                {
                    MethodInfo info2 = this.DataAdapter.GetType().GetMethod(this.FillMethod);
                    this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsORGJEDDataSet1, info2);
                }
        ...
        private void ReFillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    if (this.FillMethod == "Fill")
                    {
                        this.DataAdapter.FillPage(this.dsORGJEDDataSet1, this.startRowThread, this.PageSize);
                    }
                    else
                    {
                        MethodInfo info = this.DataAdapter.GetType().GetMethod("FillPageBy" + this.FillMethod.Substring(6));
                        this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsORGJEDDataSet1, info, this.startRowThread, this.PageSize);
                    }
                }
        ...
        public virtual IORGJEDDataAdapter DataAdapter
        {
            get
            {
                ...
                if (DataAdapterFactory.Provider != null)
                {
                    return DataAdapterFactory.GetORGJEDDataAdapter();
                }
                return null;
            }
        }
        ...
        public virtual ORGJEDDataSet DataSet
        {
            get
            {
                return this.dsORGJEDDataSet1;
            }
            set
            {
                this.dsORGJEDDataSet1 = value;
            }
        }
