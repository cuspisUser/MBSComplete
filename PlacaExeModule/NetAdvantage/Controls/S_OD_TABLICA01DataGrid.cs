namespace NetAdvantage.Controls
{
    ...
    public class S_OD_TABLICA01DataGrid : DeklaritDataGrid
    {
        private int currentRow;
        private S_OD_TABLICA01DataSet dsS_OD_TABLICA01DataSet1 = new S_OD_TABLICA01DataSet();
        ...
        private void BindDataGrid()
        {
            ...
            this.dv1.Table = this.dsS_OD_TABLICA01DataSet1.S_OD_TABLICA01;
        ...
        {
            this.PreFill();
            this.dsS_OD_TABLICA01DataSet1 = new S_OD_TABLICA01DataSet();
            this.m_StartRow = 0;
        ...
        private void FillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dsS_OD_TABLICA01DataSet1, this.m_ParameterGODINA, 0, this.PageSize);
                }
                else
                {
                    this.DataAdapter.Fill(this.dsS_OD_TABLICA01DataSet1, this.m_ParameterGODINA);
                }
        ...
        private void ReFillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dsS_OD_TABLICA01DataSet1, this.m_ParameterGODINA, this.startRowThread, this.PageSize);
                }
        ...
        private void ResumeBindingPostThread()
        {
            ...
            this.EndUpdate();
            this.BindDataGrid();
            this.Text = "S_OD_TABLICA01 : " + this.DataView.Count.ToString(CultureInfo.InvariantCulture) + " " + Deklarit.Resources.Resources.Rows;
        ...
        public virtual IS_OD_TABLICA01DataAdapter DataAdapter
        {
            get
            {
                ...
                if (DataAdapterFactory.Provider != null)
                {
                    return DataAdapterFactory.GetS_OD_TABLICA01DataAdapter();
                }
                return null;
            }
        }
        ...
        public virtual S_OD_TABLICA01DataSet DataSet
        {
            get
            {
                return this.dsS_OD_TABLICA01DataSet1;
            }
            set
            {
                this.dsS_OD_TABLICA01DataSet1 = value;
            }
        }
