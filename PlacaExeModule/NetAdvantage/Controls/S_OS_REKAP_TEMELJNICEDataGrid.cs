namespace NetAdvantage.Controls
{
    ...
    public class S_OS_REKAP_TEMELJNICEDataGrid : DeklaritDataGrid
    {
        private int currentRow;
        private S_OS_REKAP_TEMELJNICEDataSet dsS_OS_REKAP_TEMELJNICEDataSet1 = new S_OS_REKAP_TEMELJNICEDataSet();
        private System.Data.DataView dv1;
        private bool m_FillByPage = true;
        private bool m_GridLoading;
        private int m_PageSize = 60;
        private int m_ParameterBROJOSTEMELJNICE = 0;
        private int m_Parametervrstaostemeljnice = 0;
        private int m_StartRow;
        private int startRowThread;
        private const int WM_SETREDRAW = 11;

        public S_OS_REKAP_TEMELJNICEDataGrid()
        {
            this.BindDataGrid();
        ...
        private void BindDataGrid()
        {
            ...
            this.dv1.Table = this.dsS_OS_REKAP_TEMELJNICEDataSet1.S_OS_REKAP_TEMELJNICE;
        ...
        {
            this.PreFill();
            this.dsS_OS_REKAP_TEMELJNICEDataSet1 = new S_OS_REKAP_TEMELJNICEDataSet();
            this.m_StartRow = 0;
        ...
        private void FillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dsS_OS_REKAP_TEMELJNICEDataSet1, this.m_ParameterBROJOSTEMELJNICE, this.m_Parametervrstaostemeljnice, 0, this.PageSize);
                }
                else
                {
                    this.DataAdapter.Fill(this.dsS_OS_REKAP_TEMELJNICEDataSet1, this.m_ParameterBROJOSTEMELJNICE, this.m_Parametervrstaostemeljnice);
                }
        ...
        private void ReFillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dsS_OS_REKAP_TEMELJNICEDataSet1, this.m_ParameterBROJOSTEMELJNICE, this.m_Parametervrstaostemeljnice, this.startRowThread, this.PageSize);
                }
        ...
        private void ResumeBindingPostThread()
        {
            ...
            this.EndUpdate();
            this.BindDataGrid();
            this.Text = "S_OS_REKAP_TEMELJNICE : " + this.DataView.Count.ToString(CultureInfo.InvariantCulture) + " " + Deklarit.Resources.Resources.Rows;
        ...
        public virtual IS_OS_REKAP_TEMELJNICEDataAdapter DataAdapter
        {
            get
            {
                ...
                if (DataAdapterFactory.Provider != null)
                {
                    return DataAdapterFactory.GetS_OS_REKAP_TEMELJNICEDataAdapter();
                }
                return null;
            }
        }
        ...
        [Browsable(false), Category("Deklarit Work With ")]
        public virtual S_OS_REKAP_TEMELJNICEDataSet DataSet
        {
            get
            {
                return this.dsS_OS_REKAP_TEMELJNICEDataSet1;
            }
            set
            {
                this.dsS_OS_REKAP_TEMELJNICEDataSet1 = value;
            }
        }
        ...
        public virtual int ParameterBROJOSTEMELJNICE
        {
            get
            {
                return this.m_ParameterBROJOSTEMELJNICE;
            }
            set
            {
                this.m_ParameterBROJOSTEMELJNICE = value;
            }
        }
        ...
        public virtual int Parametervrstaostemeljnice
        {
            get
            {
                return this.m_Parametervrstaostemeljnice;
            }
            set
            {
                this.m_Parametervrstaostemeljnice = value;
            }
        }
    }
}
