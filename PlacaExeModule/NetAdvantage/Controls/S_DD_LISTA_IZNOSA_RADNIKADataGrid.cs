namespace NetAdvantage.Controls
{
    ...
    public class S_DD_LISTA_IZNOSA_RADNIKADataGrid : DeklaritDataGrid
    {
        private int currentRow;
        private S_DD_LISTA_IZNOSA_RADNIKADataSet dsS_DD_LISTA_IZNOSA_RADNIKADataSet1 = new S_DD_LISTA_IZNOSA_RADNIKADataSet();
        ...
        public S_DD_LISTA_IZNOSA_RADNIKADataGrid()
        {
            this.BindDataGrid();
        ...
        private void BindDataGrid()
        {
            ...
            this.dv1.Table = this.dsS_DD_LISTA_IZNOSA_RADNIKADataSet1.S_DD_LISTA_IZNOSA_RADNIKA;
        ...
        {
            this.PreFill();
            this.dsS_DD_LISTA_IZNOSA_RADNIKADataSet1 = new S_DD_LISTA_IZNOSA_RADNIKADataSet();
            this.m_StartRow = 0;
        ...
        private void FillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dsS_DD_LISTA_IZNOSA_RADNIKADataSet1, this.m_ParameterIDOBRACUN, this.m_ParameterSORT, 0, this.PageSize);
                }
                else
                {
                    this.DataAdapter.Fill(this.dsS_DD_LISTA_IZNOSA_RADNIKADataSet1, this.m_ParameterIDOBRACUN, this.m_ParameterSORT);
                }
        ...
        private void ReFillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dsS_DD_LISTA_IZNOSA_RADNIKADataSet1, this.m_ParameterIDOBRACUN, this.m_ParameterSORT, this.startRowThread, this.PageSize);
                }
        ...
        private void ResumeBindingPostThread()
        {
            ...
            this.EndUpdate();
            this.BindDataGrid();
            this.Text = "S_DD_LISTA_IZNOSA_RADNIKA : " + this.DataView.Count.ToString(CultureInfo.InvariantCulture) + " " + Deklarit.Resources.Resources.Rows;
        ...
        public virtual IS_DD_LISTA_IZNOSA_RADNIKADataAdapter DataAdapter
        {
            get
            {
                ...
                if (DataAdapterFactory.Provider != null)
                {
                    return DataAdapterFactory.GetS_DD_LISTA_IZNOSA_RADNIKADataAdapter();
                }
                return null;
            }
        }
        ...
        public virtual S_DD_LISTA_IZNOSA_RADNIKADataSet DataSet
        {
            get
            {
                return this.dsS_DD_LISTA_IZNOSA_RADNIKADataSet1;
            }
            set
            {
                this.dsS_DD_LISTA_IZNOSA_RADNIKADataSet1 = value;
            }
        }
