namespace NetAdvantage.Controls
{
    ...
    public class RACUNDataGrid : DeklaritDataGrid
    {
        private int currentRow;
        private RACUNDataSet dsRACUNDataSet1 = new RACUNDataSet();
        private System.Data.DataView dv1;
        private int m_FillByIDPARTNERIDPARTNER;
        private int m_FillByIDRACUNIDRACUN;
        private bool m_FillByPage = false;
        private short m_FillByRACUNGODINAIDGODINERACUNGODINAIDGODINE;
        ...
        public RACUNDataGrid()
        {
            this.BindDataGrid();
            DeklaritDataGrid.myFillMethods = new TypeConverter.StandardValuesCollection(new string[] { "Fill", "FillByIDPARTNER", "FillByRACUNGODINAIDGODINE", "FillByIDRACUN" });
        ...
        private void BindDataGrid()
        {
            ...
            this.dv1.Table = this.dsRACUNDataSet1.RACUN;
        ...
        private void FillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    ...
                    {
                        this.DataAdapter.FillPage(this.dsRACUNDataSet1, 0, this.PageSize);
                    }
                    else
                    {
                        MethodInfo info = this.DataAdapter.GetType().GetMethod("FillPageBy" + this.FillMethod.Substring(6));
                        this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsRACUNDataSet1, info, 0, this.PageSize);
                    }
                }
                else if (this.FillMethod == "Fill")
                {
                    this.DataAdapter.Fill(this.dsRACUNDataSet1);
                }
                else
                {
                    MethodInfo info2 = this.DataAdapter.GetType().GetMethod(this.FillMethod);
                    this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsRACUNDataSet1, info2);
                }
        ...
        private void ReFillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    if (this.FillMethod == "Fill")
                    {
                        this.DataAdapter.FillPage(this.dsRACUNDataSet1, this.startRowThread, this.PageSize);
                    }
                    else
                    {
                        MethodInfo info = this.DataAdapter.GetType().GetMethod("FillPageBy" + this.FillMethod.Substring(6));
                        this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsRACUNDataSet1, info, this.startRowThread, this.PageSize);
                    }
                }
        ...
        private void ResumeBindingPostThread()
        {
            ...
            this.EndUpdate();
            this.BindDataGrid();
            this.Text = "Izlazni računi : " + this.DataView.Count.ToString(CultureInfo.InvariantCulture) + " " + Deklarit.Resources.Resources.Rows;
        ...
        public virtual IRACUNDataAdapter DataAdapter
        {
            get
            {
                ...
                if (DataAdapterFactory.Provider != null)
                {
                    return DataAdapterFactory.GetRACUNDataAdapter();
                }
                return null;
            }
        }
        ...
        public virtual RACUNDataSet DataSet
        {
            get
            {
                return this.dsRACUNDataSet1;
            }
            set
            {
                this.dsRACUNDataSet1 = value;
            }
        }
        ...
        public virtual int FillByIDRACUNIDRACUN
        {
            get
            {
                return this.m_FillByIDRACUNIDRACUN;
            }
            set
            {
                this.m_FillByIDRACUNIDRACUN = value;
            }
        }
        ...
        public virtual short FillByRACUNGODINAIDGODINERACUNGODINAIDGODINE
        {
            get
            {
                return this.m_FillByRACUNGODINAIDGODINERACUNGODINAIDGODINE;
            }
            set
            {
                this.m_FillByRACUNGODINAIDGODINERACUNGODINAIDGODINE = value;
            }
        }
