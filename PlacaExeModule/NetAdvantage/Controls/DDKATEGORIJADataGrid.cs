namespace NetAdvantage.Controls
{
    ...
    public class DDKATEGORIJADataGrid : DeklaritDataGrid
    {
        private int currentRow;
        private DDKATEGORIJADataSet dsDDKATEGORIJADataSet1 = new DDKATEGORIJADataSet();
        private System.Data.DataView dv1;
        private int m_FillByIDKOLONAIDDIDKOLONAIDD;
        ...
        public DDKATEGORIJADataGrid()
        {
            this.BindDataGrid();
            DeklaritDataGrid.myFillMethods = new TypeConverter.StandardValuesCollection(new string[] { "Fill", "FillByIDKOLONAIDD" });
        ...
        private void BindDataGrid()
        {
            ...
            this.dv1.Table = this.dsDDKATEGORIJADataSet1.DDKATEGORIJA;
        ...
        private void FillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    ...
                    {
                        this.DataAdapter.FillPage(this.dsDDKATEGORIJADataSet1, 0, this.PageSize);
                    }
                    else
                    {
                        MethodInfo info = this.DataAdapter.GetType().GetMethod("FillPageBy" + this.FillMethod.Substring(6));
                        this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsDDKATEGORIJADataSet1, info, 0, this.PageSize);
                    }
                }
                else if (this.FillMethod == "Fill")
                {
                    this.DataAdapter.Fill(this.dsDDKATEGORIJADataSet1);
                }
                else
                {
                    MethodInfo info2 = this.DataAdapter.GetType().GetMethod(this.FillMethod);
                    this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsDDKATEGORIJADataSet1, info2);
                }
        ...
        private void ReFillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    if (this.FillMethod == "Fill")
                    {
                        this.DataAdapter.FillPage(this.dsDDKATEGORIJADataSet1, this.startRowThread, this.PageSize);
                    }
                    else
                    {
                        MethodInfo info = this.DataAdapter.GetType().GetMethod("FillPageBy" + this.FillMethod.Substring(6));
                        this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsDDKATEGORIJADataSet1, info, this.startRowThread, this.PageSize);
                    }
                }
        ...
        private void ResumeBindingPostThread()
        {
            ...
            this.EndUpdate();
            this.BindDataGrid();
            this.Text = "Kategorija drugog dohotka : " + this.DataView.Count.ToString(CultureInfo.InvariantCulture) + " " + Deklarit.Resources.Resources.Rows;
        ...
        public virtual IDDKATEGORIJADataAdapter DataAdapter
        {
            get
            {
                ...
                if (DataAdapterFactory.Provider != null)
                {
                    return DataAdapterFactory.GetDDKATEGORIJADataAdapter();
                }
                return null;
            }
        }
        ...
        [Category("Deklarit Work With "), Browsable(false)]
        public virtual DDKATEGORIJADataSet DataSet
        {
            get
            {
                return this.dsDDKATEGORIJADataSet1;
            }
            set
            {
                this.dsDDKATEGORIJADataSet1 = value;
            }
        }
        ...
        public virtual int FillByIDKOLONAIDDIDKOLONAIDD
        {
            get
            {
                return this.m_FillByIDKOLONAIDDIDKOLONAIDD;
            }
            set
            {
                this.m_FillByIDKOLONAIDDIDKOLONAIDD = value;
            }
        }
