namespace NetAdvantage.Controls
{
    ...
    public class GODINA_I_MJESEC_OBRACUNADataGrid : DeklaritDataGrid
    {
        private int currentRow;
        private GODINA_I_MJESEC_OBRACUNADataSet dsGODINA_I_MJESEC_OBRACUNADataSet1 = new GODINA_I_MJESEC_OBRACUNADataSet();
        ...
        public GODINA_I_MJESEC_OBRACUNADataGrid()
        {
            this.BindDataGrid();
        ...
        private void BindDataGrid()
        {
            ...
            this.dv1.Table = this.dsGODINA_I_MJESEC_OBRACUNADataSet1.GODINA_I_MJESEC_OBRACUNA;
        ...
        {
            this.PreFill();
            this.dsGODINA_I_MJESEC_OBRACUNADataSet1 = new GODINA_I_MJESEC_OBRACUNADataSet();
            this.m_StartRow = 0;
        ...
        private void FillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dsGODINA_I_MJESEC_OBRACUNADataSet1, 0, this.PageSize);
                }
                else
                {
                    this.DataAdapter.Fill(this.dsGODINA_I_MJESEC_OBRACUNADataSet1);
                }
        ...
        private void ReFillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dsGODINA_I_MJESEC_OBRACUNADataSet1, this.startRowThread, this.PageSize);
                }
        ...
        private void ResumeBindingPostThread()
        {
            ...
            this.EndUpdate();
            this.BindDataGrid();
            this.Text = "GODINA_I_MJESEC_OBRACUNA : " + this.DataView.Count.ToString(CultureInfo.InvariantCulture) + " " + Deklarit.Resources.Resources.Rows;
        ...
        public virtual IGODINA_I_MJESEC_OBRACUNADataAdapter DataAdapter
        {
            get
            {
                ...
                if (DataAdapterFactory.Provider != null)
                {
                    return DataAdapterFactory.GetGODINA_I_MJESEC_OBRACUNADataAdapter();
                }
                return null;
            }
        }
        ...
        public virtual GODINA_I_MJESEC_OBRACUNADataSet DataSet
        {
            get
            {
                return this.dsGODINA_I_MJESEC_OBRACUNADataSet1;
            }
            set
            {
                this.dsGODINA_I_MJESEC_OBRACUNADataSet1 = value;
            }
        }
