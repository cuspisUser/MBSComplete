namespace NetAdvantage.Controls
{
    ...
    public class V_DD_PREGLED_OBRACUNADataGrid : DeklaritDataGrid
    {
        private int currentRow;
        private V_DD_PREGLED_OBRACUNADataSet dsV_DD_PREGLED_OBRACUNADataSet1 = new V_DD_PREGLED_OBRACUNADataSet();
        ...
        public V_DD_PREGLED_OBRACUNADataGrid()
        {
            this.BindDataGrid();
        ...
        private void BindDataGrid()
        {
            ...
            this.dv1.Table = this.dsV_DD_PREGLED_OBRACUNADataSet1.V_DD_PREGLED_OBRACUNA;
        ...
        {
            this.PreFill();
            this.dsV_DD_PREGLED_OBRACUNADataSet1 = new V_DD_PREGLED_OBRACUNADataSet();
            this.m_StartRow = 0;
        ...
        private void FillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dsV_DD_PREGLED_OBRACUNADataSet1, 0, this.PageSize);
                }
                else
                {
                    this.DataAdapter.Fill(this.dsV_DD_PREGLED_OBRACUNADataSet1);
                }
        ...
        private void ReFillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dsV_DD_PREGLED_OBRACUNADataSet1, this.startRowThread, this.PageSize);
                }
        ...
        private void ResumeBindingPostThread()
        {
            ...
            this.EndUpdate();
            this.BindDataGrid();
            this.Text = "V_DD_PREGLED_OBRACUNA : " + this.DataView.Count.ToString(CultureInfo.InvariantCulture) + " " + Deklarit.Resources.Resources.Rows;
        ...
        public virtual IV_DD_PREGLED_OBRACUNADataAdapter DataAdapter
        {
            get
            {
                ...
                if (DataAdapterFactory.Provider != null)
                {
                    return DataAdapterFactory.GetV_DD_PREGLED_OBRACUNADataAdapter();
                }
                return null;
            }
        }
        ...
        public virtual V_DD_PREGLED_OBRACUNADataSet DataSet
        {
            get
            {
                return this.dsV_DD_PREGLED_OBRACUNADataSet1;
            }
            set
            {
                this.dsV_DD_PREGLED_OBRACUNADataSet1 = value;
            }
        }
