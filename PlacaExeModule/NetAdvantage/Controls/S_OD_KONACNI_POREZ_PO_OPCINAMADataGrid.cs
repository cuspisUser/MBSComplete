namespace NetAdvantage.Controls
{
    ...
    public class S_OD_KONACNI_POREZ_PO_OPCINAMADataGrid : DeklaritDataGrid
    {
        private int currentRow;
        private S_OD_KONACNI_POREZ_PO_OPCINAMADataSet dsS_OD_KONACNI_POREZ_PO_OPCINAMADataSet1 = new S_OD_KONACNI_POREZ_PO_OPCINAMADataSet();
        ...
        public S_OD_KONACNI_POREZ_PO_OPCINAMADataGrid()
        {
            this.BindDataGrid();
        ...
        private void BindDataGrid()
        {
            ...
            this.dv1.Table = this.dsS_OD_KONACNI_POREZ_PO_OPCINAMADataSet1.S_OD_KONACNI_POREZ_PO_OPCINAMA;
        ...
        {
            this.PreFill();
            this.dsS_OD_KONACNI_POREZ_PO_OPCINAMADataSet1 = new S_OD_KONACNI_POREZ_PO_OPCINAMADataSet();
            this.m_StartRow = 0;
        ...
        private void FillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dsS_OD_KONACNI_POREZ_PO_OPCINAMADataSet1, this.m_Parameteridobracun, 0, this.PageSize);
                }
                else
                {
                    this.DataAdapter.Fill(this.dsS_OD_KONACNI_POREZ_PO_OPCINAMADataSet1, this.m_Parameteridobracun);
                }
        ...
        private void ReFillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dsS_OD_KONACNI_POREZ_PO_OPCINAMADataSet1, this.m_Parameteridobracun, this.startRowThread, this.PageSize);
                }
        ...
        private void ResumeBindingPostThread()
        {
            ...
            this.EndUpdate();
            this.BindDataGrid();
            this.Text = "S_OD_KONACNI_POREZ_PO_OPCINAMA : " + this.DataView.Count.ToString(CultureInfo.InvariantCulture) + " " + Deklarit.Resources.Resources.Rows;
        ...
        public virtual IS_OD_KONACNI_POREZ_PO_OPCINAMADataAdapter DataAdapter
        {
            get
            {
                ...
                if (DataAdapterFactory.Provider != null)
                {
                    return DataAdapterFactory.GetS_OD_KONACNI_POREZ_PO_OPCINAMADataAdapter();
                }
                return null;
            }
        }
        ...
        [Category("Deklarit Work With "), Browsable(false)]
        public virtual S_OD_KONACNI_POREZ_PO_OPCINAMADataSet DataSet
        {
            get
            {
                return this.dsS_OD_KONACNI_POREZ_PO_OPCINAMADataSet1;
            }
            set
            {
                this.dsS_OD_KONACNI_POREZ_PO_OPCINAMADataSet1 = value;
            }
        }
