namespace NetAdvantage.Controls
{
    ...
    public class S_OD_KRIZNI_POREZDataGrid : DeklaritDataGrid
    {
        private int currentRow;
        private S_OD_KRIZNI_POREZDataSet dsS_OD_KRIZNI_POREZDataSet1 = new S_OD_KRIZNI_POREZDataSet();
        ...
        public S_OD_KRIZNI_POREZDataGrid()
        {
            this.BindDataGrid();
        ...
        private void BindDataGrid()
        {
            ...
            this.dv1.Table = this.dsS_OD_KRIZNI_POREZDataSet1.S_OD_KRIZNI_POREZ;
        ...
        {
            this.PreFill();
            this.dsS_OD_KRIZNI_POREZDataSet1 = new S_OD_KRIZNI_POREZDataSet();
            this.m_StartRow = 0;
        ...
        private void FillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dsS_OD_KRIZNI_POREZDataSet1, this.m_ParameterIDOBRACUN, this.m_ParameterMJESECISPLATE, this.m_ParameterGODINAISPLATE, 0, this.PageSize);
                }
                else
                {
                    this.DataAdapter.Fill(this.dsS_OD_KRIZNI_POREZDataSet1, this.m_ParameterIDOBRACUN, this.m_ParameterMJESECISPLATE, this.m_ParameterGODINAISPLATE);
                }
        ...
        private void ReFillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dsS_OD_KRIZNI_POREZDataSet1, this.m_ParameterIDOBRACUN, this.m_ParameterMJESECISPLATE, this.m_ParameterGODINAISPLATE, this.startRowThread, this.PageSize);
                }
        ...
        private void ResumeBindingPostThread()
        {
            ...
            this.EndUpdate();
            this.BindDataGrid();
            this.Text = "S_OD_KRIZNI_POREZ : " + this.DataView.Count.ToString(CultureInfo.InvariantCulture) + " " + Deklarit.Resources.Resources.Rows;
        ...
        public virtual IS_OD_KRIZNI_POREZDataAdapter DataAdapter
        {
            get
            {
                ...
                if (DataAdapterFactory.Provider != null)
                {
                    return DataAdapterFactory.GetS_OD_KRIZNI_POREZDataAdapter();
                }
                return null;
            }
        }
        ...
        [Category("Deklarit Work With "), Browsable(false)]
        public virtual S_OD_KRIZNI_POREZDataSet DataSet
        {
            get
            {
                return this.dsS_OD_KRIZNI_POREZDataSet1;
            }
            set
            {
                this.dsS_OD_KRIZNI_POREZDataSet1 = value;
            }
        }
