namespace NetAdvantage.Controls
{
    ...
    public class trazi_partneraDataGrid : DeklaritDataGrid
    {
        ...
        private void BindDataGrid()
        {
            ...
            this.dv1.Table = this.dstrazi_partneraDataSet1.PARTNER;
        ...
        {
            this.PreFill();
            this.dstrazi_partneraDataSet1 = new trazi_partneraDataSet();
            this.m_StartRow = 0;
        ...
        private void FillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dstrazi_partneraDataSet1, this.m_ParameterNAZIVPARTNER, 0, this.PageSize);
                }
                else
                {
        ...
        private void ReFillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dstrazi_partneraDataSet1, this.m_ParameterNAZIVPARTNER, this.startRowThread, this.PageSize);
                }
        ...
        private void ResumeBindingPostThread()
        {
            ...
            this.EndUpdate();
            this.BindDataGrid();
            this.Text = "trazi_partnera : " + this.DataView.Count.ToString(CultureInfo.InvariantCulture) + " " + Deklarit.Resources.Resources.Rows;
        ...
        public virtual Itrazi_partneraDataAdapter DataAdapter
        {
            get
            {
