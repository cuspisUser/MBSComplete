namespace NetAdvantage.Controls
{
    ...
    public class OBUSTAVADataGrid : DeklaritDataGrid
    {
        private int currentRow;
        private OBUSTAVADataSet dsOBUSTAVADataSet1 = new OBUSTAVADataSet();
        private System.Data.DataView dv1;
        private bool m_FillByPage = false;
        private short m_FillByVRSTAOBUSTAVEVRSTAOBUSTAVE;
        ...
        public OBUSTAVADataGrid()
        {
            this.BindDataGrid();
            DeklaritDataGrid.myFillMethods = new TypeConverter.StandardValuesCollection(new string[] { "Fill", "FillByVRSTAOBUSTAVE" });
        ...
        private void BindDataGrid()
        {
            ...
            this.dv1.Table = this.dsOBUSTAVADataSet1.OBUSTAVA;
        ...
        private void FillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    ...
                    {
                        this.DataAdapter.FillPage(this.dsOBUSTAVADataSet1, 0, this.PageSize);
                    }
                    else
                    {
                        MethodInfo info = this.DataAdapter.GetType().GetMethod("FillPageBy" + this.FillMethod.Substring(6));
                        this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsOBUSTAVADataSet1, info, 0, this.PageSize);
                    }
                }
                else if (this.FillMethod == "Fill")
                {
                    this.DataAdapter.Fill(this.dsOBUSTAVADataSet1);
                }
                else
                {
                    MethodInfo info2 = this.DataAdapter.GetType().GetMethod(this.FillMethod);
                    this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsOBUSTAVADataSet1, info2);
                }
        ...
        private void ReFillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    if (this.FillMethod == "Fill")
                    {
                        this.DataAdapter.FillPage(this.dsOBUSTAVADataSet1, this.startRowThread, this.PageSize);
                    }
                    else
                    {
                        MethodInfo info = this.DataAdapter.GetType().GetMethod("FillPageBy" + this.FillMethod.Substring(6));
                        this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsOBUSTAVADataSet1, info, this.startRowThread, this.PageSize);
                    }
                }
        ...
        private void ResumeBindingPostThread()
        {
            ...
            this.EndUpdate();
            this.BindDataGrid();
            this.Text = "Obustave : " + this.DataView.Count.ToString(CultureInfo.InvariantCulture) + " " + Deklarit.Resources.Resources.Rows;
        ...
        public virtual IOBUSTAVADataAdapter DataAdapter
        {
            get
            {
                ...
                if (DataAdapterFactory.Provider != null)
                {
                    return DataAdapterFactory.GetOBUSTAVADataAdapter();
                }
                return null;
            }
        }
        ...
        [Browsable(false), Category("Deklarit Work With ")]
        public virtual OBUSTAVADataSet DataSet
        {
            get
            {
                return this.dsOBUSTAVADataSet1;
            }
            set
            {
                this.dsOBUSTAVADataSet1 = value;
            }
        }
        ...
        public virtual short FillByVRSTAOBUSTAVEVRSTAOBUSTAVE
        {
            get
            {
                return this.m_FillByVRSTAOBUSTAVEVRSTAOBUSTAVE;
            }
            set
            {
                this.m_FillByVRSTAOBUSTAVEVRSTAOBUSTAVE = value;
            }
        }
