namespace NetAdvantage.Controls
{
    ...
    public class RAD1SPREMEVEZADataGrid : DeklaritDataGrid
    {
        private int currentRow;
        private RAD1SPREMEVEZADataSet dsRAD1SPREMEVEZADataSet1 = new RAD1SPREMEVEZADataSet();
        private System.Data.DataView dv1;
        private int m_FillByIDSTRUCNASPREMAIDSTRUCNASPREMA;
        private bool m_FillByPage = false;
        private int m_FillByRAD1IDSPREMERAD1IDSPREME;
        ...
        public RAD1SPREMEVEZADataGrid()
        {
            this.BindDataGrid();
            DeklaritDataGrid.myFillMethods = new TypeConverter.StandardValuesCollection(new string[] { "Fill", "FillByIDSTRUCNASPREMA", "FillByRAD1IDSPREME" });
        ...
        private void BindDataGrid()
        {
            ...
            this.dv1.Table = this.dsRAD1SPREMEVEZADataSet1.RAD1SPREMEVEZA;
        ...
        private void FillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    ...
                    {
                        this.DataAdapter.FillPage(this.dsRAD1SPREMEVEZADataSet1, 0, this.PageSize);
                    }
                    else
                    {
                        MethodInfo info = this.DataAdapter.GetType().GetMethod("FillPageBy" + this.FillMethod.Substring(6));
                        this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsRAD1SPREMEVEZADataSet1, info, 0, this.PageSize);
                    }
                }
                else if (this.FillMethod == "Fill")
                {
                    this.DataAdapter.Fill(this.dsRAD1SPREMEVEZADataSet1);
                }
                else
                {
                    MethodInfo info2 = this.DataAdapter.GetType().GetMethod(this.FillMethod);
                    this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsRAD1SPREMEVEZADataSet1, info2);
                }
        ...
        private void ReFillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    if (this.FillMethod == "Fill")
                    {
                        this.DataAdapter.FillPage(this.dsRAD1SPREMEVEZADataSet1, this.startRowThread, this.PageSize);
                    }
                    else
                    {
                        MethodInfo info = this.DataAdapter.GetType().GetMethod("FillPageBy" + this.FillMethod.Substring(6));
                        this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsRAD1SPREMEVEZADataSet1, info, this.startRowThread, this.PageSize);
                    }
                }
        ...
        private void ResumeBindingPostThread()
        {
            ...
            this.EndUpdate();
            this.BindDataGrid();
            this.Text = "Veza RAD1 i strucne spreme : " + this.DataView.Count.ToString(CultureInfo.InvariantCulture) + " " + Deklarit.Resources.Resources.Rows;
        ...
        public virtual IRAD1SPREMEVEZADataAdapter DataAdapter
        {
            get
            {
                ...
                if (DataAdapterFactory.Provider != null)
                {
                    return DataAdapterFactory.GetRAD1SPREMEVEZADataAdapter();
                }
                return null;
            }
        }
        ...
        public virtual RAD1SPREMEVEZADataSet DataSet
        {
            get
            {
                return this.dsRAD1SPREMEVEZADataSet1;
            }
            set
            {
                this.dsRAD1SPREMEVEZADataSet1 = value;
            }
        }
        ...
        public virtual int FillByIDSTRUCNASPREMAIDSTRUCNASPREMA
        {
            get
            {
                return this.m_FillByIDSTRUCNASPREMAIDSTRUCNASPREMA;
            }
            set
            {
                this.m_FillByIDSTRUCNASPREMAIDSTRUCNASPREMA = value;
            }
        }
        ...
        public virtual int FillByRAD1IDSPREMERAD1IDSPREME
        {
            get
            {
                return this.m_FillByRAD1IDSPREMERAD1IDSPREME;
            }
            set
            {
                this.m_FillByRAD1IDSPREMERAD1IDSPREME = value;
            }
        }
