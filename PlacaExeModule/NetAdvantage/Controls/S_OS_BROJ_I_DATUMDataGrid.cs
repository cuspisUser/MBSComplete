namespace NetAdvantage.Controls
{
    ...
    public class S_OS_BROJ_I_DATUMDataGrid : DeklaritDataGrid
    {
        private int currentRow;
        private S_OS_BROJ_I_DATUMDataSet dsS_OS_BROJ_I_DATUMDataSet1 = new S_OS_BROJ_I_DATUMDataSet();
        ...
        public S_OS_BROJ_I_DATUMDataGrid()
        {
            this.BindDataGrid();
        ...
        private void BindDataGrid()
        {
            ...
            this.dv1.Table = this.dsS_OS_BROJ_I_DATUMDataSet1.S_OS_BROJ_I_DATUM;
        ...
        {
            this.PreFill();
            this.dsS_OS_BROJ_I_DATUMDataSet1 = new S_OS_BROJ_I_DATUMDataSet();
            this.m_StartRow = 0;
        ...
        private void FillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dsS_OS_BROJ_I_DATUMDataSet1, 0, this.PageSize);
                }
                else
                {
                    this.DataAdapter.Fill(this.dsS_OS_BROJ_I_DATUMDataSet1);
                }
        ...
        private void ReFillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dsS_OS_BROJ_I_DATUMDataSet1, this.startRowThread, this.PageSize);
                }
        ...
        private void ResumeBindingPostThread()
        {
            ...
            this.EndUpdate();
            this.BindDataGrid();
            this.Text = "S_OS_BROJ_I_DATUM : " + this.DataView.Count.ToString(CultureInfo.InvariantCulture) + " " + Deklarit.Resources.Resources.Rows;
        ...
        public virtual IS_OS_BROJ_I_DATUMDataAdapter DataAdapter
        {
            get
            {
                ...
                if (DataAdapterFactory.Provider != null)
                {
                    return DataAdapterFactory.GetS_OS_BROJ_I_DATUMDataAdapter();
                }
                return null;
            }
        }
        ...
        [Browsable(false), Category("Deklarit Work With ")]
        public virtual S_OS_BROJ_I_DATUMDataSet DataSet
        {
            get
            {
                return this.dsS_OS_BROJ_I_DATUMDataSet1;
            }
            set
            {
                this.dsS_OS_BROJ_I_DATUMDataSet1 = value;
            }
        }
