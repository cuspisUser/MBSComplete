namespace NetAdvantage.Controls
{
    ...
    public class V_DD_GODINE_ISPLATEDataGrid : DeklaritDataGrid
    {
        private int currentRow;
        private V_DD_GODINE_ISPLATEDataSet dsV_DD_GODINE_ISPLATEDataSet1 = new V_DD_GODINE_ISPLATEDataSet();
        ...
        public V_DD_GODINE_ISPLATEDataGrid()
        {
            this.BindDataGrid();
        ...
        private void BindDataGrid()
        {
            ...
            this.dv1.Table = this.dsV_DD_GODINE_ISPLATEDataSet1.V_DD_GODINE_ISPLATE;
        ...
        {
            this.PreFill();
            this.dsV_DD_GODINE_ISPLATEDataSet1 = new V_DD_GODINE_ISPLATEDataSet();
            this.m_StartRow = 0;
        ...
        private void FillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dsV_DD_GODINE_ISPLATEDataSet1, 0, this.PageSize);
                }
                else
                {
                    this.DataAdapter.Fill(this.dsV_DD_GODINE_ISPLATEDataSet1);
                }
        ...
        private void ReFillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dsV_DD_GODINE_ISPLATEDataSet1, this.startRowThread, this.PageSize);
                }
        ...
        private void ResumeBindingPostThread()
        {
            ...
            this.EndUpdate();
            this.BindDataGrid();
            this.Text = "V_DD_GODINE_ISPLATE : " + this.DataView.Count.ToString(CultureInfo.InvariantCulture) + " " + Deklarit.Resources.Resources.Rows;
        ...
        public virtual IV_DD_GODINE_ISPLATEDataAdapter DataAdapter
        {
            get
            {
                ...
                if (DataAdapterFactory.Provider != null)
                {
                    return DataAdapterFactory.GetV_DD_GODINE_ISPLATEDataAdapter();
                }
                return null;
            }
        }
        ...
        public virtual V_DD_GODINE_ISPLATEDataSet DataSet
        {
            get
            {
                return this.dsV_DD_GODINE_ISPLATEDataSet1;
            }
            set
            {
                this.dsV_DD_GODINE_ISPLATEDataSet1 = value;
            }
        }
