namespace NetAdvantage.Controls
{
    ...
    public class S_DD_IPPDataGrid : DeklaritDataGrid
    {
        private int currentRow;
        private S_DD_IPPDataSet dsS_DD_IPPDataSet1 = new S_DD_IPPDataSet();
        ...
        private void BindDataGrid()
        {
            ...
            this.dv1.Table = this.dsS_DD_IPPDataSet1.S_DD_IPP;
        ...
        private void FillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dsS_DD_IPPDataSet1, this.m_ParameterMJESEC, this.m_ParameterGODINA, 0, this.PageSize);
                }
                else
                {
                    this.DataAdapter.Fill(this.dsS_DD_IPPDataSet1, this.m_ParameterMJESEC, this.m_ParameterGODINA);
                }
        ...
        private void ReFillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dsS_DD_IPPDataSet1, this.m_ParameterMJESEC, this.m_ParameterGODINA, this.startRowThread, this.PageSize);
                }
        ...
        private void ResumeBindingPostThread()
        {
            ...
            this.EndUpdate();
            this.BindDataGrid();
            this.Text = "S_DD_IPP : " + this.DataView.Count.ToString(CultureInfo.InvariantCulture) + " " + Deklarit.Resources.Resources.Rows;
        ...
        public virtual IS_DD_IPPDataAdapter DataAdapter
        {
            get
            {
                ...
                if (DataAdapterFactory.Provider != null)
                {
                    return DataAdapterFactory.GetS_DD_IPPDataAdapter();
                }
                return null;
            }
        }
        ...
        [Browsable(false), Category("Deklarit Work With ")]
        public virtual S_DD_IPPDataSet DataSet
        {
            get
            {
                return this.dsS_DD_IPPDataSet1;
            }
            set
            {
                this.dsS_DD_IPPDataSet1 = value;
            }
        }
