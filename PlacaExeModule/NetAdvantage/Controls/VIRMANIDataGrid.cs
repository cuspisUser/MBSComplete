namespace NetAdvantage.Controls
{
    ...
    public class VIRMANIDataGrid : DeklaritDataGrid
    {
        private int currentRow;
        private VIRMANIDataSet dsVIRMANIDataSet1 = new VIRMANIDataSet();
        private System.Data.DataView dv1;
        private bool m_FillByPage = false;
        private string m_FillBySIFRAOBRACUNAVIRMANSIFRAOBRACUNAVIRMAN;
        ...
        public VIRMANIDataGrid()
        {
            this.BindDataGrid();
            DeklaritDataGrid.myFillMethods = new TypeConverter.StandardValuesCollection(new string[] { "Fill", "FillBySIFRAOBRACUNAVIRMAN" });
        ...
        private void BindDataGrid()
        {
            ...
            this.dv1.Table = this.dsVIRMANIDataSet1.VIRMANI;
        ...
        private void FillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    ...
                    {
                        this.DataAdapter.FillPage(this.dsVIRMANIDataSet1, 0, this.PageSize);
                    }
                    else
                    {
                        MethodInfo info = this.DataAdapter.GetType().GetMethod("FillPageBy" + this.FillMethod.Substring(6));
                        this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsVIRMANIDataSet1, info, 0, this.PageSize);
                    }
                }
                else if (this.FillMethod == "Fill")
                {
                    this.DataAdapter.Fill(this.dsVIRMANIDataSet1);
                }
                else
                {
                    MethodInfo info2 = this.DataAdapter.GetType().GetMethod(this.FillMethod);
                    this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsVIRMANIDataSet1, info2);
                }
        ...
        private void ReFillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    if (this.FillMethod == "Fill")
                    {
                        this.DataAdapter.FillPage(this.dsVIRMANIDataSet1, this.startRowThread, this.PageSize);
                    }
                    else
                    {
                        MethodInfo info = this.DataAdapter.GetType().GetMethod("FillPageBy" + this.FillMethod.Substring(6));
                        this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsVIRMANIDataSet1, info, this.startRowThread, this.PageSize);
                    }
                }
        ...
        private void ResumeBindingPostThread()
        {
            ...
            this.EndUpdate();
            this.BindDataGrid();
            this.Text = "VIRMANI : " + this.DataView.Count.ToString(CultureInfo.InvariantCulture) + " " + Deklarit.Resources.Resources.Rows;
        ...
        public virtual IVIRMANIDataAdapter DataAdapter
        {
            get
            {
                ...
                if (DataAdapterFactory.Provider != null)
                {
                    return DataAdapterFactory.GetVIRMANIDataAdapter();
                }
                return null;
            }
        }
        ...
        public virtual VIRMANIDataSet DataSet
        {
            get
            {
                return this.dsVIRMANIDataSet1;
            }
            set
            {
                this.dsVIRMANIDataSet1 = value;
            }
        }
        ...
        public virtual string FillBySIFRAOBRACUNAVIRMANSIFRAOBRACUNAVIRMAN
        {
            get
            {
                return this.m_FillBySIFRAOBRACUNAVIRMANSIFRAOBRACUNAVIRMAN;
            }
            set
            {
                this.m_FillBySIFRAOBRACUNAVIRMANSIFRAOBRACUNAVIRMAN = value;
            }
        }
