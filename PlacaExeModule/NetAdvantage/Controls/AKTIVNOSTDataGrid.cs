namespace NetAdvantage.Controls
{
    ...
    public class AKTIVNOSTDataGrid : DeklaritDataGrid
    {
        private int currentRow;
        private AKTIVNOSTDataSet dsAKTIVNOSTDataSet1 = new AKTIVNOSTDataSet();
        ...
        private void BindDataGrid()
        {
            ...
            this.dv1.Table = this.dsAKTIVNOSTDataSet1.AKTIVNOST;
        ...
        {
            this.PreFill();
            this.dsAKTIVNOSTDataSet1 = new AKTIVNOSTDataSet();
            this.m_StartRow = 0;
        ...
        private void FillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    ...
                    {
                        this.DataAdapter.FillPage(this.dsAKTIVNOSTDataSet1, 0, this.PageSize);
                    }
                    else
                    {
                        MethodInfo info = this.DataAdapter.GetType().GetMethod("FillPageBy" + this.FillMethod.Substring(6));
                        this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsAKTIVNOSTDataSet1, info, 0, this.PageSize);
                    }
                }
                else if (this.FillMethod == "Fill")
                {
                    this.DataAdapter.Fill(this.dsAKTIVNOSTDataSet1);
                }
                else
                {
                    MethodInfo info2 = this.DataAdapter.GetType().GetMethod(this.FillMethod);
                    this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsAKTIVNOSTDataSet1, info2);
                }
        ...
        private void ReFillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    if (this.FillMethod == "Fill")
                    {
                        this.DataAdapter.FillPage(this.dsAKTIVNOSTDataSet1, this.startRowThread, this.PageSize);
                    }
                    else
                    {
                        MethodInfo info = this.DataAdapter.GetType().GetMethod("FillPageBy" + this.FillMethod.Substring(6));
                        this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsAKTIVNOSTDataSet1, info, this.startRowThread, this.PageSize);
                    }
                }
        ...
        private void ResumeBindingPostThread()
        {
            ...
            this.EndUpdate();
            this.BindDataGrid();
            this.Text = "Aktivnosti konta : " + this.DataView.Count.ToString(CultureInfo.InvariantCulture) + " " + Deklarit.Resources.Resources.Rows;
        ...
        public virtual IAKTIVNOSTDataAdapter DataAdapter
        {
            get
            {
                ...
                if (DataAdapterFactory.Provider != null)
                {
                    return DataAdapterFactory.GetAKTIVNOSTDataAdapter();
                }
                return null;
            }
        }
        ...
        public virtual AKTIVNOSTDataSet DataSet
        {
            get
            {
                return this.dsAKTIVNOSTDataSet1;
            }
            set
            {
                this.dsAKTIVNOSTDataSet1 = value;
            }
        }
