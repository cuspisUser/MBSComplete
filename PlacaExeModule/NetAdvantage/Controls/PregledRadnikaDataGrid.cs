namespace NetAdvantage.Controls
{
    ...
    public class PregledRadnikaDataGrid : DeklaritDataGrid
    {
        ...
        private void BindDataGrid()
        {
            ...
            this.dv1.Table = this.dsPregledRadnikaDataSet1.RADNIK;
        ...
        {
            this.PreFill();
            this.dsPregledRadnikaDataSet1 = new PregledRadnikaDataSet();
            this.m_StartRow = 0;
        ...
        private void FillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dsPregledRadnikaDataSet1, 0, this.PageSize);
                }
                else
                {
        ...
        private void ReFillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dsPregledRadnikaDataSet1, this.startRowThread, this.PageSize);
                }
        ...
        private void ResumeBindingPostThread()
        {
            ...
            this.EndUpdate();
            this.BindDataGrid();
            this.Text = "PregledRadnika : " + this.DataView.Count.ToString(CultureInfo.InvariantCulture) + " " + Deklarit.Resources.Resources.Rows;
        ...
        public virtual IPregledRadnikaDataAdapter DataAdapter
        {
            get
            {
