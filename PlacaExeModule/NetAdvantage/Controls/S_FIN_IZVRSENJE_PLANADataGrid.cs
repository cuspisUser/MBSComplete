namespace NetAdvantage.Controls
{
    ...
    public class S_FIN_IZVRSENJE_PLANADataGrid : DeklaritDataGrid
    {
        private int currentRow;
        private S_FIN_IZVRSENJE_PLANADataSet dsS_FIN_IZVRSENJE_PLANADataSet1 = new S_FIN_IZVRSENJE_PLANADataSet();
        ...
        private int m_ParameterIDORGJED = 0;
        private int m_StartRow;
        private int startRowThread;
        private const int WM_SETREDRAW = 11;

        public S_FIN_IZVRSENJE_PLANADataGrid()
        {
            this.BindDataGrid();
        ...
        private void BindDataGrid()
        {
            ...
            this.dv1.Table = this.dsS_FIN_IZVRSENJE_PLANADataSet1.S_FIN_IZVRSENJE_PLANA;
        ...
        {
            this.PreFill();
            this.dsS_FIN_IZVRSENJE_PLANADataSet1 = new S_FIN_IZVRSENJE_PLANADataSet();
            this.m_StartRow = 0;
        ...
        private void FillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dsS_FIN_IZVRSENJE_PLANADataSet1, this.m_ParameterIDORGJED, this.m_Parametergodina, 0, this.PageSize);
                }
                else
                {
                    this.DataAdapter.Fill(this.dsS_FIN_IZVRSENJE_PLANADataSet1, this.m_ParameterIDORGJED, this.m_Parametergodina);
                }
        ...
        private void ReFillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dsS_FIN_IZVRSENJE_PLANADataSet1, this.m_ParameterIDORGJED, this.m_Parametergodina, this.startRowThread, this.PageSize);
                }
        ...
        private void ResumeBindingPostThread()
        {
            ...
            this.EndUpdate();
            this.BindDataGrid();
            this.Text = "S_FIN_IZVRSENJE_PLANA : " + this.DataView.Count.ToString(CultureInfo.InvariantCulture) + " " + Deklarit.Resources.Resources.Rows;
        ...
        public virtual IS_FIN_IZVRSENJE_PLANADataAdapter DataAdapter
        {
            get
            {
                ...
                if (DataAdapterFactory.Provider != null)
                {
                    return DataAdapterFactory.GetS_FIN_IZVRSENJE_PLANADataAdapter();
                }
                return null;
            }
        }
        ...
        [Browsable(false), Category("Deklarit Work With ")]
        public virtual S_FIN_IZVRSENJE_PLANADataSet DataSet
        {
            get
            {
                return this.dsS_FIN_IZVRSENJE_PLANADataSet1;
            }
            set
            {
                this.dsS_FIN_IZVRSENJE_PLANADataSet1 = value;
            }
        }
        ...
        public virtual int ParameterIDORGJED
        {
            get
            {
                return this.m_ParameterIDORGJED;
            }
            set
            {
                this.m_ParameterIDORGJED = value;
            }
        }
    }
}
