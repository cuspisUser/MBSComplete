namespace NetAdvantage.Controls
{
    ...
    public class ZATVARANJADataGrid : DeklaritDataGrid
    {
        private int currentRow;
        private ZATVARANJADataSet dsZATVARANJADataSet1 = new ZATVARANJADataSet();
        private System.Data.DataView dv1;
        private int m_FillByGK1IDGKSTAVKAGK1IDGKSTAVKA;
        private int m_FillByGK2IDGKSTAVKAGK2IDGKSTAVKA;
        ...
        public ZATVARANJADataGrid()
        {
            this.BindDataGrid();
            DeklaritDataGrid.myFillMethods = new TypeConverter.StandardValuesCollection(new string[] { "Fill", "FillByGK2IDGKSTAVKA", "FillByGK1IDGKSTAVKA" });
        ...
        private void BindDataGrid()
        {
            ...
            this.dv1.Table = this.dsZATVARANJADataSet1.ZATVARANJA;
        ...
        private void FillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    ...
                    {
                        this.DataAdapter.FillPage(this.dsZATVARANJADataSet1, 0, this.PageSize);
                    }
                    else
                    {
                        MethodInfo info = this.DataAdapter.GetType().GetMethod("FillPageBy" + this.FillMethod.Substring(6));
                        this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsZATVARANJADataSet1, info, 0, this.PageSize);
                    }
                }
                else if (this.FillMethod == "Fill")
                {
                    this.DataAdapter.Fill(this.dsZATVARANJADataSet1);
                }
                else
                {
                    MethodInfo info2 = this.DataAdapter.GetType().GetMethod(this.FillMethod);
                    this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsZATVARANJADataSet1, info2);
                }
        ...
        private void ReFillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    if (this.FillMethod == "Fill")
                    {
                        this.DataAdapter.FillPage(this.dsZATVARANJADataSet1, this.startRowThread, this.PageSize);
                    }
                    else
                    {
                        MethodInfo info = this.DataAdapter.GetType().GetMethod("FillPageBy" + this.FillMethod.Substring(6));
                        this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsZATVARANJADataSet1, info, this.startRowThread, this.PageSize);
                    }
                }
        ...
        private void ResumeBindingPostThread()
        {
            ...
            this.EndUpdate();
            this.BindDataGrid();
            this.Text = "ZATVARANJA : " + this.DataView.Count.ToString(CultureInfo.InvariantCulture) + " " + Deklarit.Resources.Resources.Rows;
        ...
        public virtual IZATVARANJADataAdapter DataAdapter
        {
            get
            {
                ...
                if (DataAdapterFactory.Provider != null)
                {
                    return DataAdapterFactory.GetZATVARANJADataAdapter();
                }
                return null;
            }
        }
        ...
        public virtual ZATVARANJADataSet DataSet
        {
            get
            {
                return this.dsZATVARANJADataSet1;
            }
            set
            {
                this.dsZATVARANJADataSet1 = value;
            }
        }
        ...
        public virtual int FillByGK1IDGKSTAVKAGK1IDGKSTAVKA
        {
            get
            {
                return this.m_FillByGK1IDGKSTAVKAGK1IDGKSTAVKA;
            }
            set
            {
                this.m_FillByGK1IDGKSTAVKAGK1IDGKSTAVKA = value;
            }
        }
        ...
        public virtual int FillByGK2IDGKSTAVKAGK2IDGKSTAVKA
        {
            get
            {
                return this.m_FillByGK2IDGKSTAVKAGK2IDGKSTAVKA;
            }
            set
            {
                this.m_FillByGK2IDGKSTAVKAGK2IDGKSTAVKA = value;
            }
        }
