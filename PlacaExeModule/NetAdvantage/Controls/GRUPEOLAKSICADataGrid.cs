namespace NetAdvantage.Controls
{
    ...
    public class GRUPEOLAKSICADataGrid : DeklaritDataGrid
    {
        private int currentRow;
        private GRUPEOLAKSICADataSet dsGRUPEOLAKSICADataSet1 = new GRUPEOLAKSICADataSet();
        ...
        private void BindDataGrid()
        {
            ...
            this.dv1.Table = this.dsGRUPEOLAKSICADataSet1.GRUPEOLAKSICA;
        ...
        private void FillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    ...
                    {
                        this.DataAdapter.FillPage(this.dsGRUPEOLAKSICADataSet1, 0, this.PageSize);
                    }
                    else
                    {
                        MethodInfo info = this.DataAdapter.GetType().GetMethod("FillPageBy" + this.FillMethod.Substring(6));
                        this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsGRUPEOLAKSICADataSet1, info, 0, this.PageSize);
                    }
                }
                else if (this.FillMethod == "Fill")
                {
                    this.DataAdapter.Fill(this.dsGRUPEOLAKSICADataSet1);
                }
                else
                {
                    MethodInfo info2 = this.DataAdapter.GetType().GetMethod(this.FillMethod);
                    this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsGRUPEOLAKSICADataSet1, info2);
                }
        ...
        private void ReFillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    if (this.FillMethod == "Fill")
                    {
                        this.DataAdapter.FillPage(this.dsGRUPEOLAKSICADataSet1, this.startRowThread, this.PageSize);
                    }
                    else
                    {
                        MethodInfo info = this.DataAdapter.GetType().GetMethod("FillPageBy" + this.FillMethod.Substring(6));
                        this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsGRUPEOLAKSICADataSet1, info, this.startRowThread, this.PageSize);
                    }
                }
        ...
        private void ResumeBindingPostThread()
        {
            ...
            this.EndUpdate();
            this.BindDataGrid();
            this.Text = "Grupe olakšica : " + this.DataView.Count.ToString(CultureInfo.InvariantCulture) + " " + Deklarit.Resources.Resources.Rows;
        ...
        public virtual IGRUPEOLAKSICADataAdapter DataAdapter
        {
            get
            {
                ...
                if (DataAdapterFactory.Provider != null)
                {
                    return DataAdapterFactory.GetGRUPEOLAKSICADataAdapter();
                }
                return null;
            }
        }
        ...
        public virtual GRUPEOLAKSICADataSet DataSet
        {
            get
            {
                return this.dsGRUPEOLAKSICADataSet1;
            }
            set
            {
                this.dsGRUPEOLAKSICADataSet1 = value;
            }
        }
