namespace NetAdvantage.Controls
{
    ...
    public class OLAKSICEDataGrid : DeklaritDataGrid
    {
        private int currentRow;
        private OLAKSICEDataSet dsOLAKSICEDataSet1 = new OLAKSICEDataSet();
        private System.Data.DataView dv1;
        private int m_FillByIDGRUPEOLAKSICAIDGRUPEOLAKSICA;
        private int m_FillByIDTIPOLAKSICEIDTIPOLAKSICE;
        ...
        public OLAKSICEDataGrid()
        {
            this.BindDataGrid();
            DeklaritDataGrid.myFillMethods = new TypeConverter.StandardValuesCollection(new string[] { "Fill", "FillByIDGRUPEOLAKSICA", "FillByIDTIPOLAKSICE" });
        ...
        private void BindDataGrid()
        {
            ...
            this.dv1.Table = this.dsOLAKSICEDataSet1.OLAKSICE;
        ...
        private void FillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    ...
                    {
                        this.DataAdapter.FillPage(this.dsOLAKSICEDataSet1, 0, this.PageSize);
                    }
                    else
                    {
                        MethodInfo info = this.DataAdapter.GetType().GetMethod("FillPageBy" + this.FillMethod.Substring(6));
                        this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsOLAKSICEDataSet1, info, 0, this.PageSize);
                    }
                }
                else if (this.FillMethod == "Fill")
                {
                    this.DataAdapter.Fill(this.dsOLAKSICEDataSet1);
                }
                else
                {
                    MethodInfo info2 = this.DataAdapter.GetType().GetMethod(this.FillMethod);
                    this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsOLAKSICEDataSet1, info2);
                }
        ...
        private void ReFillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    if (this.FillMethod == "Fill")
                    {
                        this.DataAdapter.FillPage(this.dsOLAKSICEDataSet1, this.startRowThread, this.PageSize);
                    }
                    else
                    {
                        MethodInfo info = this.DataAdapter.GetType().GetMethod("FillPageBy" + this.FillMethod.Substring(6));
                        this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsOLAKSICEDataSet1, info, this.startRowThread, this.PageSize);
                    }
                }
        ...
        private void ResumeBindingPostThread()
        {
            ...
            this.EndUpdate();
            this.BindDataGrid();
            this.Text = "Osiguranja-Olakšice : " + this.DataView.Count.ToString(CultureInfo.InvariantCulture) + " " + Deklarit.Resources.Resources.Rows;
        ...
        public virtual IOLAKSICEDataAdapter DataAdapter
        {
            get
            {
                ...
                if (DataAdapterFactory.Provider != null)
                {
                    return DataAdapterFactory.GetOLAKSICEDataAdapter();
                }
                return null;
            }
        }
        ...
        public virtual OLAKSICEDataSet DataSet
        {
            get
            {
                return this.dsOLAKSICEDataSet1;
            }
            set
            {
                this.dsOLAKSICEDataSet1 = value;
            }
        }
        ...
        public virtual int FillByIDGRUPEOLAKSICAIDGRUPEOLAKSICA
        {
            get
            {
                return this.m_FillByIDGRUPEOLAKSICAIDGRUPEOLAKSICA;
            }
            set
            {
                this.m_FillByIDGRUPEOLAKSICAIDGRUPEOLAKSICA = value;
            }
        }
        ...
        public virtual int FillByIDTIPOLAKSICEIDTIPOLAKSICE
        {
            get
            {
                return this.m_FillByIDTIPOLAKSICEIDTIPOLAKSICE;
            }
            set
            {
                this.m_FillByIDTIPOLAKSICEIDTIPOLAKSICE = value;
            }
        }
