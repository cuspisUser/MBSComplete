namespace NetAdvantage.Controls
{
    ...
    public class SHEMAIRADataGrid : DeklaritDataGrid
    {
        private int currentRow;
        private SHEMAIRADataSet dsSHEMAIRADataSet1 = new SHEMAIRADataSet();
        private System.Data.DataView dv1;
        private bool m_FillByPage = false;
        private int m_FillBySHEMAIRADOKIDDOKUMENTSHEMAIRADOKIDDOKUMENT;
        ...
        public SHEMAIRADataGrid()
        {
            this.BindDataGrid();
            DeklaritDataGrid.myFillMethods = new TypeConverter.StandardValuesCollection(new string[] { "Fill", "FillBySHEMAIRADOKIDDOKUMENT" });
        ...
        private void BindDataGrid()
        {
            ...
            this.dv1.Table = this.dsSHEMAIRADataSet1.SHEMAIRA;
        ...
        private void FillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    ...
                    {
                        this.DataAdapter.FillPage(this.dsSHEMAIRADataSet1, 0, this.PageSize);
                    }
                    else
                    {
                        MethodInfo info = this.DataAdapter.GetType().GetMethod("FillPageBy" + this.FillMethod.Substring(6));
                        this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsSHEMAIRADataSet1, info, 0, this.PageSize);
                    }
                }
                else if (this.FillMethod == "Fill")
                {
                    this.DataAdapter.Fill(this.dsSHEMAIRADataSet1);
                }
                else
                {
                    MethodInfo info2 = this.DataAdapter.GetType().GetMethod(this.FillMethod);
                    this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsSHEMAIRADataSet1, info2);
                }
        ...
        private void ReFillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    if (this.FillMethod == "Fill")
                    {
                        this.DataAdapter.FillPage(this.dsSHEMAIRADataSet1, this.startRowThread, this.PageSize);
                    }
                    else
                    {
                        MethodInfo info = this.DataAdapter.GetType().GetMethod("FillPageBy" + this.FillMethod.Substring(6));
                        this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsSHEMAIRADataSet1, info, this.startRowThread, this.PageSize);
                    }
                }
        ...
        private void ResumeBindingPostThread()
        {
            ...
            this.EndUpdate();
            this.BindDataGrid();
            this.Text = "Shema kontiranja IRA : " + this.DataView.Count.ToString(CultureInfo.InvariantCulture) + " " + Deklarit.Resources.Resources.Rows;
        ...
        public virtual ISHEMAIRADataAdapter DataAdapter
        {
            get
            {
                ...
                if (DataAdapterFactory.Provider != null)
                {
                    return DataAdapterFactory.GetSHEMAIRADataAdapter();
                }
                return null;
            }
        }
        ...
        [Category("Deklarit Work With "), Browsable(false)]
        public virtual SHEMAIRADataSet DataSet
        {
            get
            {
                return this.dsSHEMAIRADataSet1;
            }
            set
            {
                this.dsSHEMAIRADataSet1 = value;
            }
        }
        ...
        public virtual int FillBySHEMAIRADOKIDDOKUMENTSHEMAIRADOKIDDOKUMENT
        {
            get
            {
                return this.m_FillBySHEMAIRADOKIDDOKUMENTSHEMAIRADOKIDDOKUMENT;
            }
            set
            {
                this.m_FillBySHEMAIRADOKIDDOKUMENTSHEMAIRADOKIDDOKUMENT = value;
            }
        }
