namespace NetAdvantage.Controls
{
    ...
    public class RadnikZaObracunDataGrid : DeklaritDataGrid
    {
        ...
        public RadnikZaObracunDataGrid()
        {
            this.BindDataGrid();
        ...
        private void ResumeBindingPostThread()
        {
            ...
            this.EndUpdate();
            this.BindDataGrid();
            this.Text = "RadnikZaObracun : " + this.DataView.Count.ToString(CultureInfo.InvariantCulture) + " " + Deklarit.Resources.Resources.Rows;
        ...
        public virtual IRadnikZaObracunDataAdapter DataAdapter
        {
            get
            {
                ...
                if (DataAdapterFactory.Provider != null)
                {
                    return DataAdapterFactory.GetRadnikZaObracunDataAdapter();
                }
                return null;
            }
        }
