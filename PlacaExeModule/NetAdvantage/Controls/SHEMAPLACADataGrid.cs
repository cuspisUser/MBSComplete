namespace NetAdvantage.Controls
{
    ...
    public class SHEMAPLACADataGrid : DeklaritDataGrid
    {
        private int currentRow;
        private SHEMAPLACADataSet dsSHEMAPLACADataSet1 = new SHEMAPLACADataSet();
        private System.Data.DataView dv1;
        private bool m_FillByPage = false;
        private int m_FillBySHEMAPLOJIDORGJEDSHEMAPLOJIDORGJED;
        ...
        public SHEMAPLACADataGrid()
        {
            this.BindDataGrid();
            DeklaritDataGrid.myFillMethods = new TypeConverter.StandardValuesCollection(new string[] { "Fill", "FillBySHEMAPLOJIDORGJED" });
        ...
        private void BindDataGrid()
        {
            ...
            this.dv1.Table = this.dsSHEMAPLACADataSet1.SHEMAPLACA;
        ...
        private void FillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    ...
                    {
                        this.DataAdapter.FillPage(this.dsSHEMAPLACADataSet1, 0, this.PageSize);
                    }
                    else
                    {
                        MethodInfo info = this.DataAdapter.GetType().GetMethod("FillPageBy" + this.FillMethod.Substring(6));
                        this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsSHEMAPLACADataSet1, info, 0, this.PageSize);
                    }
                }
                else if (this.FillMethod == "Fill")
                {
                    this.DataAdapter.Fill(this.dsSHEMAPLACADataSet1);
                }
                else
                {
                    MethodInfo info2 = this.DataAdapter.GetType().GetMethod(this.FillMethod);
                    this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsSHEMAPLACADataSet1, info2);
                }
        ...
        private void ReFillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    if (this.FillMethod == "Fill")
                    {
                        this.DataAdapter.FillPage(this.dsSHEMAPLACADataSet1, this.startRowThread, this.PageSize);
                    }
                    else
                    {
                        MethodInfo info = this.DataAdapter.GetType().GetMethod("FillPageBy" + this.FillMethod.Substring(6));
                        this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsSHEMAPLACADataSet1, info, this.startRowThread, this.PageSize);
                    }
                }
        ...
        private void ResumeBindingPostThread()
        {
            ...
            this.EndUpdate();
            this.BindDataGrid();
            this.Text = "Shema place : " + this.DataView.Count.ToString(CultureInfo.InvariantCulture) + " " + Deklarit.Resources.Resources.Rows;
        ...
        public virtual ISHEMAPLACADataAdapter DataAdapter
        {
            get
            {
                ...
                if (DataAdapterFactory.Provider != null)
                {
                    return DataAdapterFactory.GetSHEMAPLACADataAdapter();
                }
                return null;
            }
        }
        ...
        public virtual SHEMAPLACADataSet DataSet
        {
            get
            {
                return this.dsSHEMAPLACADataSet1;
            }
            set
            {
                this.dsSHEMAPLACADataSet1 = value;
            }
        }
        ...
        public virtual int FillBySHEMAPLOJIDORGJEDSHEMAPLOJIDORGJED
        {
            get
            {
                return this.m_FillBySHEMAPLOJIDORGJEDSHEMAPLOJIDORGJED;
            }
            set
            {
                this.m_FillBySHEMAPLOJIDORGJEDSHEMAPLOJIDORGJED = value;
            }
        }
