namespace NetAdvantage.Controls
{
    ...
    public class S_OD_IP_ZBIRNIDataGrid : DeklaritDataGrid
    {
        private int currentRow;
        private S_OD_IP_ZBIRNIDataSet dsS_OD_IP_ZBIRNIDataSet1 = new S_OD_IP_ZBIRNIDataSet();
        ...
        private void BindDataGrid()
        {
            ...
            this.dv1.Table = this.dsS_OD_IP_ZBIRNIDataSet1.S_OD_IP_ZBIRNI;
        ...
        {
            this.PreFill();
            this.dsS_OD_IP_ZBIRNIDataSet1 = new S_OD_IP_ZBIRNIDataSet();
            this.m_StartRow = 0;
        ...
        private void FillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dsS_OD_IP_ZBIRNIDataSet1, this.m_ParameterGODINA, 0, this.PageSize);
                }
                else
                {
                    this.DataAdapter.Fill(this.dsS_OD_IP_ZBIRNIDataSet1, this.m_ParameterGODINA);
                }
        ...
        private void ReFillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dsS_OD_IP_ZBIRNIDataSet1, this.m_ParameterGODINA, this.startRowThread, this.PageSize);
                }
        ...
        private void ResumeBindingPostThread()
        {
            ...
            this.EndUpdate();
            this.BindDataGrid();
            this.Text = "S_OD_IP_ZBIRNI : " + this.DataView.Count.ToString(CultureInfo.InvariantCulture) + " " + Deklarit.Resources.Resources.Rows;
        ...
        public virtual IS_OD_IP_ZBIRNIDataAdapter DataAdapter
        {
            get
            {
                ...
                if (DataAdapterFactory.Provider != null)
                {
                    return DataAdapterFactory.GetS_OD_IP_ZBIRNIDataAdapter();
                }
                return null;
            }
        }
        ...
        [Category("Deklarit Work With "), Browsable(false)]
        public virtual S_OD_IP_ZBIRNIDataSet DataSet
        {
            get
            {
                return this.dsS_OD_IP_ZBIRNIDataSet1;
            }
            set
            {
                this.dsS_OD_IP_ZBIRNIDataSet1 = value;
            }
        }
