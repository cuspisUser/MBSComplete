namespace NetAdvantage.Controls
{
    ...
    public class PRPLACEDataGrid : DeklaritDataGrid
    {
        private int currentRow;
        private PRPLACEDataSet dsPRPLACEDataSet1 = new PRPLACEDataSet();
        private System.Data.DataView dv1;
        private bool m_FillByPage = false;
        private int m_FillByPRPLACEIDPRPLACEID;
        private int m_FillByPRPLACEIDPRPLACEZAMJESECPRPLACEID;
        private short m_FillByPRPLACEIDPRPLACEZAMJESECPRPLACEZAMJESEC;
        ...
        public PRPLACEDataGrid()
        {
            this.BindDataGrid();
            DeklaritDataGrid.myFillMethods = new TypeConverter.StandardValuesCollection(new string[] { "Fill", "FillByPRPLACEID", "FillByPRPLACEIDPRPLACEZAMJESEC" });
        ...
        private void FillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    ...
                    {
                        this.DataAdapter.FillPage(this.dsPRPLACEDataSet1, 0, this.PageSize);
                    }
                    else
                    {
                        MethodInfo info = this.DataAdapter.GetType().GetMethod("FillPageBy" + this.FillMethod.Substring(6));
                        this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsPRPLACEDataSet1, info, 0, this.PageSize);
                    }
                }
                else if (this.FillMethod == "Fill")
                {
                    this.DataAdapter.Fill(this.dsPRPLACEDataSet1);
                }
                else
                {
                    MethodInfo info2 = this.DataAdapter.GetType().GetMethod(this.FillMethod);
                    this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsPRPLACEDataSet1, info2);
                }
        ...
        private void ReFillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    if (this.FillMethod == "Fill")
                    {
                        this.DataAdapter.FillPage(this.dsPRPLACEDataSet1, this.startRowThread, this.PageSize);
                    }
                    else
                    {
                        MethodInfo info = this.DataAdapter.GetType().GetMethod("FillPageBy" + this.FillMethod.Substring(6));
                        this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsPRPLACEDataSet1, info, this.startRowThread, this.PageSize);
                    }
                }
        ...
        private void ResumeBindingPostThread()
        {
            ...
            this.EndUpdate();
            this.BindDataGrid();
            this.Text = "Priprema plaae : " + this.DataView.Count.ToString(CultureInfo.InvariantCulture) + " " + Deklarit.Resources.Resources.Rows;
        ...
        public virtual IPRPLACEDataAdapter DataAdapter
        {
            get
            {
                ...
                if (DataAdapterFactory.Provider != null)
                {
                    return DataAdapterFactory.GetPRPLACEDataAdapter();
                }
                return null;
            }
        }
        ...
        public virtual PRPLACEDataSet DataSet
        {
            get
            {
                return this.dsPRPLACEDataSet1;
            }
            set
            {
                this.dsPRPLACEDataSet1 = value;
            }
        }
        ...
        public virtual int FillByPRPLACEIDPRPLACEID
        {
            get
            {
                return this.m_FillByPRPLACEIDPRPLACEID;
            }
            set
            {
                this.m_FillByPRPLACEIDPRPLACEID = value;
            }
        }
        ...
        public virtual int FillByPRPLACEIDPRPLACEZAMJESECPRPLACEID
        {
            get
            {
                return this.m_FillByPRPLACEIDPRPLACEZAMJESECPRPLACEID;
            }
            set
            {
                this.m_FillByPRPLACEIDPRPLACEZAMJESECPRPLACEID = value;
            }
        }
        ...
        public virtual short FillByPRPLACEIDPRPLACEZAMJESECPRPLACEZAMJESEC
        {
            get
            {
                return this.m_FillByPRPLACEIDPRPLACEZAMJESECPRPLACEZAMJESEC;
            }
            set
            {
                this.m_FillByPRPLACEIDPRPLACEZAMJESECPRPLACEZAMJESEC = value;
            }
        }
