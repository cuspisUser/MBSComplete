namespace NetAdvantage.Controls
{
    ...
    public class DDVRSTEPOSLADataGrid : DeklaritDataGrid
    {
        private int currentRow;
        private DDVRSTEPOSLADataSet dsDDVRSTEPOSLADataSet1 = new DDVRSTEPOSLADataSet();
        ...
        private void BindDataGrid()
        {
            ...
            this.dv1.Table = this.dsDDVRSTEPOSLADataSet1.DDVRSTEPOSLA;
        ...
        private void FillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    ...
                    {
                        this.DataAdapter.FillPage(this.dsDDVRSTEPOSLADataSet1, 0, this.PageSize);
                    }
                    else
                    {
                        MethodInfo info = this.DataAdapter.GetType().GetMethod("FillPageBy" + this.FillMethod.Substring(6));
                        this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsDDVRSTEPOSLADataSet1, info, 0, this.PageSize);
                    }
                }
                else if (this.FillMethod == "Fill")
                {
                    this.DataAdapter.Fill(this.dsDDVRSTEPOSLADataSet1);
                }
                else
                {
                    MethodInfo info2 = this.DataAdapter.GetType().GetMethod(this.FillMethod);
                    this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsDDVRSTEPOSLADataSet1, info2);
                }
        ...
        private void ReFillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    if (this.FillMethod == "Fill")
                    {
                        this.DataAdapter.FillPage(this.dsDDVRSTEPOSLADataSet1, this.startRowThread, this.PageSize);
                    }
                    else
                    {
                        MethodInfo info = this.DataAdapter.GetType().GetMethod("FillPageBy" + this.FillMethod.Substring(6));
                        this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsDDVRSTEPOSLADataSet1, info, this.startRowThread, this.PageSize);
                    }
                }
        ...
        private void ResumeBindingPostThread()
        {
            ...
            this.EndUpdate();
            this.BindDataGrid();
            this.Text = "Vrste posla : " + this.DataView.Count.ToString(CultureInfo.InvariantCulture) + " " + Deklarit.Resources.Resources.Rows;
        ...
        public virtual IDDVRSTEPOSLADataAdapter DataAdapter
        {
            get
            {
                ...
                if (DataAdapterFactory.Provider != null)
                {
                    return DataAdapterFactory.GetDDVRSTEPOSLADataAdapter();
                }
                return null;
            }
        }
        ...
        public virtual DDVRSTEPOSLADataSet DataSet
        {
            get
            {
                return this.dsDDVRSTEPOSLADataSet1;
            }
            set
            {
                this.dsDDVRSTEPOSLADataSet1 = value;
            }
        }
