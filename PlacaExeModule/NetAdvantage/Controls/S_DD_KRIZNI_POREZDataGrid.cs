namespace NetAdvantage.Controls
{
    ...
    public class S_DD_KRIZNI_POREZDataGrid : DeklaritDataGrid
    {
        private int currentRow;
        private S_DD_KRIZNI_POREZDataSet dsS_DD_KRIZNI_POREZDataSet1 = new S_DD_KRIZNI_POREZDataSet();
        ...
        public S_DD_KRIZNI_POREZDataGrid()
        {
            this.BindDataGrid();
        ...
        private void BindDataGrid()
        {
            ...
            this.dv1.Table = this.dsS_DD_KRIZNI_POREZDataSet1.S_DD_KRIZNI_POREZ;
        ...
        {
            this.PreFill();
            this.dsS_DD_KRIZNI_POREZDataSet1 = new S_DD_KRIZNI_POREZDataSet();
            this.m_StartRow = 0;
        ...
        private void FillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dsS_DD_KRIZNI_POREZDataSet1, this.m_ParameterIDOBRACUN, this.m_ParameterMJESECISPLATE, this.m_ParameterGODINAISPLATE, 0, this.PageSize);
                }
                else
                {
                    this.DataAdapter.Fill(this.dsS_DD_KRIZNI_POREZDataSet1, this.m_ParameterIDOBRACUN, this.m_ParameterMJESECISPLATE, this.m_ParameterGODINAISPLATE);
                }
        ...
        private void ReFillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dsS_DD_KRIZNI_POREZDataSet1, this.m_ParameterIDOBRACUN, this.m_ParameterMJESECISPLATE, this.m_ParameterGODINAISPLATE, this.startRowThread, this.PageSize);
                }
        ...
        private void ResumeBindingPostThread()
        {
            ...
            this.EndUpdate();
            this.BindDataGrid();
            this.Text = "S_DD_KRIZNI_POREZ : " + this.DataView.Count.ToString(CultureInfo.InvariantCulture) + " " + Deklarit.Resources.Resources.Rows;
        ...
        public virtual IS_DD_KRIZNI_POREZDataAdapter DataAdapter
        {
            get
            {
                ...
                if (DataAdapterFactory.Provider != null)
                {
                    return DataAdapterFactory.GetS_DD_KRIZNI_POREZDataAdapter();
                }
                return null;
            }
        }
        ...
        [Browsable(false), Category("Deklarit Work With ")]
        public virtual S_DD_KRIZNI_POREZDataSet DataSet
        {
            get
            {
                return this.dsS_DD_KRIZNI_POREZDataSet1;
            }
            set
            {
                this.dsS_DD_KRIZNI_POREZDataSet1 = value;
            }
        }
