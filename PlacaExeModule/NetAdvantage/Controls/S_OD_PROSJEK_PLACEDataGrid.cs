namespace NetAdvantage.Controls
{
    ...
    public class S_OD_PROSJEK_PLACEDataGrid : DeklaritDataGrid
    {
        private int currentRow;
        private S_OD_PROSJEK_PLACEDataSet dsS_OD_PROSJEK_PLACEDataSet1 = new S_OD_PROSJEK_PLACEDataSet();
        ...
        public S_OD_PROSJEK_PLACEDataGrid()
        {
            this.BindDataGrid();
        ...
        private void BindDataGrid()
        {
            ...
            this.dv1.Table = this.dsS_OD_PROSJEK_PLACEDataSet1.S_OD_PROSJEK_PLACE;
        ...
        {
            this.PreFill();
            this.dsS_OD_PROSJEK_PLACEDataSet1 = new S_OD_PROSJEK_PLACEDataSet();
            this.m_StartRow = 0;
        ...
        private void FillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dsS_OD_PROSJEK_PLACEDataSet1, this.m_ParameterODD, this.m_ParameterDOOO, this.m_ParameterIDRADNIK, 0, this.PageSize);
                }
                else
                {
                    this.DataAdapter.Fill(this.dsS_OD_PROSJEK_PLACEDataSet1, this.m_ParameterODD, this.m_ParameterDOOO, this.m_ParameterIDRADNIK);
                }
        ...
        private void ReFillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dsS_OD_PROSJEK_PLACEDataSet1, this.m_ParameterODD, this.m_ParameterDOOO, this.m_ParameterIDRADNIK, this.startRowThread, this.PageSize);
                }
        ...
        private void ResumeBindingPostThread()
        {
            ...
            this.EndUpdate();
            this.BindDataGrid();
            this.Text = "S_OD_PROSJEK_PLACE : " + this.DataView.Count.ToString(CultureInfo.InvariantCulture) + " " + Deklarit.Resources.Resources.Rows;
        ...
        public virtual IS_OD_PROSJEK_PLACEDataAdapter DataAdapter
        {
            get
            {
                ...
                if (DataAdapterFactory.Provider != null)
                {
                    return DataAdapterFactory.GetS_OD_PROSJEK_PLACEDataAdapter();
                }
                return null;
            }
        }
        ...
        [Category("Deklarit Work With "), Browsable(false)]
        public virtual S_OD_PROSJEK_PLACEDataSet DataSet
        {
            get
            {
                return this.dsS_OD_PROSJEK_PLACEDataSet1;
            }
            set
            {
                this.dsS_OD_PROSJEK_PLACEDataSet1 = value;
            }
        }
