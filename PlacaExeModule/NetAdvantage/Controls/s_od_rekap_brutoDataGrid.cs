namespace NetAdvantage.Controls
{
    ...
    public class s_od_rekap_brutoDataGrid : DeklaritDataGrid
    {
        private int currentRow;
        private s_od_rekap_brutoDataSet dss_od_rekap_brutoDataSet1 = new s_od_rekap_brutoDataSet();
        ...
        public s_od_rekap_brutoDataGrid()
        {
            this.BindDataGrid();
        ...
        private void BindDataGrid()
        {
            ...
            this.dv1.Table = this.dss_od_rekap_brutoDataSet1.s_od_rekap_bruto;
        ...
        {
            this.PreFill();
            this.dss_od_rekap_brutoDataSet1 = new s_od_rekap_brutoDataSet();
            this.m_StartRow = 0;
        ...
        private void FillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dss_od_rekap_brutoDataSet1, this.m_Parameteridobracun, 0, this.PageSize);
                }
                else
                {
                    this.DataAdapter.Fill(this.dss_od_rekap_brutoDataSet1, this.m_Parameteridobracun);
                }
        ...
        private void ReFillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dss_od_rekap_brutoDataSet1, this.m_Parameteridobracun, this.startRowThread, this.PageSize);
                }
        ...
        private void ResumeBindingPostThread()
        {
            ...
            this.EndUpdate();
            this.BindDataGrid();
            this.Text = "s_od_rekap_bruto : " + this.DataView.Count.ToString(CultureInfo.InvariantCulture) + " " + Deklarit.Resources.Resources.Rows;
        ...
        public virtual Is_od_rekap_brutoDataAdapter DataAdapter
        {
            get
            {
                ...
                if (DataAdapterFactory.Provider != null)
                {
                    return DataAdapterFactory.Gets_od_rekap_brutoDataAdapter();
                }
                return null;
            }
        }
        ...
        [Browsable(false), Category("Deklarit Work With ")]
        public virtual s_od_rekap_brutoDataSet DataSet
        {
            get
            {
                return this.dss_od_rekap_brutoDataSet1;
            }
            set
            {
                this.dss_od_rekap_brutoDataSet1 = value;
            }
        }
