namespace NetAdvantage.Controls
{
    ...
    public class STRUKAComboBox : DeklaritComboBox
    {
        private System.Data.DataSet m_DataSet = new STRUKADataSet();
        protected string m_FillMethod = "Fill";

        public STRUKAComboBox()
        {
            this.Text = "IDSTRUKA";
            DataView defaultView = this.DataSet.Tables["STRUKA"].DefaultView;
            defaultView.Sort = "NAZIVSTRUKA";
            this.DisplayMember = "NAZIVSTRUKA";
            this.ValueMember = "IDSTRUKA";
        ...
        protected override void InitLayout()
        {
            ...
            if (!this.DesignMode && this.FillAtStartup)
            {
                ...
                {
                    DataView view = ComboHelper.GetComboValues(this.DataSet, "STRUKA", "IDSTRUKA", "NAZIVSTRUKA", true, "<" + Deklarit.Resources.Resources.Empty + ">");
                    this.DataSource = null;
                    view.Sort = "Name";
        ...
        public ISTRUKADataAdapter DataAdapter
        {
            get
            {
