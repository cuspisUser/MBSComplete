namespace NetAdvantage.Controls
{
    ...
    public class PROVIDER_BRUTODataGrid : DeklaritDataGrid
    {
        ...
        private void BindDataGrid()
        {
            ...
            this.dv1.Table = this.dsPROVIDER_BRUTODataSet1.ELEMENT;
        ...
        {
            this.PreFill();
            this.dsPROVIDER_BRUTODataSet1 = new PROVIDER_BRUTODataSet();
            this.m_StartRow = 0;
        ...
        private void FillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dsPROVIDER_BRUTODataSet1, 0, this.PageSize);
                }
                else
                {
        ...
        private void ReFillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dsPROVIDER_BRUTODataSet1, this.startRowThread, this.PageSize);
                }
        ...
        private void ResumeBindingPostThread()
        {
            ...
            this.EndUpdate();
            this.BindDataGrid();
            this.Text = "PROVIDER_BRUTO : " + this.DataView.Count.ToString(CultureInfo.InvariantCulture) + " " + Deklarit.Resources.Resources.Rows;
        ...
        public virtual IPROVIDER_BRUTODataAdapter DataAdapter
        {
            get
            {
