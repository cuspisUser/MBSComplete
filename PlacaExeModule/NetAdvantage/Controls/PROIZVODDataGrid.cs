namespace NetAdvantage.Controls
{
    ...
    public class PROIZVODDataGrid : DeklaritDataGrid
    {
        private int currentRow;
        private PROIZVODDataSet dsPROIZVODDataSet1 = new PROIZVODDataSet();
        private System.Data.DataView dv1;
        private int m_FillByFINPOREZIDPOREZFINPOREZIDPOREZ;
        private int m_FillByIDJEDINICAMJEREIDJEDINICAMJERE;
        ...
        public PROIZVODDataGrid()
        {
            this.BindDataGrid();
            DeklaritDataGrid.myFillMethods = new TypeConverter.StandardValuesCollection(new string[] { "Fill", "FillByFINPOREZIDPOREZ", "FillByIDJEDINICAMJERE" });
        ...
        private void BindDataGrid()
        {
            ...
            this.dv1.Table = this.dsPROIZVODDataSet1.PROIZVOD;
        ...
        private void FillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    ...
                    {
                        this.DataAdapter.FillPage(this.dsPROIZVODDataSet1, 0, this.PageSize);
                    }
                    else
                    {
                        MethodInfo info = this.DataAdapter.GetType().GetMethod("FillPageBy" + this.FillMethod.Substring(6));
                        this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsPROIZVODDataSet1, info, 0, this.PageSize);
                    }
                }
                else if (this.FillMethod == "Fill")
                {
                    this.DataAdapter.Fill(this.dsPROIZVODDataSet1);
                }
                else
                {
                    MethodInfo info2 = this.DataAdapter.GetType().GetMethod(this.FillMethod);
                    this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsPROIZVODDataSet1, info2);
                }
        ...
        private void ReFillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    if (this.FillMethod == "Fill")
                    {
                        this.DataAdapter.FillPage(this.dsPROIZVODDataSet1, this.startRowThread, this.PageSize);
                    }
                    else
                    {
                        MethodInfo info = this.DataAdapter.GetType().GetMethod("FillPageBy" + this.FillMethod.Substring(6));
                        this.InvokeFillByMethod(this.FillMethod, (IDataAdapter) this.DataAdapter, this.dsPROIZVODDataSet1, info, this.startRowThread, this.PageSize);
                    }
                }
        ...
        private void ResumeBindingPostThread()
        {
            ...
            this.EndUpdate();
            this.BindDataGrid();
            this.Text = "PROIZVOD : " + this.DataView.Count.ToString(CultureInfo.InvariantCulture) + " " + Deklarit.Resources.Resources.Rows;
        ...
        public virtual IPROIZVODDataAdapter DataAdapter
        {
            get
            {
        ...
        public virtual PROIZVODDataSet DataSet
        {
            get
            {
                return this.dsPROIZVODDataSet1;
            }
            set
            {
                this.dsPROIZVODDataSet1 = value;
            }
        }
