namespace NetAdvantage.Controls
{
    ...
    public class PregledRadnikaSvihDataGrid : DeklaritDataGrid
    {
        private int currentRow;
        private PregledRadnikaSvihDataSet dsPregledRadnikaSvihDataSet1 = new PregledRadnikaSvihDataSet();
        ...
        public PregledRadnikaSvihDataGrid()
        {
            this.BindDataGrid();
        ...
        private void BindDataGrid()
        {
            ...
            this.dv1.Table = this.dsPregledRadnikaSvihDataSet1.RADNIK;
        ...
        {
            this.PreFill();
            this.dsPregledRadnikaSvihDataSet1 = new PregledRadnikaSvihDataSet();
            this.m_StartRow = 0;
        ...
        private void FillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dsPregledRadnikaSvihDataSet1, 0, this.PageSize);
                }
                else
                {
                    this.DataAdapter.Fill(this.dsPregledRadnikaSvihDataSet1);
                }
        ...
        private void ReFillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dsPregledRadnikaSvihDataSet1, this.startRowThread, this.PageSize);
                }
        ...
        private void ResumeBindingPostThread()
        {
            ...
            this.EndUpdate();
            this.BindDataGrid();
            this.Text = "PregledRadnikaSvih : " + this.DataView.Count.ToString(CultureInfo.InvariantCulture) + " " + Deklarit.Resources.Resources.Rows;
        ...
        public virtual IPregledRadnikaSvihDataAdapter DataAdapter
        {
            get
            {
                ...
                if (DataAdapterFactory.Provider != null)
                {
                    return DataAdapterFactory.GetPregledRadnikaSvihDataAdapter();
                }
                return null;
            }
        }
        ...
        public virtual PregledRadnikaSvihDataSet DataSet
        {
            get
            {
                return this.dsPregledRadnikaSvihDataSet1;
            }
            set
            {
                this.dsPregledRadnikaSvihDataSet1 = value;
            }
        }
