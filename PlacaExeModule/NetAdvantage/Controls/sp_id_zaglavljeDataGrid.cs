namespace NetAdvantage.Controls
{
    ...
    public class sp_id_zaglavljeDataGrid : DeklaritDataGrid
    {
        private int currentRow;
        private sp_id_zaglavljeDataSet dssp_id_zaglavljeDataSet1 = new sp_id_zaglavljeDataSet();
        ...
        public sp_id_zaglavljeDataGrid()
        {
            this.BindDataGrid();
        ...
        {
            this.PreFill();
            this.dssp_id_zaglavljeDataSet1 = new sp_id_zaglavljeDataSet();
            this.m_StartRow = 0;
        ...
        private void FillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dssp_id_zaglavljeDataSet1, this.m_ParameterIDOBRACUN, this.m_ParameterMJESECISPLATE, this.m_ParameterGODINAISPLATE, this.m_ParameterVOLONTERI, 0, this.PageSize);
                }
                else
                {
                    this.DataAdapter.Fill(this.dssp_id_zaglavljeDataSet1, this.m_ParameterIDOBRACUN, this.m_ParameterMJESECISPLATE, this.m_ParameterGODINAISPLATE, this.m_ParameterVOLONTERI);
                }
        ...
        private void ReFillDataThread(object state)
        {
            ...
            try
            {
                if (this.FillByPage)
                {
                    this.DataAdapter.FillPage(this.dssp_id_zaglavljeDataSet1, this.m_ParameterIDOBRACUN, this.m_ParameterMJESECISPLATE, this.m_ParameterGODINAISPLATE, this.m_ParameterVOLONTERI, this.startRowThread, this.PageSize);
                }
        ...
        private void ResumeBindingPostThread()
        {
            ...
            this.EndUpdate();
            this.BindDataGrid();
            this.Text = "sp_id_zaglavlje : " + this.DataView.Count.ToString(CultureInfo.InvariantCulture) + " " + Deklarit.Resources.Resources.Rows;
        ...
        public virtual Isp_id_zaglavljeDataAdapter DataAdapter
        {
            get
            {
                ...
                if (DataAdapterFactory.Provider != null)
                {
                    return DataAdapterFactory.Getsp_id_zaglavljeDataAdapter();
                }
                return null;
            }
        }
        ...
        public virtual sp_id_zaglavljeDataSet DataSet
        {
            get
            {
                return this.dssp_id_zaglavljeDataSet1;
            }
            set
            {
                this.dssp_id_zaglavljeDataSet1 = value;
            }
        }
