namespace NetAdvantage.WorkItems
{
    ...
    public class AKTIVNOSTSelectionListWorkItem : SelectionListWorkItemBase
    {
        public AKTIVNOSTSelectionListWorkItem() : this(new AKTIVNOSTWorkWith(), true)
        {
        }

        public AKTIVNOSTSelectionListWorkItem(Control filteredView, bool addCRUDCommands) : this(filteredView, null, addCRUDCommands)
        {
        }

        public AKTIVNOSTSelectionListWorkItem(Control filteredView, Control unfilteredView, bool addCrudCommands) : base(filteredView, unfilteredView)
        {
            if (addCrudCommands)
            {
