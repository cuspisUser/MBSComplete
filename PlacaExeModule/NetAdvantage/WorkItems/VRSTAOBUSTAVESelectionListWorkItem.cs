namespace NetAdvantage.WorkItems
{
    ...
    public class VRSTAOBUSTAVESelectionListWorkItem : SelectionListWorkItemBase
    {
        public VRSTAOBUSTAVESelectionListWorkItem() : this(new VRSTAOBUSTAVEWorkWith(), true)
        {
        }

        public VRSTAOBUSTAVESelectionListWorkItem(Control filteredView, bool addCRUDCommands) : this(filteredView, null, addCRUDCommands)
        {
        }

        public VRSTAOBUSTAVESelectionListWorkItem(Control filteredView, Control unfilteredView, bool addCrudCommands) : base(filteredView, unfilteredView)
        {
            if (addCrudCommands)
            {
