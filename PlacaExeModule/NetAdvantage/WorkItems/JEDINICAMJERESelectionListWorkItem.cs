namespace NetAdvantage.WorkItems
{
    ...
    public class JEDINICAMJERESelectionListWorkItem : SelectionListWorkItemBase
    {
        public JEDINICAMJERESelectionListWorkItem() : this(new JEDINICAMJEREWorkWith(), true)
        {
        }

        public JEDINICAMJERESelectionListWorkItem(Control filteredView, bool addCRUDCommands) : this(filteredView, null, addCRUDCommands)
        {
        }

        public JEDINICAMJERESelectionListWorkItem(Control filteredView, Control unfilteredView, bool addCrudCommands) : base(filteredView, unfilteredView)
        {
            if (addCrudCommands)
            {
