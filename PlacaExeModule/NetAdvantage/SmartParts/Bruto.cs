namespace NetAdvantage.SmartParts
{
    ...
    [SmartPart]
    public class Bruto : UserControl
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.UltraGrid1.DataMember = "s_od_rekap_bruto";
            this.UltraGrid1.DataSource = this.S_od_rekap_brutoDataSet1;
            ...
            band.Header.Caption = "REKAPITULACIJA BRUTO ELEMENATA";
            band.Header.TextOrientation = new TextOrientationInfo(0, TextFlowDirection.Horizontal);
            ...
            size = new System.Drawing.Size(0x254, 0x176);
            ...
            point = new System.Drawing.Point(0x257, 0);
            ...
            size = new System.Drawing.Size(0x257, 0);
            ...
            size = new System.Drawing.Size(0x129, 20);
            this.optKreditor.Size = size;
            this.optKreditor.TabIndex = 15;
            this.optKreditor.Text = "Skok na novu stranicu nakon svakog elementa";
            ...
            this.Name = "Bruto";
            size = new System.Drawing.Size(0x257, 0x1aa);
            this.Size = size;
        ...
        {
            new s_od_rekap_brutoDataAdapter().Fill(this.S_od_rekap_brutoDataSet1, this.obracun.Text);
            this.UltraGrid1.Text = "Broj radnika: " + this.S_od_rekap_brutoDataSet1.Tables[0].Rows.Count.ToString();
        }
