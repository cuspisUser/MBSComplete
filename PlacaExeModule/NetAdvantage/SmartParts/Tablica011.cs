namespace NetAdvantage.SmartParts
{
    ...
    [SmartPart]
    public class Tablica011 : UserControl, ISmartPartInfoProvider, IFilteredView
    {
        ...
        private S_OD_TABLICA01DataAdapter da = new S_OD_TABLICA01DataAdapter();
        private S_OD_TABLICA01DataSet ds = new S_OD_TABLICA01DataSet();
        private string godinaisplate = null;
        private SmartPartInfoProvider infoProvider = new SmartPartInfoProvider();
        private SmartPartInfo smartPartInfo1 = new SmartPartInfo("Mirovinsko Tablica01/11", "Tablica0111");
