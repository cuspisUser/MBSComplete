namespace NetAdvantage.SmartParts
{
    ...
    public class S_FIN_DNEVNIKUserDataGrid : UserControl, ISmartPartInfo
    {
        private IContainer components = null;
        private string m_Description = "Work with S_FIN_DNEVNIK";
        private bool m_FillAtStartup = true;
        private string m_Title = "Work with S_FIN_DNEVNIK";
        private S_FIN_DNEVNIKDataGrid userControlDataGridS_FIN_DNEVNIK;

        public S_FIN_DNEVNIKUserDataGrid()
        {
        ...
        private void S_FIN_DNEVNIKUserDataGrid_InitializeRow(object sender, InitializeRowEventArgs e)
        {
        }

        private void S_FIN_DNEVNIKUserDataGrid_Load(object sender, EventArgs e)
        {
            if (!this.DesignMode)
            {
        ...
        [Browsable(false)]
        public virtual S_FIN_DNEVNIKDataGrid DataGrid
        {
            get
            {
                return this.userControlDataGridS_FIN_DNEVNIK;
            }
            set
            {
                this.userControlDataGridS_FIN_DNEVNIK = value;
            }
        }
        ...
        public virtual bool ParameterSTATUS
        {
            get
            {
                return this.DataGrid.ParameterSTATUS;
            }
            set
            {
                this.DataGrid.ParameterSTATUS = value;
            }
        }
