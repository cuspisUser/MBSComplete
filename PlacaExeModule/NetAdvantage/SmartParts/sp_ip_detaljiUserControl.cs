namespace NetAdvantage.SmartParts
{
    ...
    [SmartPart]
    public class sp_ip_detaljiUserControl : UserControl, ISmartPartInfoProvider, IFilteredView
    {
        ...
        [AccessedThroughProperty("userControlDataGridsp_ip_detalji")]
        private sp_ip_detaljiUserDataGrid _userControlDataGridsp_ip_detalji;
        private IContainer components = null;
        private SmartPartInfoProvider infoProvider;
        private TableLayoutPanel layoutManagerformsp_ip_detalji;
        ...
        public sp_ip_detaljiUserControl()
        {
            this.InitializeComponent();
            this.smartPartInfo1 = new SmartPartInfo(Deklarit.Resources.Resources.Providerfor + " " + StringResources.sp_ip_detaljiDescription, Deklarit.Resources.Resources.WorkWithTitle + " " + StringResources.sp_ip_detaljiDescription);
            this.infoProvider = new SmartPartInfoProvider();
            this.infoProvider.Items.Add(this.smartPartInfo1);
            this.userControlDataGridsp_ip_detalji.DataGrid.AfterRowActivate += new EventHandler(this.DataGrid_AfterRowActivate);
            this.Localize();
        }
        ...
        {
            UltraGridSelectedRowsProviderService<sp_ip_detaljiDataSet> serviceInstance = new UltraGridSelectedRowsProviderService<sp_ip_detaljiDataSet>(this.userControlDataGridsp_ip_detalji.DataGrid);
        ...
        {
            if ((this.userControlDataGridsp_ip_detalji.DataGrid.Rows.Count > 0) && (this.userControlDataGridsp_ip_detalji.DataGrid.Rows[0] != null))
            {
                this.userControlDataGridsp_ip_detalji.DataGrid.Rows[0].Activate();
            }
        }
        ...
        public void ExportExcelHandler(object sender, EventArgs e)
        {
            if (this.Controller.WorkItem.Status == WorkItemStatus.Active)
            {
                ...
                {
                    new UltraGridExcelExporter().Export(this.userControlDataGridsp_ip_detalji.DataGrid, dialog.FileName);
        ...
        public void FillAll(object sender, EventArgs e)
        {
            if (this.Controller.WorkItem.Status == WorkItemStatus.Active)
            {
                bool fillByPage = this.userControlDataGridsp_ip_detalji.DataGrid.FillByPage;
                this.userControlDataGridsp_ip_detalji.DataGrid.FillByPage = false;
                this.FillData();
                this.userControlDataGridsp_ip_detalji.DataGrid.FillByPage = fillByPage;
            }
        }
        ...
        public virtual void FillData()
        {
            try
            {
                this.userControlDataGridsp_ip_detalji.Parametergodina = this.textgodina.Text;
                this.userControlDataGridsp_ip_detalji.Fill();
                ((sp_ip_detaljiWorkWithWorkItem) this.Controller.WorkItem).DataSet = this.userControlDataGridsp_ip_detalji.DataView.Table.DataSet;
            }
        ...
        private void LoadDefault()
        {
            ...
            if (this.m_FillByRow != null)
            {
                ...
                if (this.parameterSeted)
                {
                    ...
                    {
                        this.Text = Deklarit.Resources.Resources.Select + "sp_ip_detalji " + Deklarit.Resources.Resources.For + " " + str.Substring(1);
                    }
                    else
                    {
                        this.Text = Deklarit.Resources.Resources.Workwith + "sp_ip_detalji " + Deklarit.Resources.Resources.For + " " + str.Substring(1);
                    }
                }
            }
        }
        ...
        public void LoadFromXml(object sender, EventArgs e)
        {
            ...
            if (dialog.ShowDialog() == DialogResult.OK)
            {
                try
                {
                    this.userControlDataGridsp_ip_detalji.DataGrid.DataSet.Clear();
                    this.userControlDataGridsp_ip_detalji.DataGrid.DataSet.ReadXml(dialog.FileName);
                    new sp_ip_detaljiDataAdapter().Update(this.userControlDataGridsp_ip_detalji.DataGrid.DataSet);
                }
                catch (System.Exception exception1)
                {
                    throw exception1;
        ...
        {
            this.label1godina.Text = StringResources.sp_ip_detaljigodinaParameter;
        }
        ...
        public void SaveToXml(object sender, EventArgs e)
        {
            ...
            if (dialog.ShowDialog() == DialogResult.OK)
            {
                this.userControlDataGridsp_ip_detalji.DataGrid.DataSet.WriteXml(dialog.FileName);
            }
        }
        ...
        private void Select_Click(object sender, EventArgs e)
        {
            ...
            UIElement lastElementEntered = this.userControlDataGridsp_ip_detalji.DataGrid.DisplayLayout.UIElement.LastElementEntered;
        ...
        private void SetSmartPartInfoInformation()
        {
            if (this.m_WorkWithMode == Deklarit.Practices.CompositeUI.WorkWithMode.SelectionList)
            {
                this.smartPartInfo1.Title = string.Format("{0} sp_ip_detalji ", Deklarit.Resources.Resources.Select);
            }
            else
            {
                this.smartPartInfo1.Title = string.Format("{0} sp_ip_detalji ", Deklarit.Resources.Resources.Workwith);
            }
        ...
        private void sp_ip_detaljiUserControl_Load(object sender, EventArgs e)
        {
            if (this.m_WorkWithMode == Deklarit.Practices.CompositeUI.WorkWithMode.SelectionList)
            {
                this.userControlDataGridsp_ip_detalji.DataGrid.DoubleClick += new EventHandler(this.Select_Click);
                Size size = new System.Drawing.Size(600, 500);
                this.Parent.Parent.Size = size;
            }
            else
            {
                this.userControlDataGridsp_ip_detalji.DataGrid.DoubleClickRow += new DoubleClickRowEventHandler(this.DataGrid_DoubleClickRow);
            }
            this.userControlDataGridsp_ip_detalji.DataGrid.DisplayLayout.Override.AllowDelete = DefaultableBoolean.False;
            this.userControlDataGridsp_ip_detalji.DataGrid.DisplayLayout.Override.AllowUpdate = DefaultableBoolean.False;
            this.userControlDataGridsp_ip_detalji.DataGrid.DisplayLayout.Override.AllowAddNew = AllowAddNew.No;
            this.userControlDataGridsp_ip_detalji.DataGrid.DisplayLayout.Override.AllowRowFiltering = DefaultableBoolean.True;
            this.userControlDataGridsp_ip_detalji.DataGrid.DisplayLayout.ViewStyleBand = ViewStyleBand.OutlookGroupBy;
            this.userControlDataGridsp_ip_detalji.DataGrid.DisplayLayout.Override.HeaderClickAction = HeaderClickAction.SortSingle;
            this.LoadDefault();
            if (this.parameterSeted)
            {
                this.userControlDataGridsp_ip_detalji.DataGrid.FillByPage = true;
                this.FillData();
            }
        }

        [CreateNew]
        public sp_ip_detaljiController Controller { get; set; }

        private DataRow CurrentDataRow
        {
            get
            {
                if (this.userControlDataGridsp_ip_detalji.DataGrid.CurrentRowIndex == -1)
                {
                    return null;
                }
                return this.userControlDataGridsp_ip_detalji.DataView[this.userControlDataGridsp_ip_detalji.DataGrid.CurrentRowIndex].Row;
            }
        }
        ...
        protected virtual sp_ip_detaljiUserDataGrid userControlDataGridsp_ip_detalji
        {
            [DebuggerNonUserCode]
            get
            {
                return this._userControlDataGridsp_ip_detalji;
            }
            [MethodImpl(MethodImplOptions.Synchronized), DebuggerNonUserCode]
            set
            {
                this._userControlDataGridsp_ip_detalji = value;
            }
        }
