namespace NetAdvantage.SmartParts
{
    ...
    [SmartPart]
    public class Postotna : UserControl
    {
        ...
        [AccessedThroughProperty("S_OD_REKAP_POSTOTNEDataSet1")]
        private S_OD_REKAP_POSTOTNEDataSet _S_OD_REKAP_POSTOTNEDataSet1;
        ...
        private void InitializeComponent()
        {
            ...
            UltraGridColumn column2 = new UltraGridColumn("POSTOTAK");
            ...
            this.S_OD_REKAP_POSTOTNEDataSet1 = new S_OD_REKAP_POSTOTNEDataSet();
            ...
            this.S_OD_REKAP_POSTOTNEDataSet1.BeginInit();
            ...
            this.UltraGrid1.DataMember = "S_OD_REKAP_POSTOTNE";
            this.UltraGrid1.DataSource = this.S_OD_REKAP_POSTOTNEDataSet1;
            ...
            band.Header.Caption = "REKAPITULACIJA POSTOTNIH OBUSTAVA";
            ...
            size = new System.Drawing.Size(0x281, 0x176);
            this.UltraGrid1.Size = size;
            this.UltraGrid1.TabIndex = 3;
            this.UltraGrid1.UseAppStyling = false;
            this.S_OD_REKAP_POSTOTNEDataSet1.DataSetName = "S_OD_REKAP_POSTOTNEDataSet";
            ...
            this.S_OD_REKAP_POSTOTNEDataSet1.EndInit();
        ...
        private void UltraButton2_Click(object sender, EventArgs e)
        {
            ...
            document.Load(System.Windows.Forms.Application.StartupPath + @"\Izvjestaji\rptPostotne.rpt");
            document.SetDataSource(this.S_OD_REKAP_POSTOTNEDataSet1);
        ...
        {
            new S_OD_REKAP_POSTOTNEDataAdapter().Fill(this.S_OD_REKAP_POSTOTNEDataSet1, this.obracun.Text);
            this.UltraGrid1.Text = "Broj radnika: " + this.S_OD_REKAP_POSTOTNEDataSet1.Tables[0].Rows.Count;
        }
        ...
        internal S_OD_REKAP_POSTOTNEDataSet S_OD_REKAP_POSTOTNEDataSet1
        {
            [DebuggerNonUserCode]
            get
            {
                return this._S_OD_REKAP_POSTOTNEDataSet1;
            }
            [MethodImpl(MethodImplOptions.Synchronized), DebuggerNonUserCode]
            set
            {
                this._S_OD_REKAP_POSTOTNEDataSet1 = value;
            }
        }
