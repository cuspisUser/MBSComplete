namespace NetAdvantage.SmartParts
{
    ...
    [SmartPart]
    public class S_FIN_KONTO_KARTICEUserControl : UserControl, ISmartPartInfoProvider, IFilteredView
    {
        ...
        [AccessedThroughProperty("userControlDataGridS_FIN_KONTO_KARTICE")]
        private S_FIN_KONTO_KARTICEUserDataGrid _userControlDataGridS_FIN_KONTO_KARTICE;
        private IContainer components = null;
        private SmartPartInfoProvider infoProvider;
        private TableLayoutPanel layoutManagerformS_FIN_KONTO_KARTICE;
        ...
        public S_FIN_KONTO_KARTICEUserControl()
        {
            this.InitializeComponent();
            this.smartPartInfo1 = new SmartPartInfo(Deklarit.Resources.Resources.Providerfor + " " + StringResources.S_FIN_KONTO_KARTICEDescription, Deklarit.Resources.Resources.WorkWithTitle + " " + StringResources.S_FIN_KONTO_KARTICEDescription);
            this.infoProvider = new SmartPartInfoProvider();
            this.infoProvider.Items.Add(this.smartPartInfo1);
            this.userControlDataGridS_FIN_KONTO_KARTICE.DataGrid.AfterRowActivate += new EventHandler(this.DataGrid_AfterRowActivate);
            this.Localize();
        }
        ...
        {
            UltraGridSelectedRowsProviderService<S_FIN_KONTO_KARTICEDataSet> serviceInstance = new UltraGridSelectedRowsProviderService<S_FIN_KONTO_KARTICEDataSet>(this.userControlDataGridS_FIN_KONTO_KARTICE.DataGrid);
        ...
        {
            if ((this.userControlDataGridS_FIN_KONTO_KARTICE.DataGrid.Rows.Count > 0) && (this.userControlDataGridS_FIN_KONTO_KARTICE.DataGrid.Rows[0] != null))
            {
                this.userControlDataGridS_FIN_KONTO_KARTICE.DataGrid.Rows[0].Activate();
            }
        }
        ...
        public void ExportExcelHandler(object sender, EventArgs e)
        {
            if (this.Controller.WorkItem.Status == WorkItemStatus.Active)
            {
                ...
                {
                    new UltraGridExcelExporter().Export(this.userControlDataGridS_FIN_KONTO_KARTICE.DataGrid, dialog.FileName);
        ...
        public void FillAll(object sender, EventArgs e)
        {
            if (this.Controller.WorkItem.Status == WorkItemStatus.Active)
            {
                bool fillByPage = this.userControlDataGridS_FIN_KONTO_KARTICE.DataGrid.FillByPage;
                this.userControlDataGridS_FIN_KONTO_KARTICE.DataGrid.FillByPage = false;
                this.FillData();
                this.userControlDataGridS_FIN_KONTO_KARTICE.DataGrid.FillByPage = fillByPage;
            }
        }
        ...
        public virtual void FillData()
        {
            try
            {
                this.userControlDataGridS_FIN_KONTO_KARTICE.ParameterORG = int.Parse(this.textORG.Value.ToString(), CultureInfo.CurrentCulture);
                this.userControlDataGridS_FIN_KONTO_KARTICE.ParameterMT = this.textMT.Text;
                this.userControlDataGridS_FIN_KONTO_KARTICE.ParameterDOK = int.Parse(this.textDOK.Value.ToString(), CultureInfo.CurrentCulture);
                if (this.datePickerRAZDOBLJEOD.Value == null)
                {
                    this.userControlDataGridS_FIN_KONTO_KARTICE.ParameterRAZDOBLJEOD = DateTime.MinValue;
                }
                else
                {
                    this.userControlDataGridS_FIN_KONTO_KARTICE.ParameterRAZDOBLJEOD = DateTime.Parse(this.datePickerRAZDOBLJEOD.Value.ToString(), CultureInfo.CurrentCulture);
                }
                if (this.datePickerRAZDOBLJEDO.Value == null)
                {
                    this.userControlDataGridS_FIN_KONTO_KARTICE.ParameterRAZDOBLJEDO = DateTime.MinValue;
                }
                else
                {
                    this.userControlDataGridS_FIN_KONTO_KARTICE.ParameterRAZDOBLJEDO = DateTime.Parse(this.datePickerRAZDOBLJEDO.Value.ToString(), CultureInfo.CurrentCulture);
                }
                this.userControlDataGridS_FIN_KONTO_KARTICE.ParameterPOCETNIKONTO = this.textPOCETNIKONTO.Text;
                this.userControlDataGridS_FIN_KONTO_KARTICE.ParameterZAVRSNIKONTO = this.textZAVRSNIKONTO.Text;
                this.userControlDataGridS_FIN_KONTO_KARTICE.Fill();
                ((S_FIN_KONTO_KARTICEWorkWithWorkItem) this.Controller.WorkItem).DataSet = this.userControlDataGridS_FIN_KONTO_KARTICE.DataView.Table.DataSet;
            }
        ...
        private void InitializeComponent()
        {
            ...
            ResourceManager manager = new ResourceManager(typeof(S_FIN_KONTO_KARTICEUserControl));
            this.layoutManagerformS_FIN_KONTO_KARTICE = new TableLayoutPanel();
            this.layoutManagerformS_FIN_KONTO_KARTICE.SuspendLayout();
            this.layoutManagerformS_FIN_KONTO_KARTICE.AutoSize = true;
            this.layoutManagerformS_FIN_KONTO_KARTICE.Dock = DockStyle.Fill;
            this.layoutManagerformS_FIN_KONTO_KARTICE.AutoSizeMode = AutoSizeMode.GrowAndShrink;
            this.layoutManagerformS_FIN_KONTO_KARTICE.AutoScroll = false;
            System.Drawing.Point point = new System.Drawing.Point(0, 0);
            this.layoutManagerformS_FIN_KONTO_KARTICE.Location = point;
            Size size = new System.Drawing.Size(0, 0);
            this.layoutManagerformS_FIN_KONTO_KARTICE.Size = size;
            this.layoutManagerformS_FIN_KONTO_KARTICE.ColumnCount = 2;
            this.layoutManagerformS_FIN_KONTO_KARTICE.ColumnStyles.Add(new System.Windows.Forms.ColumnStyle());
            this.layoutManagerformS_FIN_KONTO_KARTICE.ColumnStyles.Add(new System.Windows.Forms.ColumnStyle());
            this.layoutManagerformS_FIN_KONTO_KARTICE.RowCount = 8;
            this.layoutManagerformS_FIN_KONTO_KARTICE.RowStyles.Add(new RowStyle());
            this.layoutManagerformS_FIN_KONTO_KARTICE.RowStyles.Add(new RowStyle());
            this.layoutManagerformS_FIN_KONTO_KARTICE.RowStyles.Add(new RowStyle());
            this.layoutManagerformS_FIN_KONTO_KARTICE.RowStyles.Add(new RowStyle());
            this.layoutManagerformS_FIN_KONTO_KARTICE.RowStyles.Add(new RowStyle());
            ...
            this.userControlDataGridS_FIN_KONTO_KARTICE = new S_FIN_KONTO_KARTICEUserDataGrid();
            ...
            this.layoutManagerformS_FIN_KONTO_KARTICE.Controls.Add(this.label1ORG, 0, 0);
            this.layoutManagerformS_FIN_KONTO_KARTICE.SetColumnSpan(this.label1ORG, 1);
            this.layoutManagerformS_FIN_KONTO_KARTICE.SetRowSpan(this.label1ORG, 1);
            ...
            this.layoutManagerformS_FIN_KONTO_KARTICE.Controls.Add(this.textORG, 1, 0);
            this.layoutManagerformS_FIN_KONTO_KARTICE.SetColumnSpan(this.textORG, 1);
            this.layoutManagerformS_FIN_KONTO_KARTICE.SetRowSpan(this.textORG, 1);
            ...
            this.layoutManagerformS_FIN_KONTO_KARTICE.Controls.Add(this.label1MT, 0, 1);
            this.layoutManagerformS_FIN_KONTO_KARTICE.SetColumnSpan(this.label1MT, 1);
            this.layoutManagerformS_FIN_KONTO_KARTICE.SetRowSpan(this.label1MT, 1);
            ...
            this.textMT.MaxLength = 8;
            this.layoutManagerformS_FIN_KONTO_KARTICE.Controls.Add(this.textMT, 1, 1);
            this.layoutManagerformS_FIN_KONTO_KARTICE.SetColumnSpan(this.textMT, 1);
            this.layoutManagerformS_FIN_KONTO_KARTICE.SetRowSpan(this.textMT, 1);
            padding = new Padding(0, 1, 3, 2);
            ...
            this.layoutManagerformS_FIN_KONTO_KARTICE.Controls.Add(this.label1DOK, 0, 2);
            this.layoutManagerformS_FIN_KONTO_KARTICE.SetColumnSpan(this.label1DOK, 1);
            this.layoutManagerformS_FIN_KONTO_KARTICE.SetRowSpan(this.label1DOK, 1);
            padding = new Padding(3, 1, 5, 2);
            ...
            this.layoutManagerformS_FIN_KONTO_KARTICE.Controls.Add(this.textDOK, 1, 2);
            this.layoutManagerformS_FIN_KONTO_KARTICE.SetColumnSpan(this.textDOK, 1);
            this.layoutManagerformS_FIN_KONTO_KARTICE.SetRowSpan(this.textDOK, 1);
            padding = new Padding(0, 1, 3, 2);
            ...
            this.layoutManagerformS_FIN_KONTO_KARTICE.Controls.Add(this.label1RAZDOBLJEOD, 0, 3);
            this.layoutManagerformS_FIN_KONTO_KARTICE.SetColumnSpan(this.label1RAZDOBLJEOD, 1);
            this.layoutManagerformS_FIN_KONTO_KARTICE.SetRowSpan(this.label1RAZDOBLJEOD, 1);
            padding = new Padding(3, 1, 5, 2);
            ...
            this.layoutManagerformS_FIN_KONTO_KARTICE.Controls.Add(this.datePickerRAZDOBLJEOD, 1, 3);
            this.layoutManagerformS_FIN_KONTO_KARTICE.SetColumnSpan(this.datePickerRAZDOBLJEOD, 1);
            this.layoutManagerformS_FIN_KONTO_KARTICE.SetRowSpan(this.datePickerRAZDOBLJEOD, 1);
            padding = new Padding(0, 1, 3, 2);
            ...
            this.layoutManagerformS_FIN_KONTO_KARTICE.Controls.Add(this.label1RAZDOBLJEDO, 0, 4);
            this.layoutManagerformS_FIN_KONTO_KARTICE.SetColumnSpan(this.label1RAZDOBLJEDO, 1);
            this.layoutManagerformS_FIN_KONTO_KARTICE.SetRowSpan(this.label1RAZDOBLJEDO, 1);
            padding = new Padding(3, 1, 5, 2);
            ...
            this.layoutManagerformS_FIN_KONTO_KARTICE.Controls.Add(this.datePickerRAZDOBLJEDO, 1, 4);
            this.layoutManagerformS_FIN_KONTO_KARTICE.SetColumnSpan(this.datePickerRAZDOBLJEDO, 1);
            this.layoutManagerformS_FIN_KONTO_KARTICE.SetRowSpan(this.datePickerRAZDOBLJEDO, 1);
            padding = new Padding(0, 1, 3, 2);
            ...
            this.layoutManagerformS_FIN_KONTO_KARTICE.Controls.Add(this.label1POCETNIKONTO, 0, 5);
            this.layoutManagerformS_FIN_KONTO_KARTICE.SetColumnSpan(this.label1POCETNIKONTO, 1);
            this.layoutManagerformS_FIN_KONTO_KARTICE.SetRowSpan(this.label1POCETNIKONTO, 1);
            padding = new Padding(3, 1, 5, 2);
            ...
            this.layoutManagerformS_FIN_KONTO_KARTICE.Controls.Add(this.textPOCETNIKONTO, 1, 5);
            this.layoutManagerformS_FIN_KONTO_KARTICE.SetColumnSpan(this.textPOCETNIKONTO, 1);
            this.layoutManagerformS_FIN_KONTO_KARTICE.SetRowSpan(this.textPOCETNIKONTO, 1);
            padding = new Padding(0, 1, 3, 2);
            ...
            this.layoutManagerformS_FIN_KONTO_KARTICE.Controls.Add(this.label1ZAVRSNIKONTO, 0, 6);
            this.layoutManagerformS_FIN_KONTO_KARTICE.SetColumnSpan(this.label1ZAVRSNIKONTO, 1);
            this.layoutManagerformS_FIN_KONTO_KARTICE.SetRowSpan(this.label1ZAVRSNIKONTO, 1);
            padding = new Padding(3, 1, 5, 2);
            ...
            this.layoutManagerformS_FIN_KONTO_KARTICE.Controls.Add(this.textZAVRSNIKONTO, 1, 6);
            this.layoutManagerformS_FIN_KONTO_KARTICE.SetColumnSpan(this.textZAVRSNIKONTO, 1);
            this.layoutManagerformS_FIN_KONTO_KARTICE.SetRowSpan(this.textZAVRSNIKONTO, 1);
            padding = new Padding(0, 1, 3, 2);
            this.textZAVRSNIKONTO.Margin = padding;
            size = new System.Drawing.Size(0x79, 0x16);
            this.textZAVRSNIKONTO.MinimumSize = size;
            this.layoutManagerformS_FIN_KONTO_KARTICE.Controls.Add(this.userControlDataGridS_FIN_KONTO_KARTICE, 0, 7);
            this.layoutManagerformS_FIN_KONTO_KARTICE.SetColumnSpan(this.userControlDataGridS_FIN_KONTO_KARTICE, 2);
            this.layoutManagerformS_FIN_KONTO_KARTICE.SetRowSpan(this.userControlDataGridS_FIN_KONTO_KARTICE, 1);
            padding = new Padding(5, 10, 5, 10);
            this.userControlDataGridS_FIN_KONTO_KARTICE.Margin = padding;
            size = new System.Drawing.Size(100, 100);
            this.userControlDataGridS_FIN_KONTO_KARTICE.MinimumSize = size;
            this.userControlDataGridS_FIN_KONTO_KARTICE.Dock = DockStyle.Fill;
            this.Controls.Add(this.layoutManagerformS_FIN_KONTO_KARTICE);
            this.userControlDataGridS_FIN_KONTO_KARTICE.Name = "userControlDataGridS_FIN_KONTO_KARTICE";
            this.userControlDataGridS_FIN_KONTO_KARTICE.Dock = DockStyle.Fill;
            this.userControlDataGridS_FIN_KONTO_KARTICE.DockPadding.All = 5;
            this.userControlDataGridS_FIN_KONTO_KARTICE.FillAtStartup = false;
            this.userControlDataGridS_FIN_KONTO_KARTICE.TabIndex = 6;
            point = new System.Drawing.Point(0, 0);
            this.userControlDataGridS_FIN_KONTO_KARTICE.Location = point;
            size = new System.Drawing.Size(0x285, 350);
            this.userControlDataGridS_FIN_KONTO_KARTICE.Size = size;
            this.ultraGridPrintDocument1.Grid = this.userControlDataGridS_FIN_KONTO_KARTICE.DataGrid;
            SizeF ef = new System.Drawing.SizeF(6f, 13f);
            this.AutoScaleDimensions = ef;
            this.AutoScaleMode = System.Windows.Forms.AutoScaleMode.Font;
            this.DockPadding.All = 5;
            this.Name = "S_FIN_KONTO_KARTICEWorkWith";
            this.Text = "Work With S_FIN_KONTO_KARTICE";
            this.Load += new EventHandler(this.S_FIN_KONTO_KARTICEUserControl_Load);
            this.layoutManagerformS_FIN_KONTO_KARTICE.ResumeLayout(false);
            this.layoutManagerformS_FIN_KONTO_KARTICE.PerformLayout();
        ...
        public void LoadFromXml(object sender, EventArgs e)
        {
            ...
            if (dialog.ShowDialog() == DialogResult.OK)
            {
                try
                {
                    this.userControlDataGridS_FIN_KONTO_KARTICE.DataGrid.DataSet.Clear();
                    this.userControlDataGridS_FIN_KONTO_KARTICE.DataGrid.DataSet.ReadXml(dialog.FileName);
                    new S_FIN_KONTO_KARTICEDataAdapter().Update(this.userControlDataGridS_FIN_KONTO_KARTICE.DataGrid.DataSet);
                }
                catch (System.Exception exception1)
                {
                    throw exception1;
        ...
        {
            this.label1ORG.Text = StringResources.S_FIN_KONTO_KARTICEORGParameter;
            this.label1MT.Text = StringResources.S_FIN_KONTO_KARTICEMTParameter;
            this.label1DOK.Text = StringResources.S_FIN_KONTO_KARTICEDOKParameter;
            this.label1RAZDOBLJEOD.Text = StringResources.S_FIN_KONTO_KARTICERAZDOBLJEODParameter;
            this.label1RAZDOBLJEDO.Text = StringResources.S_FIN_KONTO_KARTICERAZDOBLJEDOParameter;
            this.label1POCETNIKONTO.Text = StringResources.S_FIN_KONTO_KARTICEPOCETNIKONTOParameter;
            this.label1ZAVRSNIKONTO.Text = StringResources.S_FIN_KONTO_KARTICEZAVRSNIKONTOParameter;
        }
        ...
        private void S_FIN_KONTO_KARTICEUserControl_Load(object sender, EventArgs e)
        {
            if (this.m_WorkWithMode == Deklarit.Practices.CompositeUI.WorkWithMode.SelectionList)
            {
                this.userControlDataGridS_FIN_KONTO_KARTICE.DataGrid.DoubleClick += new EventHandler(this.Select_Click);
                Size size = new System.Drawing.Size(600, 500);
                this.Parent.Parent.Size = size;
            }
            else
            {
                this.userControlDataGridS_FIN_KONTO_KARTICE.DataGrid.DoubleClickRow += new DoubleClickRowEventHandler(this.DataGrid_DoubleClickRow);
            }
            this.userControlDataGridS_FIN_KONTO_KARTICE.DataGrid.DisplayLayout.Override.AllowDelete = DefaultableBoolean.False;
            this.userControlDataGridS_FIN_KONTO_KARTICE.DataGrid.DisplayLayout.Override.AllowUpdate = DefaultableBoolean.False;
            this.userControlDataGridS_FIN_KONTO_KARTICE.DataGrid.DisplayLayout.Override.AllowAddNew = AllowAddNew.No;
            this.userControlDataGridS_FIN_KONTO_KARTICE.DataGrid.DisplayLayout.Override.AllowRowFiltering = DefaultableBoolean.True;
            this.userControlDataGridS_FIN_KONTO_KARTICE.DataGrid.DisplayLayout.ViewStyleBand = ViewStyleBand.OutlookGroupBy;
            this.userControlDataGridS_FIN_KONTO_KARTICE.DataGrid.DisplayLayout.Override.HeaderClickAction = HeaderClickAction.SortSingle;
            this.LoadDefault();
            if (this.parameterSeted)
            {
                this.userControlDataGridS_FIN_KONTO_KARTICE.DataGrid.FillByPage = true;
                this.FillData();
            }
        }
        ...
        public void SaveToXml(object sender, EventArgs e)
        {
            ...
            if (dialog.ShowDialog() == DialogResult.OK)
            {
                this.userControlDataGridS_FIN_KONTO_KARTICE.DataGrid.DataSet.WriteXml(dialog.FileName);
            }
        }
        ...
        private void Select_Click(object sender, EventArgs e)
        {
            ...
            UIElement lastElementEntered = this.userControlDataGridS_FIN_KONTO_KARTICE.DataGrid.DisplayLayout.UIElement.LastElementEntered;
        ...
        private void SetSmartPartInfoInformation()
        {
            if (this.m_WorkWithMode == Deklarit.Practices.CompositeUI.WorkWithMode.SelectionList)
            {
                this.smartPartInfo1.Title = string.Format("{0} S_FIN_KONTO_KARTICE ", Deklarit.Resources.Resources.Select);
            }
            else
            {
                this.smartPartInfo1.Title = string.Format("{0} S_FIN_KONTO_KARTICE ", Deklarit.Resources.Resources.Workwith);
            }
        ...
        [CreateNew]
        public S_FIN_KONTO_KARTICEController Controller { get; set; }

        private DataRow CurrentDataRow
        {
            get
            {
                if (this.userControlDataGridS_FIN_KONTO_KARTICE.DataGrid.CurrentRowIndex == -1)
                {
                    return null;
                }
                return this.userControlDataGridS_FIN_KONTO_KARTICE.DataView[this.userControlDataGridS_FIN_KONTO_KARTICE.DataGrid.CurrentRowIndex].Row;
            }
        }
        ...
        protected virtual S_FIN_KONTO_KARTICEUserDataGrid userControlDataGridS_FIN_KONTO_KARTICE
        {
            [DebuggerNonUserCode]
            get
            {
                return this._userControlDataGridS_FIN_KONTO_KARTICE;
            }
            [MethodImpl(MethodImplOptions.Synchronized), DebuggerNonUserCode]
            set
            {
                this._userControlDataGridS_FIN_KONTO_KARTICE = value;
            }
        }
