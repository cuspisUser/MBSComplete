namespace NetAdvantage.SmartParts
{
    ...
    [SmartPart]
    public class Tablica01 : UserControl, ISmartPartInfoProvider, IFilteredView
    {
        ...
        public void OtvoriObracun_Za_Mjesec()
        {
            ...
            if (obracuna.DialogResult != DialogResult.Cancel)
            {
                ...
                document.Load(System.Windows.Forms.Application.StartupPath + @"\Izvjestaji\TABLICA01-10.rpt");
