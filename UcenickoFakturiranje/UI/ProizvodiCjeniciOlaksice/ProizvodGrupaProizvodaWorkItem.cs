...
{
    public class ProizvodGrupaProizvodaWorkItem : MdiWorkItemBase
    {
        public ProizvodGrupaProizvodaWorkItem() :
            base("PROIZVODGRUPAPROIZVODAPREGLED", new ProizvodGrupaProizvodaFormPregled())
        {
