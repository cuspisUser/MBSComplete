...
{
    public class PredlosciPregledWorkItem : MdiWorkItemBase
    {
        public PredlosciPregledWorkItem()
            : base("PREDLOSCIPREGLED", new uscPredlosciPregled())
        {
            this.UICommandDefinitionContainer.Add(new UICommandDefinition[]{
                ...
                new UICommandDefinition("SelectDeselect", "Označi/Odznači", this.Site + ".Tasks", Resources.ImageResourcesNew.select_by_intersection, null, null), 
