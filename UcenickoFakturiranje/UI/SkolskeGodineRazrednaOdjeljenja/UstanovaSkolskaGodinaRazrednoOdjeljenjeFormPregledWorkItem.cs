...
{
    public class UstanovaSkolskaGodinaRazrednoOdjeljenjeFormPregledWorkItem : MdiWorkItemBase
    {
        public UstanovaSkolskaGodinaRazrednoOdjeljenjeFormPregledWorkItem()
            : base("USTANOVASKOLSKAGODINARAZREDNOODJELJENJEPREGLED", new UstanovaSkolskaGodinaRazrednoOdjeljenjeFormPregled())
        {
