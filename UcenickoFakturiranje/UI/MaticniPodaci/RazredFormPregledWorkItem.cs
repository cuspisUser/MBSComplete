...
{
    public class RazredFormPregledWorkItem : MdiWorkItemBase
    {
        public RazredFormPregledWorkItem()
            : base("RAZREDPREGLED", new RazredFormPregled())
        {
            this.UICommandDefinitionContainer.Add(new UICommandDefinition[]{
                ...
                //new UICommandDefinition("Razred", "Podizanje školske godine", this.Site + ".Export", Resources.ImageResourcesNew.book_keeping, null, null),
