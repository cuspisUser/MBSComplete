...
{
    public class SkolskaGodinaFormPregledWorkItem : MdiWorkItemBase
    {
        public SkolskaGodinaFormPregledWorkItem()
            : base("SKOLSKAGODINAPREGLED", new SkolskaGodinaFormPregled())
        {
