...
namespace My
{
    ...
    internal sealed class MyProject
    {
        ...
        internal sealed class MyForms
        {
            ...
            public frmStatusAPP m_frmStatus;
            ...
            {
                return typeof(My.MyProject.MyForms);
            }
            ...
            public frmStatusAPP frmStatus
            {
                [DebuggerNonUserCode]
                get
                {
                    this.m_frmStatus = Create__Instance__<frmStatusAPP>(this.m_frmStatus);
                ...
                set
                {
                    if (value != this.m_frmStatus)
                    {
                        ...
                        this.Dispose__Instance__<frmStatusAPP>(ref this.m_frmStatus);
                    }
                }
            }
        }
        ...
        internal sealed class MyWebServices
        {
            ...
            internal new Type GetType()
            {
                return typeof(My.MyProject.MyWebServices);
            }
