...
{
    public class NacinIsporukeFormPregledWorkItem : MdiWorkItemBase
    {
        public NacinIsporukeFormPregledWorkItem()
            : base("NACINISPORUKEPREGLED", new NacinIsporukeFormPregled())
        {
