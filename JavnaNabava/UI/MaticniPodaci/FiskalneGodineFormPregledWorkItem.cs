...
{
    public class FiskalneGodineFormPregledWorkItem : MdiWorkItemBase
    {
        public FiskalneGodineFormPregledWorkItem()
            : base("FISKALNEGODINEPREGLED", new FiskalneGodineFormPregled())
        {
