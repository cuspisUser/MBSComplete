...
{
    public class NacinPlacanjaFormPregledWorkItem : MdiWorkItemBase
    {
        public NacinPlacanjaFormPregledWorkItem()
            : base("NACINPLACANJAPREGLED", new NacinPlacanjaFormPregled())
        {
