...
{
    public class NarudzbenicaFormPregledWorkItem : MdiWorkItemBase
    {
        public NarudzbenicaFormPregledWorkItem()
            : base("NARUDZBENICAPREGLED", new NarudzbenicaFormPregled())
        {
            this.UICommandDefinitionContainer.Add(new UICommandDefinition[]{
                ...
                new UICommandDefinition("Izvjestaji", "Izvještaji", this.Site, false, true, DeklaritMode.All), 
                new UICommandDefinition("Narudzbenice", "Narudžbenice", this.Site + ".Izvjestaji", Resources.ImageResourcesNew.report, null, null), 
