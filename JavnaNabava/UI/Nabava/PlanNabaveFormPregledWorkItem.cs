...
{
    public class PlanNabaveFormPregledWorkItem : MdiWorkItemBase
    {
        public PlanNabaveFormPregledWorkItem()
            : base("PLANNABAVEPREGLED", new PlanNabaveFormPregled())
        {
            this.UICommandDefinitionContainer.Add(new UICommandDefinition[]{
                ...
                new UICommandDefinition("PlanNabave", "Plan nabave", this.Site + ".Izvjestaji", Resources.ImageResourcesNew.report, null, null), 
