...
{
    public class RegistarNabaveFormPregledWorkItem : MdiWorkItemBase
    {
        public RegistarNabaveFormPregledWorkItem()
            : base("REGISTARNABAVEPREGLED", new RegistarNabaveFormPregled())
        {
