...
{
    public class UnosMeduskladisniceFormPregledWorkItem : MdiWorkItemBase
    {
        public UnosMeduskladisniceFormPregledWorkItem()
            : base("UnosMeduskladisnicePregled", new UnosMeduskladisniceFormPregled())
        {
