...
{
    public partial class GrupeProizvodaForm : Controls.BaseUserControl
    {
        #region Properties
        ...
        public GrupeProizvodaForm(FormEditMode formEditMode)
        {
            InitializeComponent();
        ...
        public StringBuilder ValidateDataInput()
        {
            ...
            else if (uteNaziv.Value.ToString().Length > 100)
            {
                message.Append(" - Naziv može sadržavati maksimalno 100 znakova");
            }
