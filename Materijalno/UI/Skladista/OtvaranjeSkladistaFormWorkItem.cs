...
{
    public class OtvaranjeSkladistaFormWorkItem : MdiWorkItemBase
    {
        public OtvaranjeSkladistaFormWorkItem()
            : base("OtvaranjeSkladistaForm", new OtvaranjeSkladistaPregled())
        {
