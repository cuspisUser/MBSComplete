...
{
    public class GrupeProizvoda : Base, IDisposable
    {
        SqlClient client = null;
        public GrupeProizvoda()
            : base()
        {
        ...
        {
            return client.GetDataTable("Select ID, Naziv From MT_GrupeProizvoda");
        }
        ...
        public DataRow GetSelectedRow()
        {
            ...
            sqlUpit.CommandText = "Select ID, Naziv From MT_GrupeProizvoda Where ID = @ID";
        ...
        public bool Delete(StringBuilder message)
        {
            ...
            sqlUpit.CommandText = "Delete from MT_GrupeProizvoda Where ID = @ID";
        ...
        public bool Insert(StringBuilder message, GrupeProizvoda objekt)
        {
            SqlCommand sqlUpit = new SqlCommand();
            sqlUpit.Connection = client.sqlConnection;
            sqlUpit.CommandType = CommandType.Text;

            sqlUpit.CommandText = "Insert Into MT_GrupeProizvoda (Naziv, TS) Values (@Naziv, @TS)";
        ...
        public bool Update(StringBuilder message, GrupeProizvoda objekt)
        {
            SqlCommand sqlUpit = new SqlCommand();
            sqlUpit.Connection = client.sqlConnection;
            sqlUpit.CommandType = CommandType.Text;

            sqlUpit.CommandText = "Update MT_GrupeProizvoda Set Naziv = @Naziv, TS = @TS Where ID = @ID";
