namespace mipsed.application.framework
{
    ...
    public class USER : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        private EntityRef<mipsed.application.framework.KORISNIK> _KORISNIK = new EntityRef<mipsed.application.framework.KORISNIK>();
        ...
        public mipsed.application.framework.KORISNIK KORISNIK
        {
            get
            {
            ...
            set
            {
                mipsed.application.framework.KORISNIK entity = this._KORISNIK.Entity;
