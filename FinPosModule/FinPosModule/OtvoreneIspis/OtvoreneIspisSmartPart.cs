...
namespace FinPosModule.OtvoreneIspis
{

    [SmartPart]
    public class OtvoreneIspisSmartPart : UserControl, ISmartPartInfoProvider, IFilteredView
    {
        ...
        public OtvoreneIspisSmartPart()
        {
            base.Load += new EventHandler(this.OtvoreneIspisSmartPart_Load);
            this.InitializeComponent();
            this.smartPartInfo1 = new SmartPartInfo("Izvještaji-SK-Otvorene stavke", "Izvještaji-SK-Otvorene stavke");
        ...
        {
            new ProgressDialog { WindowStartupLocation = WindowStartupLocation.CenterScreen, DialogText = "Pripremam izvještaj otvorene stavke!", IsCancellingEnabled = false, AutoIncrementInterval = 150 }.RunWorkerThread(1, new DoWorkEventHandler(this.CountUntilCancelled));
        }

        private void BackgroundUpdateSve()
        {
            new ProgressDialog { WindowStartupLocation = WindowStartupLocation.CenterScreen, DialogText = "Pripremam izvještaj otvorene stavke!", IsCancellingEnabled = false, AutoIncrementInterval = 150 }.RunWorkerThread(1, new DoWorkEventHandler(this.CountUntilCancelledSve));
        }
        ...
        {
            S_FIN_OTVORENE_STAVKEDataAdapter adapter = new S_FIN_OTVORENE_STAVKEDataAdapter();
            S_FIN_OTVORENE_STAVKEDataSet dataSet = new S_FIN_OTVORENE_STAVKEDataSet();
            try
            {
                int num = 0;
                int num3 = 0;
                ...
                {
                    num5 = Conversions.ToInteger(this.cmboIDMT.Value);
                }
                else
                {
                    num5 = -1;
                ...
                {
                    num4 = Conversions.ToInteger(this.cmboIDPartner.Value.ToString().Remove(0, this.cmboIDPartner.Value.ToString().LastIndexOf("|") + 1).Trim());
                }
                else
                {
                    num4 = -1;
                ...
                try
                {
                    if (this.CheckBox2.Checked)
                    {
                        try
                        {
                            adapter.Fill(dataSet, num6, num5, num, rAZDOBLJEOD, rAZDOBLJEDO, str, str2, num3, num4, "N", (short) activeYear);
                        }
                    ...
                    else
                    {
                        try
                        {
                            adapter.Fill(dataSet, num6, num5, num, rAZDOBLJEOD, rAZDOBLJEDO, str, str2, num3, num4, "S", (short) activeYear);
                        }
                ...
                this.rpt.Load(System.Windows.Forms.Application.StartupPath + @"\FinposIzvjestaji\rptOtvorene.rpt");
                this.rpt.SetDataSource(dataSet);

                int idPartnerLast = 0;

                if (dataSet.S_FIN_OTVORENE_STAVKE.Rows.Count > 0)
                    idPartnerLast = Convert.ToInt32(dataSet.S_FIN_OTVORENE_STAVKE.Rows[dataSet.S_FIN_OTVORENE_STAVKE.Rows.Count - 1]["IDPARTNER"]);

                this.rpt.SetParameterValue("naslov", "Otvorene stavke poslovnih partnera za razdoblje: " + Conversions.ToString(this.odDatuma.Value) + "-" + Conversions.ToString(this.doDatuma.Value));
                this.rpt.SetParameterValue("idPartnerLast", idPartnerLast);
                this.rpt.SetParameterValue("newPageForEveryPartner", this.CheckBox1.Checked);
        ...
        private void CountUntilCancelledSve(object sender, DoWorkEventArgs e)
        {
            S_FIN_OTVORENE_STAVKEDataAdapter adapter = new S_FIN_OTVORENE_STAVKEDataAdapter();
            S_FIN_OTVORENE_STAVKEDataSet dataSet = new S_FIN_OTVORENE_STAVKEDataSet();
            try
            {
                ...
                try
                {
                    try
                    {
                        adapter.Fill(dataSet, num6, num5, num, rAZDOBLJEOD, rAZDOBLJEDO, str, str2, num3, num4, "BEZ", (short)activeYear);
                    }
                    catch (System.Exception exception5)
                    {
                        throw exception5;
                ...
                this.rpt = new ReportDocument();
                this.rpt.Load(System.Windows.Forms.Application.StartupPath + @"\FinposIzvjestaji\rptOtvoreneSve.rpt");
                this.rpt.SetDataSource(dataSet);
        ...
        private void InitializeComponent()
        {
            ...
            Infragistics.Win.UltraWinDock.DockAreaPane dockAreaPane1 = new Infragistics.Win.UltraWinDock.DockAreaPane(Infragistics.Win.UltraWinDock.DockedLocation.DockedTop, new System.Guid("355829c0-8e35-47d5-ac50-da2605a461cc"));
            Infragistics.Win.UltraWinDock.DockableControlPane dockableControlPane1 = new Infragistics.Win.UltraWinDock.DockableControlPane(new System.Guid("c7f60abe-f7a0-43cb-a5fd-02a083a280ca"), new System.Guid("3fa374eb-a55d-46e1-bd12-cc7f34dabd04"), 0, new System.Guid("355829c0-8e35-47d5-ac50-da2605a461cc"), 0);
            Infragistics.Win.UltraWinDock.DockAreaPane dockAreaPane2 = new Infragistics.Win.UltraWinDock.DockAreaPane(Infragistics.Win.UltraWinDock.DockedLocation.Floating, new System.Guid("3fa374eb-a55d-46e1-bd12-cc7f34dabd04"));
            ...
            this.otvorene = new Infragistics.Win.UltraWinDock.UnpinnedTabArea();
            this._frmOTVORENEUnpinnedTabAreaRight = new Infragistics.Win.UltraWinDock.UnpinnedTabArea();
            this._frmOTVORENEUnpinnedTabAreaTop = new Infragistics.Win.UltraWinDock.UnpinnedTabArea();
            this._frmOTVORENEUnpinnedTabAreaBottom = new Infragistics.Win.UltraWinDock.UnpinnedTabArea();
            this._frmOTVORENEAutoHideControl = new Infragistics.Win.UltraWinDock.AutoHideControl();
            ...
            this.UltraGroupBox1.Size = new System.Drawing.Size(792, 274);
            ...
            this.CheckBox2.Location = new System.Drawing.Point(264, 244);
            this.CheckBox2.Name = "CheckBox2";
            this.CheckBox2.Size = new System.Drawing.Size(250, 24);
            this.CheckBox2.TabIndex = 1;
            this.CheckBox2.Text = "Partneri po abecednome redu";
            ...
            this.CheckBox1.Location = new System.Drawing.Point(6, 244);
            ...
            // UltraDockManager1
            // 
            dockAreaPane1.DockedBefore = new System.Guid("3fa374eb-a55d-46e1-bd12-cc7f34dabd04");
            dockableControlPane1.Control = this.UltraGroupBox1;
            dockableControlPane1.OriginalControlBounds = new System.Drawing.Rectangle(4, 30, 552, 292);
            dockableControlPane1.Settings.AllowClose = Infragistics.Win.DefaultableBoolean.False;
            dockableControlPane1.Size = new System.Drawing.Size(100, 100);
            dockAreaPane1.Panes.AddRange(new Infragistics.Win.UltraWinDock.DockablePaneBase[] {
            dockableControlPane1});
            dockAreaPane1.Size = new System.Drawing.Size(792, 292);
            dockAreaPane2.Size = new System.Drawing.Size(792, 292);
            ...
            // otvorene
            // 
            this.otvorene.Dock = System.Windows.Forms.DockStyle.Left;
            this.otvorene.Font = new System.Drawing.Font("Microsoft Sans Serif", 8.25F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(238)));
            this.otvorene.Location = new System.Drawing.Point(0, 0);
            this.otvorene.Name = "otvorene";
            this.otvorene.Owner = this.UltraDockManager1;
            this.otvorene.Size = new System.Drawing.Size(0, 420);
            this.otvorene.TabIndex = 108;
            // 
            // _frmOTVORENEUnpinnedTabAreaRight
            // 
            this._frmOTVORENEUnpinnedTabAreaRight.Dock = System.Windows.Forms.DockStyle.Right;
            this._frmOTVORENEUnpinnedTabAreaRight.Font = new System.Drawing.Font("Microsoft Sans Serif", 8.25F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(238)));
            this._frmOTVORENEUnpinnedTabAreaRight.Location = new System.Drawing.Point(792, 0);
            this._frmOTVORENEUnpinnedTabAreaRight.Name = "_frmOTVORENEUnpinnedTabAreaRight";
            this._frmOTVORENEUnpinnedTabAreaRight.Owner = this.UltraDockManager1;
            this._frmOTVORENEUnpinnedTabAreaRight.Size = new System.Drawing.Size(0, 420);
            this._frmOTVORENEUnpinnedTabAreaRight.TabIndex = 109;
            // 
            // _frmOTVORENEUnpinnedTabAreaTop
            // 
            this._frmOTVORENEUnpinnedTabAreaTop.Dock = System.Windows.Forms.DockStyle.Top;
            this._frmOTVORENEUnpinnedTabAreaTop.Font = new System.Drawing.Font("Microsoft Sans Serif", 8.25F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(238)));
            this._frmOTVORENEUnpinnedTabAreaTop.Location = new System.Drawing.Point(0, 0);
            this._frmOTVORENEUnpinnedTabAreaTop.Name = "_frmOTVORENEUnpinnedTabAreaTop";
            this._frmOTVORENEUnpinnedTabAreaTop.Owner = this.UltraDockManager1;
            this._frmOTVORENEUnpinnedTabAreaTop.Size = new System.Drawing.Size(792, 0);
            this._frmOTVORENEUnpinnedTabAreaTop.TabIndex = 110;
            // 
            // _frmOTVORENEUnpinnedTabAreaBottom
            // 
            this._frmOTVORENEUnpinnedTabAreaBottom.Dock = System.Windows.Forms.DockStyle.Bottom;
            this._frmOTVORENEUnpinnedTabAreaBottom.Font = new System.Drawing.Font("Microsoft Sans Serif", 8.25F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(238)));
            this._frmOTVORENEUnpinnedTabAreaBottom.Location = new System.Drawing.Point(0, 420);
            this._frmOTVORENEUnpinnedTabAreaBottom.Name = "_frmOTVORENEUnpinnedTabAreaBottom";
            this._frmOTVORENEUnpinnedTabAreaBottom.Owner = this.UltraDockManager1;
            this._frmOTVORENEUnpinnedTabAreaBottom.Size = new System.Drawing.Size(792, 0);
            this._frmOTVORENEUnpinnedTabAreaBottom.TabIndex = 111;
            // 
            // _frmOTVORENEAutoHideControl
            // 
            this._frmOTVORENEAutoHideControl.Font = new System.Drawing.Font("Microsoft Sans Serif", 8.25F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(238)));
            this._frmOTVORENEAutoHideControl.Location = new System.Drawing.Point(0, 0);
            this._frmOTVORENEAutoHideControl.Name = "_frmOTVORENEAutoHideControl";
            this._frmOTVORENEAutoHideControl.Owner = this.UltraDockManager1;
            this._frmOTVORENEAutoHideControl.Size = new System.Drawing.Size(0, 0);
            this._frmOTVORENEAutoHideControl.TabIndex = 112;
            // 
            // WindowDockingArea2
            // 
            ...
            this.WindowDockingArea2.Size = new System.Drawing.Size(792, 297);
            this.WindowDockingArea2.TabIndex = 114;
            // 
            // DockableWindow2
            // 
            ...
            this.DockableWindow2.Size = new System.Drawing.Size(792, 292);
            this.DockableWindow2.TabIndex = 116;
            // 
            // RPV
            // 
            ...
            this.RPV.Location = new System.Drawing.Point(0, 297);
            this.RPV.Name = "RPV";
            this.RPV.Size = new System.Drawing.Size(792, 123);
            this.RPV.TabIndex = 115;
            ...
            this.WindowDockingArea1.Size = new System.Drawing.Size(792, 292);
            ...
            this.cbkPartnerUcenik.Location = new System.Drawing.Point(652, 26);
            this.cbkPartnerUcenik.Name = "cbkPartnerUcenik";
            this.cbkPartnerUcenik.Size = new System.Drawing.Size(103, 17);
            this.cbkPartnerUcenik.TabIndex = 18;
            this.cbkPartnerUcenik.Text = "Partneri/Učenici";
            this.cbkPartnerUcenik.UseVisualStyleBackColor = false;
            // 
            // OtvoreneIspisSmartPart
            // 
            this.Controls.Add(this._frmOTVORENEAutoHideControl);
            this.Controls.Add(this.RPV);
            this.Controls.Add(this.WindowDockingArea2);
            this.Controls.Add(this._frmOTVORENEUnpinnedTabAreaTop);
            this.Controls.Add(this._frmOTVORENEUnpinnedTabAreaBottom);
            this.Controls.Add(this.otvorene);
            this.Controls.Add(this._frmOTVORENEUnpinnedTabAreaRight);
            this.Name = "OtvoreneIspisSmartPart";
        ...
        private void Ispisi()
        {
            ...
            ExtendedWindowSmartPartInfo info = new ExtendedWindowSmartPartInfo {
                ...
                Modal = true,
                Title = "Pregled izvještaja - Otvorene stavke",
                Description = "Pregled izvještaja - Otvorene stavke",
        ...
        private void IspisiSve()
        {
            this.BackgroundUpdateSve();
            ExtendedWindowSmartPartInfo info = new ExtendedWindowSmartPartInfo
            {
                StartPosition = FormStartPosition.CenterParent,
                Modal = true,
        ...
        [LocalCommandHandler("KreirajSve")]
        public void KreirajSveHandler(object sender, EventArgs e)
        {
            //this.IspisiSve();
            System.Windows.Forms.MessageBox.Show("U implementaciji...");
        }

        private void OtvoreneIspisSmartPart_Load(object sender, EventArgs e)
        {
        ...
        private AutoHideControl _frmOTVORENEAutoHideControl;

        private UnpinnedTabArea _frmOTVORENEUnpinnedTabAreaBottom;

        private UnpinnedTabArea _frmOTVORENEUnpinnedTabAreaRight;

        private UnpinnedTabArea _frmOTVORENEUnpinnedTabAreaTop;
        ...
        private UnpinnedTabArea otvorene;
