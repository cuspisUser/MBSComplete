namespace Placa
{
    ...
    public class PregledRadnikaDataReader : IDisposable
    {
        ...
        public PregledRadnikaDataReader()
        {
        ...
        public class OrderAttribute
        {
            ...
            public PregledRadnikaDataReader.Attribute OrderAttributeName;
            public string OrderAttributeString;

            public OrderAttribute(PregledRadnikaDataReader.Attribute orderAttributeName)
            {
                this.OrderAttributeName = orderAttributeName;
                this.OrderAttributeAscending = true;
                this.OrderAttributeString = PregledRadnikaDataReader.attributeNames[(int) this.OrderAttributeName];
            }

            public OrderAttribute(PregledRadnikaDataReader.Attribute orderAttributeName, bool orderAttributeAscending)
            {
                this.OrderAttributeName = orderAttributeName;
