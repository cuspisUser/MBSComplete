namespace Placa
{
    ...
    [Serializable]
    public class S_FIN_KARTICEPARTNERADataSet : DataSet
    {
        private System.Data.SchemaSerializationMode _schemaSerializationMode;
        private S_FIN_KARTICEPARTNERADataTable tableS_FIN_KARTICEPARTNERA;

        public S_FIN_KARTICEPARTNERADataSet()
        {
        ...
        protected S_FIN_KARTICEPARTNERADataSet(SerializationInfo info, StreamingContext context) : base(info, context, false)
        {
            this._schemaSerializationMode = System.Data.SchemaSerializationMode.IncludeSchema;
            ...
            else
            {
                ...
                if (this.DetermineSchemaSerializationMode(info, context) == System.Data.SchemaSerializationMode.IncludeSchema)
                {
                    ...
                    if (dataSet.Tables["S_FIN_KARTICEPARTNERA"] != null)
                    {
                        this.Tables.Add(new S_FIN_KARTICEPARTNERADataTable(dataSet.Tables["S_FIN_KARTICEPARTNERA"]));
                    }
        ...
        {
            S_FIN_KARTICEPARTNERADataSet set = (S_FIN_KARTICEPARTNERADataSet) base.Clone();
            set.InitVars();
            return set;
        }
        ...
        {
            S_FIN_KARTICEPARTNERADataSet set = new S_FIN_KARTICEPARTNERADataSet();
        ...
        {
            this.InitClassBase();
            this.ExtendedProperties.Add("DataAdapterName", "S_FIN_KARTICEPARTNERADataAdapter");
            this.ExtendedProperties.Add("BigImage", " ");
            this.ExtendedProperties.Add("SmallImage", " ");
            this.ExtendedProperties.Add("Image", " ");
            this.ExtendedProperties.Add("Deklarit.PermissionBaseId", "2164");
            this.ExtendedProperties.Add("DataSetName", "S_FIN_KARTICEPARTNERADataSet");
            this.ExtendedProperties.Add("DataAdapterInterfaceName", "IS_FIN_KARTICEPARTNERADataAdapter");
            this.ExtendedProperties.Add("ObjectName", "S_FIN_KARTICEPARTNERA");
            this.ExtendedProperties.Add("ObjectDescription", "S_FIN_KARTICE_PARTNERA");
            this.ExtendedProperties.Add("ObjectType", "DataProvider");
            this.ExtendedProperties.Add("ObjectPath", @"\DataProviders\DP_FINPOS");
            this.ExtendedProperties.Add("NameSpace", "Placa");
            this.ExtendedProperties.Add("DataChangeFrequency", "PrettyOften");
            this.ExtendedProperties.Add("CachePriority", "Medium");
            this.ExtendedProperties.Add("Deklarit.StoredProcedure", "S_FIN_KARTICE_PARTNERA");
        ...
        {
            this.DataSetName = "S_FIN_KARTICEPARTNERADataSet";
            this.Namespace = "http://www.tempuri.org/S_FIN_KARTICEPARTNERA";
            this.tableS_FIN_KARTICEPARTNERA = new S_FIN_KARTICEPARTNERADataTable();
            this.Tables.Add(this.tableS_FIN_KARTICEPARTNERA);
        }
        ...
        {
            this.tableS_FIN_KARTICEPARTNERA = (S_FIN_KARTICEPARTNERADataTable) this.Tables["S_FIN_KARTICEPARTNERA"];
            if (initTable && (this.tableS_FIN_KARTICEPARTNERA != null))
            {
                this.tableS_FIN_KARTICEPARTNERA.InitVars();
            }
        }
        ...
        private bool ShouldSerializeS_FIN_KARTICEPARTNERA()
        {
            return false;
        }
        ...
        public S_FIN_KARTICEPARTNERADataTable S_FIN_KARTICEPARTNERA
        {
            get
            {
                return this.tableS_FIN_KARTICEPARTNERA;
            }
        }
        ...
        [Serializable]
        public class S_FIN_KARTICEPARTNERADataTable : DataTable, IEnumerable
        {
            ...
            public event S_FIN_KARTICEPARTNERADataSet.S_FIN_KARTICEPARTNERARowChangeEventHandler S_FIN_KARTICEPARTNERARowChanged;

            public event S_FIN_KARTICEPARTNERADataSet.S_FIN_KARTICEPARTNERARowChangeEventHandler S_FIN_KARTICEPARTNERARowChanging;

            public event S_FIN_KARTICEPARTNERADataSet.S_FIN_KARTICEPARTNERARowChangeEventHandler S_FIN_KARTICEPARTNERARowDeleted;

            public event S_FIN_KARTICEPARTNERADataSet.S_FIN_KARTICEPARTNERARowChangeEventHandler S_FIN_KARTICEPARTNERARowDeleting;

            public S_FIN_KARTICEPARTNERADataTable()
            {
                this.TableName = "S_FIN_KARTICEPARTNERA";
                this.BeginInit();
                this.InitClass();
                this.EndInit();
            }

            internal S_FIN_KARTICEPARTNERADataTable(DataTable table) : base(table.TableName)
            {
            ...
            protected S_FIN_KARTICEPARTNERADataTable(SerializationInfo info, StreamingContext context) : base(info, context)
            {
                this.InitVars();
            }

            public void AddS_FIN_KARTICEPARTNERARow(S_FIN_KARTICEPARTNERADataSet.S_FIN_KARTICEPARTNERARow row)
            {
                this.Rows.Add(row);
            }

            public S_FIN_KARTICEPARTNERADataSet.S_FIN_KARTICEPARTNERARow AddS_FIN_KARTICEPARTNERARow(decimal duguje, decimal pOTRAZUJE, string konto, DateTime dATUMDVO, DateTime dATUMVALUTE, DateTime dATUMDOK, string sKRACENI, int bROJDOK, int bROJSTAVKE, string oPISKNJIZENJA, int iDPARTNER, string nAZIVKONTO, int iDDOKUMENT, string nAZIVPARTNER, int iDORGJED, int iDMJESTOTROSKA, string mB, string pARTNERMJESTO, string pARTNERULICA, string oRIGINALNIDOKUMENT, string nAZIVOJ, string nAZIVMT)
            {
                S_FIN_KARTICEPARTNERADataSet.S_FIN_KARTICEPARTNERARow row = (S_FIN_KARTICEPARTNERADataSet.S_FIN_KARTICEPARTNERARow) this.NewRow();
                row.ItemArray = new object[] { 
                    duguje, pOTRAZUJE, konto, dATUMDVO, dATUMVALUTE, dATUMDOK, sKRACENI, bROJDOK, bROJSTAVKE, oPISKNJIZENJA, iDPARTNER, nAZIVKONTO, iDDOKUMENT, nAZIVPARTNER, iDORGJED, iDMJESTOTROSKA, 
                    mB, pARTNERMJESTO, pARTNERULICA, oRIGINALNIDOKUMENT, nAZIVOJ, nAZIVMT
                 };
                this.Rows.Add(row);
                return row;
            }
            ...
            {
                S_FIN_KARTICEPARTNERADataSet.S_FIN_KARTICEPARTNERADataTable table = (S_FIN_KARTICEPARTNERADataSet.S_FIN_KARTICEPARTNERADataTable) base.Clone();
                table.InitVars();
                return table;
            }
            ...
            {
                return typeof(S_FIN_KARTICEPARTNERADataSet.S_FIN_KARTICEPARTNERARow);
            }
            ...
            public void InitClass()
            {
                ...
                this.ExtendedProperties.Add("LevelName", "S_FIN_KARTICEPARTNERA");
                this.ExtendedProperties.Add("Description", "S_FIN_KARTICE_PARTNERA");
            ...
            {
                return new S_FIN_KARTICEPARTNERADataSet.S_FIN_KARTICEPARTNERARow(builder);
            }

            public S_FIN_KARTICEPARTNERADataSet.S_FIN_KARTICEPARTNERARow NewS_FIN_KARTICEPARTNERARow()
            {
                return (S_FIN_KARTICEPARTNERADataSet.S_FIN_KARTICEPARTNERARow) this.NewRow();
            }

            protected override void OnRowChanged(DataRowChangeEventArgs e)
            {
                base.OnRowChanged(e);
                if (this.S_FIN_KARTICEPARTNERARowChanged != null)
                {
                    S_FIN_KARTICEPARTNERADataSet.S_FIN_KARTICEPARTNERARowChangeEventHandler handler = this.S_FIN_KARTICEPARTNERARowChanged;
                    if (handler != null)
                    {
                        handler(this, new S_FIN_KARTICEPARTNERADataSet.S_FIN_KARTICEPARTNERARowChangeEvent((S_FIN_KARTICEPARTNERADataSet.S_FIN_KARTICEPARTNERARow) e.Row, e.Action));
                    }
                }
            }
            ...
            protected override void OnRowChanging(DataRowChangeEventArgs e)
            {
                ...
                if (this.S_FIN_KARTICEPARTNERARowChanging != null)
                {
                    S_FIN_KARTICEPARTNERADataSet.S_FIN_KARTICEPARTNERARowChangeEventHandler handler = this.S_FIN_KARTICEPARTNERARowChanging;
                    if (handler != null)
                    {
                        handler(this, new S_FIN_KARTICEPARTNERADataSet.S_FIN_KARTICEPARTNERARowChangeEvent((S_FIN_KARTICEPARTNERADataSet.S_FIN_KARTICEPARTNERARow) e.Row, e.Action));
                    }
            ...
            {
                base.OnRowDeleted(e);
                if (this.S_FIN_KARTICEPARTNERARowDeleted != null)
                {
                    S_FIN_KARTICEPARTNERADataSet.S_FIN_KARTICEPARTNERARowChangeEventHandler handler = this.S_FIN_KARTICEPARTNERARowDeleted;
                    if (handler != null)
                    {
                        handler(this, new S_FIN_KARTICEPARTNERADataSet.S_FIN_KARTICEPARTNERARowChangeEvent((S_FIN_KARTICEPARTNERADataSet.S_FIN_KARTICEPARTNERARow) e.Row, e.Action));
                    }
            ...
            protected override void OnRowDeleting(DataRowChangeEventArgs e)
            {
                ...
                if (this.S_FIN_KARTICEPARTNERARowDeleting != null)
                {
                    S_FIN_KARTICEPARTNERADataSet.S_FIN_KARTICEPARTNERARowChangeEventHandler handler = this.S_FIN_KARTICEPARTNERARowDeleting;
                    if (handler != null)
                    {
                        handler(this, new S_FIN_KARTICEPARTNERADataSet.S_FIN_KARTICEPARTNERARowChangeEvent((S_FIN_KARTICEPARTNERADataSet.S_FIN_KARTICEPARTNERARow) e.Row, e.Action));
                    }
            ...
            public void RemoveS_FIN_KARTICEPARTNERARow(S_FIN_KARTICEPARTNERADataSet.S_FIN_KARTICEPARTNERARow row)
            {
            ...
            public S_FIN_KARTICEPARTNERADataSet.S_FIN_KARTICEPARTNERARow this[int index]
            {
                get
                {
                    return (S_FIN_KARTICEPARTNERADataSet.S_FIN_KARTICEPARTNERARow) this.Rows[index];
                }
            }
        ...
        public class S_FIN_KARTICEPARTNERARow : DataRow
        {
            private S_FIN_KARTICEPARTNERADataSet.S_FIN_KARTICEPARTNERADataTable tableS_FIN_KARTICEPARTNERA;

            internal S_FIN_KARTICEPARTNERARow(DataRowBuilder rb) : base(rb)
            {
                this.tableS_FIN_KARTICEPARTNERA = (S_FIN_KARTICEPARTNERADataSet.S_FIN_KARTICEPARTNERADataTable) this.Table;
            }

            public bool IsBROJDOKNull()
            {
                return this.IsNull(this.tableS_FIN_KARTICEPARTNERA.BROJDOKColumn);
            }

            public bool IsBROJSTAVKENull()
            {
                return this.IsNull(this.tableS_FIN_KARTICEPARTNERA.BROJSTAVKEColumn);
            }

            public bool IsDATUMDOKNull()
            {
                return this.IsNull(this.tableS_FIN_KARTICEPARTNERA.DATUMDOKColumn);
            }

            public bool IsDATUMDVONull()
            {
                return this.IsNull(this.tableS_FIN_KARTICEPARTNERA.DATUMDVOColumn);
            }

            public bool IsDATUMVALUTENull()
            {
                return this.IsNull(this.tableS_FIN_KARTICEPARTNERA.DATUMVALUTEColumn);
            }

            public bool IsdugujeNull()
            {
                return this.IsNull(this.tableS_FIN_KARTICEPARTNERA.dugujeColumn);
            }

            public bool IsIDDOKUMENTNull()
            {
                return this.IsNull(this.tableS_FIN_KARTICEPARTNERA.IDDOKUMENTColumn);
            }

            public bool IsIDMJESTOTROSKANull()
            {
                return this.IsNull(this.tableS_FIN_KARTICEPARTNERA.IDMJESTOTROSKAColumn);
            }

            public bool IsIDORGJEDNull()
            {
                return this.IsNull(this.tableS_FIN_KARTICEPARTNERA.IDORGJEDColumn);
            }

            public bool IsIDPARTNERNull()
            {
                return this.IsNull(this.tableS_FIN_KARTICEPARTNERA.IDPARTNERColumn);
            }

            public bool IskontoNull()
            {
                return this.IsNull(this.tableS_FIN_KARTICEPARTNERA.kontoColumn);
            }

            public bool IsMBNull()
            {
                return this.IsNull(this.tableS_FIN_KARTICEPARTNERA.MBColumn);
            }

            public bool IsNAZIVKONTONull()
            {
                return this.IsNull(this.tableS_FIN_KARTICEPARTNERA.NAZIVKONTOColumn);
            }

            public bool IsNAZIVMTNull()
            {
                return this.IsNull(this.tableS_FIN_KARTICEPARTNERA.NAZIVMTColumn);
            }

            public bool IsNAZIVOJNull()
            {
                return this.IsNull(this.tableS_FIN_KARTICEPARTNERA.NAZIVOJColumn);
            }

            public bool IsNAZIVPARTNERNull()
            {
                return this.IsNull(this.tableS_FIN_KARTICEPARTNERA.NAZIVPARTNERColumn);
            }

            public bool IsOPISKNJIZENJANull()
            {
                return this.IsNull(this.tableS_FIN_KARTICEPARTNERA.OPISKNJIZENJAColumn);
            }

            public bool IsORIGINALNIDOKUMENTNull()
            {
                return this.IsNull(this.tableS_FIN_KARTICEPARTNERA.ORIGINALNIDOKUMENTColumn);
            }

            public bool IsPARTNERMJESTONull()
            {
                return this.IsNull(this.tableS_FIN_KARTICEPARTNERA.PARTNERMJESTOColumn);
            }

            public bool IsPARTNERULICANull()
            {
                return this.IsNull(this.tableS_FIN_KARTICEPARTNERA.PARTNERULICAColumn);
            }

            public bool IsPOTRAZUJENull()
            {
                return this.IsNull(this.tableS_FIN_KARTICEPARTNERA.POTRAZUJEColumn);
            }

            public bool IsSKRACENINull()
            {
                return this.IsNull(this.tableS_FIN_KARTICEPARTNERA.SKRACENIColumn);
            }

            public void SetBROJDOKNull()
            {
                this[this.tableS_FIN_KARTICEPARTNERA.BROJDOKColumn] = RuntimeHelpers.GetObjectValue(Convert.DBNull);
            }

            public void SetBROJSTAVKENull()
            {
                this[this.tableS_FIN_KARTICEPARTNERA.BROJSTAVKEColumn] = RuntimeHelpers.GetObjectValue(Convert.DBNull);
            }

            public void SetDATUMDOKNull()
            {
                this[this.tableS_FIN_KARTICEPARTNERA.DATUMDOKColumn] = RuntimeHelpers.GetObjectValue(Convert.DBNull);
            }

            public void SetDATUMDVONull()
            {
                this[this.tableS_FIN_KARTICEPARTNERA.DATUMDVOColumn] = RuntimeHelpers.GetObjectValue(Convert.DBNull);
            }

            public void SetDATUMVALUTENull()
            {
                this[this.tableS_FIN_KARTICEPARTNERA.DATUMVALUTEColumn] = RuntimeHelpers.GetObjectValue(Convert.DBNull);
            }

            public void SetdugujeNull()
            {
                this[this.tableS_FIN_KARTICEPARTNERA.dugujeColumn] = RuntimeHelpers.GetObjectValue(Convert.DBNull);
            }

            public void SetIDDOKUMENTNull()
            {
                this[this.tableS_FIN_KARTICEPARTNERA.IDDOKUMENTColumn] = RuntimeHelpers.GetObjectValue(Convert.DBNull);
            }

            public void SetIDMJESTOTROSKANull()
            {
                this[this.tableS_FIN_KARTICEPARTNERA.IDMJESTOTROSKAColumn] = RuntimeHelpers.GetObjectValue(Convert.DBNull);
            }

            public void SetIDORGJEDNull()
            {
                this[this.tableS_FIN_KARTICEPARTNERA.IDORGJEDColumn] = RuntimeHelpers.GetObjectValue(Convert.DBNull);
            }

            public void SetIDPARTNERNull()
            {
                this[this.tableS_FIN_KARTICEPARTNERA.IDPARTNERColumn] = RuntimeHelpers.GetObjectValue(Convert.DBNull);
            }

            public void SetkontoNull()
            {
                this[this.tableS_FIN_KARTICEPARTNERA.kontoColumn] = RuntimeHelpers.GetObjectValue(Convert.DBNull);
            }

            public void SetMBNull()
            {
                this[this.tableS_FIN_KARTICEPARTNERA.MBColumn] = RuntimeHelpers.GetObjectValue(Convert.DBNull);
            }

            public void SetNAZIVKONTONull()
            {
                this[this.tableS_FIN_KARTICEPARTNERA.NAZIVKONTOColumn] = RuntimeHelpers.GetObjectValue(Convert.DBNull);
            }

            public void SetNAZIVMTNull()
            {
                this[this.tableS_FIN_KARTICEPARTNERA.NAZIVMTColumn] = RuntimeHelpers.GetObjectValue(Convert.DBNull);
            }

            public void SetNAZIVOJNull()
            {
                this[this.tableS_FIN_KARTICEPARTNERA.NAZIVOJColumn] = RuntimeHelpers.GetObjectValue(Convert.DBNull);
            }

            public void SetNAZIVPARTNERNull()
            {
                this[this.tableS_FIN_KARTICEPARTNERA.NAZIVPARTNERColumn] = RuntimeHelpers.GetObjectValue(Convert.DBNull);
            }

            public void SetOPISKNJIZENJANull()
            {
                this[this.tableS_FIN_KARTICEPARTNERA.OPISKNJIZENJAColumn] = RuntimeHelpers.GetObjectValue(Convert.DBNull);
            }

            public void SetORIGINALNIDOKUMENTNull()
            {
                this[this.tableS_FIN_KARTICEPARTNERA.ORIGINALNIDOKUMENTColumn] = RuntimeHelpers.GetObjectValue(Convert.DBNull);
            }

            public void SetPARTNERMJESTONull()
            {
                this[this.tableS_FIN_KARTICEPARTNERA.PARTNERMJESTOColumn] = RuntimeHelpers.GetObjectValue(Convert.DBNull);
            }

            public void SetPARTNERULICANull()
            {
                this[this.tableS_FIN_KARTICEPARTNERA.PARTNERULICAColumn] = RuntimeHelpers.GetObjectValue(Convert.DBNull);
            }

            public void SetPOTRAZUJENull()
            {
                this[this.tableS_FIN_KARTICEPARTNERA.POTRAZUJEColumn] = RuntimeHelpers.GetObjectValue(Convert.DBNull);
            }

            public void SetSKRACENINull()
            {
                this[this.tableS_FIN_KARTICEPARTNERA.SKRACENIColumn] = RuntimeHelpers.GetObjectValue(Convert.DBNull);
            }
            ...
            public int BROJDOK
            {
                get
                {
                    ...
                    try
                    {
                        num = Conversions.ToInteger(this[this.tableS_FIN_KARTICEPARTNERA.BROJDOKColumn]);
                    }
                ...
                set
                {
                    this[this.tableS_FIN_KARTICEPARTNERA.BROJDOKColumn] = value;
                }
            }
            ...
            public int BROJSTAVKE
            {
                get
                {
                    ...
                    try
                    {
                        num = Conversions.ToInteger(this[this.tableS_FIN_KARTICEPARTNERA.BROJSTAVKEColumn]);
                    }
                    catch (InvalidCastException exception1)
                    {
                        throw exception1;
                ...
                set
                {
                    this[this.tableS_FIN_KARTICEPARTNERA.BROJSTAVKEColumn] = value;
                }
            }
            ...
            public DateTime DATUMDOK
            {
                get
                {
                    ...
                    try
                    {
                        time = Conversions.ToDate(this[this.tableS_FIN_KARTICEPARTNERA.DATUMDOKColumn]);
                    }
                    catch (InvalidCastException exception1)
                    {
                        throw exception1;
                ...
                set
                {
                    this[this.tableS_FIN_KARTICEPARTNERA.DATUMDOKColumn] = value;
                }
            }
            ...
            public DateTime DATUMDVO
            {
                get
                {
                    ...
                    try
                    {
                        time = Conversions.ToDate(this[this.tableS_FIN_KARTICEPARTNERA.DATUMDVOColumn]);
                    }
                    catch (InvalidCastException exception1)
                    {
                        throw exception1;
                ...
                set
                {
                    this[this.tableS_FIN_KARTICEPARTNERA.DATUMDVOColumn] = value;
                }
            }
            ...
            public DateTime DATUMVALUTE
            {
                get
                {
                    ...
                    try
                    {
                        time = Conversions.ToDate(this[this.tableS_FIN_KARTICEPARTNERA.DATUMVALUTEColumn]);
                    }
                    catch (InvalidCastException exception1)
                    {
                        throw exception1;
                ...
                set
                {
                    this[this.tableS_FIN_KARTICEPARTNERA.DATUMVALUTEColumn] = value;
                }
            }
            ...
            public decimal duguje
            {
                get
                {
                    ...
                    try
                    {
                        num = Conversions.ToDecimal(this[this.tableS_FIN_KARTICEPARTNERA.dugujeColumn]);
                    }
                    catch (InvalidCastException exception1)
                    {
                        throw exception1;
                ...
                set
                {
                    this[this.tableS_FIN_KARTICEPARTNERA.dugujeColumn] = value;
                }
            }
            ...
            public int IDDOKUMENT
            {
                get
                {
                    ...
                    try
                    {
                        num = Conversions.ToInteger(this[this.tableS_FIN_KARTICEPARTNERA.IDDOKUMENTColumn]);
                    }
                    catch (InvalidCastException exception1)
                    {
                        throw exception1;
                ...
                set
                {
                    this[this.tableS_FIN_KARTICEPARTNERA.IDDOKUMENTColumn] = value;
                }
            }
            ...
            public int IDMJESTOTROSKA
            {
                get
                {
                    ...
                    try
                    {
                        num = Conversions.ToInteger(this[this.tableS_FIN_KARTICEPARTNERA.IDMJESTOTROSKAColumn]);
                    }
                    catch (InvalidCastException exception1)
                    {
                        throw exception1;
                ...
                set
                {
                    this[this.tableS_FIN_KARTICEPARTNERA.IDMJESTOTROSKAColumn] = value;
                }
            }
            ...
            public int IDORGJED
            {
                get
                {
                    ...
                    try
                    {
                        num = Conversions.ToInteger(this[this.tableS_FIN_KARTICEPARTNERA.IDORGJEDColumn]);
                    }
                    catch (InvalidCastException exception1)
                    {
                        throw exception1;
                ...
                set
                {
                    this[this.tableS_FIN_KARTICEPARTNERA.IDORGJEDColumn] = value;
                }
            }
            ...
            public int IDPARTNER
            {
                get
                {
                    ...
                    try
                    {
                        num = Conversions.ToInteger(this[this.tableS_FIN_KARTICEPARTNERA.IDPARTNERColumn]);
                    }
                    catch (InvalidCastException exception1)
                    {
                        throw exception1;
                ...
                set
                {
                    this[this.tableS_FIN_KARTICEPARTNERA.IDPARTNERColumn] = value;
                }
            }
            ...
            public string konto
            {
                get
                {
                    ...
                    try
                    {
                        str = Conversions.ToString(this[this.tableS_FIN_KARTICEPARTNERA.kontoColumn]);
                    }
                    catch (InvalidCastException exception1)
                    {
                        throw exception1;
                ...
                set
                {
                    this[this.tableS_FIN_KARTICEPARTNERA.kontoColumn] = value;
                }
            }
            ...
            public string MB
            {
                get
                {
                    ...
                    try
                    {
                        str = Conversions.ToString(this[this.tableS_FIN_KARTICEPARTNERA.MBColumn]);
                    }
                    catch (InvalidCastException exception1)
                    {
                        throw exception1;
                ...
                set
                {
                    this[this.tableS_FIN_KARTICEPARTNERA.MBColumn] = value;
                }
            }
            ...
            public string NAZIVKONTO
            {
                get
                {
                    ...
                    try
                    {
                        str = Conversions.ToString(this[this.tableS_FIN_KARTICEPARTNERA.NAZIVKONTOColumn]);
                    }
                    catch (InvalidCastException exception1)
                    {
                        throw exception1;
                ...
                set
                {
                    this[this.tableS_FIN_KARTICEPARTNERA.NAZIVKONTOColumn] = value;
                }
            }
            ...
            public string NAZIVMT
            {
                get
                {
                    ...
                    try
                    {
                        str = Conversions.ToString(this[this.tableS_FIN_KARTICEPARTNERA.NAZIVMTColumn]);
                    }
                    catch (InvalidCastException exception1)
                    {
                        throw exception1;
                ...
                set
                {
                    this[this.tableS_FIN_KARTICEPARTNERA.NAZIVMTColumn] = value;
                }
            }
            ...
            public string NAZIVOJ
            {
                get
                {
                    ...
                    try
                    {
                        str = Conversions.ToString(this[this.tableS_FIN_KARTICEPARTNERA.NAZIVOJColumn]);
                    }
                    catch (InvalidCastException exception1)
                    {
                        throw exception1;
                ...
                set
                {
                    this[this.tableS_FIN_KARTICEPARTNERA.NAZIVOJColumn] = value;
                }
            }
            ...
            public string NAZIVPARTNER
            {
                get
                {
                    ...
                    try
                    {
                        str = Conversions.ToString(this[this.tableS_FIN_KARTICEPARTNERA.NAZIVPARTNERColumn]);
                    }
                    catch (InvalidCastException exception1)
                    {
                        throw exception1;
                ...
                set
                {
                    this[this.tableS_FIN_KARTICEPARTNERA.NAZIVPARTNERColumn] = value;
                }
            }
            ...
            public string OPISKNJIZENJA
            {
                get
                {
                    ...
                    try
                    {
                        str = Conversions.ToString(this[this.tableS_FIN_KARTICEPARTNERA.OPISKNJIZENJAColumn]);
                    }
                    catch (InvalidCastException exception1)
                    {
                        throw exception1;
                ...
                set
                {
                    this[this.tableS_FIN_KARTICEPARTNERA.OPISKNJIZENJAColumn] = value;
                }
            }
            ...
            public string ORIGINALNIDOKUMENT
            {
                get
                {
                    ...
                    try
                    {
                        str = Conversions.ToString(this[this.tableS_FIN_KARTICEPARTNERA.ORIGINALNIDOKUMENTColumn]);
                    }
                    catch (InvalidCastException exception1)
                    {
                        throw exception1;
                ...
                set
                {
                    this[this.tableS_FIN_KARTICEPARTNERA.ORIGINALNIDOKUMENTColumn] = value;
                }
            }
            ...
            public string PARTNERMJESTO
            {
                get
                {
                    ...
                    try
                    {
                        str = Conversions.ToString(this[this.tableS_FIN_KARTICEPARTNERA.PARTNERMJESTOColumn]);
                    }
                    catch (InvalidCastException exception1)
                    {
                        throw exception1;
                ...
                set
                {
                    this[this.tableS_FIN_KARTICEPARTNERA.PARTNERMJESTOColumn] = value;
                }
            }
            ...
            public string PARTNERULICA
            {
                get
                {
                    ...
                    try
                    {
                        str = Conversions.ToString(this[this.tableS_FIN_KARTICEPARTNERA.PARTNERULICAColumn]);
                    }
                    catch (InvalidCastException exception1)
                    {
                        throw exception1;
                ...
                set
                {
                    this[this.tableS_FIN_KARTICEPARTNERA.PARTNERULICAColumn] = value;
                }
            }
            ...
            public decimal POTRAZUJE
            {
                get
                {
                    ...
                    try
                    {
                        num = Conversions.ToDecimal(this[this.tableS_FIN_KARTICEPARTNERA.POTRAZUJEColumn]);
                    }
                    catch (InvalidCastException exception1)
                    {
                        throw exception1;
                ...
                set
                {
                    this[this.tableS_FIN_KARTICEPARTNERA.POTRAZUJEColumn] = value;
                }
            }
            ...
            public string SKRACENI
            {
                get
                {
                    ...
                    try
                    {
                        str = Conversions.ToString(this[this.tableS_FIN_KARTICEPARTNERA.SKRACENIColumn]);
                    }
                    catch (InvalidCastException exception1)
                    {
                        throw exception1;
                ...
                set
                {
                    this[this.tableS_FIN_KARTICEPARTNERA.SKRACENIColumn] = value;
                }
            }
        }

        public class S_FIN_KARTICEPARTNERARowChangeEvent : EventArgs
        {
            private DataRowAction eventAction;
            private S_FIN_KARTICEPARTNERADataSet.S_FIN_KARTICEPARTNERARow eventRow;

            public S_FIN_KARTICEPARTNERARowChangeEvent(S_FIN_KARTICEPARTNERADataSet.S_FIN_KARTICEPARTNERARow row, DataRowAction action)
            {
                this.eventRow = row;
            ...
            public S_FIN_KARTICEPARTNERADataSet.S_FIN_KARTICEPARTNERARow Row
            {
                get
                {
        ...
        public delegate void S_FIN_KARTICEPARTNERARowChangeEventHandler(object sender, S_FIN_KARTICEPARTNERADataSet.S_FIN_KARTICEPARTNERARowChangeEvent e);
    }
}
