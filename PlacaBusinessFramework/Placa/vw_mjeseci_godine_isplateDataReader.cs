namespace Placa
{
    ...
    public class vw_mjeseci_godine_isplateDataReader : IDisposable
    {
        private static string[] attributeNames = new string[] { "TM1.[mjesecisplate]", "TM1.[godinaisplate]" };
        private ReadWriteCommand cmvw_mjeseci_godine_isplateSelect3;
        ...
        private IDataReader vw_mjeseci_godine_isplateSelect3;

        public vw_mjeseci_godine_isplateDataReader()
        {
        ...
        public void Dispose()
        {
            if (!this.m_Disposed)
            {
                ...
                try
                {
                    this.vw_mjeseci_godine_isplateSelect3.Close();
                }
                finally
                {
                    try
        ...
        public IDataReader Open()
        {
            ...
            this.cmvw_mjeseci_godine_isplateSelect3 = this.connDefault.GetCommand(this.scmdbuf, true);
            this.cmvw_mjeseci_godine_isplateSelect3.ErrorMask |= ErrorMask.Lock;
            this.vw_mjeseci_godine_isplateSelect3 = this.cmvw_mjeseci_godine_isplateSelect3.ExecuteReader((CommandBehavior) Conversions.ToInteger(Interaction.IIf(this.daCurrentTransaction == null, Configuration.ReaderCommandBehavior, CommandBehavior.Default)));
            return this.vw_mjeseci_godine_isplateSelect3;
        }
        ...
        public class OrderAttribute
        {
            ...
            public vw_mjeseci_godine_isplateDataReader.Attribute OrderAttributeName;
            public string OrderAttributeString;

            public OrderAttribute(vw_mjeseci_godine_isplateDataReader.Attribute orderAttributeName)
            {
                this.OrderAttributeName = orderAttributeName;
                this.OrderAttributeAscending = true;
                this.OrderAttributeString = vw_mjeseci_godine_isplateDataReader.attributeNames[(int) this.OrderAttributeName];
            }

            public OrderAttribute(vw_mjeseci_godine_isplateDataReader.Attribute orderAttributeName, bool orderAttributeAscending)
            {
                this.OrderAttributeName = orderAttributeName;
