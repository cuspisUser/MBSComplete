namespace Placa
{
    ...
    [Serializable]
    public class S_OD_IPPDataSet : DataSet
    {
        private System.Data.SchemaSerializationMode _schemaSerializationMode;
        private S_OD_IPPDataTable tableS_OD_IPP;

        public S_OD_IPPDataSet()
        {
        ...
        protected S_OD_IPPDataSet(SerializationInfo info, StreamingContext context) : base(info, context, false)
        {
            this._schemaSerializationMode = System.Data.SchemaSerializationMode.IncludeSchema;
            ...
            else
            {
                ...
                if (this.DetermineSchemaSerializationMode(info, context) == System.Data.SchemaSerializationMode.IncludeSchema)
                {
                    ...
                    if (dataSet.Tables["S_OD_IPP"] != null)
                    {
                        this.Tables.Add(new S_OD_IPPDataTable(dataSet.Tables["S_OD_IPP"]));
                    }
        ...
        {
            S_OD_IPPDataSet set = (S_OD_IPPDataSet) base.Clone();
            set.InitVars();
            return set;
        }
        ...
        {
            S_OD_IPPDataSet set = new S_OD_IPPDataSet();
        ...
        {
            this.InitClassBase();
            this.ExtendedProperties.Add("DataAdapterName", "S_OD_IPPDataAdapter");
            this.ExtendedProperties.Add("BigImage", " ");
            this.ExtendedProperties.Add("SmallImage", " ");
            this.ExtendedProperties.Add("Image", " ");
            this.ExtendedProperties.Add("Deklarit.PermissionBaseId", "2079");
            this.ExtendedProperties.Add("DataSetName", "S_OD_IPPDataSet");
            this.ExtendedProperties.Add("DataAdapterInterfaceName", "IS_OD_IPPDataAdapter");
            this.ExtendedProperties.Add("ObjectName", "S_OD_IPP");
            this.ExtendedProperties.Add("ObjectDescription", "S_OD_IPP");
            this.ExtendedProperties.Add("ObjectType", "DataProvider");
            this.ExtendedProperties.Add("ObjectPath", @"\DataProviders\DP_Placa");
            this.ExtendedProperties.Add("NameSpace", "Placa");
            this.ExtendedProperties.Add("DataChangeFrequency", "PrettyOften");
            this.ExtendedProperties.Add("CachePriority", "Medium");
            this.ExtendedProperties.Add("Deklarit.StoredProcedure", "S_PLACA_IPP");
        ...
        {
            this.DataSetName = "S_OD_IPPDataSet";
            this.Namespace = "http://www.tempuri.org/S_OD_IPP";
            this.tableS_OD_IPP = new S_OD_IPPDataTable();
            this.Tables.Add(this.tableS_OD_IPP);
        }
        ...
        {
            this.tableS_OD_IPP = (S_OD_IPPDataTable) this.Tables["S_OD_IPP"];
            if (initTable && (this.tableS_OD_IPP != null))
            {
                this.tableS_OD_IPP.InitVars();
            }
        }
        ...
        private bool ShouldSerializeS_OD_IPP()
        {
            return false;
        }
        ...
        public S_OD_IPPDataTable S_OD_IPP
        {
            get
            {
                return this.tableS_OD_IPP;
            }
        }
        ...
        [Serializable]
        public class S_OD_IPPDataTable : DataTable, IEnumerable
        {
            private DataColumn columnBROJRADNIKA;
            private DataColumn columnKRIZNIPOREZ;
            private DataColumn columnOSNOVICAKRIZNOGPOREZA;

            public event S_OD_IPPDataSet.S_OD_IPPRowChangeEventHandler S_OD_IPPRowChanged;

            public event S_OD_IPPDataSet.S_OD_IPPRowChangeEventHandler S_OD_IPPRowChanging;

            public event S_OD_IPPDataSet.S_OD_IPPRowChangeEventHandler S_OD_IPPRowDeleted;

            public event S_OD_IPPDataSet.S_OD_IPPRowChangeEventHandler S_OD_IPPRowDeleting;

            public S_OD_IPPDataTable()
            {
                this.TableName = "S_OD_IPP";
                this.BeginInit();
                this.InitClass();
                this.EndInit();
            }

            internal S_OD_IPPDataTable(DataTable table) : base(table.TableName)
            {
            ...
            protected S_OD_IPPDataTable(SerializationInfo info, StreamingContext context) : base(info, context)
            {
                this.InitVars();
            }

            public void AddS_OD_IPPRow(S_OD_IPPDataSet.S_OD_IPPRow row)
            {
                this.Rows.Add(row);
            }

            public S_OD_IPPDataSet.S_OD_IPPRow AddS_OD_IPPRow(decimal oSNOVICAKRIZNOGPOREZA, decimal kRIZNIPOREZ, decimal bROJRADNIKA)
            {
                S_OD_IPPDataSet.S_OD_IPPRow row = (S_OD_IPPDataSet.S_OD_IPPRow) this.NewRow();
            ...
            {
                S_OD_IPPDataSet.S_OD_IPPDataTable table = (S_OD_IPPDataSet.S_OD_IPPDataTable) base.Clone();
                table.InitVars();
                return table;
            }
            ...
            {
                return typeof(S_OD_IPPDataSet.S_OD_IPPRow);
            }
            ...
            public void InitClass()
            {
                ...
                this.ExtendedProperties.Add("LevelName", "S_OD_IPP");
                this.ExtendedProperties.Add("Description", "_S_OD_IPP");
            ...
            {
                return new S_OD_IPPDataSet.S_OD_IPPRow(builder);
            }

            public S_OD_IPPDataSet.S_OD_IPPRow NewS_OD_IPPRow()
            {
                return (S_OD_IPPDataSet.S_OD_IPPRow) this.NewRow();
            }

            protected override void OnRowChanged(DataRowChangeEventArgs e)
            {
                base.OnRowChanged(e);
                if (this.S_OD_IPPRowChanged != null)
                {
                    S_OD_IPPDataSet.S_OD_IPPRowChangeEventHandler handler = this.S_OD_IPPRowChanged;
                    if (handler != null)
                    {
                        handler(this, new S_OD_IPPDataSet.S_OD_IPPRowChangeEvent((S_OD_IPPDataSet.S_OD_IPPRow) e.Row, e.Action));
                    }
                }
            }
            ...
            protected override void OnRowChanging(DataRowChangeEventArgs e)
            {
                ...
                if (this.S_OD_IPPRowChanging != null)
                {
                    S_OD_IPPDataSet.S_OD_IPPRowChangeEventHandler handler = this.S_OD_IPPRowChanging;
                    if (handler != null)
                    {
                        handler(this, new S_OD_IPPDataSet.S_OD_IPPRowChangeEvent((S_OD_IPPDataSet.S_OD_IPPRow) e.Row, e.Action));
                    }
            ...
            {
                base.OnRowDeleted(e);
                if (this.S_OD_IPPRowDeleted != null)
                {
                    S_OD_IPPDataSet.S_OD_IPPRowChangeEventHandler handler = this.S_OD_IPPRowDeleted;
                    if (handler != null)
                    {
                        handler(this, new S_OD_IPPDataSet.S_OD_IPPRowChangeEvent((S_OD_IPPDataSet.S_OD_IPPRow) e.Row, e.Action));
                    }
            ...
            protected override void OnRowDeleting(DataRowChangeEventArgs e)
            {
                ...
                if (this.S_OD_IPPRowDeleting != null)
                {
                    S_OD_IPPDataSet.S_OD_IPPRowChangeEventHandler handler = this.S_OD_IPPRowDeleting;
                    if (handler != null)
                    {
                        handler(this, new S_OD_IPPDataSet.S_OD_IPPRowChangeEvent((S_OD_IPPDataSet.S_OD_IPPRow) e.Row, e.Action));
                    }
            ...
            public void RemoveS_OD_IPPRow(S_OD_IPPDataSet.S_OD_IPPRow row)
            {
            ...
            public S_OD_IPPDataSet.S_OD_IPPRow this[int index]
            {
                get
                {
                    return (S_OD_IPPDataSet.S_OD_IPPRow) this.Rows[index];
                }
            }
        ...
        public class S_OD_IPPRow : DataRow
        {
            private S_OD_IPPDataSet.S_OD_IPPDataTable tableS_OD_IPP;

            internal S_OD_IPPRow(DataRowBuilder rb) : base(rb)
            {
                this.tableS_OD_IPP = (S_OD_IPPDataSet.S_OD_IPPDataTable) this.Table;
            }

            public bool IsBROJRADNIKANull()
            {
                return this.IsNull(this.tableS_OD_IPP.BROJRADNIKAColumn);
            }

            public bool IsKRIZNIPOREZNull()
            {
                return this.IsNull(this.tableS_OD_IPP.KRIZNIPOREZColumn);
            }

            public bool IsOSNOVICAKRIZNOGPOREZANull()
            {
                return this.IsNull(this.tableS_OD_IPP.OSNOVICAKRIZNOGPOREZAColumn);
            }

            public void SetBROJRADNIKANull()
            {
                this[this.tableS_OD_IPP.BROJRADNIKAColumn] = RuntimeHelpers.GetObjectValue(Convert.DBNull);
            }

            public void SetKRIZNIPOREZNull()
            {
                this[this.tableS_OD_IPP.KRIZNIPOREZColumn] = RuntimeHelpers.GetObjectValue(Convert.DBNull);
            }

            public void SetOSNOVICAKRIZNOGPOREZANull()
            {
                this[this.tableS_OD_IPP.OSNOVICAKRIZNOGPOREZAColumn] = RuntimeHelpers.GetObjectValue(Convert.DBNull);
            }
            ...
            public decimal BROJRADNIKA
            {
                get
                {
                    ...
                    try
                    {
                        num = Conversions.ToDecimal(this[this.tableS_OD_IPP.BROJRADNIKAColumn]);
                    }
                ...
                set
                {
                    this[this.tableS_OD_IPP.BROJRADNIKAColumn] = value;
                }
            }
            ...
            public decimal KRIZNIPOREZ
            {
                get
                {
                    ...
                    try
                    {
                        num = Conversions.ToDecimal(this[this.tableS_OD_IPP.KRIZNIPOREZColumn]);
                    }
                    catch (InvalidCastException exception1)
                    {
                        throw exception1;
                ...
                set
                {
                    this[this.tableS_OD_IPP.KRIZNIPOREZColumn] = value;
                }
            }
            ...
            public decimal OSNOVICAKRIZNOGPOREZA
            {
                get
                {
                    ...
                    try
                    {
                        num = Conversions.ToDecimal(this[this.tableS_OD_IPP.OSNOVICAKRIZNOGPOREZAColumn]);
                    }
                    catch (InvalidCastException exception1)
                    {
                        throw exception1;
                ...
                set
                {
                    this[this.tableS_OD_IPP.OSNOVICAKRIZNOGPOREZAColumn] = value;
                }
            }
        }

        public class S_OD_IPPRowChangeEvent : EventArgs
        {
            private DataRowAction eventAction;
            private S_OD_IPPDataSet.S_OD_IPPRow eventRow;

            public S_OD_IPPRowChangeEvent(S_OD_IPPDataSet.S_OD_IPPRow row, DataRowAction action)
            {
                this.eventRow = row;
            ...
            public S_OD_IPPDataSet.S_OD_IPPRow Row
            {
                get
                {
        ...
        public delegate void S_OD_IPPRowChangeEventHandler(object sender, S_OD_IPPDataSet.S_OD_IPPRowChangeEvent e);
    }
}
