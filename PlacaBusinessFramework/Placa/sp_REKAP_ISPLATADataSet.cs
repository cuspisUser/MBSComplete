namespace Placa
{
    ...
    [Serializable]
    public class sp_REKAP_ISPLATADataSet : DataSet
    {
        private System.Data.SchemaSerializationMode _schemaSerializationMode;
        private sp_REKAP_ISPLATADataTable tablesp_REKAP_ISPLATA;

        public sp_REKAP_ISPLATADataSet()
        {
        ...
        protected sp_REKAP_ISPLATADataSet(SerializationInfo info, StreamingContext context) : base(info, context, false)
        {
            this._schemaSerializationMode = System.Data.SchemaSerializationMode.IncludeSchema;
            ...
            else
            {
                ...
                if (this.DetermineSchemaSerializationMode(info, context) == System.Data.SchemaSerializationMode.IncludeSchema)
                {
                    ...
                    if (dataSet.Tables["sp_REKAP_ISPLATA"] != null)
                    {
                        this.Tables.Add(new sp_REKAP_ISPLATADataTable(dataSet.Tables["sp_REKAP_ISPLATA"]));
                    }
        ...
        {
            sp_REKAP_ISPLATADataSet set = (sp_REKAP_ISPLATADataSet) base.Clone();
            set.InitVars();
            return set;
        }
        ...
        {
            sp_REKAP_ISPLATADataSet set = new sp_REKAP_ISPLATADataSet();
        ...
        {
            this.InitClassBase();
            this.ExtendedProperties.Add("DataAdapterName", "sp_REKAP_ISPLATADataAdapter");
            this.ExtendedProperties.Add("BigImage", " ");
            this.ExtendedProperties.Add("SmallImage", " ");
            this.ExtendedProperties.Add("Image", " ");
            this.ExtendedProperties.Add("Deklarit.PermissionBaseId", "2024");
            this.ExtendedProperties.Add("DataSetName", "sp_REKAP_ISPLATADataSet");
            this.ExtendedProperties.Add("DataAdapterInterfaceName", "Isp_REKAP_ISPLATADataAdapter");
            this.ExtendedProperties.Add("ObjectName", "sp_REKAP_ISPLATA");
            this.ExtendedProperties.Add("ObjectDescription", "sp_REKAP_ISPLATA");
            this.ExtendedProperties.Add("ObjectType", "DataProvider");
            this.ExtendedProperties.Add("ObjectPath", @"\DataProviders\DP_Placa");
            this.ExtendedProperties.Add("NameSpace", "Placa");
            this.ExtendedProperties.Add("DataChangeFrequency", "PrettyOften");
            this.ExtendedProperties.Add("CachePriority", "Medium");
            this.ExtendedProperties.Add("Deklarit.StoredProcedure", "S_OD_REKAP_ISPLATA");
        ...
        {
            this.DataSetName = "sp_REKAP_ISPLATADataSet";
            this.Namespace = "http://www.tempuri.org/sp_REKAP_ISPLATA";
            this.tablesp_REKAP_ISPLATA = new sp_REKAP_ISPLATADataTable();
            this.Tables.Add(this.tablesp_REKAP_ISPLATA);
        }
        ...
        {
            this.tablesp_REKAP_ISPLATA = (sp_REKAP_ISPLATADataTable) this.Tables["sp_REKAP_ISPLATA"];
            if (initTable && (this.tablesp_REKAP_ISPLATA != null))
            {
                this.tablesp_REKAP_ISPLATA.InitVars();
            }
        }
        ...
        private bool ShouldSerializesp_REKAP_ISPLATA()
        {
            return false;
        }
        ...
        public sp_REKAP_ISPLATADataTable sp_REKAP_ISPLATA
        {
            get
            {
                return this.tablesp_REKAP_ISPLATA;
            }
        }
        ...
        [Serializable]
        public class sp_REKAP_ISPLATADataTable : DataTable, IEnumerable
        {
            ...
            public event sp_REKAP_ISPLATADataSet.sp_REKAP_ISPLATARowChangeEventHandler sp_REKAP_ISPLATARowChanged;

            public event sp_REKAP_ISPLATADataSet.sp_REKAP_ISPLATARowChangeEventHandler sp_REKAP_ISPLATARowChanging;

            public event sp_REKAP_ISPLATADataSet.sp_REKAP_ISPLATARowChangeEventHandler sp_REKAP_ISPLATARowDeleted;

            public event sp_REKAP_ISPLATADataSet.sp_REKAP_ISPLATARowChangeEventHandler sp_REKAP_ISPLATARowDeleting;

            public sp_REKAP_ISPLATADataTable()
            {
                this.TableName = "sp_REKAP_ISPLATA";
                this.BeginInit();
                this.InitClass();
                this.EndInit();
            }

            internal sp_REKAP_ISPLATADataTable(DataTable table) : base(table.TableName)
            {
            ...
            protected sp_REKAP_ISPLATADataTable(SerializationInfo info, StreamingContext context) : base(info, context)
            {
                this.InitVars();
            }

            public void Addsp_REKAP_ISPLATARow(sp_REKAP_ISPLATADataSet.sp_REKAP_ISPLATARow row)
            {
                this.Rows.Add(row);
            }

            public sp_REKAP_ISPLATADataSet.sp_REKAP_ISPLATARow Addsp_REKAP_ISPLATARow(int iDRADNIK, string pREZIME, string iME, string jMBG, string tEKUCI, bool zBIRNINETO, string vBDIBANKE, string zRNBANKE, int iDBANKE, string nAZIVBANKE1, string nAZIVBANKE2, decimal uKUPNOZAISPLATU)
            {
                sp_REKAP_ISPLATADataSet.sp_REKAP_ISPLATARow row = (sp_REKAP_ISPLATADataSet.sp_REKAP_ISPLATARow) this.NewRow();
            ...
            {
                sp_REKAP_ISPLATADataSet.sp_REKAP_ISPLATADataTable table = (sp_REKAP_ISPLATADataSet.sp_REKAP_ISPLATADataTable) base.Clone();
                table.InitVars();
                return table;
            }
            ...
            {
                return typeof(sp_REKAP_ISPLATADataSet.sp_REKAP_ISPLATARow);
            }
            ...
            public void InitClass()
            {
                ...
                this.columnTEKUCI.MaxLength = 30;
                ...
                this.columnTEKUCI.ExtendedProperties.Add("Length", "30");
                ...
                this.ExtendedProperties.Add("LevelName", "sp_REKAP_ISPLATA");
                this.ExtendedProperties.Add("Description", "_SP_REKAP_ISPLATA");
            ...
            {
                return new sp_REKAP_ISPLATADataSet.sp_REKAP_ISPLATARow(builder);
            }

            public sp_REKAP_ISPLATADataSet.sp_REKAP_ISPLATARow Newsp_REKAP_ISPLATARow()
            {
                return (sp_REKAP_ISPLATADataSet.sp_REKAP_ISPLATARow) this.NewRow();
            }

            protected override void OnRowChanged(DataRowChangeEventArgs e)
            {
                base.OnRowChanged(e);
                if (this.sp_REKAP_ISPLATARowChanged != null)
                {
                    sp_REKAP_ISPLATADataSet.sp_REKAP_ISPLATARowChangeEventHandler handler = this.sp_REKAP_ISPLATARowChanged;
                    if (handler != null)
                    {
                        handler(this, new sp_REKAP_ISPLATADataSet.sp_REKAP_ISPLATARowChangeEvent((sp_REKAP_ISPLATADataSet.sp_REKAP_ISPLATARow) e.Row, e.Action));
                    }
                }
            }
            ...
            protected override void OnRowChanging(DataRowChangeEventArgs e)
            {
                ...
                if (this.sp_REKAP_ISPLATARowChanging != null)
                {
                    sp_REKAP_ISPLATADataSet.sp_REKAP_ISPLATARowChangeEventHandler handler = this.sp_REKAP_ISPLATARowChanging;
                    if (handler != null)
                    {
                        handler(this, new sp_REKAP_ISPLATADataSet.sp_REKAP_ISPLATARowChangeEvent((sp_REKAP_ISPLATADataSet.sp_REKAP_ISPLATARow) e.Row, e.Action));
                    }
            ...
            {
                base.OnRowDeleted(e);
                if (this.sp_REKAP_ISPLATARowDeleted != null)
                {
                    sp_REKAP_ISPLATADataSet.sp_REKAP_ISPLATARowChangeEventHandler handler = this.sp_REKAP_ISPLATARowDeleted;
                    if (handler != null)
                    {
                        handler(this, new sp_REKAP_ISPLATADataSet.sp_REKAP_ISPLATARowChangeEvent((sp_REKAP_ISPLATADataSet.sp_REKAP_ISPLATARow) e.Row, e.Action));
                    }
            ...
            protected override void OnRowDeleting(DataRowChangeEventArgs e)
            {
                ...
                if (this.sp_REKAP_ISPLATARowDeleting != null)
                {
                    sp_REKAP_ISPLATADataSet.sp_REKAP_ISPLATARowChangeEventHandler handler = this.sp_REKAP_ISPLATARowDeleting;
                    if (handler != null)
                    {
                        handler(this, new sp_REKAP_ISPLATADataSet.sp_REKAP_ISPLATARowChangeEvent((sp_REKAP_ISPLATADataSet.sp_REKAP_ISPLATARow) e.Row, e.Action));
                    }
            ...
            public void Removesp_REKAP_ISPLATARow(sp_REKAP_ISPLATADataSet.sp_REKAP_ISPLATARow row)
            {
            ...
            public sp_REKAP_ISPLATADataSet.sp_REKAP_ISPLATARow this[int index]
            {
                get
                {
                    return (sp_REKAP_ISPLATADataSet.sp_REKAP_ISPLATARow) this.Rows[index];
                }
            }
        ...
        public class sp_REKAP_ISPLATARow : DataRow
        {
            private sp_REKAP_ISPLATADataSet.sp_REKAP_ISPLATADataTable tablesp_REKAP_ISPLATA;

            internal sp_REKAP_ISPLATARow(DataRowBuilder rb) : base(rb)
            {
                this.tablesp_REKAP_ISPLATA = (sp_REKAP_ISPLATADataSet.sp_REKAP_ISPLATADataTable) this.Table;
            }

            public bool IsIDBANKENull()
            {
                return this.IsNull(this.tablesp_REKAP_ISPLATA.IDBANKEColumn);
            }

            public bool IsIDRADNIKNull()
            {
                return this.IsNull(this.tablesp_REKAP_ISPLATA.IDRADNIKColumn);
            }

            public bool IsIMENull()
            {
                return this.IsNull(this.tablesp_REKAP_ISPLATA.IMEColumn);
            }

            public bool IsJMBGNull()
            {
                return this.IsNull(this.tablesp_REKAP_ISPLATA.JMBGColumn);
            }

            public bool IsNAZIVBANKE1Null()
            {
                return this.IsNull(this.tablesp_REKAP_ISPLATA.NAZIVBANKE1Column);
            }

            public bool IsNAZIVBANKE2Null()
            {
                return this.IsNull(this.tablesp_REKAP_ISPLATA.NAZIVBANKE2Column);
            }

            public bool IsPREZIMENull()
            {
                return this.IsNull(this.tablesp_REKAP_ISPLATA.PREZIMEColumn);
            }

            public bool IsTEKUCINull()
            {
                return this.IsNull(this.tablesp_REKAP_ISPLATA.TEKUCIColumn);
            }

            public bool IsUKUPNOZAISPLATUNull()
            {
                return this.IsNull(this.tablesp_REKAP_ISPLATA.UKUPNOZAISPLATUColumn);
            }

            public bool IsVBDIBANKENull()
            {
                return this.IsNull(this.tablesp_REKAP_ISPLATA.VBDIBANKEColumn);
            }

            public bool IsZBIRNINETONull()
            {
                return this.IsNull(this.tablesp_REKAP_ISPLATA.ZBIRNINETOColumn);
            }

            public bool IsZRNBANKENull()
            {
                return this.IsNull(this.tablesp_REKAP_ISPLATA.ZRNBANKEColumn);
            }

            public void SetIDBANKENull()
            {
                this[this.tablesp_REKAP_ISPLATA.IDBANKEColumn] = RuntimeHelpers.GetObjectValue(Convert.DBNull);
            }

            public void SetIDRADNIKNull()
            {
                this[this.tablesp_REKAP_ISPLATA.IDRADNIKColumn] = RuntimeHelpers.GetObjectValue(Convert.DBNull);
            }

            public void SetIMENull()
            {
                this[this.tablesp_REKAP_ISPLATA.IMEColumn] = RuntimeHelpers.GetObjectValue(Convert.DBNull);
            }

            public void SetJMBGNull()
            {
                this[this.tablesp_REKAP_ISPLATA.JMBGColumn] = RuntimeHelpers.GetObjectValue(Convert.DBNull);
            }

            public void SetNAZIVBANKE1Null()
            {
                this[this.tablesp_REKAP_ISPLATA.NAZIVBANKE1Column] = RuntimeHelpers.GetObjectValue(Convert.DBNull);
            }

            public void SetNAZIVBANKE2Null()
            {
                this[this.tablesp_REKAP_ISPLATA.NAZIVBANKE2Column] = RuntimeHelpers.GetObjectValue(Convert.DBNull);
            }

            public void SetPREZIMENull()
            {
                this[this.tablesp_REKAP_ISPLATA.PREZIMEColumn] = RuntimeHelpers.GetObjectValue(Convert.DBNull);
            }

            public void SetTEKUCINull()
            {
                this[this.tablesp_REKAP_ISPLATA.TEKUCIColumn] = RuntimeHelpers.GetObjectValue(Convert.DBNull);
            }

            public void SetUKUPNOZAISPLATUNull()
            {
                this[this.tablesp_REKAP_ISPLATA.UKUPNOZAISPLATUColumn] = RuntimeHelpers.GetObjectValue(Convert.DBNull);
            }

            public void SetVBDIBANKENull()
            {
                this[this.tablesp_REKAP_ISPLATA.VBDIBANKEColumn] = RuntimeHelpers.GetObjectValue(Convert.DBNull);
            }

            public void SetZBIRNINETONull()
            {
                this[this.tablesp_REKAP_ISPLATA.ZBIRNINETOColumn] = RuntimeHelpers.GetObjectValue(Convert.DBNull);
            }

            public void SetZRNBANKENull()
            {
                this[this.tablesp_REKAP_ISPLATA.ZRNBANKEColumn] = RuntimeHelpers.GetObjectValue(Convert.DBNull);
            }
            ...
            public int IDBANKE
            {
                get
                {
                    ...
                    try
                    {
                        num = Conversions.ToInteger(this[this.tablesp_REKAP_ISPLATA.IDBANKEColumn]);
                    }
                ...
                set
                {
                    this[this.tablesp_REKAP_ISPLATA.IDBANKEColumn] = value;
                }
            }
            ...
            public int IDRADNIK
            {
                get
                {
                    ...
                    try
                    {
                        num = Conversions.ToInteger(this[this.tablesp_REKAP_ISPLATA.IDRADNIKColumn]);
                    }
                    catch (InvalidCastException exception1)
                    {
                        throw exception1;
                ...
                set
                {
                    this[this.tablesp_REKAP_ISPLATA.IDRADNIKColumn] = value;
                }
            }
            ...
            public string IME
            {
                get
                {
                    ...
                    try
                    {
                        str = Conversions.ToString(this[this.tablesp_REKAP_ISPLATA.IMEColumn]);
                    }
                    catch (InvalidCastException exception1)
                    {
                        throw exception1;
                ...
                set
                {
                    this[this.tablesp_REKAP_ISPLATA.IMEColumn] = value;
                }
            }
            ...
            public string JMBG
            {
                get
                {
                    ...
                    try
                    {
                        str = Conversions.ToString(this[this.tablesp_REKAP_ISPLATA.JMBGColumn]);
                    }
                    catch (InvalidCastException exception1)
                    {
                        throw exception1;
                ...
                set
                {
                    this[this.tablesp_REKAP_ISPLATA.JMBGColumn] = value;
                }
            }
            ...
            public string NAZIVBANKE1
            {
                get
                {
                    ...
                    try
                    {
                        str = Conversions.ToString(this[this.tablesp_REKAP_ISPLATA.NAZIVBANKE1Column]);
                    }
                    catch (InvalidCastException exception1)
                    {
                        throw exception1;
                ...
                set
                {
                    this[this.tablesp_REKAP_ISPLATA.NAZIVBANKE1Column] = value;
                }
            }
            ...
            public string NAZIVBANKE2
            {
                get
                {
                    ...
                    try
                    {
                        str = Conversions.ToString(this[this.tablesp_REKAP_ISPLATA.NAZIVBANKE2Column]);
                    }
                    catch (InvalidCastException exception1)
                    {
                        throw exception1;
                ...
                set
                {
                    this[this.tablesp_REKAP_ISPLATA.NAZIVBANKE2Column] = value;
                }
            }
            ...
            public string PREZIME
            {
                get
                {
                    ...
                    try
                    {
                        str = Conversions.ToString(this[this.tablesp_REKAP_ISPLATA.PREZIMEColumn]);
                    }
                    catch (InvalidCastException exception1)
                    {
                        throw exception1;
                ...
                set
                {
                    this[this.tablesp_REKAP_ISPLATA.PREZIMEColumn] = value;
                }
            }
            ...
            public string TEKUCI
            {
                get
                {
                    ...
                    try
                    {
                        str = Conversions.ToString(this[this.tablesp_REKAP_ISPLATA.TEKUCIColumn]);
                    }
                    catch (InvalidCastException exception1)
                    {
                        throw exception1;
                ...
                set
                {
                    this[this.tablesp_REKAP_ISPLATA.TEKUCIColumn] = value;
                }
            }
            ...
            public decimal UKUPNOZAISPLATU
            {
                get
                {
                    ...
                    try
                    {
                        num = Conversions.ToDecimal(this[this.tablesp_REKAP_ISPLATA.UKUPNOZAISPLATUColumn]);
                    }
                    catch (InvalidCastException exception1)
                    {
                        throw exception1;
                ...
                set
                {
                    this[this.tablesp_REKAP_ISPLATA.UKUPNOZAISPLATUColumn] = value;
                }
            }
            ...
            public string VBDIBANKE
            {
                get
                {
                    ...
                    try
                    {
                        str = Conversions.ToString(this[this.tablesp_REKAP_ISPLATA.VBDIBANKEColumn]);
                    }
                    catch (InvalidCastException exception1)
                    {
                        throw exception1;
                ...
                set
                {
                    this[this.tablesp_REKAP_ISPLATA.VBDIBANKEColumn] = value;
                }
            }
            ...
            public bool ZBIRNINETO
            {
                get
                {
                    ...
                    try
                    {
                        flag = Conversions.ToBoolean(this[this.tablesp_REKAP_ISPLATA.ZBIRNINETOColumn]);
                    }
                    catch (InvalidCastException exception1)
                    {
                        throw exception1;
                ...
                set
                {
                    this[this.tablesp_REKAP_ISPLATA.ZBIRNINETOColumn] = value;
                }
            }
            ...
            public string ZRNBANKE
            {
                get
                {
                    ...
                    try
                    {
                        str = Conversions.ToString(this[this.tablesp_REKAP_ISPLATA.ZRNBANKEColumn]);
                    }
                    catch (InvalidCastException exception1)
                    {
                        throw exception1;
                ...
                set
                {
                    this[this.tablesp_REKAP_ISPLATA.ZRNBANKEColumn] = value;
                }
            }
        }

        public class sp_REKAP_ISPLATARowChangeEvent : EventArgs
        {
            private DataRowAction eventAction;
            private sp_REKAP_ISPLATADataSet.sp_REKAP_ISPLATARow eventRow;

            public sp_REKAP_ISPLATARowChangeEvent(sp_REKAP_ISPLATADataSet.sp_REKAP_ISPLATARow row, DataRowAction action)
            {
                this.eventRow = row;
            ...
            public sp_REKAP_ISPLATADataSet.sp_REKAP_ISPLATARow Row
            {
                get
                {
        ...
        public delegate void sp_REKAP_ISPLATARowChangeEventHandler(object sender, sp_REKAP_ISPLATADataSet.sp_REKAP_ISPLATARowChangeEvent e);
    }
}
