namespace Placa
{
    ...
    public class RadnikPripremaDataReader : IDisposable
    {
        ...
        public RadnikPripremaDataReader()
        {
        ...
        public class OrderAttribute
        {
            ...
            public RadnikPripremaDataReader.Attribute OrderAttributeName;
            public string OrderAttributeString;

            public OrderAttribute(RadnikPripremaDataReader.Attribute orderAttributeName)
            {
                this.OrderAttributeName = orderAttributeName;
                this.OrderAttributeAscending = true;
                this.OrderAttributeString = RadnikPripremaDataReader.attributeNames[(int) this.OrderAttributeName];
            }

            public OrderAttribute(RadnikPripremaDataReader.Attribute orderAttributeName, bool orderAttributeAscending)
            {
                this.OrderAttributeName = orderAttributeName;
