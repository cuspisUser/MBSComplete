namespace Placa
{
    ...
    [Serializable]
    public class s_od_rekap_brutoDataSet : DataSet
    {
        private System.Data.SchemaSerializationMode _schemaSerializationMode;
        private s_od_rekap_brutoDataTable tables_od_rekap_bruto;

        public s_od_rekap_brutoDataSet()
        {
        ...
        protected s_od_rekap_brutoDataSet(SerializationInfo info, StreamingContext context) : base(info, context, false)
        {
            this._schemaSerializationMode = System.Data.SchemaSerializationMode.IncludeSchema;
            ...
            else
            {
                ...
                if (this.DetermineSchemaSerializationMode(info, context) == System.Data.SchemaSerializationMode.IncludeSchema)
                {
                    ...
                    if (dataSet.Tables["s_od_rekap_bruto"] != null)
                    {
                        this.Tables.Add(new s_od_rekap_brutoDataTable(dataSet.Tables["s_od_rekap_bruto"]));
                    }
        ...
        {
            s_od_rekap_brutoDataSet set = (s_od_rekap_brutoDataSet) base.Clone();
            set.InitVars();
            return set;
        }
        ...
        {
            s_od_rekap_brutoDataSet set = new s_od_rekap_brutoDataSet();
        ...
        {
            this.InitClassBase();
            this.ExtendedProperties.Add("DataAdapterName", "s_od_rekap_brutoDataAdapter");
            this.ExtendedProperties.Add("BigImage", " ");
            this.ExtendedProperties.Add("SmallImage", " ");
            this.ExtendedProperties.Add("Image", " ");
            this.ExtendedProperties.Add("Deklarit.PermissionBaseId", "2045");
            this.ExtendedProperties.Add("DataSetName", "s_od_rekap_brutoDataSet");
            this.ExtendedProperties.Add("DataAdapterInterfaceName", "Is_od_rekap_brutoDataAdapter");
            this.ExtendedProperties.Add("ObjectName", "s_od_rekap_bruto");
            this.ExtendedProperties.Add("ObjectDescription", "s_od_rekap_bruto");
            this.ExtendedProperties.Add("ObjectType", "DataProvider");
            this.ExtendedProperties.Add("ObjectPath", @"\DataProviders\DP_Placa");
            this.ExtendedProperties.Add("NameSpace", "Placa");
            this.ExtendedProperties.Add("DataChangeFrequency", "PrettyOften");
            this.ExtendedProperties.Add("CachePriority", "Medium");
            this.ExtendedProperties.Add("Deklarit.StoredProcedure", "S_PLACA_BRUTO");
        ...
        {
            this.DataSetName = "s_od_rekap_brutoDataSet";
            this.Namespace = "http://www.tempuri.org/s_od_rekap_bruto";
            this.tables_od_rekap_bruto = new s_od_rekap_brutoDataTable();
            this.Tables.Add(this.tables_od_rekap_bruto);
        }
        ...
        {
            this.tables_od_rekap_bruto = (s_od_rekap_brutoDataTable) this.Tables["s_od_rekap_bruto"];
            if (initTable && (this.tables_od_rekap_bruto != null))
            {
                this.tables_od_rekap_bruto.InitVars();
            }
        }
        ...
        private bool ShouldSerializes_od_rekap_bruto()
        {
            return false;
        }
        ...
        public s_od_rekap_brutoDataTable s_od_rekap_bruto
        {
            get
            {
                return this.tables_od_rekap_bruto;
            }
        }
        ...
        [Serializable]
        public class s_od_rekap_brutoDataTable : DataTable, IEnumerable
        {
            ...
            public event s_od_rekap_brutoDataSet.s_od_rekap_brutoRowChangeEventHandler s_od_rekap_brutoRowChanged;

            public event s_od_rekap_brutoDataSet.s_od_rekap_brutoRowChangeEventHandler s_od_rekap_brutoRowChanging;

            public event s_od_rekap_brutoDataSet.s_od_rekap_brutoRowChangeEventHandler s_od_rekap_brutoRowDeleted;

            public event s_od_rekap_brutoDataSet.s_od_rekap_brutoRowChangeEventHandler s_od_rekap_brutoRowDeleting;

            public s_od_rekap_brutoDataTable()
            {
                this.TableName = "s_od_rekap_bruto";
                this.BeginInit();
                this.InitClass();
                this.EndInit();
            }

            internal s_od_rekap_brutoDataTable(DataTable table) : base(table.TableName)
            {
            ...
            protected s_od_rekap_brutoDataTable(SerializationInfo info, StreamingContext context) : base(info, context)
            {
                this.InitVars();
            }
            ...
            {
                s_od_rekap_brutoDataSet.s_od_rekap_brutoDataTable table = (s_od_rekap_brutoDataSet.s_od_rekap_brutoDataTable) base.Clone();
                table.InitVars();
                return table;
            }
            ...
            {
                return typeof(s_od_rekap_brutoDataSet.s_od_rekap_brutoRow);
            }
            ...
            public void InitClass()
            {
                ...
                this.ExtendedProperties.Add("LevelName", "s_od_rekap_bruto");
                this.ExtendedProperties.Add("Description", "_S_OD_REKAP_BRUTO");
            ...
            {
                return new s_od_rekap_brutoDataSet.s_od_rekap_brutoRow(builder);
            }

            public s_od_rekap_brutoDataSet.s_od_rekap_brutoRow News_od_rekap_brutoRow()
            {
                return (s_od_rekap_brutoDataSet.s_od_rekap_brutoRow) this.NewRow();
            }

            protected override void OnRowChanged(DataRowChangeEventArgs e)
            {
                base.OnRowChanged(e);
                if (this.s_od_rekap_brutoRowChanged != null)
                {
                    s_od_rekap_brutoDataSet.s_od_rekap_brutoRowChangeEventHandler handler = this.s_od_rekap_brutoRowChanged;
                    if (handler != null)
                    {
                        handler(this, new s_od_rekap_brutoDataSet.s_od_rekap_brutoRowChangeEvent((s_od_rekap_brutoDataSet.s_od_rekap_brutoRow) e.Row, e.Action));
                    }
                }
            }
            ...
            protected override void OnRowChanging(DataRowChangeEventArgs e)
            {
                ...
                if (this.s_od_rekap_brutoRowChanging != null)
                {
                    s_od_rekap_brutoDataSet.s_od_rekap_brutoRowChangeEventHandler handler = this.s_od_rekap_brutoRowChanging;
                    if (handler != null)
                    {
                        handler(this, new s_od_rekap_brutoDataSet.s_od_rekap_brutoRowChangeEvent((s_od_rekap_brutoDataSet.s_od_rekap_brutoRow) e.Row, e.Action));
                    }
            ...
            {
                base.OnRowDeleted(e);
                if (this.s_od_rekap_brutoRowDeleted != null)
                {
                    s_od_rekap_brutoDataSet.s_od_rekap_brutoRowChangeEventHandler handler = this.s_od_rekap_brutoRowDeleted;
                    if (handler != null)
                    {
                        handler(this, new s_od_rekap_brutoDataSet.s_od_rekap_brutoRowChangeEvent((s_od_rekap_brutoDataSet.s_od_rekap_brutoRow) e.Row, e.Action));
                    }
            ...
            protected override void OnRowDeleting(DataRowChangeEventArgs e)
            {
                ...
                if (this.s_od_rekap_brutoRowDeleting != null)
                {
                    s_od_rekap_brutoDataSet.s_od_rekap_brutoRowChangeEventHandler handler = this.s_od_rekap_brutoRowDeleting;
                    if (handler != null)
                    {
                        handler(this, new s_od_rekap_brutoDataSet.s_od_rekap_brutoRowChangeEvent((s_od_rekap_brutoDataSet.s_od_rekap_brutoRow) e.Row, e.Action));
                    }
            ...
            public s_od_rekap_brutoDataSet.s_od_rekap_brutoRow this[int index]
            {
                get
                {
                    return (s_od_rekap_brutoDataSet.s_od_rekap_brutoRow) this.Rows[index];
                }
            }
        ...
        public class s_od_rekap_brutoRow : DataRow
        {
            private s_od_rekap_brutoDataSet.s_od_rekap_brutoDataTable tables_od_rekap_bruto;

            internal s_od_rekap_brutoRow(DataRowBuilder rb) : base(rb)
            {
                this.tables_od_rekap_bruto = (s_od_rekap_brutoDataSet.s_od_rekap_brutoDataTable) this.Table;
            }

            public bool IsIDRADNIKNull()
            {
                return this.IsNull(this.tables_od_rekap_bruto.IDRADNIKColumn);
            }

            public bool IsIDVRSTAELEMENTANull()
            {
                return this.IsNull(this.tables_od_rekap_bruto.IDVRSTAELEMENTAColumn);
            }

            public bool IsIMENull()
            {
                return this.IsNull(this.tables_od_rekap_bruto.IMEColumn);
            }

            public bool IsIZNOSNull()
            {
                return this.IsNull(this.tables_od_rekap_bruto.IZNOSColumn);
            }

            public bool IsJMBGNull()
            {
                return this.IsNull(this.tables_od_rekap_bruto.JMBGColumn);
            }

            public bool IsNAZIVELEMENTNull()
            {
                return this.IsNull(this.tables_od_rekap_bruto.NAZIVELEMENTColumn);
            }

            public bool IsNAZIVVRSTAELEMENTNull()
            {
                return this.IsNull(this.tables_od_rekap_bruto.NAZIVVRSTAELEMENTColumn);
            }

            public bool IsPREZIMENull()
            {
                return this.IsNull(this.tables_od_rekap_bruto.PREZIMEColumn);
            }

            public bool IssatiNull()
            {
                return this.IsNull(this.tables_od_rekap_bruto.satiColumn);
            }

            public void SetIDRADNIKNull()
            {
                this[this.tables_od_rekap_bruto.IDRADNIKColumn] = RuntimeHelpers.GetObjectValue(Convert.DBNull);
            }

            public void SetIDVRSTAELEMENTANull()
            {
                this[this.tables_od_rekap_bruto.IDVRSTAELEMENTAColumn] = RuntimeHelpers.GetObjectValue(Convert.DBNull);
            }

            public void SetIMENull()
            {
                this[this.tables_od_rekap_bruto.IMEColumn] = RuntimeHelpers.GetObjectValue(Convert.DBNull);
            }

            public void SetIZNOSNull()
            {
                this[this.tables_od_rekap_bruto.IZNOSColumn] = RuntimeHelpers.GetObjectValue(Convert.DBNull);
            }

            public void SetJMBGNull()
            {
                this[this.tables_od_rekap_bruto.JMBGColumn] = RuntimeHelpers.GetObjectValue(Convert.DBNull);
            }

            public void SetNAZIVELEMENTNull()
            {
                this[this.tables_od_rekap_bruto.NAZIVELEMENTColumn] = RuntimeHelpers.GetObjectValue(Convert.DBNull);
            }

            public void SetNAZIVVRSTAELEMENTNull()
            {
                this[this.tables_od_rekap_bruto.NAZIVVRSTAELEMENTColumn] = RuntimeHelpers.GetObjectValue(Convert.DBNull);
            }

            public void SetPREZIMENull()
            {
                this[this.tables_od_rekap_bruto.PREZIMEColumn] = RuntimeHelpers.GetObjectValue(Convert.DBNull);
            }

            public void SetsatiNull()
            {
                this[this.tables_od_rekap_bruto.satiColumn] = RuntimeHelpers.GetObjectValue(Convert.DBNull);
            }
            ...
            public int IDRADNIK
            {
                get
                {
                    ...
                    try
                    {
                        num = Conversions.ToInteger(this[this.tables_od_rekap_bruto.IDRADNIKColumn]);
                    }
                ...
                set
                {
                    this[this.tables_od_rekap_bruto.IDRADNIKColumn] = value;
                }
            }
            ...
            public short IDVRSTAELEMENTA
            {
                get
                {
                    ...
                    try
                    {
                        num = Conversions.ToShort(this[this.tables_od_rekap_bruto.IDVRSTAELEMENTAColumn]);
                    }
                    catch (InvalidCastException exception1)
                    {
                        throw exception1;
                ...
                set
                {
                    this[this.tables_od_rekap_bruto.IDVRSTAELEMENTAColumn] = value;
                }
            }
            ...
            public string IME
            {
                get
                {
                    ...
                    try
                    {
                        str = Conversions.ToString(this[this.tables_od_rekap_bruto.IMEColumn]);
                    }
                    catch (InvalidCastException exception1)
                    {
                        throw exception1;
                ...
                set
                {
                    this[this.tables_od_rekap_bruto.IMEColumn] = value;
                }
            }
            ...
            public decimal IZNOS
            {
                get
                {
                    ...
                    try
                    {
                        num = Conversions.ToDecimal(this[this.tables_od_rekap_bruto.IZNOSColumn]);
                    }
                    catch (InvalidCastException exception1)
                    {
                        throw exception1;
                ...
                set
                {
                    this[this.tables_od_rekap_bruto.IZNOSColumn] = value;
                }
            }
            ...
            public string JMBG
            {
                get
                {
                    ...
                    try
                    {
                        str = Conversions.ToString(this[this.tables_od_rekap_bruto.JMBGColumn]);
                    }
                    catch (InvalidCastException exception1)
                    {
                        throw exception1;
                ...
                set
                {
                    this[this.tables_od_rekap_bruto.JMBGColumn] = value;
                }
            }
            ...
            public string NAZIVELEMENT
            {
                get
                {
                    ...
                    try
                    {
                        str = Conversions.ToString(this[this.tables_od_rekap_bruto.NAZIVELEMENTColumn]);
                    }
                    catch (InvalidCastException exception1)
                    {
                        throw exception1;
                ...
                set
                {
                    this[this.tables_od_rekap_bruto.NAZIVELEMENTColumn] = value;
                }
            }
            ...
            public string NAZIVVRSTAELEMENT
            {
                get
                {
                    ...
                    try
                    {
                        str = Conversions.ToString(this[this.tables_od_rekap_bruto.NAZIVVRSTAELEMENTColumn]);
                    }
                    catch (InvalidCastException exception1)
                    {
                        throw exception1;
                ...
                set
                {
                    this[this.tables_od_rekap_bruto.NAZIVVRSTAELEMENTColumn] = value;
                }
            }
            ...
            public string PREZIME
            {
                get
                {
                    ...
                    try
                    {
                        str = Conversions.ToString(this[this.tables_od_rekap_bruto.PREZIMEColumn]);
                    }
                    catch (InvalidCastException exception1)
                    {
                        throw exception1;
                ...
                set
                {
                    this[this.tables_od_rekap_bruto.PREZIMEColumn] = value;
                }
            }
            ...
            public decimal sati
            {
                get
                {
                    ...
                    try
                    {
                        num = Conversions.ToDecimal(this[this.tables_od_rekap_bruto.satiColumn]);
                    }
                    catch (InvalidCastException exception1)
                    {
                        throw exception1;
                ...
                set
                {
                    this[this.tables_od_rekap_bruto.satiColumn] = value;
                }
            }
        }

        public class s_od_rekap_brutoRowChangeEvent : EventArgs
        {
            private DataRowAction eventAction;
            private s_od_rekap_brutoDataSet.s_od_rekap_brutoRow eventRow;
            ...
            public s_od_rekap_brutoDataSet.s_od_rekap_brutoRow Row
            {
                get
                {
        ...
        public delegate void s_od_rekap_brutoRowChangeEventHandler(object sender, s_od_rekap_brutoDataSet.s_od_rekap_brutoRowChangeEvent e);
    }
}
