namespace Placa
{
    ...
    public class S_PLACA_KONACNI_REKAPOPCINEDataAdapter : IDataAdapter, IS_PLACA_KONACNI_REKAPOPCINEDataAdapter
    {
        private string AV8IDOBRAC;
        private ReadWriteCommand cmS_PLACA_KONACNI_REKAPOPCINESelect1;
        private ReadWriteCommand cmS_PLACA_KONACNI_REKAPOPCINESelect2;
        ...
        private S_PLACA_KONACNI_REKAPOPCINEDataSet.S_PLACA_KONACNI_REKAPOPCINERow rowS_PLACA_KONACNI_REKAPOPCINE;
        private IDataReader S_PLACA_KONACNI_REKAPOPCINESelect1;
        private IDataReader S_PLACA_KONACNI_REKAPOPCINESelect2;
        private S_PLACA_KONACNI_REKAPOPCINEDataSet S_PLACA_KONACNI_REKAPOPCINESet;

        private void AddRowS_placa_konacni_rekapopcine()
        {
            this.S_PLACA_KONACNI_REKAPOPCINESet.S_PLACA_KONACNI_REKAPOPCINE.AddS_PLACA_KONACNI_REKAPOPCINERow(this.rowS_PLACA_KONACNI_REKAPOPCINE);
            this.rowS_PLACA_KONACNI_REKAPOPCINE.AcceptChanges();
        }
        ...
        public virtual int Fill(S_PLACA_KONACNI_REKAPOPCINEDataSet dataSet, string iDOBRACUN)
        {
            this.Initialize();
        ...
        {
            this.connDefault = this.dsDefault.GetReadWriteConnection(this.daCurrentTransaction);
            this.cmS_PLACA_KONACNI_REKAPOPCINESelect1 = this.connDefault.GetCommand("S_PLACA_KONACNI_REKAPOPCINE", true);
            this.cmS_PLACA_KONACNI_REKAPOPCINESelect1.IDbCommand.CommandType = CommandType.StoredProcedure;
            this.cmS_PLACA_KONACNI_REKAPOPCINESelect1.IDbCommand.Parameters.Clear();
            this.cmS_PLACA_KONACNI_REKAPOPCINESelect1.IDbCommand.Parameters.Add(this.dsDefault.GetDbParameter("@IDOBRACUN", iDOBRACUN));
            this.cmS_PLACA_KONACNI_REKAPOPCINESelect1.ErrorMask |= ErrorMask.Lock;
            this.S_PLACA_KONACNI_REKAPOPCINESelect1 = this.cmS_PLACA_KONACNI_REKAPOPCINESelect1.FetchData();
            if (this.S_PLACA_KONACNI_REKAPOPCINESelect1.IsDBNull(0))
            {
                this.m_RecordCount = 0;
            }
            else
            {
                this.m_RecordCount = this.S_PLACA_KONACNI_REKAPOPCINESelect1.GetInt32(0);
            }
            this.S_PLACA_KONACNI_REKAPOPCINESelect1.Close();
