namespace Placa
{
    ...
    public class vw_DD_MJESECI_GODINE_ISPLATEDataReader : IDisposable
    {
        private static string[] attributeNames = new string[] { "TM1.[MJESECISPLATE]", "TM1.[GODINAISPLATE]" };
        private ReadWriteCommand cmvw_DD_MJESECI_GODINE_ISPLATESelect3;
        ...
        private IDataReader vw_DD_MJESECI_GODINE_ISPLATESelect3;

        public vw_DD_MJESECI_GODINE_ISPLATEDataReader()
        {
        ...
        public void Dispose()
        {
            if (!this.m_Disposed)
            {
                ...
                try
                {
                    this.vw_DD_MJESECI_GODINE_ISPLATESelect3.Close();
                }
                finally
                {
                    try
        ...
        public IDataReader Open()
        {
            ...
            this.cmvw_DD_MJESECI_GODINE_ISPLATESelect3 = this.connDefault.GetCommand(this.scmdbuf, true);
            this.cmvw_DD_MJESECI_GODINE_ISPLATESelect3.ErrorMask |= ErrorMask.Lock;
            this.vw_DD_MJESECI_GODINE_ISPLATESelect3 = this.cmvw_DD_MJESECI_GODINE_ISPLATESelect3.ExecuteReader((CommandBehavior) Conversions.ToInteger(Interaction.IIf(this.daCurrentTransaction == null, Configuration.ReaderCommandBehavior, CommandBehavior.Default)));
            return this.vw_DD_MJESECI_GODINE_ISPLATESelect3;
        }
        ...
        public class OrderAttribute
        {
            ...
            public vw_DD_MJESECI_GODINE_ISPLATEDataReader.Attribute OrderAttributeName;
            public string OrderAttributeString;

            public OrderAttribute(vw_DD_MJESECI_GODINE_ISPLATEDataReader.Attribute orderAttributeName)
            {
                this.OrderAttributeName = orderAttributeName;
                this.OrderAttributeAscending = true;
                this.OrderAttributeString = vw_DD_MJESECI_GODINE_ISPLATEDataReader.attributeNames[(int) this.OrderAttributeName];
            }

            public OrderAttribute(vw_DD_MJESECI_GODINE_ISPLATEDataReader.Attribute orderAttributeName, bool orderAttributeAscending)
            {
                this.OrderAttributeName = orderAttributeName;
