namespace Placa
{
    ...
    public class VW_MJESECI_GODINE_OBRACUNADataReader : IDisposable
    {
        private static string[] attributeNames = new string[] { "[MJESECOBRACUNA]", "[GODINAOBRACUNA]" };
        private ReadWriteCommand cmVW_MJESECI_GODINE_OBRACUNASelect3;
        ...
        private IDataReader VW_MJESECI_GODINE_OBRACUNASelect3;

        public VW_MJESECI_GODINE_OBRACUNADataReader()
        {
        ...
        public void Dispose()
        {
            if (!this.m_Disposed)
            {
                ...
                try
                {
                    this.VW_MJESECI_GODINE_OBRACUNASelect3.Close();
                }
                finally
                {
                    try
        ...
        public IDataReader Open()
        {
            ...
            this.cmVW_MJESECI_GODINE_OBRACUNASelect3 = this.connDefault.GetCommand(this.scmdbuf, true);
            this.cmVW_MJESECI_GODINE_OBRACUNASelect3.ErrorMask |= ErrorMask.Lock;
            this.VW_MJESECI_GODINE_OBRACUNASelect3 = this.cmVW_MJESECI_GODINE_OBRACUNASelect3.ExecuteReader((CommandBehavior) Conversions.ToInteger(Interaction.IIf(this.daCurrentTransaction == null, Configuration.ReaderCommandBehavior, CommandBehavior.Default)));
            return this.VW_MJESECI_GODINE_OBRACUNASelect3;
        }
        ...
        public class OrderAttribute
        {
            ...
            public VW_MJESECI_GODINE_OBRACUNADataReader.Attribute OrderAttributeName;
            public string OrderAttributeString;

            public OrderAttribute(VW_MJESECI_GODINE_OBRACUNADataReader.Attribute orderAttributeName)
            {
                this.OrderAttributeName = orderAttributeName;
                this.OrderAttributeAscending = true;
                this.OrderAttributeString = VW_MJESECI_GODINE_OBRACUNADataReader.attributeNames[(int) this.OrderAttributeName];
            }

            public OrderAttribute(VW_MJESECI_GODINE_OBRACUNADataReader.Attribute orderAttributeName, bool orderAttributeAscending)
            {
                this.OrderAttributeName = orderAttributeName;
