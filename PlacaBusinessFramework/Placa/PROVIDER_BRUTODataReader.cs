namespace Placa
{
    ...
    public class PROVIDER_BRUTODataReader : IDisposable
    {
        ...
        public PROVIDER_BRUTODataReader()
        {
        ...
        public class OrderAttribute
        {
            ...
            public PROVIDER_BRUTODataReader.Attribute OrderAttributeName;
            public string OrderAttributeString;

            public OrderAttribute(PROVIDER_BRUTODataReader.Attribute orderAttributeName)
            {
                this.OrderAttributeName = orderAttributeName;
                this.OrderAttributeAscending = true;
                this.OrderAttributeString = PROVIDER_BRUTODataReader.attributeNames[(int) this.OrderAttributeName];
            }

            public OrderAttribute(PROVIDER_BRUTODataReader.Attribute orderAttributeName, bool orderAttributeAscending)
            {
                this.OrderAttributeName = orderAttributeName;
