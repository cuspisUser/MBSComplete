namespace Placa
{
    ...
    public class S_PLACA_RAD1G_IIIDataReader : IDisposable
    {
        private ReadWriteCommand cmS_PLACA_RAD1G_IIISelect3;
        private ReadWriteConnection connDefault;
        private IDbTransaction daCurrentTransaction;
        private DataStore dsDefault;
        private bool m_Disposed;
        private IDataReader S_PLACA_RAD1G_IIISelect3;
        ...
        public void Dispose()
        {
            if (!this.m_Disposed)
            {
                ...
                try
                {
                    this.S_PLACA_RAD1G_IIISelect3.Close();
                }
                finally
                {
                    try
