namespace Placa
{
    ...
    public class VW_GODINE_ISPLATEDataReader : IDisposable
    {
        private static string[] attributeNames = new string[] { "[godinaisplaTE]" };
        private ReadWriteCommand cmVW_GODINE_ISPLATESelect3;
        ...
        private IDataReader VW_GODINE_ISPLATESelect3;

        public VW_GODINE_ISPLATEDataReader()
        {
        ...
        public void Dispose()
        {
            if (!this.m_Disposed)
            {
                ...
                try
                {
                    this.VW_GODINE_ISPLATESelect3.Close();
                }
                finally
                {
                    try
        ...
        public IDataReader Open()
        {
            ...
            this.cmVW_GODINE_ISPLATESelect3 = this.connDefault.GetCommand(this.scmdbuf, true);
            this.cmVW_GODINE_ISPLATESelect3.ErrorMask |= ErrorMask.Lock;
            this.VW_GODINE_ISPLATESelect3 = this.cmVW_GODINE_ISPLATESelect3.ExecuteReader((CommandBehavior) Conversions.ToInteger(Interaction.IIf(this.daCurrentTransaction == null, Configuration.ReaderCommandBehavior, CommandBehavior.Default)));
            return this.VW_GODINE_ISPLATESelect3;
        }
        ...
        public class OrderAttribute
        {
            ...
            public VW_GODINE_ISPLATEDataReader.Attribute OrderAttributeName;
            public string OrderAttributeString;

            public OrderAttribute(VW_GODINE_ISPLATEDataReader.Attribute orderAttributeName)
            {
                this.OrderAttributeName = orderAttributeName;
                this.OrderAttributeAscending = true;
                this.OrderAttributeString = VW_GODINE_ISPLATEDataReader.attributeNames[(int) this.OrderAttributeName];
            }

            public OrderAttribute(VW_GODINE_ISPLATEDataReader.Attribute orderAttributeName, bool orderAttributeAscending)
            {
                this.OrderAttributeName = orderAttributeName;
