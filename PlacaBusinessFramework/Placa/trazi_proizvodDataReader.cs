namespace Placa
{
    ...
    public class trazi_proizvodDataReader : IDisposable
    {
        ...
        public trazi_proizvodDataReader()
        {
        ...
        public IDataReader Open(string nazivproizvod)
        {
            this.init_reader();
            ...
            this.cmPROIZVODSelect3 = this.connDefault.GetCommand(this.scmdbuf, false);
            if (this.cmPROIZVODSelect3.IDbCommand.Parameters.Count == 0)
            {
                this.cmPROIZVODSelect3.IDbCommand.Parameters.Add(this.dsDefault.GetDbParameter("@nazivproizvod", DbType.String, 500));
            }
            this.lV8nazivpr = StringUtil.PadRight(StringUtil.RTrim(nazivproizvod), 500, "%");
            this.cmPROIZVODSelect3.SetParameter(0, this.lV8nazivpr);
            this.cmPROIZVODSelect3.ErrorMask |= ErrorMask.Lock;
            this.PROIZVODSelect3 = this.cmPROIZVODSelect3.ExecuteReader((CommandBehavior) Conversions.ToInteger(Interaction.IIf(this.daCurrentTransaction == null, Configuration.ReaderCommandBehavior, CommandBehavior.Default)));
            return this.PROIZVODSelect3;
        }
        ...
        public class OrderAttribute
        {
            ...
            public trazi_proizvodDataReader.Attribute OrderAttributeName;
            public string OrderAttributeString;

            public OrderAttribute(trazi_proizvodDataReader.Attribute orderAttributeName)
            {
                this.OrderAttributeName = orderAttributeName;
                this.OrderAttributeAscending = true;
                this.OrderAttributeString = trazi_proizvodDataReader.attributeNames[(int) this.OrderAttributeName];
            }

            public OrderAttribute(trazi_proizvodDataReader.Attribute orderAttributeName, bool orderAttributeAscending)
            {
                this.OrderAttributeName = orderAttributeName;
