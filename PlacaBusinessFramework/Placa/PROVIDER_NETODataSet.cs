namespace Placa
{
    ...
    [Serializable]
    public class PROVIDER_NETODataSet : DataSet
    {
        private System.Data.SchemaSerializationMode _schemaSerializationMode;
        private ELEMENTDataTable tableELEMENT;

        public PROVIDER_NETODataSet()
        {
        ...
        protected PROVIDER_NETODataSet(SerializationInfo info, StreamingContext context) : base(info, context, false)
        {
            this._schemaSerializationMode = System.Data.SchemaSerializationMode.IncludeSchema;
        ...
        {
            PROVIDER_NETODataSet set = (PROVIDER_NETODataSet) base.Clone();
            set.InitVars();
            return set;
        }
        ...
        {
            PROVIDER_NETODataSet set = new PROVIDER_NETODataSet();
        ...
        {
            this.InitClassBase();
            this.ExtendedProperties.Add("DataAdapterName", "PROVIDER_NETODataAdapter");
            this.ExtendedProperties.Add("BigImage", " ");
            this.ExtendedProperties.Add("SmallImage", " ");
            this.ExtendedProperties.Add("Image", " ");
            this.ExtendedProperties.Add("Deklarit.PermissionBaseId", "2011");
            this.ExtendedProperties.Add("DataSetName", "PROVIDER_NETODataSet");
            this.ExtendedProperties.Add("DataAdapterInterfaceName", "IPROVIDER_NETODataAdapter");
            this.ExtendedProperties.Add("ObjectName", "PROVIDER_NETO");
            this.ExtendedProperties.Add("ObjectDescription", "PROVIDER_NETO");
        ...
        {
            this.DataSetName = "PROVIDER_NETODataSet";
            this.Namespace = "http://www.tempuri.org/PROVIDER_NETO";
        ...
        public class ELEMENTDataTable : DataTable, IEnumerable
        {
            ...
            public event PROVIDER_NETODataSet.ELEMENTRowChangeEventHandler ELEMENTRowChanged;

            public event PROVIDER_NETODataSet.ELEMENTRowChangeEventHandler ELEMENTRowChanging;

            public event PROVIDER_NETODataSet.ELEMENTRowChangeEventHandler ELEMENTRowDeleted;

            public event PROVIDER_NETODataSet.ELEMENTRowChangeEventHandler ELEMENTRowDeleting;
            ...
            public void AddELEMENTRow(PROVIDER_NETODataSet.ELEMENTRow row)
            {
                this.Rows.Add(row);
            }

            public PROVIDER_NETODataSet.ELEMENTRow AddELEMENTRow(int iDELEMENT, string nAZIVELEMENT, short iDVRSTAELEMENTA, string eL)
            {
                PROVIDER_NETODataSet.ELEMENTRow row = (PROVIDER_NETODataSet.ELEMENTRow) this.NewRow();
                row.ItemArray = new object[] { iDELEMENT, nAZIVELEMENT, iDVRSTAELEMENTA, eL };
                this.Rows.Add(row);
                return row;
            }
            ...
            {
                PROVIDER_NETODataSet.ELEMENTDataTable table = (PROVIDER_NETODataSet.ELEMENTDataTable) base.Clone();
                table.InitVars();
                return table;
            }
            ...
            {
                return typeof(PROVIDER_NETODataSet.ELEMENTRow);
            }
            ...
            public void InitClass()
            {
                ...
                this.ExtendedProperties.Add("LevelName", "PROVIDER_NETO");
            ...
            public PROVIDER_NETODataSet.ELEMENTRow NewELEMENTRow()
            {
                return (PROVIDER_NETODataSet.ELEMENTRow) this.NewRow();
            }

            protected override DataRow NewRowFromBuilder(DataRowBuilder builder)
            {
                return new PROVIDER_NETODataSet.ELEMENTRow(builder);
            }
            ...
            protected override void OnRowChanged(DataRowChangeEventArgs e)
            {
                ...
                {
                    PROVIDER_NETODataSet.ELEMENTRowChangeEventHandler eLEMENTRowChangedEvent = this.ELEMENTRowChanged;
                    if (eLEMENTRowChangedEvent != null)
                    {
                        eLEMENTRowChangedEvent(this, new PROVIDER_NETODataSet.ELEMENTRowChangeEvent((PROVIDER_NETODataSet.ELEMENTRow) e.Row, e.Action));
                    }
                }
            }
            ...
            protected override void OnRowChanging(DataRowChangeEventArgs e)
            {
                ...
                {
                    PROVIDER_NETODataSet.ELEMENTRowChangeEventHandler eLEMENTRowChangingEvent = this.ELEMENTRowChanging;
                    if (eLEMENTRowChangingEvent != null)
                    {
                        eLEMENTRowChangingEvent(this, new PROVIDER_NETODataSet.ELEMENTRowChangeEvent((PROVIDER_NETODataSet.ELEMENTRow) e.Row, e.Action));
                    }
                }
            }
            ...
            protected override void OnRowDeleted(DataRowChangeEventArgs e)
            {
                ...
                {
                    PROVIDER_NETODataSet.ELEMENTRowChangeEventHandler eLEMENTRowDeletedEvent = this.ELEMENTRowDeleted;
                    if (eLEMENTRowDeletedEvent != null)
                    {
                        eLEMENTRowDeletedEvent(this, new PROVIDER_NETODataSet.ELEMENTRowChangeEvent((PROVIDER_NETODataSet.ELEMENTRow) e.Row, e.Action));
                    }
                }
            }
            ...
            protected override void OnRowDeleting(DataRowChangeEventArgs e)
            {
                ...
                {
                    PROVIDER_NETODataSet.ELEMENTRowChangeEventHandler eLEMENTRowDeletingEvent = this.ELEMENTRowDeleting;
                    if (eLEMENTRowDeletingEvent != null)
                    {
                        eLEMENTRowDeletingEvent(this, new PROVIDER_NETODataSet.ELEMENTRowChangeEvent((PROVIDER_NETODataSet.ELEMENTRow) e.Row, e.Action));
                    }
                }
            }

            public void RemoveELEMENTRow(PROVIDER_NETODataSet.ELEMENTRow row)
            {
            ...
            public PROVIDER_NETODataSet.ELEMENTRow this[int index]
            {
                get
                {
                    return (PROVIDER_NETODataSet.ELEMENTRow) this.Rows[index];
                }
            }
        ...
        {
            private PROVIDER_NETODataSet.ELEMENTDataTable tableELEMENT;

            internal ELEMENTRow(DataRowBuilder rb) : base(rb)
            {
                this.tableELEMENT = (PROVIDER_NETODataSet.ELEMENTDataTable) this.Table;
            }
        ...
        public class ELEMENTRowChangeEvent : EventArgs
        {
            ...
            private PROVIDER_NETODataSet.ELEMENTRow eventRow;

            public ELEMENTRowChangeEvent(PROVIDER_NETODataSet.ELEMENTRow row, DataRowAction action)
            {
                this.eventRow = row;
            ...
            public PROVIDER_NETODataSet.ELEMENTRow Row
            {
                get
                {
        ...
        public delegate void ELEMENTRowChangeEventHandler(object sender, PROVIDER_NETODataSet.ELEMENTRowChangeEvent e);
    }
}
